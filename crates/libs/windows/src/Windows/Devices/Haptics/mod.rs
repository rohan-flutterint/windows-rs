...
impl KnownSimpleHapticsControllerWaveforms {
    pub fn Click() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics(|this| unsafe {
            ...
            ::windows_core::vcall!(this.Click(&mut result__)).from_abi(result__)
        })
    }
    pub fn BuzzContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BuzzContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn RumbleContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RumbleContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn Press() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Press(&mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn BrushContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BrushContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn ChiselMarkerContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ChiselMarkerContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn EraserContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.EraserContinuous(&mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn GalaxyPenContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GalaxyPenContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn Hover() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Hover(&mut result__)).from_abi(result__)
        })
    }
    pub fn InkContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.InkContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn MarkerContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MarkerContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn PencilContinuous() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PencilContinuous(&mut result__)).from_abi(result__)
        })
    }
    pub fn Success() -> ::windows_core::Result<u16> {
        Self::IKnownSimpleHapticsControllerWaveformsStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Success(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl SimpleHapticsController {
    ...
    pub fn SupportedFeedback(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVectorView<SimpleHapticsControllerFeedback>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SupportedFeedback(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsIntensitySupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsIntensitySupported(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsPlayCountSupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsPlayCountSupported(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsPlayDurationSupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsPlayDurationSupported(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsReplayPauseIntervalSupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsReplayPauseIntervalSupported(&mut result__)).from_abi(result__)
        }
    }
    pub fn StopFeedback(&self) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.StopFeedback()).ok() }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SendHapticFeedback(feedback.into_param().abi())).ok() }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SendHapticFeedbackWithIntensity(feedback.into_param().abi(), intensity)).ok() }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SendHapticFeedbackForDuration(feedback.into_param().abi(), intensity, playduration)).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SendHapticFeedbackForPlayCount(feedback.into_param().abi(), intensity, playcount, replaypauseinterval)).ok() }
    }
}
...
impl SimpleHapticsControllerFeedback {
    pub fn Waveform(&self) -> ::windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Waveform(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
