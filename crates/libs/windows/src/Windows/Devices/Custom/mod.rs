...
impl IIOControlCode {
    pub fn AccessMode(&self) -> ::windows_core::Result<IOControlAccessMode> {
        ...
        unsafe {
            ...
            ::windows_core::vcall!(this.AccessMode(&mut result__)).from_abi(result__)
        }
    }
    pub fn BufferingMethod(&self) -> ::windows_core::Result<IOControlBufferingMethod> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BufferingMethod(&mut result__)).from_abi(result__)
        }
    }
    pub fn Function(&self) -> ::windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Function(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn ControlCode(&self) -> ::windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ControlCode(&mut result__)).from_abi(result__)
        }
    }
}
...
impl CustomDevice {
        ...
        P2: ::windows_core::TryIntoParam<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SendIOControlAsync(iocontrolcode.try_into_param()?.abi(), inputbuffer.try_into_param()?.abi(), outputbuffer.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`, `\"Storage_Streams\"`"]
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
        ...
        P2: ::windows_core::TryIntoParam<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TrySendIOControlAsync(iocontrolcode.try_into_param()?.abi(), inputbuffer.try_into_param()?.abi(), outputbuffer.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        }
    }
    pub fn GetDeviceSelector(classguid: ::windows_core::GUID) -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICustomDeviceStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelector(classguid, &mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn FromIdAsync(deviceid: &::windows_core::HSTRING, desiredaccess: DeviceAccessMode, sharingmode: DeviceSharingMode) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<CustomDevice>> {
        Self::ICustomDeviceStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FromIdAsync(::core::mem::transmute_copy(deviceid), desiredaccess, sharingmode, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl IOControlCode {
    ...
    pub fn CreateIOControlCode(devicetype: u16, function: u16, accessmode: IOControlAccessMode, bufferingmethod: IOControlBufferingMethod) -> ::windows_core::Result<IOControlCode> {
        Self::IIOControlCodeFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateIOControlCode(devicetype, function, accessmode, bufferingmethod, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
