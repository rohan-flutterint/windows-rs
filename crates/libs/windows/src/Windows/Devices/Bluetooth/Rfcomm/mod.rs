...
impl RfcommDeviceService {
    ...
    pub fn ConnectionHostName(&self) -> ::windows_core::Result<super::super::super::Networking::HostName> {
        ...
        unsafe {
            ...
            ::windows_core::vcall!(this.ConnectionHostName(&mut result__)).from_abi(result__)
        }
    }
    pub fn ConnectionServiceName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ConnectionServiceName(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn MaxProtectionLevel(&self) -> ::windows_core::Result<super::super::super::Networking::Sockets::SocketProtectionLevel> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MaxProtectionLevel(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn GetSdpRawAttributesAsync(&self) -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<super::super::super::Foundation::Collections::IMapView<u32, super::super::super::Storage::Streams::IBuffer>>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetSdpRawAttributesAsync(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation_Collections\"`, `\"Storage_Streams\"`"]
    #[cfg(all(feature = "Foundation_Collections", feature = "Storage_Streams"))]
    pub fn GetSdpRawAttributesWithCacheModeAsync(&self, cachemode: super::BluetoothCacheMode) -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<super::super::super::Foundation::Collections::IMapView<u32, super::super::super::Storage::Streams::IBuffer>>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetSdpRawAttributesWithCacheModeAsync(cachemode, &mut result__)).from_abi(result__)
        }
    }
        ...
        P0: ::windows_core::IntoParam<RfcommServiceId>,
    {
        Self::IRfcommDeviceServiceStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelector(serviceid.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
        ...
        P0: ::windows_core::IntoParam<super::BluetoothDevice>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelectorForBluetoothDevice(bluetoothdevice.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
        ...
        P0: ::windows_core::IntoParam<super::BluetoothDevice>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelectorForBluetoothDeviceWithCacheMode(bluetoothdevice.into_param().abi(), cachemode, &mut result__)).from_abi(result__)
        })
    }
        ...
        P1: ::windows_core::IntoParam<RfcommServiceId>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelectorForBluetoothDeviceAndServiceId(bluetoothdevice.into_param().abi(), serviceid.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
        ...
        P1: ::windows_core::IntoParam<RfcommServiceId>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode(bluetoothdevice.into_param().abi(), serviceid.into_param().abi(), cachemode, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl RfcommServiceId {
    ...
    pub fn AsShortId(&self) -> ::windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AsShortId(&mut result__)).from_abi(result__)
        }
    }
    pub fn AsString(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AsString(&mut result__)).from_abi(result__)
        }
    }
    pub fn FromUuid(uuid: ::windows_core::GUID) -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FromUuid(uuid, &mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn SerialPort() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SerialPort(&mut result__)).from_abi(result__)
        })
    }
    pub fn ObexObjectPush() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ObexObjectPush(&mut result__)).from_abi(result__)
        })
    }
    pub fn ObexFileTransfer() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ObexFileTransfer(&mut result__)).from_abi(result__)
        })
    }
    pub fn PhoneBookAccessPce() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PhoneBookAccessPce(&mut result__)).from_abi(result__)
        })
    }
    pub fn PhoneBookAccessPse() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PhoneBookAccessPse(&mut result__)).from_abi(result__)
        })
    }
    pub fn GenericFileTransfer() -> ::windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GenericFileTransfer(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl RfcommServiceProvider {
    ...
    pub fn SdpRawAttributes(&self) -> ::windows_core::Result<super::super::super::Foundation::Collections::IMap<u32, super::super::super::Storage::Streams::IBuffer>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SdpRawAttributes(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Networking_Sockets\"`"]
    #[cfg(feature = "Networking_Sockets")]
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.StartAdvertising(listener.into_param().abi())).ok() }
    }
        ...
        P0: ::windows_core::IntoParam<super::super::super::Networking::Sockets::StreamSocketListener>,
    {
        ...
        unsafe { ::windows_core::vcall!(this.StartAdvertisingWithRadioDiscoverability(listener.into_param().abi(), radiodiscoverable)).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<RfcommServiceId>,
    {
        Self::IRfcommServiceProviderStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateAsync(serviceid.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
