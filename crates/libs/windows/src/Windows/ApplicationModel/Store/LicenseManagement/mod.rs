...
impl LicenseManager {
        ...
        P0: ::windows_core::TryIntoParam<super::super::super::Storage::Streams::IBuffer>,
    {
        Self::ILicenseManagerStatics(|this| unsafe {
            ...
            ::windows_core::vcall!(this.AddLicenseAsync(license.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
        ...
        P1: ::windows_core::TryIntoParam<super::super::super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        Self::ILicenseManagerStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetSatisfactionInfosAsync(contentids.try_into_param()?.abi(), keyids.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn RefreshLicensesAsync(refreshoption: LicenseRefreshOption) -> ::windows_core::Result<super::super::super::Foundation::IAsyncAction> {
        Self::ILicenseManagerStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RefreshLicensesAsync(refreshoption, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl LicenseSatisfactionInfo {
    pub fn SatisfiedByDevice(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedByDevice(&mut result__)).from_abi(result__)
        }
    }
    pub fn SatisfiedByOpenLicense(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedByOpenLicense(&mut result__)).from_abi(result__)
        }
    }
    pub fn SatisfiedByTrial(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedByTrial(&mut result__)).from_abi(result__)
        }
    }
    pub fn SatisfiedByPass(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedByPass(&mut result__)).from_abi(result__)
        }
    }
    pub fn SatisfiedByInstallMedia(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedByInstallMedia(&mut result__)).from_abi(result__)
        }
    }
    pub fn SatisfiedBySignedInUser(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SatisfiedBySignedInUser(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsSatisfied(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsSatisfied(&mut result__)).from_abi(result__)
        }
    }
}
...
impl LicenseSatisfactionResult {
    ...
    pub fn LicenseSatisfactionInfos(&self) -> ::windows_core::Result<super::super::super::Foundation::Collections::IMapView<::windows_core::HSTRING, LicenseSatisfactionInfo>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LicenseSatisfactionInfos(&mut result__)).from_abi(result__)
        }
    }
