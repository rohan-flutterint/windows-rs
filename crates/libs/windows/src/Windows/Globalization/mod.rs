...
impl ApplicationLanguages {
    pub fn PrimaryLanguageOverride() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::IApplicationLanguagesStatics(|this| unsafe {
            ...
            ::windows_core::vcall!(this.PrimaryLanguageOverride(&mut result__)).from_abi(result__)
        })
    }
    pub fn SetPrimaryLanguageOverride(value: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        Self::IApplicationLanguagesStatics(|this| unsafe { ::windows_core::vcall!(this.SetPrimaryLanguageOverride(::core::mem::transmute_copy(value))).ok() })
    }
    ...
    pub fn ManifestLanguages() -> ::windows_core::Result<super::Foundation::Collections::IVectorView<::windows_core::HSTRING>> {
        Self::IApplicationLanguagesStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ManifestLanguages(&mut result__)).from_abi(result__)
        })
    }
        ...
        P0: ::windows_core::IntoParam<super::System::User>,
    {
        Self::IApplicationLanguagesStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetLanguagesForUser(user.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl Calendar {
    ...
    pub fn SetNumeralSystem(&self, value: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetNumeralSystem(::core::mem::transmute_copy(value))).ok() }
    }
    ...
    pub fn ChangeCalendarSystem(&self, value: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.ChangeCalendarSystem(::core::mem::transmute_copy(value))).ok() }
    }
    ...
    pub fn YearAsTruncatedString(&self, remainingdigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.YearAsTruncatedString(remainingdigits, &mut result__)).from_abi(result__)
        }
    }
    pub fn YearAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.YearAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn MonthAsString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MonthAsString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn MonthAsSoloString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MonthAsSoloString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn MonthAsPaddedNumericString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MonthAsPaddedNumericString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn DayAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DayAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn DayOfWeekAsString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DayOfWeekAsString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn DayOfWeekAsSoloString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DayOfWeekAsSoloString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn PeriodAsString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PeriodAsString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn HourAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HourAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn MinuteAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MinuteAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn SecondAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SecondAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn NanosecondAsPaddedString(&self, mindigits: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NanosecondAsPaddedString(mindigits, &mut result__)).from_abi(result__)
        }
    }
        ...
        P0: ::windows_core::IntoParam<Calendar>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Compare(other.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    ...
    pub fn NumberOfSecondsInThisMinute(&self) -> ::windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NumberOfSecondsInThisMinute(&mut result__)).from_abi(result__)
        }
    }
        ...
        P0: ::windows_core::TryIntoParam<super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        Self::ICalendarFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateCalendarDefaultCalendarAndClock(languages.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
        ...
        P0: ::windows_core::TryIntoParam<super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        Self::ICalendarFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateCalendar(languages.try_into_param()?.abi(), ::core::mem::transmute_copy(calendar), ::core::mem::transmute_copy(clock), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
        ...
        P0: ::windows_core::TryIntoParam<super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        Self::ICalendarFactory2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateCalendarWithTimeZone(languages.try_into_param()?.abi(), ::core::mem::transmute_copy(calendar), ::core::mem::transmute_copy(clock), ::core::mem::transmute_copy(timezoneid), &mut result__)).from_abi(result__)
        })
    }
    ...
    pub fn ChangeTimeZone(&self, timezoneid: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<ITimeZoneOnCalendar>(self)?;
        unsafe { ::windows_core::vcall!(this.ChangeTimeZone(::core::mem::transmute_copy(timezoneid))).ok() }
    }
    ...
    pub fn TimeZoneAsString(&self, ideallength: i32) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TimeZoneAsString(ideallength, &mut result__)).from_abi(result__)
        }
    }
    #[doc(hidden)]
...
impl CalendarIdentifiers {
    pub fn Gregorian() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Gregorian(&mut result__)).from_abi(result__)
        })
    }
    pub fn Hebrew() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Hebrew(&mut result__)).from_abi(result__)
        })
    }
    pub fn Hijri() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Hijri(&mut result__)).from_abi(result__)
        })
    }
    pub fn Japanese() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Japanese(&mut result__)).from_abi(result__)
        })
    }
    pub fn Julian() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Julian(&mut result__)).from_abi(result__)
        })
    }
    pub fn Korean() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Korean(&mut result__)).from_abi(result__)
        })
    }
    pub fn Taiwan() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Taiwan(&mut result__)).from_abi(result__)
        })
    }
    pub fn Thai() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Thai(&mut result__)).from_abi(result__)
        })
    }
    pub fn UmAlQura() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.UmAlQura(&mut result__)).from_abi(result__)
        })
    }
    pub fn Persian() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Persian(&mut result__)).from_abi(result__)
        })
    }
    pub fn ChineseLunar() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ChineseLunar(&mut result__)).from_abi(result__)
        })
    }
    pub fn JapaneseLunar() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.JapaneseLunar(&mut result__)).from_abi(result__)
        })
    }
    pub fn KoreanLunar() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KoreanLunar(&mut result__)).from_abi(result__)
        })
    }
    pub fn TaiwanLunar() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TaiwanLunar(&mut result__)).from_abi(result__)
        })
    }
    pub fn VietnameseLunar() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICalendarIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.VietnameseLunar(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl ClockIdentifiers {
    pub fn TwelveHour() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::IClockIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TwelveHour(&mut result__)).from_abi(result__)
        })
    }
    pub fn TwentyFourHour() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::IClockIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TwentyFourHour(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl CurrencyAmount {
    ...
    pub fn Create(amount: &::windows_core::HSTRING, currency: &::windows_core::HSTRING) -> ::windows_core::Result<CurrencyAmount> {
        Self::ICurrencyAmountFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Create(::core::mem::transmute_copy(amount), ::core::mem::transmute_copy(currency), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl CurrencyIdentifiers {
    pub fn AED() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AED(&mut result__)).from_abi(result__)
        })
    }
    pub fn AFN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AFN(&mut result__)).from_abi(result__)
        })
    }
    pub fn ALL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ALL(&mut result__)).from_abi(result__)
        })
    }
    pub fn AMD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AMD(&mut result__)).from_abi(result__)
        })
    }
    pub fn ANG() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ANG(&mut result__)).from_abi(result__)
        })
    }
    pub fn AOA() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AOA(&mut result__)).from_abi(result__)
        })
    }
    pub fn ARS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ARS(&mut result__)).from_abi(result__)
        })
    }
    pub fn AUD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AUD(&mut result__)).from_abi(result__)
        })
    }
    pub fn AWG() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AWG(&mut result__)).from_abi(result__)
        })
    }
    pub fn AZN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AZN(&mut result__)).from_abi(result__)
        })
    }
    pub fn BAM() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BAM(&mut result__)).from_abi(result__)
        })
    }
    pub fn BBD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BBD(&mut result__)).from_abi(result__)
        })
    }
    pub fn BDT() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BDT(&mut result__)).from_abi(result__)
        })
    }
    pub fn BGN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BGN(&mut result__)).from_abi(result__)
        })
    }
    pub fn BHD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BHD(&mut result__)).from_abi(result__)
        })
    }
    pub fn BIF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BIF(&mut result__)).from_abi(result__)
        })
    }
    pub fn BMD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BMD(&mut result__)).from_abi(result__)
        })
    }
    pub fn BND() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BND(&mut result__)).from_abi(result__)
        })
    }
    pub fn BOB() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BOB(&mut result__)).from_abi(result__)
        })
    }
    pub fn BRL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BRL(&mut result__)).from_abi(result__)
        })
    }
    pub fn BSD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BSD(&mut result__)).from_abi(result__)
        })
    }
    pub fn BTN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BTN(&mut result__)).from_abi(result__)
        })
    }
    pub fn BWP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BWP(&mut result__)).from_abi(result__)
        })
    }
    pub fn BYR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BYR(&mut result__)).from_abi(result__)
        })
    }
    pub fn BZD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BZD(&mut result__)).from_abi(result__)
        })
    }
    pub fn CAD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CAD(&mut result__)).from_abi(result__)
        })
    }
    pub fn CDF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CDF(&mut result__)).from_abi(result__)
        })
    }
    pub fn CHF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CHF(&mut result__)).from_abi(result__)
        })
    }
    pub fn CLP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CLP(&mut result__)).from_abi(result__)
        })
    }
    pub fn CNY() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CNY(&mut result__)).from_abi(result__)
        })
    }
    pub fn COP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.COP(&mut result__)).from_abi(result__)
        })
    }
    pub fn CRC() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CRC(&mut result__)).from_abi(result__)
        })
    }
    pub fn CUP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CUP(&mut result__)).from_abi(result__)
        })
    }
    pub fn CVE() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CVE(&mut result__)).from_abi(result__)
        })
    }
    pub fn CZK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CZK(&mut result__)).from_abi(result__)
        })
    }
    pub fn DJF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DJF(&mut result__)).from_abi(result__)
        })
    }
    pub fn DKK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DKK(&mut result__)).from_abi(result__)
        })
    }
    pub fn DOP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DOP(&mut result__)).from_abi(result__)
        })
    }
    pub fn DZD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DZD(&mut result__)).from_abi(result__)
        })
    }
    pub fn EGP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.EGP(&mut result__)).from_abi(result__)
        })
    }
    pub fn ERN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ERN(&mut result__)).from_abi(result__)
        })
    }
    pub fn ETB() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ETB(&mut result__)).from_abi(result__)
        })
    }
    pub fn EUR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.EUR(&mut result__)).from_abi(result__)
        })
    }
    pub fn FJD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FJD(&mut result__)).from_abi(result__)
        })
    }
    pub fn FKP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FKP(&mut result__)).from_abi(result__)
        })
    }
    pub fn GBP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GBP(&mut result__)).from_abi(result__)
        })
    }
    pub fn GEL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GEL(&mut result__)).from_abi(result__)
        })
    }
    pub fn GHS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GHS(&mut result__)).from_abi(result__)
        })
    }
    pub fn GIP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GIP(&mut result__)).from_abi(result__)
        })
    }
    pub fn GMD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GMD(&mut result__)).from_abi(result__)
        })
    }
    pub fn GNF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GNF(&mut result__)).from_abi(result__)
        })
    }
    pub fn GTQ() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GTQ(&mut result__)).from_abi(result__)
        })
    }
    pub fn GYD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GYD(&mut result__)).from_abi(result__)
        })
    }
    pub fn HKD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HKD(&mut result__)).from_abi(result__)
        })
    }
    pub fn HNL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HNL(&mut result__)).from_abi(result__)
        })
    }
    pub fn HRK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HRK(&mut result__)).from_abi(result__)
        })
    }
    pub fn HTG() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HTG(&mut result__)).from_abi(result__)
        })
    }
    pub fn HUF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HUF(&mut result__)).from_abi(result__)
        })
    }
    pub fn IDR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IDR(&mut result__)).from_abi(result__)
        })
    }
    pub fn ILS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ILS(&mut result__)).from_abi(result__)
        })
    }
    pub fn INR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.INR(&mut result__)).from_abi(result__)
        })
    }
    pub fn IQD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IQD(&mut result__)).from_abi(result__)
        })
    }
    pub fn IRR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IRR(&mut result__)).from_abi(result__)
        })
    }
    pub fn ISK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ISK(&mut result__)).from_abi(result__)
        })
    }
    pub fn JMD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.JMD(&mut result__)).from_abi(result__)
        })
    }
    pub fn JOD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.JOD(&mut result__)).from_abi(result__)
        })
    }
    pub fn JPY() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.JPY(&mut result__)).from_abi(result__)
        })
    }
    pub fn KES() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KES(&mut result__)).from_abi(result__)
        })
    }
    pub fn KGS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KGS(&mut result__)).from_abi(result__)
        })
    }
    pub fn KHR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KHR(&mut result__)).from_abi(result__)
        })
    }
    pub fn KMF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KMF(&mut result__)).from_abi(result__)
        })
    }
    pub fn KPW() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KPW(&mut result__)).from_abi(result__)
        })
    }
    pub fn KRW() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KRW(&mut result__)).from_abi(result__)
        })
    }
    pub fn KWD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KWD(&mut result__)).from_abi(result__)
        })
    }
    pub fn KYD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KYD(&mut result__)).from_abi(result__)
        })
    }
    pub fn KZT() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.KZT(&mut result__)).from_abi(result__)
        })
    }
    pub fn LAK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LAK(&mut result__)).from_abi(result__)
        })
    }
    pub fn LBP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LBP(&mut result__)).from_abi(result__)
        })
    }
    pub fn LKR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LKR(&mut result__)).from_abi(result__)
        })
    }
    pub fn LRD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LRD(&mut result__)).from_abi(result__)
        })
    }
    pub fn LSL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LSL(&mut result__)).from_abi(result__)
        })
    }
    pub fn LTL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LTL(&mut result__)).from_abi(result__)
        })
    }
    pub fn LVL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LVL(&mut result__)).from_abi(result__)
        })
    }
    pub fn LYD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LYD(&mut result__)).from_abi(result__)
        })
    }
    pub fn MAD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MAD(&mut result__)).from_abi(result__)
        })
    }
    pub fn MDL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MDL(&mut result__)).from_abi(result__)
        })
    }
    pub fn MGA() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MGA(&mut result__)).from_abi(result__)
        })
    }
    pub fn MKD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MKD(&mut result__)).from_abi(result__)
        })
    }
    pub fn MMK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MMK(&mut result__)).from_abi(result__)
        })
    }
    pub fn MNT() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MNT(&mut result__)).from_abi(result__)
        })
    }
    pub fn MOP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MOP(&mut result__)).from_abi(result__)
        })
    }
    pub fn MRO() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MRO(&mut result__)).from_abi(result__)
        })
    }
    pub fn MUR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MUR(&mut result__)).from_abi(result__)
        })
    }
    pub fn MVR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MVR(&mut result__)).from_abi(result__)
        })
    }
    pub fn MWK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MWK(&mut result__)).from_abi(result__)
        })
    }
    pub fn MXN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MXN(&mut result__)).from_abi(result__)
        })
    }
    pub fn MYR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MYR(&mut result__)).from_abi(result__)
        })
    }
    pub fn MZN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MZN(&mut result__)).from_abi(result__)
        })
    }
    pub fn NAD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NAD(&mut result__)).from_abi(result__)
        })
    }
    pub fn NGN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NGN(&mut result__)).from_abi(result__)
        })
    }
    pub fn NIO() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NIO(&mut result__)).from_abi(result__)
        })
    }
    pub fn NOK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NOK(&mut result__)).from_abi(result__)
        })
    }
    pub fn NPR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NPR(&mut result__)).from_abi(result__)
        })
    }
    pub fn NZD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NZD(&mut result__)).from_abi(result__)
        })
    }
    pub fn OMR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.OMR(&mut result__)).from_abi(result__)
        })
    }
    pub fn PAB() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PAB(&mut result__)).from_abi(result__)
        })
    }
    pub fn PEN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PEN(&mut result__)).from_abi(result__)
        })
    }
    pub fn PGK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PGK(&mut result__)).from_abi(result__)
        })
    }
    pub fn PHP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PHP(&mut result__)).from_abi(result__)
        })
    }
    pub fn PKR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PKR(&mut result__)).from_abi(result__)
        })
    }
    pub fn PLN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PLN(&mut result__)).from_abi(result__)
        })
    }
    pub fn PYG() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PYG(&mut result__)).from_abi(result__)
        })
    }
    pub fn QAR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.QAR(&mut result__)).from_abi(result__)
        })
    }
    pub fn RON() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RON(&mut result__)).from_abi(result__)
        })
    }
    pub fn RSD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RSD(&mut result__)).from_abi(result__)
        })
    }
    pub fn RUB() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RUB(&mut result__)).from_abi(result__)
        })
    }
    pub fn RWF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RWF(&mut result__)).from_abi(result__)
        })
    }
    pub fn SAR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SAR(&mut result__)).from_abi(result__)
        })
    }
    pub fn SBD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SBD(&mut result__)).from_abi(result__)
        })
    }
    pub fn SCR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SCR(&mut result__)).from_abi(result__)
        })
    }
    pub fn SDG() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SDG(&mut result__)).from_abi(result__)
        })
    }
    pub fn SEK() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SEK(&mut result__)).from_abi(result__)
        })
    }
    pub fn SGD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SGD(&mut result__)).from_abi(result__)
        })
    }
    pub fn SHP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SHP(&mut result__)).from_abi(result__)
        })
    }
    pub fn SLL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SLL(&mut result__)).from_abi(result__)
        })
    }
    pub fn SOS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SOS(&mut result__)).from_abi(result__)
        })
    }
    pub fn SRD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SRD(&mut result__)).from_abi(result__)
        })
    }
    pub fn STD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.STD(&mut result__)).from_abi(result__)
        })
    }
    pub fn SYP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SYP(&mut result__)).from_abi(result__)
        })
    }
    pub fn SZL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SZL(&mut result__)).from_abi(result__)
        })
    }
    pub fn THB() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.THB(&mut result__)).from_abi(result__)
        })
    }
    pub fn TJS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TJS(&mut result__)).from_abi(result__)
        })
    }
    pub fn TMT() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TMT(&mut result__)).from_abi(result__)
        })
    }
    pub fn TND() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TND(&mut result__)).from_abi(result__)
        })
    }
    pub fn TOP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TOP(&mut result__)).from_abi(result__)
        })
    }
    pub fn TRY() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TRY(&mut result__)).from_abi(result__)
        })
    }
    pub fn TTD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TTD(&mut result__)).from_abi(result__)
        })
    }
    pub fn TWD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TWD(&mut result__)).from_abi(result__)
        })
    }
    pub fn TZS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TZS(&mut result__)).from_abi(result__)
        })
    }
    pub fn UAH() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.UAH(&mut result__)).from_abi(result__)
        })
    }
    pub fn UGX() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.UGX(&mut result__)).from_abi(result__)
        })
    }
    pub fn USD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.USD(&mut result__)).from_abi(result__)
        })
    }
    pub fn UYU() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.UYU(&mut result__)).from_abi(result__)
        })
    }
    pub fn UZS() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.UZS(&mut result__)).from_abi(result__)
        })
    }
    pub fn VEF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.VEF(&mut result__)).from_abi(result__)
        })
    }
    pub fn VND() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.VND(&mut result__)).from_abi(result__)
        })
    }
    pub fn VUV() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.VUV(&mut result__)).from_abi(result__)
        })
    }
    pub fn WST() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.WST(&mut result__)).from_abi(result__)
        })
    }
    pub fn XAF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.XAF(&mut result__)).from_abi(result__)
        })
    }
    pub fn XCD() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.XCD(&mut result__)).from_abi(result__)
        })
    }
    pub fn XOF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.XOF(&mut result__)).from_abi(result__)
        })
    }
    pub fn XPF() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.XPF(&mut result__)).from_abi(result__)
        })
    }
    pub fn XXX() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.XXX(&mut result__)).from_abi(result__)
        })
    }
    pub fn YER() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.YER(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZAR() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZAR(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZMW() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZMW(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZWL() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZWL(&mut result__)).from_abi(result__)
        })
    }
    pub fn BYN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BYN(&mut result__)).from_abi(result__)
        })
    }
    pub fn MRU() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MRU(&mut result__)).from_abi(result__)
        })
    }
    pub fn SSP() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SSP(&mut result__)).from_abi(result__)
        })
    }
    pub fn STN() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.STN(&mut result__)).from_abi(result__)
        })
    }
    pub fn VES() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ICurrencyIdentifiersStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.VES(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl GeographicRegion {
    ...
    pub fn CodeTwoLetter(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CodeTwoLetter(&mut result__)).from_abi(result__)
        }
    }
    pub fn CodeThreeLetter(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CodeThreeLetter(&mut result__)).from_abi(result__)
        }
    }
    pub fn CodeThreeDigit(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CodeThreeDigit(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn NativeName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NativeName(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
    pub fn CurrenciesInUse(&self) -> ::windows_core::Result<super::Foundation::Collections::IVectorView<::windows_core::HSTRING>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CurrenciesInUse(&mut result__)).from_abi(result__)
        }
    }
    pub fn CreateGeographicRegion(geographicregioncode: &::windows_core::HSTRING) -> ::windows_core::Result<GeographicRegion> {
        Self::IGeographicRegionFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateGeographicRegion(::core::mem::transmute_copy(geographicregioncode), &mut result__)).from_abi(result__)
        })
    }
    pub fn IsSupported(geographicregioncode: &::windows_core::HSTRING) -> ::windows_core::Result<bool> {
        Self::IGeographicRegionStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsSupported(::core::mem::transmute_copy(geographicregioncode), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl JapanesePhoneme {
    ...
    pub fn YomiText(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.YomiText(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsPhraseStart(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsPhraseStart(&mut result__)).from_abi(result__)
        }
    }
}
...
impl JapanesePhoneticAnalyzer {
    ...
    pub fn GetWords(input: &::windows_core::HSTRING) -> ::windows_core::Result<super::Foundation::Collections::IVectorView<JapanesePhoneme>> {
        Self::IJapanesePhoneticAnalyzerStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetWords(::core::mem::transmute_copy(input), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetWordsWithMonoRubyOption(input: &::windows_core::HSTRING, monoruby: bool) -> ::windows_core::Result<super::Foundation::Collections::IVectorView<JapanesePhoneme>> {
        Self::IJapanesePhoneticAnalyzerStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetWordsWithMonoRubyOption(::core::mem::transmute_copy(input), monoruby, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl Language {
    pub fn LanguageTag(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LanguageTag(&mut result__)).from_abi(result__)
        }
    }
    pub fn DisplayName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        let this = self;
    ...
    pub fn Script(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Script(&mut result__)).from_abi(result__)
        }
    }
    pub fn LayoutDirection(&self) -> ::windows_core::Result<LanguageLayoutDirection> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LayoutDirection(&mut result__)).from_abi(result__)
        }
    }
    pub fn AbbreviatedName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AbbreviatedName(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetExtensionSubtags(&self, singleton: &::windows_core::HSTRING) -> ::windows_core::Result<super::Foundation::Collections::IVectorView<::windows_core::HSTRING>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetExtensionSubtags(::core::mem::transmute_copy(singleton), &mut result__)).from_abi(result__)
        }
    }
    pub fn CreateLanguage(languagetag: &::windows_core::HSTRING) -> ::windows_core::Result<Language> {
        Self::ILanguageFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateLanguage(::core::mem::transmute_copy(languagetag), &mut result__)).from_abi(result__)
        })
    }
    pub fn IsWellFormed(languagetag: &::windows_core::HSTRING) -> ::windows_core::Result<bool> {
        Self::ILanguageStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsWellFormed(::core::mem::transmute_copy(languagetag), &mut result__)).from_abi(result__)
        })
    }
    pub fn CurrentInputMethodLanguageTag() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::ILanguageStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CurrentInputMethodLanguageTag(&mut result__)).from_abi(result__)
        })
    }
    pub fn TrySetInputMethodLanguageTag(languagetag: &::windows_core::HSTRING) -> ::windows_core::Result<bool> {
        Self::ILanguageStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TrySetInputMethodLanguageTag(::core::mem::transmute_copy(languagetag), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation_Collections\"`"]
    #[cfg(feature = "Foundation_Collections")]
        ...
        P0: ::windows_core::TryIntoParam<super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        Self::ILanguageStatics3(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetMuiCompatibleLanguageListFromLanguageTags(languagetags.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl NumeralSystemIdentifiers {
    pub fn Arab() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Arab(&mut result__)).from_abi(result__)
        })
    }
    pub fn ArabExt() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ArabExt(&mut result__)).from_abi(result__)
        })
    }
    pub fn Bali() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Bali(&mut result__)).from_abi(result__)
        })
    }
    pub fn Beng() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Beng(&mut result__)).from_abi(result__)
        })
    }
    pub fn Cham() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Cham(&mut result__)).from_abi(result__)
        })
    }
    pub fn Deva() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Deva(&mut result__)).from_abi(result__)
        })
    }
    pub fn FullWide() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FullWide(&mut result__)).from_abi(result__)
        })
    }
    pub fn Gujr() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Gujr(&mut result__)).from_abi(result__)
        })
    }
    pub fn Guru() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Guru(&mut result__)).from_abi(result__)
        })
    }
    pub fn HaniDec() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.HaniDec(&mut result__)).from_abi(result__)
        })
    }
    pub fn Java() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Java(&mut result__)).from_abi(result__)
        })
    }
    pub fn Kali() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Kali(&mut result__)).from_abi(result__)
        })
    }
    pub fn Khmr() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Khmr(&mut result__)).from_abi(result__)
        })
    }
    pub fn Knda() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Knda(&mut result__)).from_abi(result__)
        })
    }
    pub fn Lana() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Lana(&mut result__)).from_abi(result__)
        })
    }
    pub fn LanaTham() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LanaTham(&mut result__)).from_abi(result__)
        })
    }
    pub fn Laoo() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Laoo(&mut result__)).from_abi(result__)
        })
    }
    pub fn Latn() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Latn(&mut result__)).from_abi(result__)
        })
    }
    pub fn Lepc() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Lepc(&mut result__)).from_abi(result__)
        })
    }
    pub fn Limb() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Limb(&mut result__)).from_abi(result__)
        })
    }
    pub fn Mlym() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Mlym(&mut result__)).from_abi(result__)
        })
    }
    pub fn Mong() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Mong(&mut result__)).from_abi(result__)
        })
    }
    pub fn Mtei() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Mtei(&mut result__)).from_abi(result__)
        })
    }
    pub fn Mymr() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Mymr(&mut result__)).from_abi(result__)
        })
    }
    pub fn MymrShan() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MymrShan(&mut result__)).from_abi(result__)
        })
    }
    pub fn Nkoo() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Nkoo(&mut result__)).from_abi(result__)
        })
    }
    pub fn Olck() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Olck(&mut result__)).from_abi(result__)
        })
    }
    pub fn Orya() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Orya(&mut result__)).from_abi(result__)
        })
    }
    pub fn Saur() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Saur(&mut result__)).from_abi(result__)
        })
    }
    pub fn Sund() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Sund(&mut result__)).from_abi(result__)
        })
    }
    pub fn Talu() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Talu(&mut result__)).from_abi(result__)
        })
    }
    pub fn TamlDec() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TamlDec(&mut result__)).from_abi(result__)
        })
    }
    pub fn Telu() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Telu(&mut result__)).from_abi(result__)
        })
    }
    pub fn Thai() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
    ...
    pub fn Tibt() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Tibt(&mut result__)).from_abi(result__)
        })
    }
    pub fn Vaii() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Vaii(&mut result__)).from_abi(result__)
        })
    }
    pub fn Brah() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Brah(&mut result__)).from_abi(result__)
        })
    }
    pub fn Osma() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Osma(&mut result__)).from_abi(result__)
        })
    }
    pub fn MathBold() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MathBold(&mut result__)).from_abi(result__)
        })
    }
    pub fn MathDbl() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MathDbl(&mut result__)).from_abi(result__)
        })
    }
    pub fn MathSans() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MathSans(&mut result__)).from_abi(result__)
        })
    }
    pub fn MathSanb() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MathSanb(&mut result__)).from_abi(result__)
        })
    }
    pub fn MathMono() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MathMono(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZmthBold() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZmthBold(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZmthDbl() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZmthDbl(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZmthSans() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZmthSans(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZmthSanb() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZmthSanb(&mut result__)).from_abi(result__)
        })
    }
    pub fn ZmthMono() -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::INumeralSystemIdentifiersStatics2(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ZmthMono(&mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
