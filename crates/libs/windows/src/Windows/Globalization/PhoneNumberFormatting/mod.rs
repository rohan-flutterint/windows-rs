...
impl PhoneNumberFormatter {
        ...
        P0: ::windows_core::IntoParam<PhoneNumberInfo>,
    {
        ...
        unsafe {
            ...
            ::windows_core::vcall!(this.Format(number.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
        ...
        P0: ::windows_core::IntoParam<PhoneNumberInfo>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FormatWithOutputFormat(number.into_param().abi(), numberformat, &mut result__)).from_abi(result__)
        }
    }
    pub fn FormatPartialString(&self, number: &::windows_core::HSTRING) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FormatPartialString(::core::mem::transmute_copy(number), &mut result__)).from_abi(result__)
        }
    }
    pub fn FormatString(&self, number: &::windows_core::HSTRING) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FormatString(::core::mem::transmute_copy(number), &mut result__)).from_abi(result__)
        }
    }
    pub fn FormatStringWithLeftToRightMarkers(&self, number: &::windows_core::HSTRING) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.FormatStringWithLeftToRightMarkers(::core::mem::transmute_copy(number), &mut result__)).from_abi(result__)
        }
    }
    pub fn TryCreate(regioncode: &::windows_core::HSTRING, phonenumber: &mut ::core::option::Option<PhoneNumberFormatter>) -> ::windows_core::Result<()> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe { ::windows_core::vcall!(this.TryCreate(::core::mem::transmute_copy(regioncode), phonenumber as *mut _ as _)).ok() })
    }
    pub fn GetCountryCodeForRegion(regioncode: &::windows_core::HSTRING) -> ::windows_core::Result<i32> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetCountryCodeForRegion(::core::mem::transmute_copy(regioncode), &mut result__)).from_abi(result__)
        })
    }
    pub fn GetNationalDirectDialingPrefixForRegion(regioncode: &::windows_core::HSTRING, stripnondigit: bool) -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetNationalDirectDialingPrefixForRegion(::core::mem::transmute_copy(regioncode), stripnondigit, &mut result__)).from_abi(result__)
        })
    }
    pub fn WrapWithLeftToRightMarkers(number: &::windows_core::HSTRING) -> ::windows_core::Result<::windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.WrapWithLeftToRightMarkers(::core::mem::transmute_copy(number), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl PhoneNumberInfo {
    ...
    pub fn GetLengthOfGeographicalAreaCode(&self) -> ::windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetLengthOfGeographicalAreaCode(&mut result__)).from_abi(result__)
        }
    }
    pub fn GetNationalSignificantNumber(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetNationalSignificantNumber(&mut result__)).from_abi(result__)
        }
    }
    pub fn GetLengthOfNationalDestinationCode(&self) -> ::windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetLengthOfNationalDestinationCode(&mut result__)).from_abi(result__)
        }
    }
    pub fn PredictNumberKind(&self) -> ::windows_core::Result<PredictedPhoneNumberKind> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PredictNumberKind(&mut result__)).from_abi(result__)
        }
    }
    pub fn GetGeographicRegionCode(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetGeographicRegionCode(&mut result__)).from_abi(result__)
        }
    }
        ...
        P0: ::windows_core::IntoParam<PhoneNumberInfo>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CheckNumberMatch(othernumber.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    pub fn Create(number: &::windows_core::HSTRING) -> ::windows_core::Result<PhoneNumberInfo> {
        Self::IPhoneNumberInfoFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.Create(::core::mem::transmute_copy(number), &mut result__)).from_abi(result__)
        })
    }
    pub fn TryParse(input: &::windows_core::HSTRING, phonenumber: &mut ::core::option::Option<PhoneNumberInfo>) -> ::windows_core::Result<PhoneNumberParseResult> {
        Self::IPhoneNumberInfoStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TryParse(::core::mem::transmute_copy(input), phonenumber as *mut _ as _, &mut result__)).from_abi(result__)
        })
    }
    pub fn TryParseWithRegion(input: &::windows_core::HSTRING, regioncode: &::windows_core::HSTRING, phonenumber: &mut ::core::option::Option<PhoneNumberInfo>) -> ::windows_core::Result<PhoneNumberParseResult> {
        Self::IPhoneNumberInfoStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TryParseWithRegion(::core::mem::transmute_copy(input), ::core::mem::transmute_copy(regioncode), phonenumber as *mut _ as _, &mut result__)).from_abi(result__)
        })
    }
