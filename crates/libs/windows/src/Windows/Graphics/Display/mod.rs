...
impl AdvancedColorInfo {
    pub fn CurrentAdvancedColorKind(&self) -> ::windows_core::Result<AdvancedColorKind> {
        ...
        unsafe {
            ...
            ::windows_core::vcall!(this.CurrentAdvancedColorKind(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn RedPrimary(&self) -> ::windows_core::Result<super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RedPrimary(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn GreenPrimary(&self) -> ::windows_core::Result<super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GreenPrimary(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn BluePrimary(&self) -> ::windows_core::Result<super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BluePrimary(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn WhitePoint(&self) -> ::windows_core::Result<super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.WhitePoint(&mut result__)).from_abi(result__)
        }
    }
    pub fn MaxLuminanceInNits(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MaxLuminanceInNits(&mut result__)).from_abi(result__)
        }
    }
    pub fn MinLuminanceInNits(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MinLuminanceInNits(&mut result__)).from_abi(result__)
        }
    }
    pub fn MaxAverageFullFrameLuminanceInNits(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.MaxAverageFullFrameLuminanceInNits(&mut result__)).from_abi(result__)
        }
    }
    pub fn SdrWhiteLevelInNits(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SdrWhiteLevelInNits(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsHdrMetadataFormatCurrentlySupported(&self, format: HdrMetadataFormat) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsHdrMetadataFormatCurrentlySupported(format, &mut result__)).from_abi(result__)
        }
    }
    pub fn IsAdvancedColorKindAvailable(&self, kind: AdvancedColorKind) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsAdvancedColorKindAvailable(kind, &mut result__)).from_abi(result__)
        }
    }
}
...
impl BrightnessOverride {
    ...
    pub fn IsOverrideActive(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsOverrideActive(&mut result__)).from_abi(result__)
        }
    }
    pub fn BrightnessLevel(&self) -> ::windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BrightnessLevel(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetBrightnessLevel(&self, brightnesslevel: f64, options: DisplayBrightnessOverrideOptions) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetBrightnessLevel(brightnesslevel, options)).ok() }
    }
    pub fn SetBrightnessScenario(&self, scenario: DisplayBrightnessScenario, options: DisplayBrightnessOverrideOptions) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetBrightnessScenario(scenario, options)).ok() }
    }
    pub fn GetLevelForScenario(&self, scenario: DisplayBrightnessScenario) -> ::windows_core::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetLevelForScenario(scenario, &mut result__)).from_abi(result__)
        }
    }
    pub fn StartOverride(&self) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.StartOverride()).ok() }
    }
    pub fn StopOverride(&self) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.StopOverride()).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<BrightnessOverride, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsSupportedChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveIsSupportedChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveIsSupportedChanged(token)).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<BrightnessOverride, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsOverrideActiveChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveIsOverrideActiveChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveIsOverrideActiveChanged(token)).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<BrightnessOverride, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BrightnessLevelChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveBrightnessLevelChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveBrightnessLevelChanged(token)).ok() }
    }
    pub fn GetDefaultForSystem() -> ::windows_core::Result<BrightnessOverride> {
        Self::IBrightnessOverrideStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetDefaultForSystem(&mut result__)).from_abi(result__)
        })
    }
        ...
        P0: ::windows_core::IntoParam<BrightnessOverride>,
    {
        Self::IBrightnessOverrideStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.SaveForSystemAsync(value.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl BrightnessOverrideSettings {
    pub fn DesiredLevel(&self) -> ::windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DesiredLevel(&mut result__)).from_abi(result__)
        }
    }
    pub fn DesiredNits(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DesiredNits(&mut result__)).from_abi(result__)
        }
    }
    pub fn CreateFromLevel(level: f64) -> ::windows_core::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateFromLevel(level, &mut result__)).from_abi(result__)
        })
    }
    pub fn CreateFromNits(nits: f32) -> ::windows_core::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateFromNits(nits, &mut result__)).from_abi(result__)
        })
    }
    pub fn CreateFromDisplayBrightnessOverrideScenario(overridescenario: DisplayBrightnessOverrideScenario) -> ::windows_core::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateFromDisplayBrightnessOverrideScenario(overridescenario, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl ColorOverrideSettings {
    pub fn DesiredDisplayColorOverrideScenario(&self) -> ::windows_core::Result<DisplayColorOverrideScenario> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DesiredDisplayColorOverrideScenario(&mut result__)).from_abi(result__)
        }
    }
    pub fn CreateFromDisplayColorOverrideScenario(overridescenario: DisplayColorOverrideScenario) -> ::windows_core::Result<ColorOverrideSettings> {
        Self::IColorOverrideSettingsStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateFromDisplayColorOverrideScenario(overridescenario, &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl DisplayEnhancementOverride {
    pub fn ColorOverrideSettings(&self) -> ::windows_core::Result<ColorOverrideSettings> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ColorOverrideSettings(&mut result__)).from_abi(result__)
        }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetColorOverrideSettings(value.into_param().abi())).ok() }
    }
    pub fn BrightnessOverrideSettings(&self) -> ::windows_core::Result<BrightnessOverrideSettings> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.BrightnessOverrideSettings(&mut result__)).from_abi(result__)
        }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetBrightnessOverrideSettings(value.into_param().abi())).ok() }
    }
    pub fn CanOverride(&self) -> ::windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CanOverride(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsOverrideActive(&self) -> ::windows_core::Result<bool> {
        let this = self;
    ...
    pub fn GetCurrentDisplayEnhancementOverrideCapabilities(&self) -> ::windows_core::Result<DisplayEnhancementOverrideCapabilities> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetCurrentDisplayEnhancementOverrideCapabilities(&mut result__)).from_abi(result__)
        }
    }
    pub fn RequestOverride(&self) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RequestOverride()).ok() }
    }
    pub fn StopOverride(&self) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.StopOverride()).ok() }
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayEnhancementOverride, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CanOverrideChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveCanOverrideChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveCanOverrideChanged(token)).ok() }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn IsOverrideActiveChanged<P0>(&self, handler: P0) -> ::windows_core::Result<super::super::Foundation::EventRegistrationToken>
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayEnhancementOverride, DisplayEnhancementOverrideCapabilitiesChangedEventArgs>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DisplayEnhancementOverrideCapabilitiesChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisplayEnhancementOverrideCapabilitiesChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveDisplayEnhancementOverrideCapabilitiesChanged(token)).ok() }
    }
...
impl DisplayEnhancementOverrideCapabilities {
    pub fn IsBrightnessControlSupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsBrightnessControlSupported(&mut result__)).from_abi(result__)
        }
    }
    pub fn IsBrightnessNitsControlSupported(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.IsBrightnessNitsControlSupported(&mut result__)).from_abi(result__)
        }
    }
    ...
    pub fn GetSupportedNitRanges(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVectorView<NitRange>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetSupportedNitRanges(&mut result__)).from_abi(result__)
        }
    }
}
...
impl DisplayInformation {
    pub fn CurrentOrientation(&self) -> ::windows_core::Result<DisplayOrientations> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CurrentOrientation(&mut result__)).from_abi(result__)
        }
    }
    pub fn NativeOrientation(&self) -> ::windows_core::Result<DisplayOrientations> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.NativeOrientation(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    ...
    pub fn ResolutionScale(&self) -> ::windows_core::Result<ResolutionScale> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ResolutionScale(&mut result__)).from_abi(result__)
        }
    }
    pub fn LogicalDpi(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LogicalDpi(&mut result__)).from_abi(result__)
        }
    }
    pub fn RawDpiX(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RawDpiX(&mut result__)).from_abi(result__)
        }
    }
    pub fn RawDpiY(&self) -> ::windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RawDpiY(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayInformation, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DpiChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveDpiChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveDpiChanged(token)).ok() }
    }
    pub fn StereoEnabled(&self) -> ::windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.StereoEnabled(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayInformation, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.StereoEnabledChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveStereoEnabledChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveStereoEnabledChanged(token)).ok() }
    }
    ...
    pub fn GetColorProfileAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStream>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetColorProfileAsync(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayInformation, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ColorProfileChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveColorProfileChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.RemoveColorProfileChanged(token)).ok() }
    }
    pub fn RawPixelsPerViewPixel(&self) -> ::windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RawPixelsPerViewPixel(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn DiagonalSizeInInches(&self) -> ::windows_core::Result<super::super::Foundation::IReference<f64>> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DiagonalSizeInInches(&mut result__)).from_abi(result__)
        }
    }
    pub fn ScreenWidthInRawPixels(&self) -> ::windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ScreenWidthInRawPixels(&mut result__)).from_abi(result__)
        }
    }
    pub fn ScreenHeightInRawPixels(&self) -> ::windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.ScreenHeightInRawPixels(&mut result__)).from_abi(result__)
        }
    }
    pub fn GetAdvancedColorInfo(&self) -> ::windows_core::Result<AdvancedColorInfo> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.GetAdvancedColorInfo(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayInformation, ::windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AdvancedColorInfoChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveAdvancedColorInfoChanged(&self, token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<IDisplayInformation5>(self)?;
        unsafe { ::windows_core::vcall!(this.RemoveAdvancedColorInfoChanged(token)).ok() }
    }
    ...
    pub fn AutoRotationPreferences() -> ::windows_core::Result<DisplayOrientations> {
        Self::IDisplayInformationStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AutoRotationPreferences(&mut result__)).from_abi(result__)
        })
    }
    pub fn SetAutoRotationPreferences(value: DisplayOrientations) -> ::windows_core::Result<()> {
        Self::IDisplayInformationStatics(|this| unsafe { ::windows_core::vcall!(this.SetAutoRotationPreferences(value)).ok() })
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
        ...
        P0: ::windows_core::IntoParam<super::super::Foundation::TypedEventHandler<DisplayInformation, ::windows_core::IInspectable>>,
    {
        Self::IDisplayInformationStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.DisplayContentsInvalidated(handler.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisplayContentsInvalidated(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayInformationStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveDisplayContentsInvalidated(token)).ok() })
    }
    #[doc(hidden)]
...
impl DisplayProperties {
    ...
    #[cfg(feature = "deprecated")]
    pub fn SetAutoRotationPreferences(value: DisplayOrientations) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.SetAutoRotationPreferences(value)).ok() })
    }
    ...
    pub fn RemoveOrientationChanged(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveOrientationChanged(token)).ok() })
    }
    #[doc = "Required features: `\"deprecated\"`"]
    #[cfg(feature = "deprecated")]
        ...
        P0: ::windows_core::IntoParam<DisplayPropertiesEventHandler>,
    {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.LogicalDpiChanged(handler.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`, `\"deprecated\"`"]
    #[cfg(all(feature = "Foundation", feature = "deprecated"))]
    pub fn RemoveLogicalDpiChanged(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveLogicalDpiChanged(token)).ok() })
    }
    #[doc = "Required features: `\"deprecated\"`"]
    #[cfg(feature = "deprecated")]
    ...
    pub fn RemoveStereoEnabledChanged(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveStereoEnabledChanged(token)).ok() })
    }
    ...
    pub fn RemoveColorProfileChanged(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveColorProfileChanged(token)).ok() })
    }
    #[doc = "Required features: `\"Foundation\"`, `\"deprecated\"`"]
    #[cfg(all(feature = "Foundation", feature = "deprecated"))]
    pub fn DisplayContentsInvalidated<P0>(handler: P0) -> ::windows_core::Result<super::super::Foundation::EventRegistrationToken>
    ...
    #[cfg(all(feature = "Foundation", feature = "deprecated"))]
    pub fn RemoveDisplayContentsInvalidated(token: super::super::Foundation::EventRegistrationToken) -> ::windows_core::Result<()> {
        Self::IDisplayPropertiesStatics(|this| unsafe { ::windows_core::vcall!(this.RemoveDisplayContentsInvalidated(token)).ok() })
    }
    #[doc(hidden)]
    #[cfg(feature = "deprecated")]
...
impl DisplayServices {
    pub fn FindAll() -> ::windows_core::Result<::windows_core::Array<super::DisplayId>> {
        Self::IDisplayServicesStatics(|this| unsafe {
            ...
            ::windows_core::vcall!(this.FindAll(::windows_core::Array::<super::DisplayId>::set_abi_len(::std::mem::transmute(&mut result__)), result__.as_mut_ptr() as *mut _ as _)).and_then(|| result__.assume_init())
        })
    }
    #[doc(hidden)]
