...
impl CredentialPicker {
        ...
        P0: ::windows_core::IntoParam<CredentialPickerOptions>,
    {
        Self::ICredentialPickerStatics(|this| unsafe {
            ...
            ::windows_core::vcall!(this.PickWithOptionsAsync(options.into_param().abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn PickWithMessageAsync(targetname: &::windows_core::HSTRING, message: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<CredentialPickerResults>> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PickWithMessageAsync(::core::mem::transmute_copy(targetname), ::core::mem::transmute_copy(message), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn PickWithCaptionAsync(targetname: &::windows_core::HSTRING, message: &::windows_core::HSTRING, caption: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<CredentialPickerResults>> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PickWithCaptionAsync(::core::mem::transmute_copy(targetname), ::core::mem::transmute_copy(message), ::core::mem::transmute_copy(caption), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl CredentialPickerOptions {
    ...
    pub fn SetErrorCode(&self, value: u32) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetErrorCode(value)).ok() }
    }
    ...
    pub fn SetTargetName(&self, value: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetTargetName(::core::mem::transmute_copy(value))).ok() }
    }
    pub fn TargetName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.TargetName(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetAuthenticationProtocol(&self, value: AuthenticationProtocol) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetAuthenticationProtocol(value)).ok() }
    }
    pub fn AuthenticationProtocol(&self) -> ::windows_core::Result<AuthenticationProtocol> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AuthenticationProtocol(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetCustomAuthenticationProtocol(&self, value: &::windows_core::HSTRING) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetCustomAuthenticationProtocol(::core::mem::transmute_copy(value))).ok() }
    }
    pub fn CustomAuthenticationProtocol(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CustomAuthenticationProtocol(&mut result__)).from_abi(result__)
        }
    }
    ...
    {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetPreviousCredential(value.try_into_param()?.abi())).ok() }
    }
    #[doc = "Required features: `\"Storage_Streams\"`"]
    #[cfg(feature = "Storage_Streams")]
    pub fn PreviousCredential(&self) -> ::windows_core::Result<super::super::super::Storage::Streams::IBuffer> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.PreviousCredential(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetAlwaysDisplayDialog(&self, value: bool) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetAlwaysDisplayDialog(value)).ok() }
    }
    pub fn AlwaysDisplayDialog(&self) -> ::windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.AlwaysDisplayDialog(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetCallerSavesCredential(&self, value: bool) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetCallerSavesCredential(value)).ok() }
    }
    pub fn CallerSavesCredential(&self) -> ::windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CallerSavesCredential(&mut result__)).from_abi(result__)
        }
    }
    pub fn SetCredentialSaveOption(&self, value: CredentialSaveOption) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { ::windows_core::vcall!(this.SetCredentialSaveOption(value)).ok() }
    }
    pub fn CredentialSaveOption(&self) -> ::windows_core::Result<CredentialSaveOption> {
        let this = self;
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CredentialSaveOption(&mut result__)).from_abi(result__)
        }
    }
}
...
impl CredentialPickerResults {
    ...
    pub fn CredentialSaved(&self) -> ::windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CredentialSaved(&mut result__)).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Storage_Streams\"`"]
    #[cfg(feature = "Storage_Streams")]
    ...
    pub fn CredentialDomainName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CredentialDomainName(&mut result__)).from_abi(result__)
        }
    }
    pub fn CredentialUserName(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CredentialUserName(&mut result__)).from_abi(result__)
        }
    }
    pub fn CredentialPassword(&self) -> ::windows_core::Result<::windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CredentialPassword(&mut result__)).from_abi(result__)
        }
    }
}
...
impl UserConsentVerifier {
    ...
    pub fn CheckAvailabilityAsync() -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<UserConsentVerifierAvailability>> {
        Self::IUserConsentVerifierStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CheckAvailabilityAsync(&mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`"]
    #[cfg(feature = "Foundation")]
    pub fn RequestVerificationAsync(message: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::super::Foundation::IAsyncOperation<UserConsentVerificationResult>> {
        Self::IUserConsentVerifierStatics(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.RequestVerificationAsync(::core::mem::transmute_copy(message), &mut result__)).from_abi(result__)
        })
    }
    #[doc(hidden)]
