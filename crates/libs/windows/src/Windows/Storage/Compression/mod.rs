...
impl Compressor {
        ...
        P0: ::windows_core::TryIntoParam<super::Streams::IOutputStream>,
    {
        Self::ICompressorFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateCompressor(underlyingstream.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Storage_Streams\"`"]
    #[cfg(feature = "Storage_Streams")]
        ...
        P0: ::windows_core::TryIntoParam<super::Streams::IOutputStream>,
    {
        Self::ICompressorFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateCompressorEx(underlyingstream.try_into_param()?.abi(), algorithm, blocksize, &mut result__)).from_abi(result__)
        })
    }
...
impl Decompressor {
        ...
        P0: ::windows_core::TryIntoParam<super::Streams::IInputStream>,
    {
        Self::IDecompressorFactory(|this| unsafe {
            let mut result__ = ::std::mem::zeroed();
            ::windows_core::vcall!(this.CreateDecompressor(underlyingstream.try_into_param()?.abi(), &mut result__)).from_abi(result__)
        })
    }
    #[doc = "Required features: `\"Foundation\"`, `\"Storage_Streams\"`"]
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
