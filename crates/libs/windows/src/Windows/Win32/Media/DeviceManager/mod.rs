...
pub const g_wszAudioWAVECodec: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AudioWAVECodec");
pub const g_wszVideoFourCCCodec: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/VideoFourCCCodec");
pub const g_wszWMDMAlbumArt: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumArt");
pub const g_wszWMDMAlbumArtist: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumArtist");
pub const g_wszWMDMAlbumCoverData: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverData");
pub const g_wszWMDMAlbumCoverDuration: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverDuration");
pub const g_wszWMDMAlbumCoverFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverFormat");
pub const g_wszWMDMAlbumCoverHeight: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverHeight");
pub const g_wszWMDMAlbumCoverSize: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverSize");
pub const g_wszWMDMAlbumCoverWidth: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumCoverWidth");
pub const g_wszWMDMAlbumTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AlbumTitle");
pub const g_wszWMDMAudioBitDepth: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AudioBitDepth");
pub const g_wszWMDMAuthor: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Author");
pub const g_wszWMDMAuthorDate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/AuthorDate");
pub const g_wszWMDMBitRateType: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/BitRateType");
pub const g_wszWMDMBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Bitrate");
pub const g_wszWMDMBlockAlignment: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/BlockAlignment");
pub const g_wszWMDMBufferSize: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/BufferSize");
pub const g_wszWMDMBuyNow: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/BuyNow");
pub const g_wszWMDMByteBookmark: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/ByteBookmark");
pub const g_wszWMDMCategory: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Category");
pub const g_wszWMDMCodec: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Codec");
pub const g_wszWMDMCollectionID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/CollectionID");
pub const g_wszWMDMComposer: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Composer");
pub const g_wszWMDMDRMId: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DRMId");
pub const g_wszWMDMDataLength: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DataLength");
pub const g_wszWMDMDataOffset: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DataOffset");
pub const g_wszWMDMDataUnits: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DataUnits");
pub const g_wszWMDMDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Description");
pub const g_wszWMDMDestinationURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DestinationURL");
pub const g_wszWMDMDeviceFirmwareVersion: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceFirmwareVersion");
pub const g_wszWMDMDeviceFriendlyName: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceFriendlyName");
pub const g_wszWMDMDeviceModelName: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceModelName");
pub const g_wszWMDMDevicePlayCount: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DevicePlayCount");
pub const g_wszWMDMDeviceProtocol: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceProtocol");
pub const g_wszWMDMDeviceRevocationInfo: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceRevocationInfo");
pub const g_wszWMDMDeviceServiceProviderVendor: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceServiceProviderVendor");
pub const g_wszWMDMDeviceVendorExtension: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/DeviceVendorExtension");
pub const g_wszWMDMDuration: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Duration");
pub const g_wszWMDMEditor: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Editor");
pub const g_wszWMDMEncodingProfile: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/EncodingProfile");
pub const g_wszWMDMFileAttributes: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FileAttributes");
pub const g_wszWMDMFileCreationDate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FileCreationDate");
pub const g_wszWMDMFileName: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FileName");
pub const g_wszWMDMFileSize: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FileSize");
pub const g_wszWMDMFormatCode: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FormatCode");
pub const g_wszWMDMFormatsSupported: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FormatsSupported");
pub const g_wszWMDMFormatsSupportedAreOrdered: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FormatsSupportedAreOrdered");
pub const g_wszWMDMFrameRate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/FrameRate");
pub const g_wszWMDMGenre: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Genre");
pub const g_wszWMDMHeight: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Height");
pub const g_wszWMDMIsProtected: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/IsProtected");
pub const g_wszWMDMIsRepeat: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/IsRepeat");
pub const g_wszWMDMKeyFrameDistance: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/KeyFrameDistance");
pub const g_wszWMDMLastModifiedDate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/LastModifiedDate");
pub const g_wszWMDMMediaClassSecondaryID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaClassSecondaryID");
pub const g_wszWMDMMediaCredits: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaCredits");
pub const g_wszWMDMMediaGuid: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaGuid");
pub const g_wszWMDMMediaOriginalBroadcastDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaOriginalBroadcastDateTime");
pub const g_wszWMDMMediaOriginalChannel: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaOriginalChannel");
pub const g_wszWMDMMediaStationName: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaStationName");
pub const g_wszWMDMMetaGenre: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MetaGenre");
pub const g_wszWMDMNonConsumable: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/NonConsumable");
pub const g_wszWMDMNumChannels: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/NumChannels");
pub const g_wszWMDMObjectBookmark: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/ObjectBookmark");
pub const g_wszWMDMOwner: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Owner");
pub const g_wszWMDMParentalRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/ParentalRating");
pub const g_wszWMDMPersistentUniqueID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/PersistentUniqueID");
pub const g_wszWMDMPlayCount: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/PlayCount");
pub const g_wszWMDMProviderCopyright: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/ProviderCopyright");
pub const g_wszWMDMQualitySetting: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/QualitySetting");
pub const g_wszWMDMSampleRate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SampleRate");
pub const g_wszWMDMScanType: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/ScanType");
pub const g_wszWMDMSourceURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SourceURL");
pub const g_wszWMDMSubTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SubTitle");
pub const g_wszWMDMSubTitleDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SubTitleDescription");
pub const g_wszWMDMSupportedDeviceProperties: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SupportedDeviceProperties");
pub const g_wszWMDMSyncID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SyncID");
pub const g_wszWMDMSyncRelationshipID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SyncRelationshipID");
pub const g_wszWMDMSyncTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/SyncTime");
pub const g_wszWMDMTimeBookmark: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/TimeBookmark");
pub const g_wszWMDMTimeToLive: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/TimeToLive");
pub const g_wszWMDMTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Title");
pub const g_wszWMDMTotalBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/TotalBitrate");
pub const g_wszWMDMTrack: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Track");
pub const g_wszWMDMTrackMood: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/TrackMood");
pub const g_wszWMDMUserEffectiveRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/UserEffectiveRating");
pub const g_wszWMDMUserLastPlayTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/UserLastPlayTime");
pub const g_wszWMDMUserRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/UserRating");
pub const g_wszWMDMUserRatingOnDevice: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/UserRatingOnDevice");
pub const g_wszWMDMVideoBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/VideoBitrate");
pub const g_wszWMDMWebmaster: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Webmaster");
pub const g_wszWMDMWidth: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Width");
pub const g_wszWMDMYear: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/Year");
pub const g_wszWMDMediaClassPrimaryID: ::windows_strings::PCWSTR = ::windows_strings::w!("WMDM/MediaClassPrimaryID");
pub const g_wszWPDPassthroughPropertyValues: ::windows_strings::PCWSTR = ::windows_strings::w!("WPD/PassthroughPropertyValues");
#[repr(transparent)]
