...
pub const g_wszASFLeakyBucketPairs: ::windows_strings::PCWSTR = ::windows_strings::w!("ASFLeakyBucketPairs");
pub const g_wszAllowInterlacedOutput: ::windows_strings::PCWSTR = ::windows_strings::w!("AllowInterlacedOutput");
pub const g_wszAverageLevel: ::windows_strings::PCWSTR = ::windows_strings::w!("AverageLevel");
pub const g_wszBufferAverage: ::windows_strings::PCWSTR = ::windows_strings::w!("Buffer Average");
pub const g_wszComplexity: ::windows_strings::PCWSTR = ::windows_strings::w!("_COMPLEXITYEX");
pub const g_wszComplexityLive: ::windows_strings::PCWSTR = ::windows_strings::w!("_COMPLEXITYEXLIVE");
pub const g_wszComplexityMax: ::windows_strings::PCWSTR = ::windows_strings::w!("_COMPLEXITYEXMAX");
pub const g_wszComplexityOffline: ::windows_strings::PCWSTR = ::windows_strings::w!("_COMPLEXITYEXOFFLINE");
pub const g_wszDecoderComplexityRequested: ::windows_strings::PCWSTR = ::windows_strings::w!("_DECODERCOMPLEXITYPROFILE");
pub const g_wszDedicatedDeliveryThread: ::windows_strings::PCWSTR = ::windows_strings::w!("DedicatedDeliveryThread");
pub const g_wszDeinterlaceMode: ::windows_strings::PCWSTR = ::windows_strings::w!("DeinterlaceMode");
pub const g_wszDeliverOnReceive: ::windows_strings::PCWSTR = ::windows_strings::w!("DeliverOnReceive");
pub const g_wszDeviceConformanceTemplate: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceConformanceTemplate");
pub const g_wszDynamicRangeControl: ::windows_strings::PCWSTR = ::windows_strings::w!("DynamicRangeControl");
pub const g_wszEDL: ::windows_strings::PCWSTR = ::windows_strings::w!("_EDL");
pub const g_wszEarlyDataDelivery: ::windows_strings::PCWSTR = ::windows_strings::w!("EarlyDataDelivery");
pub const g_wszEnableDiscreteOutput: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableDiscreteOutput");
pub const g_wszEnableFrameInterpolation: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableFrameInterpolation");
pub const g_wszEnableWMAProSPDIFOutput: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableWMAProSPDIFOutput");
pub const g_wszFailSeekOnError: ::windows_strings::PCWSTR = ::windows_strings::w!("FailSeekOnError");
pub const g_wszFixedFrameRate: ::windows_strings::PCWSTR = ::windows_strings::w!("FixedFrameRate");
pub const g_wszFold6To2Channels3: ::windows_strings::PCWSTR = ::windows_strings::w!("Fold6To2Channels3");
pub const g_wszFoldToChannelsTemplate: ::windows_strings::PCWSTR = ::windows_strings::w!("Fold%luTo%luChannels%lu");
pub const g_wszInitialPatternForInverseTelecine: ::windows_strings::PCWSTR = ::windows_strings::w!("InitialPatternForInverseTelecine");
pub const g_wszInterlacedCoding: ::windows_strings::PCWSTR = ::windows_strings::w!("InterlacedCoding");
pub const g_wszIsVBRSupported: ::windows_strings::PCWSTR = ::windows_strings::w!("_ISVBRSUPPORTED");
pub const g_wszJPEGCompressionQuality: ::windows_strings::PCWSTR = ::windows_strings::w!("JPEGCompressionQuality");
pub const g_wszJustInTimeDecode: ::windows_strings::PCWSTR = ::windows_strings::w!("JustInTimeDecode");
pub const g_wszMixedClassMode: ::windows_strings::PCWSTR = ::windows_strings::w!("MixedClassMode");
pub const g_wszMusicClassMode: ::windows_strings::PCWSTR = ::windows_strings::w!("MusicClassMode");
pub const g_wszMusicSpeechClassMode: ::windows_strings::PCWSTR = ::windows_strings::w!("MusicSpeechClassMode");
pub const g_wszNeedsPreviousSample: ::windows_strings::PCWSTR = ::windows_strings::w!("NeedsPreviousSample");
pub const g_wszNumPasses: ::windows_strings::PCWSTR = ::windows_strings::w!("_PASSESUSED");
pub const g_wszOriginalSourceFormatTag: ::windows_strings::PCWSTR = ::windows_strings::w!("_SOURCEFORMATTAG");
pub const g_wszOriginalWaveFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("_ORIGINALWAVEFORMAT");
pub const g_wszPeakValue: ::windows_strings::PCWSTR = ::windows_strings::w!("PeakValue");
pub const g_wszPermitSeeksBeyondEndOfStream: ::windows_strings::PCWSTR = ::windows_strings::w!("PermitSeeksBeyondEndOfStream");
pub const g_wszReloadIndexOnSeek: ::windows_strings::PCWSTR = ::windows_strings::w!("ReloadIndexOnSeek");
pub const g_wszScrambledAudio: ::windows_strings::PCWSTR = ::windows_strings::w!("ScrambledAudio");
pub const g_wszSingleOutputBuffer: ::windows_strings::PCWSTR = ::windows_strings::w!("SingleOutputBuffer");
pub const g_wszSoftwareScaling: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftwareScaling");
pub const g_wszSourceBufferTime: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceBufferTime");
pub const g_wszSourceMaxBytesAtOnce: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceMaxBytesAtOnce");
pub const g_wszSpeakerConfig: ::windows_strings::PCWSTR = ::windows_strings::w!("SpeakerConfig");
pub const g_wszSpeechCaps: ::windows_strings::PCWSTR = ::windows_strings::w!("SpeechFormatCap");
pub const g_wszSpeechClassMode: ::windows_strings::PCWSTR = ::windows_strings::w!("SpeechClassMode");
pub const g_wszStreamLanguage: ::windows_strings::PCWSTR = ::windows_strings::w!("StreamLanguage");
pub const g_wszStreamNumIndexObjects: ::windows_strings::PCWSTR = ::windows_strings::w!("StreamNumIndexObjects");
pub const g_wszUsePacketAtSeekPoint: ::windows_strings::PCWSTR = ::windows_strings::w!("UsePacketAtSeekPoint");
pub const g_wszVBRBitrateMax: ::windows_strings::PCWSTR = ::windows_strings::w!("_RMAX");
pub const g_wszVBRBufferWindowMax: ::windows_strings::PCWSTR = ::windows_strings::w!("_BMAX");
pub const g_wszVBREnabled: ::windows_strings::PCWSTR = ::windows_strings::w!("_VBRENABLED");
pub const g_wszVBRPeak: ::windows_strings::PCWSTR = ::windows_strings::w!("VBR Peak");
pub const g_wszVBRQuality: ::windows_strings::PCWSTR = ::windows_strings::w!("_VBRQUALITY");
pub const g_wszVideoSampleDurations: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoSampleDurations");
pub const g_wszWMADID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ADID");
pub const g_wszWMASFPacketCount: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ASFPacketCount");
pub const g_wszWMASFSecurityObjectsSize: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ASFSecurityObjectsSize");
pub const g_wszWMAlbumArtist: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AlbumArtist");
pub const g_wszWMAlbumArtistSort: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AlbumArtistSort");
pub const g_wszWMAlbumCoverURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AlbumCoverURL");
pub const g_wszWMAlbumTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AlbumTitle");
pub const g_wszWMAlbumTitleSort: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AlbumTitleSort");
pub const g_wszWMAspectRatioX: ::windows_strings::PCWSTR = ::windows_strings::w!("AspectRatioX");
pub const g_wszWMAspectRatioY: ::windows_strings::PCWSTR = ::windows_strings::w!("AspectRatioY");
pub const g_wszWMAudioFileURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AudioFileURL");
pub const g_wszWMAudioSourceURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AudioSourceURL");
pub const g_wszWMAuthor: ::windows_strings::PCWSTR = ::windows_strings::w!("Author");
pub const g_wszWMAuthorSort: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthorSort");
pub const g_wszWMAuthorURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/AuthorURL");
pub const g_wszWMBannerImageData: ::windows_strings::PCWSTR = ::windows_strings::w!("BannerImageData");
pub const g_wszWMBannerImageType: ::windows_strings::PCWSTR = ::windows_strings::w!("BannerImageType");
pub const g_wszWMBannerImageURL: ::windows_strings::PCWSTR = ::windows_strings::w!("BannerImageURL");
pub const g_wszWMBeatsPerMinute: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/BeatsPerMinute");
pub const g_wszWMBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("Bitrate");
pub const g_wszWMBroadcast: ::windows_strings::PCWSTR = ::windows_strings::w!("Broadcast");
pub const g_wszWMCategory: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Category");
pub const g_wszWMCodec: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Codec");
pub const g_wszWMComposer: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Composer");
pub const g_wszWMComposerSort: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ComposerSort");
pub const g_wszWMConductor: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Conductor");
pub const g_wszWMContainerFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ContainerFormat");
pub const g_wszWMContentDistributor: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ContentDistributor");
pub const g_wszWMContentGroupDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ContentGroupDescription");
pub const g_wszWMCopyright: ::windows_strings::PCWSTR = ::windows_strings::w!("Copyright");
pub const g_wszWMCopyrightURL: ::windows_strings::PCWSTR = ::windows_strings::w!("CopyrightURL");
pub const g_wszWMCurrentBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("CurrentBitrate");
pub const g_wszWMDRM: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/DRM");
pub const g_wszWMDRM_ContentID: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_ContentID");
pub const g_wszWMDRM_Flags: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_Flags");
pub const g_wszWMDRM_HeaderSignPrivKey: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_HeaderSignPrivKey");
pub const g_wszWMDRM_IndividualizedVersion: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_IndividualizedVersion");
pub const g_wszWMDRM_KeyID: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_KeyID");
pub const g_wszWMDRM_KeySeed: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_KeySeed");
pub const g_wszWMDRM_LASignatureCert: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_LASignatureCert");
pub const g_wszWMDRM_LASignatureLicSrvCert: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_LASignatureLicSrvCert");
pub const g_wszWMDRM_LASignaturePrivKey: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_LASignaturePrivKey");
pub const g_wszWMDRM_LASignatureRootCert: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_LASignatureRootCert");
pub const g_wszWMDRM_Level: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_Level");
pub const g_wszWMDRM_LicenseAcqURL: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_LicenseAcqURL");
pub const g_wszWMDRM_SourceID: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_SourceID");
pub const g_wszWMDRM_V1LicenseAcqURL: ::windows_strings::PCWSTR = ::windows_strings::w!("DRM_V1LicenseAcqURL");
pub const g_wszWMDVDID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/DVDID");
pub const g_wszWMDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const g_wszWMDirector: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Director");
pub const g_wszWMDuration: ::windows_strings::PCWSTR = ::windows_strings::w!("Duration");
pub const g_wszWMEncodedBy: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/EncodedBy");
pub const g_wszWMEncodingSettings: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/EncodingSettings");
pub const g_wszWMEncodingTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/EncodingTime");
pub const g_wszWMEpisodeNumber: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/EpisodeNumber");
pub const g_wszWMFileSize: ::windows_strings::PCWSTR = ::windows_strings::w!("FileSize");
pub const g_wszWMGenre: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Genre");
pub const g_wszWMGenreID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/GenreID");
pub const g_wszWMHasArbitraryDataStream: ::windows_strings::PCWSTR = ::windows_strings::w!("HasArbitraryDataStream");
pub const g_wszWMHasAttachedImages: ::windows_strings::PCWSTR = ::windows_strings::w!("HasAttachedImages");
pub const g_wszWMHasAudio: ::windows_strings::PCWSTR = ::windows_strings::w!("HasAudio");
pub const g_wszWMHasFileTransferStream: ::windows_strings::PCWSTR = ::windows_strings::w!("HasFileTransferStream");
pub const g_wszWMHasImage: ::windows_strings::PCWSTR = ::windows_strings::w!("HasImage");
pub const g_wszWMHasScript: ::windows_strings::PCWSTR = ::windows_strings::w!("HasScript");
pub const g_wszWMHasVideo: ::windows_strings::PCWSTR = ::windows_strings::w!("HasVideo");
pub const g_wszWMISAN: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ISAN");
pub const g_wszWMISRC: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ISRC");
pub const g_wszWMInitialKey: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/InitialKey");
pub const g_wszWMIsCompilation: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/IsCompilation");
pub const g_wszWMIsVBR: ::windows_strings::PCWSTR = ::windows_strings::w!("IsVBR");
pub const g_wszWMLanguage: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Language");
pub const g_wszWMLyrics: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Lyrics");
pub const g_wszWMLyrics_Synchronised: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Lyrics_Synchronised");
pub const g_wszWMMCDI: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MCDI");
pub const g_wszWMMediaClassPrimaryID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaClassPrimaryID");
pub const g_wszWMMediaClassSecondaryID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaClassSecondaryID");
pub const g_wszWMMediaCredits: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaCredits");
pub const g_wszWMMediaIsDelay: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsDelay");
pub const g_wszWMMediaIsFinale: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsFinale");
pub const g_wszWMMediaIsLive: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsLive");
pub const g_wszWMMediaIsPremiere: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsPremiere");
pub const g_wszWMMediaIsRepeat: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsRepeat");
pub const g_wszWMMediaIsSAP: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsSAP");
pub const g_wszWMMediaIsStereo: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsStereo");
pub const g_wszWMMediaIsSubtitled: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsSubtitled");
pub const g_wszWMMediaIsTape: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaIsTape");
pub const g_wszWMMediaNetworkAffiliation: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaNetworkAffiliation");
pub const g_wszWMMediaOriginalBroadcastDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaOriginalBroadcastDateTime");
pub const g_wszWMMediaOriginalChannel: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaOriginalChannel");
pub const g_wszWMMediaStationCallSign: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaStationCallSign");
pub const g_wszWMMediaStationName: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/MediaStationName");
pub const g_wszWMModifiedBy: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ModifiedBy");
pub const g_wszWMMood: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Mood");
pub const g_wszWMNSCAddress: ::windows_strings::PCWSTR = ::windows_strings::w!("NSC_Address");
pub const g_wszWMNSCDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("NSC_Description");
pub const g_wszWMNSCEmail: ::windows_strings::PCWSTR = ::windows_strings::w!("NSC_Email");
pub const g_wszWMNSCName: ::windows_strings::PCWSTR = ::windows_strings::w!("NSC_Name");
pub const g_wszWMNSCPhone: ::windows_strings::PCWSTR = ::windows_strings::w!("NSC_Phone");
pub const g_wszWMNumberOfFrames: ::windows_strings::PCWSTR = ::windows_strings::w!("NumberOfFrames");
pub const g_wszWMOptimalBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("OptimalBitrate");
pub const g_wszWMOriginalAlbumTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalAlbumTitle");
pub const g_wszWMOriginalArtist: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalArtist");
pub const g_wszWMOriginalFilename: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalFilename");
pub const g_wszWMOriginalLyricist: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalLyricist");
pub const g_wszWMOriginalReleaseTime: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalReleaseTime");
pub const g_wszWMOriginalReleaseYear: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/OriginalReleaseYear");
pub const g_wszWMParentalRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ParentalRating");
pub const g_wszWMParentalRatingReason: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ParentalRatingReason");
pub const g_wszWMPartOfSet: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/PartOfSet");
pub const g_wszWMPeakBitrate: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/PeakBitrate");
pub const g_wszWMPeriod: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Period");
pub const g_wszWMPicture: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Picture");
pub const g_wszWMPlaylistDelay: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/PlaylistDelay");
pub const g_wszWMProducer: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Producer");
pub const g_wszWMPromotionURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/PromotionURL");
pub const g_wszWMProtected: ::windows_strings::PCWSTR = ::windows_strings::w!("Is_Protected");
pub const g_wszWMProtectionType: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ProtectionType");
pub const g_wszWMProvider: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Provider");
pub const g_wszWMProviderCopyright: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ProviderCopyright");
pub const g_wszWMProviderRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ProviderRating");
pub const g_wszWMProviderStyle: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ProviderStyle");
pub const g_wszWMPublisher: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Publisher");
pub const g_wszWMRadioStationName: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/RadioStationName");
pub const g_wszWMRadioStationOwner: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/RadioStationOwner");
pub const g_wszWMRating: ::windows_strings::PCWSTR = ::windows_strings::w!("Rating");
pub const g_wszWMSeasonNumber: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/SeasonNumber");
pub const g_wszWMSeekable: ::windows_strings::PCWSTR = ::windows_strings::w!("Seekable");
pub const g_wszWMSharedUserRating: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/SharedUserRating");
pub const g_wszWMSignature_Name: ::windows_strings::PCWSTR = ::windows_strings::w!("Signature_Name");
pub const g_wszWMSkipBackward: ::windows_strings::PCWSTR = ::windows_strings::w!("Can_Skip_Backward");
pub const g_wszWMSkipForward: ::windows_strings::PCWSTR = ::windows_strings::w!("Can_Skip_Forward");
pub const g_wszWMStreamTypeInfo: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/StreamTypeInfo");
pub const g_wszWMStridable: ::windows_strings::PCWSTR = ::windows_strings::w!("Stridable");
pub const g_wszWMSubTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/SubTitle");
pub const g_wszWMSubTitleDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/SubTitleDescription");
pub const g_wszWMSubscriptionContentID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/SubscriptionContentID");
pub const g_wszWMText: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Text");
pub const g_wszWMTitle: ::windows_strings::PCWSTR = ::windows_strings::w!("Title");
pub const g_wszWMTitleSort: ::windows_strings::PCWSTR = ::windows_strings::w!("TitleSort");
pub const g_wszWMToolName: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ToolName");
pub const g_wszWMToolVersion: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/ToolVersion");
pub const g_wszWMTrack: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Track");
pub const g_wszWMTrackNumber: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/TrackNumber");
pub const g_wszWMTrusted: ::windows_strings::PCWSTR = ::windows_strings::w!("Is_Trusted");
pub const g_wszWMUniqueFileIdentifier: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/UniqueFileIdentifier");
pub const g_wszWMUse_Advanced_DRM: ::windows_strings::PCWSTR = ::windows_strings::w!("Use_Advanced_DRM");
pub const g_wszWMUse_DRM: ::windows_strings::PCWSTR = ::windows_strings::w!("Use_DRM");
pub const g_wszWMUserWebURL: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/UserWebURL");
pub const g_wszWMVideoClosedCaptioning: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/VideoClosedCaptioning");
pub const g_wszWMVideoFrameRate: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/VideoFrameRate");
pub const g_wszWMVideoHeight: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/VideoHeight");
pub const g_wszWMVideoWidth: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/VideoWidth");
pub const g_wszWMWMADRCAverageReference: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMADRCAverageReference");
pub const g_wszWMWMADRCAverageTarget: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMADRCAverageTarget");
pub const g_wszWMWMADRCPeakReference: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMADRCPeakReference");
pub const g_wszWMWMADRCPeakTarget: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMADRCPeakTarget");
pub const g_wszWMWMCPDistributor: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMCPDistributor");
pub const g_wszWMWMCPDistributorID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMCPDistributorID");
pub const g_wszWMWMCollectionGroupID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMCollectionGroupID");
pub const g_wszWMWMCollectionID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMCollectionID");
pub const g_wszWMWMContentID: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMContentID");
pub const g_wszWMWMShadowFileSourceDRMType: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMShadowFileSourceDRMType");
pub const g_wszWMWMShadowFileSourceFileType: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/WMShadowFileSourceFileType");
pub const g_wszWMWriter: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Writer");
pub const g_wszWMYear: ::windows_strings::PCWSTR = ::windows_strings::w!("WM/Year");
pub const g_wszWatermarkCLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("WatermarkCLSID");
pub const g_wszWatermarkConfig: ::windows_strings::PCWSTR = ::windows_strings::w!("WatermarkConfig");
#[repr(transparent)]
