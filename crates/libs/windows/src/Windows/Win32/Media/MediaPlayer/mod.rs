...
pub const PLUGIN_ALL_PLAYLISTSENDTO: ::windows_strings::PCWSTR = ::windows_strings::w!("PlaylistSendTo");
...
pub const PLUGIN_INSTALLREGKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\MediaPlayer\\UIPlugins");
pub const PLUGIN_INSTALLREGKEY_CAPABILITIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Capabilities");
pub const PLUGIN_INSTALLREGKEY_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const PLUGIN_INSTALLREGKEY_FRIENDLYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FriendlyName");
pub const PLUGIN_INSTALLREGKEY_UNINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("UninstallPath");
pub const PLUGIN_MISC_CURRENTPRESET: ::windows_strings::PCWSTR = ::windows_strings::w!("CurrentPreset");
pub const PLUGIN_MISC_PRESETCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("PresetCount");
pub const PLUGIN_MISC_PRESETNAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("PresetNames");
pub const PLUGIN_MISC_QUERYDESTROY: ::windows_strings::PCWSTR = ::windows_strings::w!("QueryDestroy");
pub const PLUGIN_SEPARATEWINDOW_DEFAULTHEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultHeight");
pub const PLUGIN_SEPARATEWINDOW_DEFAULTWIDTH: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultWidth");
pub const PLUGIN_SEPARATEWINDOW_MAXHEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxHeight");
pub const PLUGIN_SEPARATEWINDOW_MAXWIDTH: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxWidth");
pub const PLUGIN_SEPARATEWINDOW_MINHEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("MinHeight");
pub const PLUGIN_SEPARATEWINDOW_MINWIDTH: ::windows_strings::PCWSTR = ::windows_strings::w!("MinWidth");
pub const PLUGIN_SEPARATEWINDOW_RESIZABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Resizable");
...
pub const WMP_SUBSCR_DL_TYPE_BACKGROUND: ::windows_strings::PCWSTR = ::windows_strings::w!("background");
pub const WMP_SUBSCR_DL_TYPE_REALTIME: ::windows_strings::PCWSTR = ::windows_strings::w!("real time");
...
pub const g_szAllCPAlbumSubGenreIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPAlbumSubGenreIDs");
pub const g_szAllCPArtistIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPArtistIDs");
pub const g_szAllCPGenreIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPGenreIDs");
pub const g_szAllCPListIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPListIDs");
pub const g_szAllCPRadioIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPRadioIDs");
pub const g_szAllCPTrackIDs: ::windows_strings::PCWSTR = ::windows_strings::w!("AllCPTrackIDs");
pub const g_szAllReleaseDateYears: ::windows_strings::PCWSTR = ::windows_strings::w!("AllReleaseDateYears");
pub const g_szAllUserEffectiveRatingStarss: ::windows_strings::PCWSTR = ::windows_strings::w!("AllUserEffectiveRatingStarss");
pub const g_szAllWMParentalRatings: ::windows_strings::PCWSTR = ::windows_strings::w!("AllWMParentalRatings");
pub const g_szAuthor: ::windows_strings::PCWSTR = ::windows_strings::w!("Author");
pub const g_szCPAlbumID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPAlbumID");
pub const g_szCPAlbumSubGenreID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPAlbumSubGenreID");
pub const g_szCPArtistID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPArtistID");
pub const g_szCPGenreID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPGenreID");
pub const g_szCPListID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPListID");
pub const g_szCPRadioID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPRadioID");
pub const g_szCPTrackID: ::windows_strings::PCWSTR = ::windows_strings::w!("CPTrackID");
pub const g_szContentPartnerInfo_AccountBalance: ::windows_strings::PCWSTR = ::windows_strings::w!("AccountBalance");
pub const g_szContentPartnerInfo_AccountType: ::windows_strings::PCWSTR = ::windows_strings::w!("AccountType");
pub const g_szContentPartnerInfo_HasCachedCredentials: ::windows_strings::PCWSTR = ::windows_strings::w!("HasCachedCredentials");
pub const g_szContentPartnerInfo_LicenseRefreshAdvanceWarning: ::windows_strings::PCWSTR = ::windows_strings::w!("LicenseRefreshAdvanceWarning");
pub const g_szContentPartnerInfo_LoginState: ::windows_strings::PCWSTR = ::windows_strings::w!("LoginState");
pub const g_szContentPartnerInfo_MaximumTrackPurchasePerPurchase: ::windows_strings::PCWSTR = ::windows_strings::w!("MaximumNumberOfTracksPerPurchase");
pub const g_szContentPartnerInfo_MediaPlayerAccountType: ::windows_strings::PCWSTR = ::windows_strings::w!("MediaPlayerAccountType");
pub const g_szContentPartnerInfo_PurchasedTrackRequiresReDownload: ::windows_strings::PCWSTR = ::windows_strings::w!("PurchasedTrackRequiresReDownload");
pub const g_szContentPartnerInfo_UserName: ::windows_strings::PCWSTR = ::windows_strings::w!("UserName");
pub const g_szContentPrice_CannotBuy: ::windows_strings::PCWSTR = ::windows_strings::w!("PriceCannotBuy");
pub const g_szContentPrice_Free: ::windows_strings::PCWSTR = ::windows_strings::w!("PriceFree");
pub const g_szContentPrice_Unknown: ::windows_strings::PCWSTR = ::windows_strings::w!("PriceUnknown");
pub const g_szFlyoutMenu: ::windows_strings::PCWSTR = ::windows_strings::w!("FlyoutMenu");
pub const g_szItemInfo_ALTLoginCaption: ::windows_strings::PCWSTR = ::windows_strings::w!("ALTLoginCaption");
pub const g_szItemInfo_ALTLoginURL: ::windows_strings::PCWSTR = ::windows_strings::w!("ALTLoginURL");
pub const g_szItemInfo_AlbumArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("AlbumArt");
pub const g_szItemInfo_ArtistArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("ArtistArt");
pub const g_szItemInfo_AuthenticationSuccessURL: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthenticationSuccessURL");
pub const g_szItemInfo_CreateAccountURL: ::windows_strings::PCWSTR = ::windows_strings::w!("CreateAccount");
pub const g_szItemInfo_ErrorDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("CPErrorDescription");
pub const g_szItemInfo_ErrorURL: ::windows_strings::PCWSTR = ::windows_strings::w!("CPErrorURL");
pub const g_szItemInfo_ErrorURLLinkText: ::windows_strings::PCWSTR = ::windows_strings::w!("CPErrorURLLinkText");
pub const g_szItemInfo_ForgetPasswordURL: ::windows_strings::PCWSTR = ::windows_strings::w!("ForgotPassword");
pub const g_szItemInfo_GenreArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("GenreArt");
pub const g_szItemInfo_HTMLViewURL: ::windows_strings::PCWSTR = ::windows_strings::w!("HTMLViewURL");
pub const g_szItemInfo_ListArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("ListArt");
pub const g_szItemInfo_LoginFailureURL: ::windows_strings::PCWSTR = ::windows_strings::w!("LoginFailureURL");
pub const g_szItemInfo_PopupCaption: ::windows_strings::PCWSTR = ::windows_strings::w!("PopupCaption");
pub const g_szItemInfo_PopupURL: ::windows_strings::PCWSTR = ::windows_strings::w!("Popup");
pub const g_szItemInfo_RadioArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("RadioArt");
pub const g_szItemInfo_SubGenreArtURL: ::windows_strings::PCWSTR = ::windows_strings::w!("SubGenreArt");
pub const g_szItemInfo_TreeListIconURL: ::windows_strings::PCWSTR = ::windows_strings::w!("CPListIDIcon");
pub const g_szMediaPlayerTask_Browse: ::windows_strings::PCWSTR = ::windows_strings::w!("Browse");
pub const g_szMediaPlayerTask_Burn: ::windows_strings::PCWSTR = ::windows_strings::w!("Burn");
pub const g_szMediaPlayerTask_Sync: ::windows_strings::PCWSTR = ::windows_strings::w!("Sync");
pub const g_szOnlineStore: ::windows_strings::PCWSTR = ::windows_strings::w!("OnlineStore");
pub const g_szRefreshLicenseBurn: ::windows_strings::PCWSTR = ::windows_strings::w!("RefreshForBurn");
pub const g_szRefreshLicensePlay: ::windows_strings::PCWSTR = ::windows_strings::w!("RefreshForPlay");
pub const g_szRefreshLicenseSync: ::windows_strings::PCWSTR = ::windows_strings::w!("RefreshForSync");
pub const g_szReleaseDateYear: ::windows_strings::PCWSTR = ::windows_strings::w!("ReleaseDateYear");
pub const g_szRootLocation: ::windows_strings::PCWSTR = ::windows_strings::w!("RootLocation");
pub const g_szStationEvent_Complete: ::windows_strings::PCWSTR = ::windows_strings::w!("TrackComplete");
pub const g_szStationEvent_Skipped: ::windows_strings::PCWSTR = ::windows_strings::w!("TrackSkipped");
pub const g_szStationEvent_Started: ::windows_strings::PCWSTR = ::windows_strings::w!("TrackStarted");
pub const g_szUnknownLocation: ::windows_strings::PCWSTR = ::windows_strings::w!("UnknownLocation");
pub const g_szUserEffectiveRatingStars: ::windows_strings::PCWSTR = ::windows_strings::w!("UserEffectiveRatingStars");
pub const g_szUserPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("UserPlaylist");
pub const g_szVerifyPermissionSync: ::windows_strings::PCWSTR = ::windows_strings::w!("VerifyPermissionSync");
pub const g_szVideoRecent: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoRecent");
pub const g_szVideoRoot: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoRoot");
pub const g_szViewMode_Details: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewModeDetails");
pub const g_szViewMode_Icon: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewModeIcon");
pub const g_szViewMode_OrderedList: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewModeOrderedList");
