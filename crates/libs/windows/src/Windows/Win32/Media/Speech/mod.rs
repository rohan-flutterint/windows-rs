...
pub const SPALTERNATESCLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("AlternatesCLSID");
...
pub const SPCAT_APPLEXICONS: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\AppLexicons");
pub const SPCAT_AUDIOIN: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\AudioInput");
pub const SPCAT_AUDIOOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\AudioOutput");
pub const SPCAT_PHONECONVERTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\PhoneConverters");
pub const SPCAT_RECOGNIZERS: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\Recognizers");
pub const SPCAT_RECOPROFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Speech\\RecoProfiles");
pub const SPCAT_TEXTNORMALIZERS: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\TextNormalizers");
pub const SPCAT_VOICES: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\Voices");
...
pub const SPCURRENT_USER_LEXICON_TOKEN_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Speech\\CurrentUserLexicon");
pub const SPCURRENT_USER_SHORTCUT_TOKEN_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Speech\\CurrentUserShortcut");
...
pub const SPDICTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("*");
...
pub const SPDUI_AddRemoveWord: ::windows_strings::PCWSTR = ::windows_strings::w!("AddRemoveWord");
pub const SPDUI_AudioProperties: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioProperties");
pub const SPDUI_AudioVolume: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioVolume");
pub const SPDUI_EngineProperties: ::windows_strings::PCWSTR = ::windows_strings::w!("EngineProperties");
pub const SPDUI_MicTraining: ::windows_strings::PCWSTR = ::windows_strings::w!("MicTraining");
pub const SPDUI_RecoProfileProperties: ::windows_strings::PCWSTR = ::windows_strings::w!("RecoProfileProperties");
pub const SPDUI_ShareData: ::windows_strings::PCWSTR = ::windows_strings::w!("ShareData");
pub const SPDUI_Tutorial: ::windows_strings::PCWSTR = ::windows_strings::w!("Tutorial");
pub const SPDUI_UserEnrollment: ::windows_strings::PCWSTR = ::windows_strings::w!("UserEnrollment");
pub const SPDUI_UserTraining: ::windows_strings::PCWSTR = ::windows_strings::w!("UserTraining");
...
pub const SPINFDICTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("*+");
...
pub const SPMMSYS_AUDIO_IN_TOKEN_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\AudioInput\\TokenEnums\\MMAudioIn\\");
pub const SPMMSYS_AUDIO_OUT_TOKEN_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\AudioOutput\\TokenEnums\\MMAudioOut\\");
...
pub const SPPROP_ADAPTATION_ON: ::windows_strings::PCWSTR = ::windows_strings::w!("AdaptationOn");
pub const SPPROP_COMPLEX_RESPONSE_SPEED: ::windows_strings::PCWSTR = ::windows_strings::w!("ComplexResponseSpeed");
pub const SPPROP_HIGH_CONFIDENCE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("HighConfidenceThreshold");
pub const SPPROP_LOW_CONFIDENCE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("LowConfidenceThreshold");
pub const SPPROP_NORMAL_CONFIDENCE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("NormalConfidenceThreshold");
pub const SPPROP_PERSISTED_BACKGROUND_ADAPTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistedBackgroundAdaptation");
pub const SPPROP_PERSISTED_LANGUAGE_MODEL_ADAPTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistedLanguageModelAdaptation");
pub const SPPROP_RESOURCE_USAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceUsage");
pub const SPPROP_RESPONSE_SPEED: ::windows_strings::PCWSTR = ::windows_strings::w!("ResponseSpeed");
pub const SPPROP_UX_IS_LISTENING: ::windows_strings::PCWSTR = ::windows_strings::w!("UXIsListening");
...
pub const SPRECOEXTENSION: ::windows_strings::PCWSTR = ::windows_strings::w!("RecoExtension");
...
pub const SPREG_LOCAL_MACHINE_ROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech");
pub const SPREG_SAFE_USER_TOKENS: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\UserTokens");
pub const SPREG_USER_ROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Speech");
...
pub const SPTOKENKEY_ATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("Attributes");
pub const SPTOKENKEY_AUDIO_LATENCY_TRUNCATE: ::windows_strings::PCWSTR = ::windows_strings::w!("LatencyTruncateThreshold");
pub const SPTOKENKEY_AUDIO_LATENCY_UPDATE_INTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("LatencyUpdateInterval");
pub const SPTOKENKEY_AUDIO_LATENCY_WARNING: ::windows_strings::PCWSTR = ::windows_strings::w!("LatencyWarningThreshold");
pub const SPTOKENKEY_FILES: ::windows_strings::PCWSTR = ::windows_strings::w!("Files");
pub const SPTOKENKEY_RETAINEDAUDIO: ::windows_strings::PCWSTR = ::windows_strings::w!("SecondsPerRetainedAudioEvent");
pub const SPTOKENKEY_UI: ::windows_strings::PCWSTR = ::windows_strings::w!("UI");
pub const SPTOKENVALUE_CLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("CLSID");
pub const SPTOPIC_SPELLING: ::windows_strings::PCWSTR = ::windows_strings::w!("Spelling");
...
pub const SPVOICECATEGORY_TTSRATE: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultTTSRate");
...
pub const SPWILDCARD: ::windows_strings::PCWSTR = ::windows_strings::w!("...");
...
pub const SR_LOCALIZED_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
