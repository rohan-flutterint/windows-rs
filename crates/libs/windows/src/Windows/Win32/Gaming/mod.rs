...
pub const ID_GDF_THUMBNAIL_STR: ::windows_strings::PCWSTR = ::windows_strings::w!("__GDF_THUMBNAIL");
pub const ID_GDF_XML_STR: ::windows_strings::PCWSTR = ::windows_strings::w!("__GDF_XML");
=======
