...
pub const IMAPI2FS_FullVersion_STR: ::windows_strings::PCSTR = ::windows_strings::s!("1.0");
pub const IMAPI2FS_FullVersion_WSTR: ::windows_strings::PCWSTR = ::windows_strings::w!("1.0");
