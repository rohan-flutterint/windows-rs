...
pub const CLFS_BASELOG_EXTENSION: ::windows_strings::PCWSTR = ::windows_strings::w!(".blf");
pub const CLFS_CONTAINER_RELATIVE_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("%BLF%\\");
pub const CLFS_CONTAINER_STREAM_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("%BLF%:");
...
pub const EA_CONTAINER_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("ContainerName");
pub const EA_CONTAINER_SIZE: ::windows_strings::PCSTR = ::windows_strings::s!("ContainerSize");
...
pub const ENLISTMENT_OBJECT_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Enlistment\\");
...
pub const RESOURCE_MANAGER_OBJECT_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\ResourceManager\\");
...
pub const TRANSACTIONMANAGER_OBJECT_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\TransactionManager\\");
...
pub const TRANSACTION_OBJECT_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Transaction\\");
