...
pub const SZ_WWDEST_GLOBAL: ::windows_strings::PCWSTR = ::windows_strings::w!("GLOBAL");
pub const SZ_WWDEST_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("KEY");
pub const SZ_WWDEST_OCC: ::windows_strings::PCWSTR = ::windows_strings::w!("OCC");
