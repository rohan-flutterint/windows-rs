...
pub const AUTHSRV_AUTHORIZATION_VALUE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthorizationDLLs");
pub const AUTHSRV_ENFORCE_NP_FOR_PAP_CHALLENGE_RESPONSE_VALUE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("EnforceNetworkPolicyForPAPBasedChallengeResponse");
pub const AUTHSRV_EXTENSIONS_VALUE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionDLLs");
pub const AUTHSRV_PARAMETERS_KEY_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System\\CurrentControlSet\\Services\\AuthSrv\\Parameters");
...
pub const RADIUS_EXTENSION_FREE_ATTRIBUTES: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionFreeAttributes");
pub const RADIUS_EXTENSION_INIT: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionInit");
pub const RADIUS_EXTENSION_PROCESS: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionProcess");
pub const RADIUS_EXTENSION_PROCESS2: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionProcess2");
pub const RADIUS_EXTENSION_PROCESS_EX: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionProcessEx");
pub const RADIUS_EXTENSION_TERM: ::windows_strings::PCSTR = ::windows_strings::s!("RadiusExtensionTerm");
