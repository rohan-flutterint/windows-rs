...
pub const GET_RESOURCE_STRING_FN_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("GetResourceString");
pub const MAX_NAME_LEN: u32 = 48u32;
pub const NETSH_ARG_DELIMITER: ::windows_strings::PCWSTR = ::windows_strings::w!("=");
pub const NETSH_CMD_DELIMITER: ::windows_strings::PCWSTR = ::windows_strings::w!(" ");
...
pub const NS_GET_EVENT_IDS_FN_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("GetEventIds");
