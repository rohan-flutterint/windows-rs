...
pub const IHV_INIT_FUNCTION_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("Dot11ExtIhvInitService");
pub const IHV_INIT_VS_FUNCTION_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("Dot11ExtIhvInitVirtualStation");
pub const IHV_VERSION_FUNCTION_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("Dot11ExtIhvGetVersionInfo");
