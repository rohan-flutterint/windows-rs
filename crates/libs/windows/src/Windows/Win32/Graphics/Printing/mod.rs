...
pub const BIDI_ACTION_ENUM_SCHEMA: ::windows_strings::PCWSTR = ::windows_strings::w!("EnumSchema");
pub const BIDI_ACTION_GET: ::windows_strings::PCWSTR = ::windows_strings::w!("Get");
pub const BIDI_ACTION_GET_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("GetAll");
pub const BIDI_ACTION_GET_WITH_ARGUMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("GetWithArgument");
pub const BIDI_ACTION_SET: ::windows_strings::PCWSTR = ::windows_strings::w!("Set");
...
pub const MS_PRINT_JOB_OUTPUT_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("MsPrintJobOutputFile");
...
pub const SPLDS_ASSET_NUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("assetNumber");
pub const SPLDS_BYTES_PER_MINUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("bytesPerMinute");
pub const SPLDS_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("description");
pub const SPLDS_DRIVER_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("DsDriver");
pub const SPLDS_DRIVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("driverName");
pub const SPLDS_DRIVER_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("driverVersion");
pub const SPLDS_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("flags");
pub const SPLDS_LOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("location");
pub const SPLDS_PORT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("portName");
pub const SPLDS_PRINTER_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("printQueue");
pub const SPLDS_PRINTER_LOCATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("printerLocations");
pub const SPLDS_PRINTER_MODEL: ::windows_strings::PCWSTR = ::windows_strings::w!("printerModel");
pub const SPLDS_PRINTER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("printerName");
pub const SPLDS_PRINTER_NAME_ALIASES: ::windows_strings::PCWSTR = ::windows_strings::w!("printerNameAliases");
pub const SPLDS_PRINT_ATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("printAttributes");
pub const SPLDS_PRINT_BIN_NAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("printBinNames");
pub const SPLDS_PRINT_COLLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("printCollate");
pub const SPLDS_PRINT_COLOR: ::windows_strings::PCWSTR = ::windows_strings::w!("printColor");
pub const SPLDS_PRINT_DUPLEX_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("printDuplexSupported");
pub const SPLDS_PRINT_END_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("printEndTime");
pub const SPLDS_PRINT_KEEP_PRINTED_JOBS: ::windows_strings::PCWSTR = ::windows_strings::w!("printKeepPrintedJobs");
pub const SPLDS_PRINT_LANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("printLanguage");
pub const SPLDS_PRINT_MAC_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("printMACAddress");
pub const SPLDS_PRINT_MAX_RESOLUTION_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("printMaxResolutionSupported");
pub const SPLDS_PRINT_MAX_X_EXTENT: ::windows_strings::PCWSTR = ::windows_strings::w!("printMaxXExtent");
pub const SPLDS_PRINT_MAX_Y_EXTENT: ::windows_strings::PCWSTR = ::windows_strings::w!("printMaxYExtent");
pub const SPLDS_PRINT_MEDIA_READY: ::windows_strings::PCWSTR = ::windows_strings::w!("printMediaReady");
pub const SPLDS_PRINT_MEDIA_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("printMediaSupported");
pub const SPLDS_PRINT_MEMORY: ::windows_strings::PCWSTR = ::windows_strings::w!("printMemory");
pub const SPLDS_PRINT_MIN_X_EXTENT: ::windows_strings::PCWSTR = ::windows_strings::w!("printMinXExtent");
pub const SPLDS_PRINT_MIN_Y_EXTENT: ::windows_strings::PCWSTR = ::windows_strings::w!("printMinYExtent");
pub const SPLDS_PRINT_NETWORK_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("printNetworkAddress");
pub const SPLDS_PRINT_NOTIFY: ::windows_strings::PCWSTR = ::windows_strings::w!("printNotify");
pub const SPLDS_PRINT_NUMBER_UP: ::windows_strings::PCWSTR = ::windows_strings::w!("printNumberUp");
pub const SPLDS_PRINT_ORIENTATIONS_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("printOrientationsSupported");
pub const SPLDS_PRINT_OWNER: ::windows_strings::PCWSTR = ::windows_strings::w!("printOwner");
pub const SPLDS_PRINT_PAGES_PER_MINUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("printPagesPerMinute");
pub const SPLDS_PRINT_RATE: ::windows_strings::PCWSTR = ::windows_strings::w!("printRate");
pub const SPLDS_PRINT_RATE_UNIT: ::windows_strings::PCWSTR = ::windows_strings::w!("printRateUnit");
pub const SPLDS_PRINT_SEPARATOR_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("printSeparatorFile");
pub const SPLDS_PRINT_SHARE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("printShareName");
pub const SPLDS_PRINT_SPOOLING: ::windows_strings::PCWSTR = ::windows_strings::w!("printSpooling");
pub const SPLDS_PRINT_STAPLING_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("printStaplingSupported");
pub const SPLDS_PRINT_START_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("printStartTime");
pub const SPLDS_PRINT_STATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("printStatus");
pub const SPLDS_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("priority");
pub const SPLDS_SERVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("serverName");
pub const SPLDS_SHORT_SERVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("shortServerName");
pub const SPLDS_SPOOLER_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("DsSpooler");
pub const SPLDS_UNC_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("uNCName");
pub const SPLDS_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("url");
pub const SPLDS_USER_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("DsUser");
pub const SPLDS_VERSION_NUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("versionNumber");
pub const SPLPRINTER_USER_MODE_PRINTER_DRIVER: ::windows_strings::PCWSTR = ::windows_strings::w!("SPLUserModePrinterDriver");
pub const SPLREG_ALLOW_USER_MANAGEFORMS: ::windows_strings::PCWSTR = ::windows_strings::w!("AllowUserManageForms");
pub const SPLREG_ARCHITECTURE: ::windows_strings::PCWSTR = ::windows_strings::w!("Architecture");
pub const SPLREG_BEEP_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("BeepEnabled");
pub const SPLREG_DEFAULT_SPOOL_DIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultSpoolDirectory");
pub const SPLREG_DNS_MACHINE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DNSMachineName");
pub const SPLREG_DS_PRESENT: ::windows_strings::PCWSTR = ::windows_strings::w!("DsPresent");
pub const SPLREG_DS_PRESENT_FOR_USER: ::windows_strings::PCWSTR = ::windows_strings::w!("DsPresentForUser");
pub const SPLREG_EVENT_LOG: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLog");
pub const SPLREG_MAJOR_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("MajorVersion");
pub const SPLREG_MINOR_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("MinorVersion");
pub const SPLREG_NET_POPUP: ::windows_strings::PCWSTR = ::windows_strings::w!("NetPopup");
pub const SPLREG_NET_POPUP_TO_COMPUTER: ::windows_strings::PCWSTR = ::windows_strings::w!("NetPopupToComputer");
pub const SPLREG_OS_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("OSVersion");
pub const SPLREG_OS_VERSIONEX: ::windows_strings::PCWSTR = ::windows_strings::w!("OSVersionEx");
pub const SPLREG_PORT_THREAD_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("PortThreadPriority");
pub const SPLREG_PORT_THREAD_PRIORITY_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("PortThreadPriorityDefault");
pub const SPLREG_PRINT_DRIVER_ISOLATION_EXECUTION_POLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationExecutionPolicy");
pub const SPLREG_PRINT_DRIVER_ISOLATION_GROUPS: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationGroups");
pub const SPLREG_PRINT_DRIVER_ISOLATION_IDLE_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationIdleTimeout");
pub const SPLREG_PRINT_DRIVER_ISOLATION_MAX_OBJECTS_BEFORE_RECYCLE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationMaxobjsBeforeRecycle");
pub const SPLREG_PRINT_DRIVER_ISOLATION_OVERRIDE_POLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationOverrideCompat");
pub const SPLREG_PRINT_DRIVER_ISOLATION_TIME_BEFORE_RECYCLE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDriverIsolationTimeBeforeRecycle");
pub const SPLREG_PRINT_QUEUE_V4_DRIVER_DIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintQueueV4DriverDirectory");
pub const SPLREG_REMOTE_FAX: ::windows_strings::PCWSTR = ::windows_strings::w!("RemoteFax");
pub const SPLREG_RESTART_JOB_ON_POOL_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartJobOnPoolEnabled");
pub const SPLREG_RESTART_JOB_ON_POOL_ERROR: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartJobOnPoolError");
pub const SPLREG_RETRY_POPUP: ::windows_strings::PCWSTR = ::windows_strings::w!("RetryPopup");
pub const SPLREG_SCHEDULER_THREAD_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("SchedulerThreadPriority");
pub const SPLREG_SCHEDULER_THREAD_PRIORITY_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("SchedulerThreadPriorityDefault");
pub const SPLREG_WEBSHAREMGMT: ::windows_strings::PCWSTR = ::windows_strings::w!("WebShareMgmt");
...
pub const XPS_FP_DRIVER_PROPERTY_BAG: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverPropertyBag");
pub const XPS_FP_JOB_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintJobId");
pub const XPS_FP_JOB_LEVEL_PRINTTICKET: ::windows_strings::PCWSTR = ::windows_strings::w!("JobPrintTicket");
pub const XPS_FP_MERGED_DATAFILE_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("MergedDataFilePath");
pub const XPS_FP_MS_CONTENT_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverMultiContentType");
pub const XPS_FP_MS_CONTENT_TYPE_OPENXPS: ::windows_strings::PCWSTR = ::windows_strings::w!("OpenXPS");
pub const XPS_FP_MS_CONTENT_TYPE_XPS: ::windows_strings::PCWSTR = ::windows_strings::w!("XPS");
pub const XPS_FP_OUTPUT_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintOutputFileName");
pub const XPS_FP_PRINTDEVICECAPABILITIES: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintDeviceCapabilities");
pub const XPS_FP_PRINTER_HANDLE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrinterHandle");
pub const XPS_FP_PRINTER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PrinterName");
pub const XPS_FP_PRINT_CLASS_FACTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintClassFactory");
pub const XPS_FP_PROGRESS_REPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgressReport");
pub const XPS_FP_QUEUE_PROPERTY_BAG: ::windows_strings::PCWSTR = ::windows_strings::w!("QueuePropertyBag");
pub const XPS_FP_RESOURCE_DLL_PATHS: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceDLLPaths");
pub const XPS_FP_USER_PRINT_TICKET: ::windows_strings::PCWSTR = ::windows_strings::w!("PerUserPrintTicket");
pub const XPS_FP_USER_TOKEN: ::windows_strings::PCWSTR = ::windows_strings::w!("UserSecurityToken");
