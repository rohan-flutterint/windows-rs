...
pub const DXC_ARG_ALL_RESOURCES_BOUND: ::windows_strings::PCWSTR = ::windows_strings::w!("-all_resources_bound");
pub const DXC_ARG_AVOID_FLOW_CONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("-Gfa");
pub const DXC_ARG_DEBUG: ::windows_strings::PCWSTR = ::windows_strings::w!("-Zi");
pub const DXC_ARG_DEBUG_NAME_FOR_BINARY: ::windows_strings::PCWSTR = ::windows_strings::w!("-Zsb");
pub const DXC_ARG_DEBUG_NAME_FOR_SOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("-Zss");
pub const DXC_ARG_ENABLE_BACKWARDS_COMPATIBILITY: ::windows_strings::PCWSTR = ::windows_strings::w!("-Gec");
pub const DXC_ARG_ENABLE_STRICTNESS: ::windows_strings::PCWSTR = ::windows_strings::w!("-Ges");
pub const DXC_ARG_IEEE_STRICTNESS: ::windows_strings::PCWSTR = ::windows_strings::w!("-Gis");
pub const DXC_ARG_OPTIMIZATION_LEVEL0: ::windows_strings::PCWSTR = ::windows_strings::w!("-O0");
pub const DXC_ARG_OPTIMIZATION_LEVEL1: ::windows_strings::PCWSTR = ::windows_strings::w!("-O1");
pub const DXC_ARG_OPTIMIZATION_LEVEL2: ::windows_strings::PCWSTR = ::windows_strings::w!("-O2");
pub const DXC_ARG_OPTIMIZATION_LEVEL3: ::windows_strings::PCWSTR = ::windows_strings::w!("-O3");
pub const DXC_ARG_PACK_MATRIX_COLUMN_MAJOR: ::windows_strings::PCWSTR = ::windows_strings::w!("-Zpc");
pub const DXC_ARG_PACK_MATRIX_ROW_MAJOR: ::windows_strings::PCWSTR = ::windows_strings::w!("-Zpr");
pub const DXC_ARG_PREFER_FLOW_CONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("-Gfp");
pub const DXC_ARG_RESOURCES_MAY_ALIAS: ::windows_strings::PCWSTR = ::windows_strings::w!("-res_may_alias");
pub const DXC_ARG_SKIP_OPTIMIZATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("-Od");
pub const DXC_ARG_SKIP_VALIDATION: ::windows_strings::PCWSTR = ::windows_strings::w!("-Vd");
pub const DXC_ARG_WARNINGS_ARE_ERRORS: ::windows_strings::PCWSTR = ::windows_strings::w!("-WX");
...
pub const DXC_EXTRA_OUTPUT_NAME_STDERR: ::windows_strings::PCWSTR = ::windows_strings::w!("*stderr*");
pub const DXC_EXTRA_OUTPUT_NAME_STDOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("*stdout*");
