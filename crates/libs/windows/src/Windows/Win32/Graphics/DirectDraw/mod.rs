...
pub const DDHAL_APP_DLLNAME: ::windows_strings::PCSTR = ::windows_strings::s!("DDRAW.DLL");
...
pub const DDHAL_DRIVER_DLLNAME: ::windows_strings::PCSTR = ::windows_strings::s!("DDRAW16.DLL");
...
pub const REGSTR_KEY_DDHW_DESCRIPTION: ::windows_strings::PCSTR = ::windows_strings::s!("Description");
pub const REGSTR_KEY_DDHW_DRIVERNAME: ::windows_strings::PCSTR = ::windows_strings::s!("DriverName");
pub const REGSTR_PATH_DDHW: ::windows_strings::PCSTR = ::windows_strings::s!("Hardware\\DirectDrawDrivers");
