...
pub const CLOUD_WITNESS_CONTAINER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("msft-cloud-witness");
...
pub const CLUSREG_KEYNAME_OBJECTGUIDS: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectGUIDs");
pub const CLUSREG_LAST_COMMAND: CLUSTER_REG_COMMAND = CLUSTER_REG_COMMAND(19i32);
pub const CLUSREG_NAME_AFFINITYRULE_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled");
pub const CLUSREG_NAME_AFFINITYRULE_GROUPS: ::windows_strings::PCWSTR = ::windows_strings::w!("Groups");
pub const CLUSREG_NAME_AFFINITYRULE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_AFFINITYRULE_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RuleType");
pub const CLUSREG_NAME_CLOUDWITNESS_ACCOUNT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AccountName");
pub const CLUSREG_NAME_CLOUDWITNESS_CONTAINER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ContainerName");
pub const CLUSREG_NAME_CLOUDWITNESS_ENDPOINT_INFO: ::windows_strings::PCWSTR = ::windows_strings::w!("EndpointInfo");
pub const CLUSREG_NAME_CLOUDWITNESS_PRIMARY_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryKey");
pub const CLUSREG_NAME_CLOUDWITNESS_PRIMARY_TOKEN: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryToken");
pub const CLUSREG_NAME_CLUS_DEFAULT_NETWORK_ROLE: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultNetworkRole");
pub const CLUSREG_NAME_CLUS_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_CLUS_SD: ::windows_strings::PCWSTR = ::windows_strings::w!("Security Descriptor");
pub const CLUSREG_NAME_CROSS_SITE_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossSiteDelay");
pub const CLUSREG_NAME_CROSS_SITE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossSiteThreshold");
pub const CLUSREG_NAME_CROSS_SUBNET_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossSubnetDelay");
pub const CLUSREG_NAME_CROSS_SUBNET_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossSubnetThreshold");
pub const CLUSREG_NAME_CSV_BLOCK_CACHE: ::windows_strings::PCWSTR = ::windows_strings::w!("BlockCacheSize");
pub const CLUSREG_NAME_CSV_MDS_SD: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedVolumeSecurityDescriptor");
pub const CLUSREG_NAME_DATABASE_READ_WRITE_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("DatabaseReadWriteMode");
pub const CLUSREG_NAME_DDA_DEVICE_ALLOCATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("DdaDeviceAllocations");
pub const CLUSREG_NAME_DHCP_BACKUP_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("BackupPath");
pub const CLUSREG_NAME_DHCP_DATABASE_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("DatabasePath");
pub const CLUSREG_NAME_DRAIN_ON_SHUTDOWN: ::windows_strings::PCWSTR = ::windows_strings::w!("DrainOnShutdown");
pub const CLUSREG_NAME_ENABLED_EVENT_LOGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnabledEventLogs");
pub const CLUSREG_NAME_FAILOVER_MOVE_MIGRATION_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("FailoverMoveMigrationType");
pub const CLUSREG_NAME_FILESHR_CA_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("CATimeout");
pub const CLUSREG_NAME_FILESHR_HIDE_SUBDIR_SHARES: ::windows_strings::PCWSTR = ::windows_strings::w!("HideSubDirShares");
pub const CLUSREG_NAME_FILESHR_IS_DFS_ROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("IsDfsRoot");
pub const CLUSREG_NAME_FILESHR_MAX_USERS: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxUsers");
pub const CLUSREG_NAME_FILESHR_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Path");
pub const CLUSREG_NAME_FILESHR_QOS_FLOWSCOPE: ::windows_strings::PCWSTR = ::windows_strings::w!("QosFlowScope");
pub const CLUSREG_NAME_FILESHR_QOS_POLICYID: ::windows_strings::PCWSTR = ::windows_strings::w!("QosPolicyId");
pub const CLUSREG_NAME_FILESHR_REMARK: ::windows_strings::PCWSTR = ::windows_strings::w!("Remark");
pub const CLUSREG_NAME_FILESHR_SD: ::windows_strings::PCWSTR = ::windows_strings::w!("Security Descriptor");
pub const CLUSREG_NAME_FILESHR_SERVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ServerName");
pub const CLUSREG_NAME_FILESHR_SHARE_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("ShareFlags");
pub const CLUSREG_NAME_FILESHR_SHARE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ShareName");
pub const CLUSREG_NAME_FILESHR_SHARE_SUBDIRS: ::windows_strings::PCWSTR = ::windows_strings::w!("ShareSubDirs");
pub const CLUSREG_NAME_FIXQUORUM: ::windows_strings::PCWSTR = ::windows_strings::w!("FixQuorum");
pub const CLUSREG_NAME_FSWITNESS_ARB_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("ArbitrationDelay");
pub const CLUSREG_NAME_FSWITNESS_IMPERSONATE_CNO: ::windows_strings::PCWSTR = ::windows_strings::w!("ImpersonateCNO");
pub const CLUSREG_NAME_FSWITNESS_SHARE_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("SharePath");
pub const CLUSREG_NAME_FUNCTIONAL_LEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterFunctionalLevel");
pub const CLUSREG_NAME_GENAPP_COMMAND_LINE: ::windows_strings::PCWSTR = ::windows_strings::w!("CommandLine");
pub const CLUSREG_NAME_GENAPP_CURRENT_DIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("CurrentDirectory");
pub const CLUSREG_NAME_GENAPP_USE_NETWORK_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("UseNetworkName");
pub const CLUSREG_NAME_GENSCRIPT_SCRIPT_FILEPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("ScriptFilepath");
pub const CLUSREG_NAME_GENSVC_SERVICE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceName");
pub const CLUSREG_NAME_GENSVC_STARTUP_PARAMS: ::windows_strings::PCWSTR = ::windows_strings::w!("StartupParameters");
pub const CLUSREG_NAME_GENSVC_USE_NETWORK_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("UseNetworkName");
pub const CLUSREG_NAME_GPUP_DEVICE_ALLOCATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("GpupDeviceAllocations");
pub const CLUSREG_NAME_GROUPSET_AVAILABILITY_SET_INDEX_TO_NODE_MAPPING: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeDomainInfo");
pub const CLUSREG_NAME_GROUPSET_FAULT_DOMAINS: ::windows_strings::PCWSTR = ::windows_strings::w!("FaultDomains");
pub const CLUSREG_NAME_GROUPSET_IS_AVAILABILITY_SET: ::windows_strings::PCWSTR = ::windows_strings::w!("IsAvailabilitySet");
pub const CLUSREG_NAME_GROUPSET_IS_GLOBAL: ::windows_strings::PCWSTR = ::windows_strings::w!("IsGlobal");
pub const CLUSREG_NAME_GROUPSET_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_GROUPSET_RESERVE_NODE: ::windows_strings::PCWSTR = ::windows_strings::w!("ReserveSpareNode");
pub const CLUSREG_NAME_GROUPSET_STARTUP_COUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("StartupCount");
pub const CLUSREG_NAME_GROUPSET_STARTUP_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("StartupDelay");
pub const CLUSREG_NAME_GROUPSET_STARTUP_SETTING: ::windows_strings::PCWSTR = ::windows_strings::w!("StartupSetting");
pub const CLUSREG_NAME_GROUPSET_STATUS_INFORMATION: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusInformation");
pub const CLUSREG_NAME_GROUPSET_UPDATE_DOMAINS: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateDomains");
pub const CLUSREG_NAME_GROUP_DEPENDENCY_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("GroupDependencyTimeout");
pub const CLUSREG_NAME_GRP_ANTI_AFFINITY_CLASS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AntiAffinityClassNames");
pub const CLUSREG_NAME_GRP_CCF_EPOCH: ::windows_strings::PCWSTR = ::windows_strings::w!("CCFEpoch");
pub const CLUSREG_NAME_GRP_CCF_EPOCH_HIGH: ::windows_strings::PCWSTR = ::windows_strings::w!("CCFEpochHigh");
pub const CLUSREG_NAME_GRP_COLD_START_SETTING: ::windows_strings::PCWSTR = ::windows_strings::w!("ColdStartSetting");
pub const CLUSREG_NAME_GRP_DEFAULT_OWNER: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultOwner");
pub const CLUSREG_NAME_GRP_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_GRP_FAILBACK_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoFailbackType");
pub const CLUSREG_NAME_GRP_FAILBACK_WIN_END: ::windows_strings::PCWSTR = ::windows_strings::w!("FailbackWindowEnd");
pub const CLUSREG_NAME_GRP_FAILBACK_WIN_START: ::windows_strings::PCWSTR = ::windows_strings::w!("FailbackWindowStart");
pub const CLUSREG_NAME_GRP_FAILOVER_PERIOD: ::windows_strings::PCWSTR = ::windows_strings::w!("FailoverPeriod");
pub const CLUSREG_NAME_GRP_FAILOVER_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("FailoverThreshold");
pub const CLUSREG_NAME_GRP_FAULT_DOMAIN: ::windows_strings::PCWSTR = ::windows_strings::w!("FaultDomain");
pub const CLUSREG_NAME_GRP_LOCK_MOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("LockedFromMoving");
pub const CLUSREG_NAME_GRP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_GRP_PERSISTENT_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistentState");
pub const CLUSREG_NAME_GRP_PLACEMENT_OPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("PlacementOptions");
pub const CLUSREG_NAME_GRP_PREFERRED_SITE: ::windows_strings::PCWSTR = ::windows_strings::w!("PreferredSite");
pub const CLUSREG_NAME_GRP_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Priority");
pub const CLUSREG_NAME_GRP_RESILIENCY_PERIOD: ::windows_strings::PCWSTR = ::windows_strings::w!("ResiliencyPeriod");
pub const CLUSREG_NAME_GRP_START_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("GroupStartDelay");
pub const CLUSREG_NAME_GRP_STATUS_INFORMATION: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusInformation");
pub const CLUSREG_NAME_GRP_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("GroupType");
pub const CLUSREG_NAME_GRP_UPDATE_DOMAIN: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateDomain");
pub const CLUSREG_NAME_IGNORE_PERSISTENT_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("IgnorePersistentStateOnStartup");
pub const CLUSREG_NAME_IPADDR_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_IPADDR_DHCP_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("DhcpAddress");
pub const CLUSREG_NAME_IPADDR_DHCP_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("DhcpServer");
pub const CLUSREG_NAME_IPADDR_DHCP_SUBNET_MASK: ::windows_strings::PCWSTR = ::windows_strings::w!("DhcpSubnetMask");
pub const CLUSREG_NAME_IPADDR_ENABLE_DHCP: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableDhcp");
pub const CLUSREG_NAME_IPADDR_ENABLE_NETBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableNetBIOS");
pub const CLUSREG_NAME_IPADDR_LEASE_OBTAINED_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("LeaseObtainedTime");
pub const CLUSREG_NAME_IPADDR_LEASE_TERMINATES_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("LeaseExpiresTime");
pub const CLUSREG_NAME_IPADDR_NETWORK: ::windows_strings::PCWSTR = ::windows_strings::w!("Network");
pub const CLUSREG_NAME_IPADDR_OVERRIDE_ADDRMATCH: ::windows_strings::PCWSTR = ::windows_strings::w!("OverrideAddressMatch");
pub const CLUSREG_NAME_IPADDR_PROBE_FAILURE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("ProbeFailureThreshold");
pub const CLUSREG_NAME_IPADDR_PROBE_PORT: ::windows_strings::PCWSTR = ::windows_strings::w!("ProbePort");
pub const CLUSREG_NAME_IPADDR_SHARED_NETNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedNetname");
pub const CLUSREG_NAME_IPADDR_SUBNET_MASK: ::windows_strings::PCWSTR = ::windows_strings::w!("SubnetMask");
pub const CLUSREG_NAME_IPADDR_T1: ::windows_strings::PCWSTR = ::windows_strings::w!("T1");
pub const CLUSREG_NAME_IPADDR_T2: ::windows_strings::PCWSTR = ::windows_strings::w!("T2");
pub const CLUSREG_NAME_IPV6_NATIVE_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_IPV6_NATIVE_NETWORK: ::windows_strings::PCWSTR = ::windows_strings::w!("Network");
pub const CLUSREG_NAME_IPV6_NATIVE_PREFIX_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("PrefixLength");
pub const CLUSREG_NAME_IPV6_TUNNEL_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_IPV6_TUNNEL_TUNNELTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("TunnelType");
pub const CLUSREG_NAME_LAST_RECENT_EVENTS_RESET_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("RecentEventsResetTime");
pub const CLUSREG_NAME_LOG_FILE_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("LogFilePath");
pub const CLUSREG_NAME_MESSAGE_BUFFER_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("MessageBufferLength");
pub const CLUSREG_NAME_MIXED_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("MixedMode");
pub const CLUSREG_NAME_NETFT_IPSEC_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("NetftIPSecEnabled");
pub const CLUSREG_NAME_NETIFACE_ADAPTER_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("AdapterId");
pub const CLUSREG_NAME_NETIFACE_ADAPTER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Adapter");
pub const CLUSREG_NAME_NETIFACE_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_NETIFACE_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_NETIFACE_DHCP_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("DhcpEnabled");
pub const CLUSREG_NAME_NETIFACE_IPV4_ADDRESSES: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv4Addresses");
pub const CLUSREG_NAME_NETIFACE_IPV6_ADDRESSES: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv6Addresses");
pub const CLUSREG_NAME_NETIFACE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_NETIFACE_NETWORK: ::windows_strings::PCWSTR = ::windows_strings::w!("Network");
pub const CLUSREG_NAME_NETIFACE_NODE: ::windows_strings::PCWSTR = ::windows_strings::w!("Node");
pub const CLUSREG_NAME_NETNAME_AD_AWARE: ::windows_strings::PCWSTR = ::windows_strings::w!("ADAware");
pub const CLUSREG_NAME_NETNAME_ALIASES: ::windows_strings::PCWSTR = ::windows_strings::w!("Aliases");
pub const CLUSREG_NAME_NETNAME_CONTAINERGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptoContainerGUID");
pub const CLUSREG_NAME_NETNAME_CREATING_DC: ::windows_strings::PCWSTR = ::windows_strings::w!("CreatingDC");
pub const CLUSREG_NAME_NETNAME_DNN_DISABLE_CLONES: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableClones");
pub const CLUSREG_NAME_NETNAME_DNS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DnsName");
pub const CLUSREG_NAME_NETNAME_DNS_SUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("DnsSuffix");
pub const CLUSREG_NAME_NETNAME_EXCLUDE_NETWORKS: ::windows_strings::PCWSTR = ::windows_strings::w!("ExcludeNetworks");
pub const CLUSREG_NAME_NETNAME_HOST_TTL: ::windows_strings::PCWSTR = ::windows_strings::w!("HostRecordTTL");
pub const CLUSREG_NAME_NETNAME_IN_USE_NETWORKS: ::windows_strings::PCWSTR = ::windows_strings::w!("InUseNetworks");
pub const CLUSREG_NAME_NETNAME_LAST_DNS_UPDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("LastDNSUpdateTime");
pub const CLUSREG_NAME_NETNAME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_NETNAME_OBJECT_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectGUID");
pub const CLUSREG_NAME_NETNAME_PUBLISH_PTR: ::windows_strings::PCWSTR = ::windows_strings::w!("PublishPTRRecords");
pub const CLUSREG_NAME_NETNAME_REGISTER_ALL_IP: ::windows_strings::PCWSTR = ::windows_strings::w!("RegisterAllProvidersIP");
pub const CLUSREG_NAME_NETNAME_REMAP_PIPE_NAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("RemapPipeNames");
pub const CLUSREG_NAME_NETNAME_REMOVEVCO_ONDELETE: ::windows_strings::PCWSTR = ::windows_strings::w!("DeleteVcoOnResCleanup");
pub const CLUSREG_NAME_NETNAME_RESOURCE_DATA: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceData");
pub const CLUSREG_NAME_NETNAME_STATUS_DNS: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusDNS");
pub const CLUSREG_NAME_NETNAME_STATUS_KERBEROS: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusKerberos");
pub const CLUSREG_NAME_NETNAME_STATUS_NETBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusNetBIOS");
pub const CLUSREG_NAME_NETNAME_VCO_CONTAINER: ::windows_strings::PCWSTR = ::windows_strings::w!("VcoContainer");
pub const CLUSREG_NAME_NET_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_NET_ADDRESS_MASK: ::windows_strings::PCWSTR = ::windows_strings::w!("AddressMask");
pub const CLUSREG_NAME_NET_AUTOMETRIC: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoMetric");
pub const CLUSREG_NAME_NET_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_NET_IPV4_ADDRESSES: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv4Addresses");
pub const CLUSREG_NAME_NET_IPV4_PREFIXLENGTHS: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv4PrefixLengths");
pub const CLUSREG_NAME_NET_IPV6_ADDRESSES: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv6Addresses");
pub const CLUSREG_NAME_NET_IPV6_PREFIXLENGTHS: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv6PrefixLengths");
pub const CLUSREG_NAME_NET_METRIC: ::windows_strings::PCWSTR = ::windows_strings::w!("Metric");
pub const CLUSREG_NAME_NET_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_NET_RDMA_CAPABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("RdmaCapable");
pub const CLUSREG_NAME_NET_ROLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Role");
pub const CLUSREG_NAME_NET_RSS_CAPABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("RssCapable");
pub const CLUSREG_NAME_NET_SPEED: ::windows_strings::PCWSTR = ::windows_strings::w!("LinkSpeed");
pub const CLUSREG_NAME_NODE_BUILD_NUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("BuildNumber");
pub const CLUSREG_NAME_NODE_CSDVERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("CSDVersion");
pub const CLUSREG_NAME_NODE_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_NODE_DRAIN_STATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeDrainStatus");
pub const CLUSREG_NAME_NODE_DRAIN_TARGET: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeDrainTarget");
pub const CLUSREG_NAME_NODE_DYNAMIC_WEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("DynamicWeight");
pub const CLUSREG_NAME_NODE_FAULT_DOMAIN: ::windows_strings::PCWSTR = ::windows_strings::w!("FaultDomain");
pub const CLUSREG_NAME_NODE_FDID: ::windows_strings::PCWSTR = ::windows_strings::w!("FaultDomainId");
pub const CLUSREG_NAME_NODE_HIGHEST_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeHighestVersion");
pub const CLUSREG_NAME_NODE_IS_PRIMARY: ::windows_strings::PCWSTR = ::windows_strings::w!("IsPrimary");
pub const CLUSREG_NAME_NODE_LOWEST_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeLowestVersion");
pub const CLUSREG_NAME_NODE_MAJOR_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("MajorVersion");
pub const CLUSREG_NAME_NODE_MANUFACTURER: ::windows_strings::PCWSTR = ::windows_strings::w!("Manufacturer");
pub const CLUSREG_NAME_NODE_MINOR_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("MinorVersion");
pub const CLUSREG_NAME_NODE_MODEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Model");
pub const CLUSREG_NAME_NODE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeName");
pub const CLUSREG_NAME_NODE_NEEDS_PQ: ::windows_strings::PCWSTR = ::windows_strings::w!("NeedsPreventQuorum");
pub const CLUSREG_NAME_NODE_SERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("SerialNumber");
pub const CLUSREG_NAME_NODE_STATUS_INFO: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusInformation");
pub const CLUSREG_NAME_NODE_UNIQUEID: ::windows_strings::PCWSTR = ::windows_strings::w!("UniqueID");
pub const CLUSREG_NAME_NODE_WEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("NodeWeight");
pub const CLUSREG_NAME_PHYSDISK_CSVBLOCKCACHE: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableBlockCache");
pub const CLUSREG_NAME_PHYSDISK_CSVSNAPSHOTAGELIMIT: ::windows_strings::PCWSTR = ::windows_strings::w!("SnapshotAgeLimit");
pub const CLUSREG_NAME_PHYSDISK_CSVSNAPSHOTDIFFAREASIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("SnapshotDiffSize");
pub const CLUSREG_NAME_PHYSDISK_CSVWRITETHROUGH: ::windows_strings::PCWSTR = ::windows_strings::w!("CsvEnforceWriteThrough");
pub const CLUSREG_NAME_PHYSDISK_DISKARBINTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskArbInterval");
pub const CLUSREG_NAME_PHYSDISK_DISKARBTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskArbType");
pub const CLUSREG_NAME_PHYSDISK_DISKGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskGuid");
pub const CLUSREG_NAME_PHYSDISK_DISKIDGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskIdGuid");
pub const CLUSREG_NAME_PHYSDISK_DISKIDTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskIdType");
pub const CLUSREG_NAME_PHYSDISK_DISKIODELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxIoLatency");
pub const CLUSREG_NAME_PHYSDISK_DISKPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskPath");
pub const CLUSREG_NAME_PHYSDISK_DISKRECOVERYACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskRecoveryAction");
pub const CLUSREG_NAME_PHYSDISK_DISKRELOAD: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskReload");
pub const CLUSREG_NAME_PHYSDISK_DISKRUNCHKDSK: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskRunChkDsk");
pub const CLUSREG_NAME_PHYSDISK_DISKSIGNATURE: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskSignature");
pub const CLUSREG_NAME_PHYSDISK_DISKUNIQUEIDS: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskUniqueIds");
pub const CLUSREG_NAME_PHYSDISK_DISKVOLUMEINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskVolumeInfo");
pub const CLUSREG_NAME_PHYSDISK_FASTONLINEARBITRATE: ::windows_strings::PCWSTR = ::windows_strings::w!("FastOnlineArbitrate");
pub const CLUSREG_NAME_PHYSDISK_MAINTMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaintenanceMode");
pub const CLUSREG_NAME_PHYSDISK_MIGRATEFIXUP: ::windows_strings::PCWSTR = ::windows_strings::w!("MigrateDriveLetters");
pub const CLUSREG_NAME_PHYSDISK_SPACEIDGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskId");
pub const CLUSREG_NAME_PHYSDISK_VOLSNAPACTIVATETIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("VolsnapActivateTimeout");
pub const CLUSREG_NAME_PLACEMENT_OPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("PlacementOptions");
pub const CLUSREG_NAME_PLUMB_ALL_CROSS_SUBNET_ROUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("PlumbAllCrossSubnetRoutes");
pub const CLUSREG_NAME_PREVENTQUORUM: ::windows_strings::PCWSTR = ::windows_strings::w!("PreventQuorum");
pub const CLUSREG_NAME_PRTSPOOL_DEFAULT_SPOOL_DIR: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultSpoolDirectory");
pub const CLUSREG_NAME_PRTSPOOL_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("JobCompletionTimeout");
pub const CLUSREG_NAME_QUARANTINE_DURATION: ::windows_strings::PCWSTR = ::windows_strings::w!("QuarantineDuration");
pub const CLUSREG_NAME_QUARANTINE_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("QuarantineThreshold");
pub const CLUSREG_NAME_QUORUM_ARBITRATION_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("QuorumArbitrationTimeMax");
pub const CLUSREG_NAME_RESILIENCY_DEFAULT_SECONDS: ::windows_strings::PCWSTR = ::windows_strings::w!("ResiliencyDefaultPeriod");
pub const CLUSREG_NAME_RESILIENCY_LEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ResiliencyLevel");
pub const CLUSREG_NAME_RESTYPE_ADMIN_EXTENSIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("AdminExtensions");
pub const CLUSREG_NAME_RESTYPE_DEADLOCK_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("DeadlockTimeout");
pub const CLUSREG_NAME_RESTYPE_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_RESTYPE_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DllName");
pub const CLUSREG_NAME_RESTYPE_DUMP_LOG_QUERY: ::windows_strings::PCWSTR = ::windows_strings::w!("DumpLogQuery");
pub const CLUSREG_NAME_RESTYPE_DUMP_POLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("DumpPolicy");
pub const CLUSREG_NAME_RESTYPE_DUMP_SERVICES: ::windows_strings::PCWSTR = ::windows_strings::w!("DumpServices");
pub const CLUSREG_NAME_RESTYPE_ENABLED_EVENT_LOGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnabledEventLogs");
pub const CLUSREG_NAME_RESTYPE_IS_ALIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("IsAlivePollInterval");
pub const CLUSREG_NAME_RESTYPE_LOOKS_ALIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("LooksAlivePollInterval");
pub const CLUSREG_NAME_RESTYPE_MAX_MONITORS: ::windows_strings::PCWSTR = ::windows_strings::w!("MaximumMonitors");
pub const CLUSREG_NAME_RESTYPE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_RESTYPE_PENDING_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("PendingTimeout");
pub const CLUSREG_NAME_RESTYPE_WPR_PROFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("WprProfiles");
pub const CLUSREG_NAME_RESTYPE_WPR_START_AFTER: ::windows_strings::PCWSTR = ::windows_strings::w!("WprStartAfter");
pub const CLUSREG_NAME_RES_DATA1: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceSpecificData1");
pub const CLUSREG_NAME_RES_DATA2: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceSpecificData2");
pub const CLUSREG_NAME_RES_DEADLOCK_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("DeadlockTimeout");
pub const CLUSREG_NAME_RES_DESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_RES_EMBEDDED_FAILURE_ACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("EmbeddedFailureAction");
pub const CLUSREG_NAME_RES_IS_ALIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("IsAlivePollInterval");
pub const CLUSREG_NAME_RES_LAST_OPERATION_STATUS_CODE: ::windows_strings::PCWSTR = ::windows_strings::w!("LastOperationStatusCode");
pub const CLUSREG_NAME_RES_LOOKS_ALIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("LooksAlivePollInterval");
pub const CLUSREG_NAME_RES_MONITOR_PID: ::windows_strings::PCWSTR = ::windows_strings::w!("MonitorProcessId");
pub const CLUSREG_NAME_RES_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_RES_PENDING_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("PendingTimeout");
pub const CLUSREG_NAME_RES_PERSISTENT_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistentState");
pub const CLUSREG_NAME_RES_RESTART_ACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartAction");
pub const CLUSREG_NAME_RES_RESTART_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartDelay");
pub const CLUSREG_NAME_RES_RESTART_PERIOD: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartPeriod");
pub const CLUSREG_NAME_RES_RESTART_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("RestartThreshold");
pub const CLUSREG_NAME_RES_RETRY_PERIOD_ON_FAILURE: ::windows_strings::PCWSTR = ::windows_strings::w!("RetryPeriodOnFailure");
pub const CLUSREG_NAME_RES_SEPARATE_MONITOR: ::windows_strings::PCWSTR = ::windows_strings::w!("SeparateMonitor");
pub const CLUSREG_NAME_RES_STATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceSpecificStatus");
pub const CLUSREG_NAME_RES_STATUS_INFORMATION: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusInformation");
pub const CLUSREG_NAME_RES_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("Type");
pub const CLUSREG_NAME_ROUTE_HISTORY_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("RouteHistoryLength");
pub const CLUSREG_NAME_SAME_SUBNET_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("SameSubnetDelay");
pub const CLUSREG_NAME_SAME_SUBNET_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("SameSubnetThreshold");
pub const CLUSREG_NAME_SHUTDOWN_TIMEOUT_MINUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("ShutdownTimeoutInMinutes");
pub const CLUSREG_NAME_SOFS_SMBASYMMETRYMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("SmbAsymmetryMode");
pub const CLUSREG_NAME_START_MEMORY: ::windows_strings::PCWSTR = ::windows_strings::w!("StartMemory");
pub const CLUSREG_NAME_STORAGESPACE_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskDescription");
pub const CLUSREG_NAME_STORAGESPACE_HEALTH: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskHealth");
pub const CLUSREG_NAME_STORAGESPACE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskName");
pub const CLUSREG_NAME_STORAGESPACE_POOLARBITRATE: ::windows_strings::PCWSTR = ::windows_strings::w!("Arbitrate");
pub const CLUSREG_NAME_STORAGESPACE_POOLCONSUMEDCAPACITY: ::windows_strings::PCWSTR = ::windows_strings::w!("ConsumedCapacity");
pub const CLUSREG_NAME_STORAGESPACE_POOLDESC: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSREG_NAME_STORAGESPACE_POOLDRIVEIDS: ::windows_strings::PCWSTR = ::windows_strings::w!("DriveIds");
pub const CLUSREG_NAME_STORAGESPACE_POOLHEALTH: ::windows_strings::PCWSTR = ::windows_strings::w!("Health");
pub const CLUSREG_NAME_STORAGESPACE_POOLIDGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("PoolId");
pub const CLUSREG_NAME_STORAGESPACE_POOLNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const CLUSREG_NAME_STORAGESPACE_POOLQUORUMSHARE: ::windows_strings::PCWSTR = ::windows_strings::w!("PoolQuorumShare");
pub const CLUSREG_NAME_STORAGESPACE_POOLQUORUMUSERACCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("PoolQuorumUserAccount");
pub const CLUSREG_NAME_STORAGESPACE_POOLREEVALTIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("ReEvaluatePlacementTimeout");
pub const CLUSREG_NAME_STORAGESPACE_POOLSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("State");
pub const CLUSREG_NAME_STORAGESPACE_POOLTOTALCAPACITY: ::windows_strings::PCWSTR = ::windows_strings::w!("TotalCapacity");
pub const CLUSREG_NAME_STORAGESPACE_PROVISIONING: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskProvisioning");
pub const CLUSREG_NAME_STORAGESPACE_RESILIENCYCOLUMNS: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskResiliencyColumns");
pub const CLUSREG_NAME_STORAGESPACE_RESILIENCYINTERLEAVE: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskResiliencyInterleave");
pub const CLUSREG_NAME_STORAGESPACE_RESILIENCYTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskResiliencyType");
pub const CLUSREG_NAME_STORAGESPACE_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualDiskState");
pub const CLUSREG_NAME_UPGRADE_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterUpgradeVersion");
pub const CLUSREG_NAME_VIP_ADAPTER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AdapterName");
pub const CLUSREG_NAME_VIP_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Address");
pub const CLUSREG_NAME_VIP_PREFIX_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("PrefixLength");
pub const CLUSREG_NAME_VIP_RDID: ::windows_strings::PCWSTR = ::windows_strings::w!("RDID");
pub const CLUSREG_NAME_VIP_VSID: ::windows_strings::PCWSTR = ::windows_strings::w!("VSID");
pub const CLUSREG_NAME_VIRTUAL_NUMA_COUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualNumaCount");
pub const CLUSREG_NAME_VSSTASK_APPNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ApplicationName");
pub const CLUSREG_NAME_VSSTASK_APPPARAMS: ::windows_strings::PCWSTR = ::windows_strings::w!("ApplicationParams");
pub const CLUSREG_NAME_VSSTASK_CURRENTDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("CurrentDirectory");
pub const CLUSREG_NAME_VSSTASK_TRIGGERARRAY: ::windows_strings::PCWSTR = ::windows_strings::w!("TriggerArray");
pub const CLUSREG_NAME_WINS_BACKUP_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("BackupPath");
pub const CLUSREG_NAME_WINS_DATABASE_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("DatabasePath");
pub const CLUSREG_NAME_WITNESS_DYNAMIC_WEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("WitnessDynamicWeight");
...
pub const CLUSRES_NAME_GET_OPERATION_CONTEXT_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
...
pub const CLUSTER_ADD_EVICT_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("AddEvictDelay");
...
pub const CLUSTER_CSA_VSS_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("BackupInProgress");
pub const CLUSTER_CSV_COMPATIBLE_FILTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedVolumeCompatibleFilters");
pub const CLUSTER_CSV_INCOMPATIBLE_FILTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedVolumeIncompatibleFilters");
pub const CLUSTER_DELETE_ACCESS_CONTROL_ENTRY: u32 = 2u32;
pub const CLUSTER_ENFORCED_ANTIAFFINITY: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterEnforcedAntiaffinity");
...
pub const CLUSTER_GROUP_WAIT_DELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterGroupWaitDelay");
pub const CLUSTER_HANG_RECOVERY_ACTION_KEYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("HangRecoveryAction");
pub const CLUSTER_HANG_TIMEOUT_KEYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusSvcHangTimeout");
pub const CLUSTER_HEALTH_FAULT_ARGS: u32 = 7u32;
pub const CLUSTER_HEALTH_FAULT_DESCRIPTION: u32 = 3u32;
pub const CLUSTER_HEALTH_FAULT_DESCRIPTION_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const CLUSTER_HEALTH_FAULT_ERRORCODE: u32 = 2u32;
pub const CLUSTER_HEALTH_FAULT_ERRORCODE_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ErrorCode");
pub const CLUSTER_HEALTH_FAULT_ERRORTYPE: u32 = 1u32;
pub const CLUSTER_HEALTH_FAULT_ERRORTYPE_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ErrorType");
pub const CLUSTER_HEALTH_FAULT_FLAGS: u32 = 5u32;
pub const CLUSTER_HEALTH_FAULT_FLAGS_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
pub const CLUSTER_HEALTH_FAULT_ID: u32 = 0u32;
pub const CLUSTER_HEALTH_FAULT_ID_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Id");
pub const CLUSTER_HEALTH_FAULT_PROPERTY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterHealth");
pub const CLUSTER_HEALTH_FAULT_PROVIDER: u32 = 4u32;
pub const CLUSTER_HEALTH_FAULT_PROVIDER_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider");
pub const CLUSTER_HEALTH_FAULT_RESERVED: u32 = 6u32;
pub const CLUSTER_HEALTH_FAULT_RESERVED_LABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Reserved");
...
pub const CLUSTER_NAME_AUTO_BALANCER_LEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoBalancerLevel");
pub const CLUSTER_NAME_AUTO_BALANCER_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoBalancerMode");
pub const CLUSTER_NAME_PREFERRED_SITE: ::windows_strings::PCWSTR = ::windows_strings::w!("PreferredSite");
...
pub const CLUSTER_REQUEST_REPLY_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestReplyTimeout");
...
pub const CLUSTER_S2D_BUS_TYPES: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DBusTypes");
pub const CLUSTER_S2D_CACHE_BEHAVIOR_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DCacheBehavior");
pub const CLUSTER_S2D_CACHE_DESIRED_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DCacheDesiredState");
pub const CLUSTER_S2D_CACHE_FLASH_RESERVE_PERCENT: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DCacheFlashReservePercent");
pub const CLUSTER_S2D_CACHE_METADATA_RESERVE: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DCacheMetadataReserveBytes");
pub const CLUSTER_S2D_CACHE_PAGE_SIZE_KBYTES: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DCachePageSizeKBytes");
pub const CLUSTER_S2D_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DEnabled");
pub const CLUSTER_S2D_IO_LATENCY_THRESHOLD: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DIOLatencyThreshold");
pub const CLUSTER_S2D_OPTIMIZATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("S2DOptimizations");
pub const CLUSTER_SET_ACCESS_TYPE_ALLOWED: u32 = 0u32;
pub const CLUSTER_SET_ACCESS_TYPE_DENIED: u32 = 1u32;
pub const CLUSTER_SHARED_VOLUMES_ROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedVolumesRoot");
pub const CLUSTER_SHARED_VOLUME_VSS_WRITER_OPERATION_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedVolumeVssWriterOperationTimeout");
pub const CLUSTER_VERSION_FLAG_MIXED_MODE: u32 = 1u32;
pub const CLUSTER_VERSION_UNKNOWN: u32 = 4294967295u32;
pub const CLUSTER_WITNESS_DATABASE_WRITE_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("WitnessDatabaseWriteTimeout");
pub const CLUSTER_WITNESS_FAILED_RESTART_INTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("WitnessRestartInterval");
...
pub const CLUS_NAME_RES_TYPE_CLUSTER_GROUPID: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterGroupId");
pub const CLUS_NAME_RES_TYPE_DATA_RESID: ::windows_strings::PCWSTR = ::windows_strings::w!("DataResourceId");
pub const CLUS_NAME_RES_TYPE_LOG_MULTIPLE: ::windows_strings::PCWSTR = ::windows_strings::w!("LogSizeMultiple");
pub const CLUS_NAME_RES_TYPE_LOG_RESID: ::windows_strings::PCWSTR = ::windows_strings::w!("LogResourceId");
pub const CLUS_NAME_RES_TYPE_LOG_VOLUME: ::windows_strings::PCWSTR = ::windows_strings::w!("LogVolume");
pub const CLUS_NAME_RES_TYPE_MINIMUM_LOG_SIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MinimumLogSizeInBytes");
pub const CLUS_NAME_RES_TYPE_REPLICATION_GROUPID: ::windows_strings::PCWSTR = ::windows_strings::w!("ReplicationGroupId");
pub const CLUS_NAME_RES_TYPE_REPLICATION_GROUP_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ReplicationClusterGroupType");
pub const CLUS_NAME_RES_TYPE_SOURCE_RESID: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceResourceId");
pub const CLUS_NAME_RES_TYPE_SOURCE_VOLUMES: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceVolumes");
pub const CLUS_NAME_RES_TYPE_TARGET_RESID: ::windows_strings::PCWSTR = ::windows_strings::w!("TargetResourceId");
pub const CLUS_NAME_RES_TYPE_TARGET_VOLUMES: ::windows_strings::PCWSTR = ::windows_strings::w!("TargetVolumes");
pub const CLUS_NAME_RES_TYPE_UNIT_LOG_SIZE_CHANGE: ::windows_strings::PCWSTR = ::windows_strings::w!("UnitOfLogSizeChangeInBytes");
...
pub const CLUS_RESTYPE_NAME_CAU: ::windows_strings::PCWSTR = ::windows_strings::w!("ClusterAwareUpdatingResource");
pub const CLUS_RESTYPE_NAME_CLOUD_WITNESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Cloud Witness");
pub const CLUS_RESTYPE_NAME_CONTAINER: ::windows_strings::PCWSTR = ::windows_strings::w!("Container");
pub const CLUS_RESTYPE_NAME_CROSS_CLUSTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Cross Cluster Dependency Orchestrator");
pub const CLUS_RESTYPE_NAME_DFS: ::windows_strings::PCWSTR = ::windows_strings::w!("Distributed File System");
pub const CLUS_RESTYPE_NAME_DFSR: ::windows_strings::PCWSTR = ::windows_strings::w!("DFS Replicated Folder");
pub const CLUS_RESTYPE_NAME_DHCP: ::windows_strings::PCWSTR = ::windows_strings::w!("DHCP Service");
pub const CLUS_RESTYPE_NAME_DNN: ::windows_strings::PCWSTR = ::windows_strings::w!("Distributed Network Name");
pub const CLUS_RESTYPE_NAME_FILESERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("File Server");
pub const CLUS_RESTYPE_NAME_FILESHR: ::windows_strings::PCWSTR = ::windows_strings::w!("File Share");
pub const CLUS_RESTYPE_NAME_FSWITNESS: ::windows_strings::PCWSTR = ::windows_strings::w!("File Share Witness");
pub const CLUS_RESTYPE_NAME_GENAPP: ::windows_strings::PCWSTR = ::windows_strings::w!("Generic Application");
pub const CLUS_RESTYPE_NAME_GENSCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("Generic Script");
pub const CLUS_RESTYPE_NAME_GENSVC: ::windows_strings::PCWSTR = ::windows_strings::w!("Generic Service");
pub const CLUS_RESTYPE_NAME_HARDDISK: ::windows_strings::PCWSTR = ::windows_strings::w!("Physical Disk");
pub const CLUS_RESTYPE_NAME_HCSVM: ::windows_strings::PCWSTR = ::windows_strings::w!("HCS Virtual Machine");
pub const CLUS_RESTYPE_NAME_HEALTH_SERVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("Health Service");
pub const CLUS_RESTYPE_NAME_IPADDR: ::windows_strings::PCWSTR = ::windows_strings::w!("IP Address");
pub const CLUS_RESTYPE_NAME_IPV6_NATIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv6 Address");
pub const CLUS_RESTYPE_NAME_IPV6_TUNNEL: ::windows_strings::PCWSTR = ::windows_strings::w!("IPv6 Tunnel Address");
pub const CLUS_RESTYPE_NAME_ISCSITARGET: ::windows_strings::PCWSTR = ::windows_strings::w!("iSCSI Target Server");
pub const CLUS_RESTYPE_NAME_ISNS: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft iSNS");
pub const CLUS_RESTYPE_NAME_MSDTC: ::windows_strings::PCWSTR = ::windows_strings::w!("Distributed Transaction Coordinator");
pub const CLUS_RESTYPE_NAME_MSMQ: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Message Queue Server");
pub const CLUS_RESTYPE_NAME_MSMQ_TRIGGER: ::windows_strings::PCWSTR = ::windows_strings::w!("MSMQTriggers");
pub const CLUS_RESTYPE_NAME_NAT: ::windows_strings::PCWSTR = ::windows_strings::w!("Nat");
pub const CLUS_RESTYPE_NAME_NETNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Network Name");
pub const CLUS_RESTYPE_NAME_NETWORK_FILE_SYSTEM: ::windows_strings::PCWSTR = ::windows_strings::w!("Network File System");
pub const CLUS_RESTYPE_NAME_NEW_MSMQ: ::windows_strings::PCWSTR = ::windows_strings::w!("MSMQ");
pub const CLUS_RESTYPE_NAME_NFS: ::windows_strings::PCWSTR = ::windows_strings::w!("NFS Share");
pub const CLUS_RESTYPE_NAME_NFS_MSNS: ::windows_strings::PCWSTR = ::windows_strings::w!("NFS Multi Server Namespace");
pub const CLUS_RESTYPE_NAME_NFS_V2: ::windows_strings::PCWSTR = ::windows_strings::w!("Network File System");
pub const CLUS_RESTYPE_NAME_NV_PROVIDER_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider Address");
pub const CLUS_RESTYPE_NAME_PHYS_DISK: ::windows_strings::PCWSTR = ::windows_strings::w!("Physical Disk");
pub const CLUS_RESTYPE_NAME_PRTSPLR: ::windows_strings::PCWSTR = ::windows_strings::w!("Print Spooler");
pub const CLUS_RESTYPE_NAME_SCALEOUT_MASTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Scaleout Master");
pub const CLUS_RESTYPE_NAME_SCALEOUT_WORKER: ::windows_strings::PCWSTR = ::windows_strings::w!("Scaleout Worker");
pub const CLUS_RESTYPE_NAME_SDDC_MANAGEMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("SDDC Management");
pub const CLUS_RESTYPE_NAME_SODAFILESERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Scale Out File Server");
pub const CLUS_RESTYPE_NAME_STORAGE_POLICIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Storage Policies");
pub const CLUS_RESTYPE_NAME_STORAGE_POOL: ::windows_strings::PCWSTR = ::windows_strings::w!("Storage Pool");
pub const CLUS_RESTYPE_NAME_STORAGE_REPLICA: ::windows_strings::PCWSTR = ::windows_strings::w!("Storage Replica");
pub const CLUS_RESTYPE_NAME_STORQOS: ::windows_strings::PCWSTR = ::windows_strings::w!("Storage QoS Policy Manager");
pub const CLUS_RESTYPE_NAME_TASKSCHEDULER: ::windows_strings::PCWSTR = ::windows_strings::w!("Task Scheduler");
pub const CLUS_RESTYPE_NAME_VIRTUAL_IPV4: ::windows_strings::PCWSTR = ::windows_strings::w!("Disjoint IPv4 Address");
pub const CLUS_RESTYPE_NAME_VIRTUAL_IPV6: ::windows_strings::PCWSTR = ::windows_strings::w!("Disjoint IPv6 Address");
pub const CLUS_RESTYPE_NAME_VM: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Machine");
pub const CLUS_RESTYPE_NAME_VMREPLICA_BROKER: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Machine Replication Broker");
pub const CLUS_RESTYPE_NAME_VMREPLICA_COORDINATOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Machine Replication Coordinator");
pub const CLUS_RESTYPE_NAME_VM_CONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Machine Configuration");
pub const CLUS_RESTYPE_NAME_VM_WMI: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Machine Cluster WMI");
pub const CLUS_RESTYPE_NAME_VSSTASK: ::windows_strings::PCWSTR = ::windows_strings::w!("Volume Shadow Copy Service Task");
pub const CLUS_RESTYPE_NAME_WINS: ::windows_strings::PCWSTR = ::windows_strings::w!("WINS Service");
pub const CLUS_RES_NAME_SCALEOUT_MASTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Scaleout Master");
pub const CLUS_RES_NAME_SCALEOUT_WORKER: ::windows_strings::PCWSTR = ::windows_strings::w!("Scaleout Worker");
...
pub const MINIMUM_NEVER_PREEMPT_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("MinimumNeverPreemptPriority");
pub const MINIMUM_PREEMPTOR_PRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("MinimumPreemptorPriority");
...
pub const STARTUP_EX_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("StartupEx");
pub const STARTUP_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("Startup");
...
pub const USE_CLIENT_ACCESS_NETWORKS_FOR_CSV: ::windows_strings::PCWSTR = ::windows_strings::w!("UseClientAccessNetworksForSharedVolumes");
