...
impl IFindSimilarResults {
    ...
    pub unsafe fn GetNextFileId(&self, numtraitsmatched: *mut u32, similarityfileid: *mut SimilarityFileId) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.GetNextFileId(numtraitsmatched, similarityfileid)).ok()
    }
}
...
impl IRdcComparator {
    ...
    {
        ::windows_core::vcall!(self.Process(endofinput.into_param().abi(), endofoutput, inputbuffer, outputbuffer, rdc_errorcode)).ok()
    }
}
...
impl IRdcFileReader {
    ...
    pub unsafe fn Read(&self, offsetfilestart: u64, bytestoread: u32, bytesactuallyread: *mut u32, buffer: *mut u8, eof: *mut super::super::Foundation::BOOL) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Read(offsetfilestart, bytestoread, bytesactuallyread, buffer, eof)).ok()
    }
    pub unsafe fn GetFilePosition(&self) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetFilePosition(&mut result__)).from_abi(result__)
    }
}
...
impl IRdcFileWriter {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Read(&self, offsetfilestart: u64, bytestoread: u32, bytesactuallyread: *mut u32, buffer: *mut u8, eof: *mut super::super::Foundation::BOOL) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.base__.Read(offsetfilestart, bytestoread, bytesactuallyread, buffer, eof)).ok()
    }
    pub unsafe fn GetFilePosition(&self) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.GetFilePosition(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Write(&self, offsetfilestart: u64, bytestowrite: u32) -> ::windows_core::Result<u8> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Write(offsetfilestart, bytestowrite, &mut result__)).from_abi(result__)
    }
    pub unsafe fn Truncate(&self) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Truncate()).ok()
    }
    pub unsafe fn DeleteOnClose(&self) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.DeleteOnClose()).ok()
    }
}
...
impl IRdcGenerator {
    pub unsafe fn GetGeneratorParameters(&self, level: u32) -> ::windows_core::Result<IRdcGeneratorParameters> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetGeneratorParameters(level, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    where
        P0: ::windows_core::IntoParam<super::super::Foundation::BOOL>,
    {
        ::windows_core::vcall!(self.Process(endofinput.into_param().abi(), endofoutput, inputbuffer, outputbuffers.len().try_into().unwrap(), ::core::mem::transmute(outputbuffers.as_ptr()), rdc_errorcode)).ok()
    }
}
...
impl IRdcGeneratorFilterMaxParameters {
    pub unsafe fn GetHorizonSize(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetHorizonSize(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetHorizonSize(&self, horizonsize: u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.SetHorizonSize(horizonsize)).ok()
    }
    pub unsafe fn GetHashWindowSize(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetHashWindowSize(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetHashWindowSize(&self, hashwindowsize: u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.SetHashWindowSize(hashwindowsize)).ok()
    }
}
...
impl IRdcGeneratorParameters {
    pub unsafe fn GetGeneratorParametersType(&self) -> ::windows_core::Result<GeneratorParametersType> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetGeneratorParametersType(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetParametersVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.GetParametersVersion(currentversion, minimumcompatibleappversion)).ok()
    }
    pub unsafe fn GetSerializeSize(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetSerializeSize(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Serialize(&self, size: u32, parametersblob: *mut u8, byteswritten: *mut u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Serialize(size, parametersblob, byteswritten)).ok()
    }
}
...
impl IRdcLibrary {
    pub unsafe fn ComputeDefaultRecursionDepth(&self, filesize: u64) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ComputeDefaultRecursionDepth(filesize, &mut result__)).from_abi(result__)
    }
    pub unsafe fn CreateGeneratorParameters(&self, parameterstype: GeneratorParametersType, level: u32) -> ::windows_core::Result<IRdcGeneratorParameters> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateGeneratorParameters(parameterstype, level, &mut result__)).from_abi(result__)
    }
    pub unsafe fn OpenGeneratorParameters(&self, size: u32, parametersblob: *const u8) -> ::windows_core::Result<IRdcGeneratorParameters> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.OpenGeneratorParameters(size, parametersblob, &mut result__)).from_abi(result__)
    }
    pub unsafe fn CreateGenerator(&self, igeneratorparametersarray: &[::core::option::Option<IRdcGeneratorParameters>]) -> ::windows_core::Result<IRdcGenerator> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateGenerator(igeneratorparametersarray.len().try_into().unwrap(), ::core::mem::transmute(igeneratorparametersarray.as_ptr()), &mut result__)).from_abi(result__)
    }
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateComparator(iseedsignaturesfile.into_param().abi(), comparatorbuffersize, &mut result__)).from_abi(result__)
    }
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateSignatureReader(ifilereader.into_param().abi(), &mut result__)).from_abi(result__)
    }
    pub unsafe fn GetRDCVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.GetRDCVersion(currentversion, minimumcompatibleappversion)).ok()
    }
}
...
impl IRdcSignatureReader {
    pub unsafe fn ReadHeader(&self) -> ::windows_core::Result<RDC_ErrorCode> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ReadHeader(&mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ReadSignatures(&self, rdcsignaturepointer: *mut RdcSignaturePointer, endofoutput: *mut super::super::Foundation::BOOL) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.ReadSignatures(rdcsignaturepointer, endofoutput)).ok()
    }
}
...
impl IRdcSimilarityGenerator {
    pub unsafe fn EnableSimilarity(&self) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.EnableSimilarity()).ok()
    }
...
impl ISimilarity {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateTable(path.into_param().abi(), truncate.into_param().abi(), securitydescriptor, recordsize, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateTableIndirect(mapping.into_param().abi(), fileidfile.into_param().abi(), truncate.into_param().abi(), recordsize, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    where
        P0: ::windows_core::IntoParam<super::super::Foundation::BOOL>,
    {
        ::windows_core::vcall!(self.CloseTable(isvalid.into_param().abi())).ok()
    }
    pub unsafe fn Append(&self, similarityfileid: *const SimilarityFileId, similaritydata: *const SimilarityData) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Append(similarityfileid, similaritydata)).ok()
    }
    pub unsafe fn FindSimilarFileId(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, resultssize: u32) -> ::windows_core::Result<IFindSimilarResults> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.FindSimilarFileId(similaritydata, numberofmatchesrequired, resultssize, &mut result__)).from_abi(result__)
    }
    ...
    {
        ::windows_core::vcall!(self.CopyAndSwap(newsimilaritytables.into_param().abi(), reportprogress.into_param().abi())).ok()
    }
...
impl ISimilarityFileIdTable {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateTableIndirect(fileidfile.into_param().abi(), truncate.into_param().abi(), recordsize, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CloseTable<P0>(&self, isvalid: P0) -> ::windows_core::Result<()>
    ...
    pub unsafe fn Append(&self, similarityfileid: *const SimilarityFileId) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Append(similarityfileid, &mut result__)).from_abi(result__)
    }
    pub unsafe fn Lookup(&self, similarityfileindex: u32, similarityfileid: *mut SimilarityFileId) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Lookup(similarityfileindex, similarityfileid)).ok()
    }
    pub unsafe fn Invalidate(&self, similarityfileindex: u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Invalidate(similarityfileindex)).ok()
    }
    pub unsafe fn GetRecordCount(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetRecordCount(&mut result__)).from_abi(result__)
...
impl ISimilarityReportProgress {
    pub unsafe fn ReportProgress(&self, percentcompleted: u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.ReportProgress(percentcompleted)).ok()
    }
}
...
impl ISimilarityTableDumpState {
    ...
    pub unsafe fn GetNextData(&self, resultssize: u32, resultsused: *mut u32, eof: *mut super::super::Foundation::BOOL, results: *mut SimilarityDumpData) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.GetNextData(resultssize, resultsused, eof, results)).ok()
    }
}
...
impl ISimilarityTraitsMappedView {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Get(index, dirty.into_param().abi(), numelements, &mut result__)).from_abi(result__)
    }
    pub unsafe fn GetView(&self, mappedpagebegin: *mut *mut u8, mappedpageend: *mut *mut u8) {
        ::windows_core::vcall!(self.GetView(mappedpagebegin, mappedpageend))
    }
}
...
impl ISimilarityTraitsMapping {
    pub unsafe fn CloseMapping(&self) {
        ::windows_core::vcall!(self.CloseMapping())
    }
    pub unsafe fn SetFileSize(&self, filesize: u64) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.SetFileSize(filesize)).ok()
    }
    pub unsafe fn GetFileSize(&self) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetFileSize(&mut result__)).from_abi(result__)
    ...
    pub unsafe fn OpenMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.OpenMapping(accessmode, begin, end, &mut result__)).from_abi(result__)
    }
    pub unsafe fn ResizeMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ResizeMapping(accessmode, begin, end, &mut result__)).from_abi(result__)
    }
    pub unsafe fn GetPageSize(&self) -> u32 {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetPageSize(&mut result__));
    ...
    pub unsafe fn CreateView(&self, minimummappedpages: u32, accessmode: RdcMappingAccessMode) -> ::windows_core::Result<ISimilarityTraitsMappedView> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateView(minimummappedpages, accessmode, &mut result__)).from_abi(result__)
    }
}
...
impl ISimilarityTraitsTable {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateTable(path.into_param().abi(), truncate.into_param().abi(), securitydescriptor, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateTableIndirect(mapping.into_param().abi(), truncate.into_param().abi(), &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CloseTable<P0>(&self, isvalid: P0) -> ::windows_core::Result<()>
    ...
    pub unsafe fn Append(&self, data: *const SimilarityData, fileindex: u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Append(data, fileindex)).ok()
    }
    pub unsafe fn FindSimilarFileIndex(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, findsimilarfileindexresults: *mut FindSimilarFileIndexResults, resultssize: u32, resultsused: *mut u32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.FindSimilarFileIndex(similaritydata, numberofmatchesrequired, findsimilarfileindexresults, resultssize, resultsused)).ok()
    }
    pub unsafe fn BeginDump(&self) -> ::windows_core::Result<ISimilarityTableDumpState> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.BeginDump(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetLastIndex(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetLastIndex(&mut result__)).from_abi(result__)
    }
}
