...
pub const IEGetProcessModule_PROC_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("IEGetProcessModule");
pub const IEGetTabWindowExports_PROC_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("IEGetTabWindowExports");
...
pub const IE_USE_OE_NEWS_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Internet Explorer\\News");
pub const IE_USE_OE_NEWS_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("Use Outlook Express");
pub const IE_USE_OE_PRESENT_HKEY: i32 = -2147483646i32;
pub const IE_USE_OE_PRESENT_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Windows\\CurrentVersion\\app.paths\\msimn.exe");
...
pub const REGSTRA_VAL_STARTPAGE: ::windows_strings::PCSTR = ::windows_strings::s!("Start Page");
pub const REGSTR_PATH_CURRENT: ::windows_strings::PCWSTR = ::windows_strings::w!("current");
pub const REGSTR_PATH_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("default");
pub const REGSTR_PATH_INETCPL_RESTRICTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Policies\\Microsoft\\Internet Explorer\\Control Panel");
pub const REGSTR_PATH_MIME_DATABASE: ::windows_strings::PCWSTR = ::windows_strings::w!("MIME\\Database");
pub const REGSTR_PATH_REMOTEACCESS: ::windows_strings::PCWSTR = ::windows_strings::w!("RemoteAccess");
pub const REGSTR_PATH_REMOTEACESS: ::windows_strings::PCWSTR = ::windows_strings::w!("RemoteAccess");
pub const REGSTR_SHIFTQUICKSUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("ShiftQuickCompleteSuffix");
pub const REGSTR_VAL_ACCEPT_LANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("AcceptLanguage");
pub const REGSTR_VAL_ACCESSMEDIUM: ::windows_strings::PCWSTR = ::windows_strings::w!("AccessMedium");
pub const REGSTR_VAL_ACCESSTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("AccessType");
pub const REGSTR_VAL_ALIASTO: ::windows_strings::PCWSTR = ::windows_strings::w!("AliasForCharset");
pub const REGSTR_VAL_ANCHORCOLOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Anchor Color");
pub const REGSTR_VAL_ANCHORCOLORHOVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Anchor Color Hover");
pub const REGSTR_VAL_ANCHORCOLORVISITED: ::windows_strings::PCWSTR = ::windows_strings::w!("Anchor Color Visited");
pub const REGSTR_VAL_ANCHORUNDERLINE: ::windows_strings::PCWSTR = ::windows_strings::w!("Anchor Underline");
pub const REGSTR_VAL_AUTODETECT: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoDetect");
pub const REGSTR_VAL_AUTODIALDLLNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutodialDllName");
pub const REGSTR_VAL_AUTODIALFCNNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutodialFcnName");
pub const REGSTR_VAL_AUTODIAL_MONITORCLASSNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MS_AutodialMonitor");
pub const REGSTR_VAL_AUTODIAL_TRYONLYONCE: ::windows_strings::PCWSTR = ::windows_strings::w!("TryAutodialOnce");
pub const REGSTR_VAL_AUTONAVIGATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SearchForExtensions");
pub const REGSTR_VAL_AUTOSEARCH: ::windows_strings::PCWSTR = ::windows_strings::w!("Do404Search");
pub const REGSTR_VAL_BACKBITMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("BackBitmap");
pub const REGSTR_VAL_BACKGROUNDCOLOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Background Color");
pub const REGSTR_VAL_BODYCHARSET: ::windows_strings::PCWSTR = ::windows_strings::w!("BodyCharset");
pub const REGSTR_VAL_BYPASSAUTOCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("BypassAutoconfig");
pub const REGSTR_VAL_CACHEPREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("CachePrefix");
pub const REGSTR_VAL_CHECKASSOC: ::windows_strings::PCWSTR = ::windows_strings::w!("Check_Associations");
pub const REGSTR_VAL_CODEDOWNLOAD: ::windows_strings::PCWSTR = ::windows_strings::w!("Code Download");
pub const REGSTR_VAL_CODEDOWNLOAD_DEF: ::windows_strings::PCWSTR = ::windows_strings::w!("yes");
pub const REGSTR_VAL_CODEPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("CodePage");
pub const REGSTR_VAL_COVEREXCLUDE: ::windows_strings::PCWSTR = ::windows_strings::w!("CoverExclude");
pub const REGSTR_VAL_DAYSTOKEEP: ::windows_strings::PCWSTR = ::windows_strings::w!("DaysToKeep");
pub const REGSTR_VAL_DEFAULT_CODEPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Default_CodePage");
pub const REGSTR_VAL_DEFAULT_SCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("Default_Script");
pub const REGSTR_VAL_DEF_ENCODING: ::windows_strings::PCWSTR = ::windows_strings::w!("Default_Encoding");
pub const REGSTR_VAL_DEF_INETENCODING: ::windows_strings::PCWSTR = ::windows_strings::w!("Default_InternetEncoding");
pub const REGSTR_VAL_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const REGSTR_VAL_DIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("Directory");
pub const REGSTR_VAL_DISCONNECTIDLETIME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisconnectIdleTime");
pub const REGSTR_VAL_ENABLEAUTODIAL: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableAutodial");
pub const REGSTR_VAL_ENABLEAUTODIALDISCONNECT: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableAutodisconnect");
pub const REGSTR_VAL_ENABLEAUTODISCONNECT: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableAutodisconnect");
pub const REGSTR_VAL_ENABLEEXITDISCONNECT: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableExitDisconnect");
pub const REGSTR_VAL_ENABLESECURITYCHECK: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableSecurityCheck");
pub const REGSTR_VAL_ENABLEUNATTENDED: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableUnattended");
pub const REGSTR_VAL_ENCODENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EncodingName");
pub const REGSTR_VAL_FAMILY: ::windows_strings::PCWSTR = ::windows_strings::w!("Family");
pub const REGSTR_VAL_FIXEDWIDTHFONT: ::windows_strings::PCWSTR = ::windows_strings::w!("FixedWidthFont");
pub const REGSTR_VAL_FIXED_FONT: ::windows_strings::PCWSTR = ::windows_strings::w!("IEFixedFontName");
pub const REGSTR_VAL_FONT_SCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("Script");
...
pub const REGSTR_VAL_IE_CUSTOMCOLORS: ::windows_strings::PCWSTR = ::windows_strings::w!("Custom Colors");
pub const REGSTR_VAL_INETCPL_ADVANCEDTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("AdvancedTab");
pub const REGSTR_VAL_INETCPL_CONNECTIONSTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("ConnectionsTab");
pub const REGSTR_VAL_INETCPL_CONTENTTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("ContentTab");
pub const REGSTR_VAL_INETCPL_GENERALTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("GeneralTab");
pub const REGSTR_VAL_INETCPL_IEAK: ::windows_strings::PCWSTR = ::windows_strings::w!("IEAKContext");
pub const REGSTR_VAL_INETCPL_PRIVACYTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("PrivacyTab");
pub const REGSTR_VAL_INETCPL_PROGRAMSTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgramsTab");
pub const REGSTR_VAL_INETCPL_SECURITYTAB: ::windows_strings::PCWSTR = ::windows_strings::w!("SecurityTab");
pub const REGSTR_VAL_INETENCODING: ::windows_strings::PCWSTR = ::windows_strings::w!("InternetEncoding");
pub const REGSTR_VAL_INTERNETENTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("InternetProfile");
pub const REGSTR_VAL_INTERNETENTRYBKUP: ::windows_strings::PCWSTR = ::windows_strings::w!("BackupInternetProfile");
pub const REGSTR_VAL_INTERNETPROFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("InternetProfile");
pub const REGSTR_VAL_JAVAJIT: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableJIT");
pub const REGSTR_VAL_JAVAJIT_DEF: u32 = 0u32;
pub const REGSTR_VAL_JAVALOGGING: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableLogging");
pub const REGSTR_VAL_JAVALOGGING_DEF: u32 = 0u32;
pub const REGSTR_VAL_LEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Level");
pub const REGSTR_VAL_LOADIMAGES: ::windows_strings::PCWSTR = ::windows_strings::w!("Display Inline Images");
pub const REGSTR_VAL_LOCALPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Local Page");
pub const REGSTR_VAL_MOSDISCONNECT: ::windows_strings::PCWSTR = ::windows_strings::w!("DisconnectTimeout");
pub const REGSTR_VAL_NEWDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("NewDirectory");
pub const REGSTR_VAL_NONETAUTODIAL: ::windows_strings::PCWSTR = ::windows_strings::w!("NoNetAutodial");
pub const REGSTR_VAL_PLAYSOUNDS: ::windows_strings::PCWSTR = ::windows_strings::w!("Play_Background_Sounds");
pub const REGSTR_VAL_PLAYVIDEOS: ::windows_strings::PCWSTR = ::windows_strings::w!("Display Inline Videos");
pub const REGSTR_VAL_PRIVCONVERTER: ::windows_strings::PCWSTR = ::windows_strings::w!("PrivConverter");
pub const REGSTR_VAL_PROPORTIONALFONT: ::windows_strings::PCWSTR = ::windows_strings::w!("ProportionalFont");
pub const REGSTR_VAL_PROP_FONT: ::windows_strings::PCWSTR = ::windows_strings::w!("IEPropFontName");
pub const REGSTR_VAL_PROXYENABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProxyEnable");
pub const REGSTR_VAL_PROXYOVERRIDE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProxyOverride");
pub const REGSTR_VAL_PROXYSERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("ProxyServer");
pub const REGSTR_VAL_REDIALATTEMPTS: ::windows_strings::PCWSTR = ::windows_strings::w!("RedialAttempts");
pub const REGSTR_VAL_REDIALINTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("RedialWait");
pub const REGSTR_VAL_RNAINSTALLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Installed");
pub const REGSTR_VAL_SAFETYWARNINGLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Safety Warning Level");
pub const REGSTR_VAL_SCHANNELENABLEPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled");
pub const REGSTR_VAL_SCHANNELENABLEPROTOCOL_DEF: u32 = 1u32;
pub const REGSTR_VAL_SCRIPT_FIXED_FONT: ::windows_strings::PCWSTR = ::windows_strings::w!("IEFixedFontName");
pub const REGSTR_VAL_SCRIPT_PROP_FONT: ::windows_strings::PCWSTR = ::windows_strings::w!("IEPropFontName");
pub const REGSTR_VAL_SEARCHPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Search Page");
pub const REGSTR_VAL_SECURITYACTICEXSCRIPTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Security_RunScripts");
pub const REGSTR_VAL_SECURITYACTICEXSCRIPTS_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYACTIVEX: ::windows_strings::PCWSTR = ::windows_strings::w!("Security_RunActiveXControls");
pub const REGSTR_VAL_SECURITYACTIVEX_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYALLOWCOOKIES: ::windows_strings::PCWSTR = ::windows_strings::w!("AllowCookies");
pub const REGSTR_VAL_SECURITYALLOWCOOKIES_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYDISABLECACHINGOFSSLPAGES: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableCachingOfSSLPages");
pub const REGSTR_VAL_SECURITYDISABLECACHINGOFSSLPAGES_DEF: u32 = 0u32;
pub const REGSTR_VAL_SECURITYJAVA: ::windows_strings::PCWSTR = ::windows_strings::w!("Security_RunJavaApplets");
pub const REGSTR_VAL_SECURITYJAVA_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONBADCERTSENDING: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnOnBadCertSending");
pub const REGSTR_VAL_SECURITYWARNONBADCERTSENDING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONBADCERTVIEWING: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnOnBadCertRecving");
pub const REGSTR_VAL_SECURITYWARNONBADCERTVIEWING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONSEND: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnOnPost");
pub const REGSTR_VAL_SECURITYWARNONSENDALWAYS: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnAlwaysOnPost");
pub const REGSTR_VAL_SECURITYWARNONSENDALWAYS_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONSEND_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONVIEW: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnOnView");
pub const REGSTR_VAL_SECURITYWARNONVIEW_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONZONECROSSING: ::windows_strings::PCWSTR = ::windows_strings::w!("WarnOnZoneCrossing");
pub const REGSTR_VAL_SECURITYWARNONZONECROSSING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SHOWADDRESSBAR: ::windows_strings::PCWSTR = ::windows_strings::w!("Show_URLToolBar");
pub const REGSTR_VAL_SHOWFOCUS: ::windows_strings::PCWSTR = ::windows_strings::w!("Tabstop - MouseDown");
pub const REGSTR_VAL_SHOWFOCUS_DEF: ::windows_strings::PCWSTR = ::windows_strings::w!("no");
pub const REGSTR_VAL_SHOWFULLURLS: ::windows_strings::PCWSTR = ::windows_strings::w!("Show_FullURL");
pub const REGSTR_VAL_SHOWTOOLBAR: ::windows_strings::PCWSTR = ::windows_strings::w!("Show_ToolBar");
pub const REGSTR_VAL_SMOOTHSCROLL: ::windows_strings::PCWSTR = ::windows_strings::w!("SmoothScroll");
pub const REGSTR_VAL_SMOOTHSCROLL_DEF: u32 = 1u32;
pub const REGSTR_VAL_STARTPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Start Page");
pub const REGSTR_VAL_TEXTCOLOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Text Color");
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_HIGH: ::windows_strings::PCWSTR = ::windows_strings::w!("High");
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_LOW: ::windows_strings::PCWSTR = ::windows_strings::w!("No Security");
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_MED: ::windows_strings::PCWSTR = ::windows_strings::w!("Medium");
pub const REGSTR_VAL_USEAUTOAPPEND: ::windows_strings::PCWSTR = ::windows_strings::w!("Append Completion");
pub const REGSTR_VAL_USEAUTOCOMPLETE: ::windows_strings::PCWSTR = ::windows_strings::w!("Use AutoComplete");
pub const REGSTR_VAL_USEAUTOSUGGEST: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoSuggest");
pub const REGSTR_VAL_USEDLGCOLORS: ::windows_strings::PCWSTR = ::windows_strings::w!("Use_DlgBox_Colors");
pub const REGSTR_VAL_USEHOVERCOLOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Use Anchor Hover Color");
pub const REGSTR_VAL_USEIBAR: ::windows_strings::PCWSTR = ::windows_strings::w!("UseBar");
pub const REGSTR_VAL_USEICM: ::windows_strings::PCWSTR = ::windows_strings::w!("UseICM");
pub const REGSTR_VAL_USEICM_DEF: u32 = 0u32;
pub const REGSTR_VAL_USERAGENT: ::windows_strings::PCWSTR = ::windows_strings::w!("User Agent");
pub const REGSTR_VAL_USESTYLESHEETS: ::windows_strings::PCWSTR = ::windows_strings::w!("Use Stylesheets");
pub const REGSTR_VAL_USESTYLESHEETS_DEF: ::windows_strings::PCWSTR = ::windows_strings::w!("yes");
pub const REGSTR_VAL_VISIBLEBANDS: ::windows_strings::PCWSTR = ::windows_strings::w!("VisibleBands");
pub const REGSTR_VAL_VISIBLEBANDS_DEF: u32 = 7u32;
pub const REGSTR_VAL_WEBCHARSET: ::windows_strings::PCWSTR = ::windows_strings::w!("WebCharset");
...
pub const SZBACKBITMAP: ::windows_strings::PCSTR = ::windows_strings::s!("BackBitmap");
pub const SZJAVAVMPATH: ::windows_strings::PCSTR = ::windows_strings::s!("\\Java VM");
pub const SZNOTEXT: ::windows_strings::PCSTR = ::windows_strings::s!("NoText");
pub const SZTOOLBAR: ::windows_strings::PCSTR = ::windows_strings::s!("\\Toolbar");
pub const SZTRUSTWARNLEVEL: ::windows_strings::PCSTR = ::windows_strings::s!("Trust Warning Level");
pub const SZVISIBLE: ::windows_strings::PCSTR = ::windows_strings::s!("VisibleBands");
pub const SZ_IE_DEFAULT_HTML_EDITOR: ::windows_strings::PCSTR = ::windows_strings::s!("Default HTML Editor");
pub const SZ_IE_IBAR: ::windows_strings::PCSTR = ::windows_strings::s!("Bar");
pub const SZ_IE_IBAR_BANDS: ::windows_strings::PCSTR = ::windows_strings::s!("Bands");
pub const SZ_IE_MAIN: ::windows_strings::PCSTR = ::windows_strings::s!("Main");
pub const SZ_IE_SEARCHSTRINGS: ::windows_strings::PCSTR = ::windows_strings::s!("UrlTemplate");
pub const SZ_IE_SECURITY: ::windows_strings::PCSTR = ::windows_strings::s!("Security");
pub const SZ_IE_SETTINGS: ::windows_strings::PCSTR = ::windows_strings::s!("Settings");
pub const SZ_IE_THRESHOLDS: ::windows_strings::PCSTR = ::windows_strings::s!("ErrorThresholds");
pub const S_SURFACE_DISCARDED: i32 = 49155i32;
pub const TARGET_NOTIFY_OBJECT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("863a99a0-21bc-11d0-82b4-00a0c90c29c5");
...
pub const TSZCALENDARPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("unk");
pub const TSZCALLTOPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("callto");
pub const TSZINTERNETCLIENTSPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Internet Explorer\\Unix");
pub const TSZLDAPPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("ldap");
pub const TSZMAILTOPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("mailto");
pub const TSZMICROSOFTPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft");
pub const TSZNEWSPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("news");
pub const TSZPROTOCOLSPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Protocols\\");
pub const TSZSCHANNELPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL");
pub const TSZVSOURCEPROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("view source");
