...
pub const DD_FULLSCREEN_VIDEO_DEVICE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Device\\FSVideo");
...
pub const VIDEO_DEVICE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("DISPLAY%d");
...
pub const WVIDEO_DEVICE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DISPLAY%d");
