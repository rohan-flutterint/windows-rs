...
pub const DD_KEYBOARD_DEVICE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("\\Device\\KeyboardClass");
pub const DD_KEYBOARD_DEVICE_NAME_U: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Device\\KeyboardClass");
pub const DD_MOUSE_DEVICE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("\\Device\\PointerClass");
pub const DD_MOUSE_DEVICE_NAME_U: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Device\\PointerClass");
...
pub const DIRECTINPUT_NOTIFICATION_MSGSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("DIRECTINPUT_NOTIFICATION_MSGSTRING");
pub const DIRECTINPUT_NOTIFICATION_MSGSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("DIRECTINPUT_NOTIFICATION_MSGSTRING");
pub const DIRECTINPUT_NOTIFICATION_MSGSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("DIRECTINPUT_NOTIFICATION_MSGSTRING");
pub const DIRECTINPUT_REGSTR_KEY_LASTAPP: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentApplication");
pub const DIRECTINPUT_REGSTR_KEY_LASTAPPA: ::windows_strings::PCSTR = ::windows_strings::s!("MostRecentApplication");
pub const DIRECTINPUT_REGSTR_KEY_LASTAPPW: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentApplication");
pub const DIRECTINPUT_REGSTR_KEY_LASTMAPAPP: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentMapperApplication");
pub const DIRECTINPUT_REGSTR_KEY_LASTMAPAPPA: ::windows_strings::PCSTR = ::windows_strings::s!("MostRecentMapperApplication");
pub const DIRECTINPUT_REGSTR_KEY_LASTMAPAPPW: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentMapperApplication");
pub const DIRECTINPUT_REGSTR_VAL_APPIDFLAG: ::windows_strings::PCWSTR = ::windows_strings::w!("AppIdFlag");
pub const DIRECTINPUT_REGSTR_VAL_APPIDFLAGA: ::windows_strings::PCSTR = ::windows_strings::s!("AppIdFlag");
pub const DIRECTINPUT_REGSTR_VAL_APPIDFLAGW: ::windows_strings::PCWSTR = ::windows_strings::w!("AppIdFlag");
pub const DIRECTINPUT_REGSTR_VAL_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("Id");
pub const DIRECTINPUT_REGSTR_VAL_IDA: ::windows_strings::PCSTR = ::windows_strings::s!("Id");
pub const DIRECTINPUT_REGSTR_VAL_IDW: ::windows_strings::PCWSTR = ::windows_strings::w!("Id");
pub const DIRECTINPUT_REGSTR_VAL_LASTSTART: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentStart");
pub const DIRECTINPUT_REGSTR_VAL_LASTSTARTA: ::windows_strings::PCSTR = ::windows_strings::s!("MostRecentStart");
pub const DIRECTINPUT_REGSTR_VAL_LASTSTARTW: ::windows_strings::PCWSTR = ::windows_strings::w!("MostRecentStart");
pub const DIRECTINPUT_REGSTR_VAL_MAPPER: ::windows_strings::PCWSTR = ::windows_strings::w!("UsesMapper");
pub const DIRECTINPUT_REGSTR_VAL_MAPPERA: ::windows_strings::PCSTR = ::windows_strings::s!("UsesMapper");
pub const DIRECTINPUT_REGSTR_VAL_MAPPERW: ::windows_strings::PCWSTR = ::windows_strings::w!("UsesMapper");
pub const DIRECTINPUT_REGSTR_VAL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const DIRECTINPUT_REGSTR_VAL_NAMEA: ::windows_strings::PCSTR = ::windows_strings::s!("Name");
pub const DIRECTINPUT_REGSTR_VAL_NAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const DIRECTINPUT_REGSTR_VAL_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const DIRECTINPUT_REGSTR_VAL_VERSIONA: ::windows_strings::PCSTR = ::windows_strings::s!("Version");
pub const DIRECTINPUT_REGSTR_VAL_VERSIONW: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
