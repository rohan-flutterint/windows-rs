...
pub const NAME_3GPP2File: ::windows_strings::PCWSTR = ::windows_strings::w!("3GPP2File");
pub const NAME_3GPPFile: ::windows_strings::PCWSTR = ::windows_strings::w!("3GPPFile");
pub const NAME_AACFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AACFile");
pub const NAME_AIFFFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AIFFFile");
pub const NAME_AMRFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AMRFile");
pub const NAME_ASFFile: ::windows_strings::PCWSTR = ::windows_strings::w!("ASFFile");
pub const NAME_ASXPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("ASXPlaylist");
pub const NAME_ATSCTSFile: ::windows_strings::PCWSTR = ::windows_strings::w!("ATSCTSFile");
pub const NAME_AVCHDFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AVCHDFile");
pub const NAME_AVIFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AVIFile");
pub const NAME_AbstractActivity: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractActivity");
pub const NAME_AbstractActivityOccurrence: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractActivityOccurrence");
pub const NAME_AbstractAudioAlbum: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractAudioAlbum");
pub const NAME_AbstractAudioPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractAudioPlaylist");
pub const NAME_AbstractAudioVideoAlbum: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractAudioVideoAlbum");
pub const NAME_AbstractChapteredProduction: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractChapteredProduction");
pub const NAME_AbstractContact: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractContact");
pub const NAME_AbstractContactGroup: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractContactGroup");
pub const NAME_AbstractDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractDocument");
pub const NAME_AbstractImageAlbum: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractImageAlbum");
pub const NAME_AbstractMediacast: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractMediacast");
pub const NAME_AbstractMessage: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractMessage");
pub const NAME_AbstractMessageFolder: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractMessageFolder");
pub const NAME_AbstractMultimediaAlbum: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractMultimediaAlbum");
pub const NAME_AbstractNote: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractNote");
pub const NAME_AbstractTask: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractTask");
pub const NAME_AbstractVideoAlbum: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractVideoAlbum");
pub const NAME_AbstractVideoPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("AbstractVideoPlaylist");
pub const NAME_AnchorResults: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorResults");
pub const NAME_AnchorResults_Anchor: ::windows_strings::PCWSTR = ::windows_strings::w!("Anchor");
pub const NAME_AnchorResults_AnchorState: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorState");
pub const NAME_AnchorResults_ResultObjectID: ::windows_strings::PCWSTR = ::windows_strings::w!("ResultObjectID");
pub const NAME_AnchorSyncKnowledge: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorSyncKnowledge");
pub const NAME_AnchorSyncSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorSync");
pub const NAME_AnchorSyncSvc_BeginSync: ::windows_strings::PCWSTR = ::windows_strings::w!("BeginSync");
pub const NAME_AnchorSyncSvc_CurrentAnchor: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorCurrentAnchor");
pub const NAME_AnchorSyncSvc_EndSync: ::windows_strings::PCWSTR = ::windows_strings::w!("EndSync");
pub const NAME_AnchorSyncSvc_FilterType: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterType");
pub const NAME_AnchorSyncSvc_GetChangesSinceAnchor: ::windows_strings::PCWSTR = ::windows_strings::w!("GetChangesSinceAnchor");
pub const NAME_AnchorSyncSvc_KnowledgeObjectID: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorKnowledgeObjectID");
pub const NAME_AnchorSyncSvc_LastSyncProxyID: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorLastSyncProxyID");
pub const NAME_AnchorSyncSvc_LocalOnlyDelete: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalOnlyDelete");
pub const NAME_AnchorSyncSvc_ProviderVersion: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorProviderVersion");
pub const NAME_AnchorSyncSvc_ReplicaID: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorReplicaID");
pub const NAME_AnchorSyncSvc_SyncFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncFormat");
pub const NAME_AnchorSyncSvc_VersionProps: ::windows_strings::PCWSTR = ::windows_strings::w!("AnchorVersionProps");
pub const NAME_Association: ::windows_strings::PCWSTR = ::windows_strings::w!("Association");
pub const NAME_AudibleFile: ::windows_strings::PCWSTR = ::windows_strings::w!("AudibleFile");
pub const NAME_AudioObj_AudioBitDepth: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioBitDepth");
pub const NAME_AudioObj_AudioBitRate: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioBitRate");
pub const NAME_AudioObj_AudioBlockAlignment: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioBlockAlignment");
pub const NAME_AudioObj_AudioFormatCode: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioFormatCode");
pub const NAME_AudioObj_Channels: ::windows_strings::PCWSTR = ::windows_strings::w!("Channels");
pub const NAME_AudioObj_Lyrics: ::windows_strings::PCWSTR = ::windows_strings::w!("Lyrics");
pub const NAME_BMPImage: ::windows_strings::PCWSTR = ::windows_strings::w!("BMPImage");
pub const NAME_CIFFImage: ::windows_strings::PCWSTR = ::windows_strings::w!("CIFFImage");
pub const NAME_CalendarObj_Accepted: ::windows_strings::PCWSTR = ::windows_strings::w!("Accepted");
pub const NAME_CalendarObj_BeginDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("BeginDateTime");
pub const NAME_CalendarObj_BusyStatus: ::windows_strings::PCWSTR = ::windows_strings::w!("BusyStatus");
pub const NAME_CalendarObj_Declined: ::windows_strings::PCWSTR = ::windows_strings::w!("Declined");
pub const NAME_CalendarObj_EndDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("EndDateTime");
pub const NAME_CalendarObj_Location: ::windows_strings::PCWSTR = ::windows_strings::w!("Location");
pub const NAME_CalendarObj_PatternDuration: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternDuration");
pub const NAME_CalendarObj_PatternStartTime: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternStartTime");
pub const NAME_CalendarObj_ReminderOffset: ::windows_strings::PCWSTR = ::windows_strings::w!("ReminderOffset");
pub const NAME_CalendarObj_Tentative: ::windows_strings::PCWSTR = ::windows_strings::w!("Tentative");
pub const NAME_CalendarObj_TimeZone: ::windows_strings::PCWSTR = ::windows_strings::w!("TimeZone");
pub const NAME_CalendarSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Calendar");
pub const NAME_CalendarSvc_SyncWindowEnd: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncWindowEnd");
pub const NAME_CalendarSvc_SyncWindowStart: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncWindowStart");
pub const NAME_ContactObj_AnniversaryDate: ::windows_strings::PCWSTR = ::windows_strings::w!("AnniversaryDate");
pub const NAME_ContactObj_Assistant: ::windows_strings::PCWSTR = ::windows_strings::w!("Assistant");
pub const NAME_ContactObj_Birthdate: ::windows_strings::PCWSTR = ::windows_strings::w!("Birthdate");
pub const NAME_ContactObj_BusinessAddressCity: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressCity");
pub const NAME_ContactObj_BusinessAddressCountry: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressCountry");
pub const NAME_ContactObj_BusinessAddressFull: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressFull");
pub const NAME_ContactObj_BusinessAddressLine2: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressLine2");
pub const NAME_ContactObj_BusinessAddressPostalCode: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressPostalCode");
pub const NAME_ContactObj_BusinessAddressRegion: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressRegion");
pub const NAME_ContactObj_BusinessAddressStreet: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessAddressStreet");
pub const NAME_ContactObj_BusinessEmail: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessEmail");
pub const NAME_ContactObj_BusinessEmail2: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessEmail2");
pub const NAME_ContactObj_BusinessFax: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessFax");
pub const NAME_ContactObj_BusinessPhone: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessPhone");
pub const NAME_ContactObj_BusinessPhone2: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessPhone2");
pub const NAME_ContactObj_BusinessWebAddress: ::windows_strings::PCWSTR = ::windows_strings::w!("BusinessWebAddress");
pub const NAME_ContactObj_Children: ::windows_strings::PCWSTR = ::windows_strings::w!("Children");
pub const NAME_ContactObj_Email: ::windows_strings::PCWSTR = ::windows_strings::w!("Email");
pub const NAME_ContactObj_FamilyName: ::windows_strings::PCWSTR = ::windows_strings::w!("FamilyName");
pub const NAME_ContactObj_Fax: ::windows_strings::PCWSTR = ::windows_strings::w!("Fax");
pub const NAME_ContactObj_GivenName: ::windows_strings::PCWSTR = ::windows_strings::w!("GivenName");
pub const NAME_ContactObj_IMAddress: ::windows_strings::PCWSTR = ::windows_strings::w!("IMAddress");
pub const NAME_ContactObj_IMAddress2: ::windows_strings::PCWSTR = ::windows_strings::w!("IMAddress2");
pub const NAME_ContactObj_IMAddress3: ::windows_strings::PCWSTR = ::windows_strings::w!("IMAddress3");
pub const NAME_ContactObj_MiddleNames: ::windows_strings::PCWSTR = ::windows_strings::w!("MiddleNames");
pub const NAME_ContactObj_MobilePhone: ::windows_strings::PCWSTR = ::windows_strings::w!("MobilePhone");
pub const NAME_ContactObj_MobilePhone2: ::windows_strings::PCWSTR = ::windows_strings::w!("MobilePhone2");
pub const NAME_ContactObj_Organization: ::windows_strings::PCWSTR = ::windows_strings::w!("Organization");
pub const NAME_ContactObj_OtherAddressCity: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressCity");
pub const NAME_ContactObj_OtherAddressCountry: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressCountry");
pub const NAME_ContactObj_OtherAddressFull: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressFull");
pub const NAME_ContactObj_OtherAddressLine2: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressLine2");
pub const NAME_ContactObj_OtherAddressPostalCode: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressPostalCode");
pub const NAME_ContactObj_OtherAddressRegion: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressRegion");
pub const NAME_ContactObj_OtherAddressStreet: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherAddressStreet");
pub const NAME_ContactObj_OtherEmail: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherEmail");
pub const NAME_ContactObj_OtherPhone: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherPhone");
pub const NAME_ContactObj_Pager: ::windows_strings::PCWSTR = ::windows_strings::w!("Pager");
pub const NAME_ContactObj_PersonalAddressCity: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressCity");
pub const NAME_ContactObj_PersonalAddressCountry: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressCountry");
pub const NAME_ContactObj_PersonalAddressFull: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressFull");
pub const NAME_ContactObj_PersonalAddressLine2: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressLine2");
pub const NAME_ContactObj_PersonalAddressPostalCode: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressPostalCode");
pub const NAME_ContactObj_PersonalAddressRegion: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressRegion");
pub const NAME_ContactObj_PersonalAddressStreet: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalAddressStreet");
pub const NAME_ContactObj_PersonalEmail: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalEmail");
pub const NAME_ContactObj_PersonalEmail2: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalEmail2");
pub const NAME_ContactObj_PersonalFax: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalFax");
pub const NAME_ContactObj_PersonalPhone: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalPhone");
pub const NAME_ContactObj_PersonalPhone2: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalPhone2");
pub const NAME_ContactObj_PersonalWebAddress: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalWebAddress");
pub const NAME_ContactObj_Phone: ::windows_strings::PCWSTR = ::windows_strings::w!("Phone");
pub const NAME_ContactObj_PhoneticFamilyName: ::windows_strings::PCWSTR = ::windows_strings::w!("PhoneticFamilyName");
pub const NAME_ContactObj_PhoneticGivenName: ::windows_strings::PCWSTR = ::windows_strings::w!("PhoneticGivenName");
pub const NAME_ContactObj_PhoneticOrganization: ::windows_strings::PCWSTR = ::windows_strings::w!("PhoneticOrganization");
pub const NAME_ContactObj_Ringtone: ::windows_strings::PCWSTR = ::windows_strings::w!("Ringtone");
pub const NAME_ContactObj_Role: ::windows_strings::PCWSTR = ::windows_strings::w!("Role");
pub const NAME_ContactObj_Spouse: ::windows_strings::PCWSTR = ::windows_strings::w!("Spouse");
pub const NAME_ContactObj_Suffix: ::windows_strings::PCWSTR = ::windows_strings::w!("Suffix");
pub const NAME_ContactObj_Title: ::windows_strings::PCWSTR = ::windows_strings::w!("Title");
pub const NAME_ContactObj_WebAddress: ::windows_strings::PCWSTR = ::windows_strings::w!("WebAddress");
pub const NAME_ContactSvc_SyncWithPhoneOnly: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterType");
pub const NAME_ContactsSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Contacts");
pub const NAME_DPOFDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("DPOFDocument");
pub const NAME_DVBTSFile: ::windows_strings::PCWSTR = ::windows_strings::w!("DVBTSFile");
pub const NAME_DeviceExecutable: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceExecutable");
pub const NAME_DeviceMetadataCAB: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceMetadataCAB");
pub const NAME_DeviceMetadataObj_ContentID: ::windows_strings::PCWSTR = ::windows_strings::w!("ContentID");
pub const NAME_DeviceMetadataObj_DefaultCAB: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultCAB");
pub const NAME_DeviceMetadataSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Metadata");
pub const NAME_DeviceScript: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceScript");
pub const NAME_EXIFImage: ::windows_strings::PCWSTR = ::windows_strings::w!("EXIFImage");
pub const NAME_ExcelDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("ExcelDocument");
pub const NAME_FLACFile: ::windows_strings::PCWSTR = ::windows_strings::w!("FLACFile");
pub const NAME_FirmwareFile: ::windows_strings::PCWSTR = ::windows_strings::w!("FirmwareFile");
pub const NAME_FlashPixImage: ::windows_strings::PCWSTR = ::windows_strings::w!("FlashPixImage");
pub const NAME_FullEnumSyncKnowledge: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumSyncKnowledge");
pub const NAME_FullEnumSyncSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumSync");
pub const NAME_FullEnumSyncSvc_BeginSync: ::windows_strings::PCWSTR = ::windows_strings::w!("BeginSync");
pub const NAME_FullEnumSyncSvc_EndSync: ::windows_strings::PCWSTR = ::windows_strings::w!("EndSync");
pub const NAME_FullEnumSyncSvc_FilterType: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterType");
pub const NAME_FullEnumSyncSvc_KnowledgeObjectID: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumKnowledgeObjectID");
pub const NAME_FullEnumSyncSvc_LastSyncProxyID: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumLastSyncProxyID");
pub const NAME_FullEnumSyncSvc_LocalOnlyDelete: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalOnlyDelete");
pub const NAME_FullEnumSyncSvc_ProviderVersion: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumProviderVersion");
pub const NAME_FullEnumSyncSvc_ReplicaID: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumReplicaID");
pub const NAME_FullEnumSyncSvc_SyncFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncFormat");
pub const NAME_FullEnumSyncSvc_VersionProps: ::windows_strings::PCWSTR = ::windows_strings::w!("FullEnumVersionProps");
pub const NAME_GIFImage: ::windows_strings::PCWSTR = ::windows_strings::w!("GIFImage");
pub const NAME_GenericObj_AllowedFolderContents: ::windows_strings::PCWSTR = ::windows_strings::w!("AllowedFolderContents");
pub const NAME_GenericObj_AssociationDesc: ::windows_strings::PCWSTR = ::windows_strings::w!("AssociationDesc");
pub const NAME_GenericObj_AssociationType: ::windows_strings::PCWSTR = ::windows_strings::w!("AssociationType");
pub const NAME_GenericObj_Copyright: ::windows_strings::PCWSTR = ::windows_strings::w!("Copyright");
pub const NAME_GenericObj_Corrupt: ::windows_strings::PCWSTR = ::windows_strings::w!("Corrupt");
pub const NAME_GenericObj_DRMStatus: ::windows_strings::PCWSTR = ::windows_strings::w!("DRMStatus");
pub const NAME_GenericObj_DateAccessed: ::windows_strings::PCWSTR = ::windows_strings::w!("DateAccessed");
pub const NAME_GenericObj_DateAdded: ::windows_strings::PCWSTR = ::windows_strings::w!("DateAdded");
pub const NAME_GenericObj_DateAuthored: ::windows_strings::PCWSTR = ::windows_strings::w!("DateAuthored");
pub const NAME_GenericObj_DateCreated: ::windows_strings::PCWSTR = ::windows_strings::w!("DateCreated");
pub const NAME_GenericObj_DateModified: ::windows_strings::PCWSTR = ::windows_strings::w!("DateModified");
pub const NAME_GenericObj_DateRevised: ::windows_strings::PCWSTR = ::windows_strings::w!("DateRevised");
pub const NAME_GenericObj_Description: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const NAME_GenericObj_Hidden: ::windows_strings::PCWSTR = ::windows_strings::w!("Hidden");
pub const NAME_GenericObj_Keywords: ::windows_strings::PCWSTR = ::windows_strings::w!("Keywords");
pub const NAME_GenericObj_LanguageLocale: ::windows_strings::PCWSTR = ::windows_strings::w!("LanguageLocale");
pub const NAME_GenericObj_Name: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const NAME_GenericObj_NonConsumable: ::windows_strings::PCWSTR = ::windows_strings::w!("NonConsumable");
pub const NAME_GenericObj_ObjectFileName: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectFileName");
pub const NAME_GenericObj_ObjectFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectFormat");
pub const NAME_GenericObj_ObjectID: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectID");
pub const NAME_GenericObj_ObjectSize: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectSize");
pub const NAME_GenericObj_ParentID: ::windows_strings::PCWSTR = ::windows_strings::w!("ParentID");
pub const NAME_GenericObj_PersistentUID: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistentUID");
pub const NAME_GenericObj_PropertyBag: ::windows_strings::PCWSTR = ::windows_strings::w!("PropertyBag");
pub const NAME_GenericObj_ProtectionStatus: ::windows_strings::PCWSTR = ::windows_strings::w!("ProtectionStatus");
pub const NAME_GenericObj_ReferenceParentID: ::windows_strings::PCWSTR = ::windows_strings::w!("ReferenceParentID");
pub const NAME_GenericObj_StorageID: ::windows_strings::PCWSTR = ::windows_strings::w!("StorageID");
pub const NAME_GenericObj_SubDescription: ::windows_strings::PCWSTR = ::windows_strings::w!("SubDescription");
pub const NAME_GenericObj_SyncID: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncID");
pub const NAME_GenericObj_SystemObject: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemObject");
pub const NAME_GenericObj_TimeToLive: ::windows_strings::PCWSTR = ::windows_strings::w!("TimeToLive");
pub const NAME_HDPhotoImage: ::windows_strings::PCWSTR = ::windows_strings::w!("HDPhotoImage");
pub const NAME_HTMLDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("HTMLDocument");
pub const NAME_HintsSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Hints");
pub const NAME_ICalendarActivity: ::windows_strings::PCWSTR = ::windows_strings::w!("ICalendar");
pub const NAME_ImageObj_Aperature: ::windows_strings::PCWSTR = ::windows_strings::w!("Aperature");
pub const NAME_ImageObj_Exposure: ::windows_strings::PCWSTR = ::windows_strings::w!("Exposure");
pub const NAME_ImageObj_ISOSpeed: ::windows_strings::PCWSTR = ::windows_strings::w!("ISOSpeed");
pub const NAME_ImageObj_ImageBitDepth: ::windows_strings::PCWSTR = ::windows_strings::w!("ImageBitDepth");
pub const NAME_ImageObj_IsColorCorrected: ::windows_strings::PCWSTR = ::windows_strings::w!("IsColorCorrected");
pub const NAME_ImageObj_IsCropped: ::windows_strings::PCWSTR = ::windows_strings::w!("IsCropped");
pub const NAME_JFIFImage: ::windows_strings::PCWSTR = ::windows_strings::w!("JFIFImage");
pub const NAME_JP2Image: ::windows_strings::PCWSTR = ::windows_strings::w!("JP2Image");
pub const NAME_JPEGXRImage: ::windows_strings::PCWSTR = ::windows_strings::w!("JPEGXRImage");
pub const NAME_JPXImage: ::windows_strings::PCWSTR = ::windows_strings::w!("JPXImage");
pub const NAME_M3UPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("M3UPlaylist");
pub const NAME_MHTDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("MHTDocument");
pub const NAME_MP3File: ::windows_strings::PCWSTR = ::windows_strings::w!("MP3File");
pub const NAME_MPEG2File: ::windows_strings::PCWSTR = ::windows_strings::w!("MPEG2File");
pub const NAME_MPEG4File: ::windows_strings::PCWSTR = ::windows_strings::w!("MPEG4File");
pub const NAME_MPEGFile: ::windows_strings::PCWSTR = ::windows_strings::w!("MPEGFile");
pub const NAME_MPLPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("MPLPlaylist");
pub const NAME_MediaObj_AlbumArtist: ::windows_strings::PCWSTR = ::windows_strings::w!("AlbumArtist");
pub const NAME_MediaObj_AlbumName: ::windows_strings::PCWSTR = ::windows_strings::w!("AlbumName");
pub const NAME_MediaObj_Artist: ::windows_strings::PCWSTR = ::windows_strings::w!("Artist");
pub const NAME_MediaObj_AudioEncodingProfile: ::windows_strings::PCWSTR = ::windows_strings::w!("AudioEncodingProfile");
pub const NAME_MediaObj_BitRateType: ::windows_strings::PCWSTR = ::windows_strings::w!("BitRateType");
pub const NAME_MediaObj_BookmarkByte: ::windows_strings::PCWSTR = ::windows_strings::w!("BookmarkByte");
pub const NAME_MediaObj_BookmarkObject: ::windows_strings::PCWSTR = ::windows_strings::w!("BookmarkObject");
pub const NAME_MediaObj_BookmarkTime: ::windows_strings::PCWSTR = ::windows_strings::w!("BookmarkTime");
pub const NAME_MediaObj_BufferSize: ::windows_strings::PCWSTR = ::windows_strings::w!("BufferSize");
pub const NAME_MediaObj_Composer: ::windows_strings::PCWSTR = ::windows_strings::w!("Composer");
pub const NAME_MediaObj_Credits: ::windows_strings::PCWSTR = ::windows_strings::w!("Credits");
pub const NAME_MediaObj_DateOriginalRelease: ::windows_strings::PCWSTR = ::windows_strings::w!("DateOriginalRelease");
pub const NAME_MediaObj_Duration: ::windows_strings::PCWSTR = ::windows_strings::w!("Duration");
pub const NAME_MediaObj_Editor: ::windows_strings::PCWSTR = ::windows_strings::w!("Editor");
pub const NAME_MediaObj_EffectiveRating: ::windows_strings::PCWSTR = ::windows_strings::w!("EffectiveRating");
pub const NAME_MediaObj_EncodingProfile: ::windows_strings::PCWSTR = ::windows_strings::w!("EncodingProfile");
pub const NAME_MediaObj_EncodingQuality: ::windows_strings::PCWSTR = ::windows_strings::w!("EncodingQuality");
pub const NAME_MediaObj_Genre: ::windows_strings::PCWSTR = ::windows_strings::w!("Genre");
pub const NAME_MediaObj_GeographicOrigin: ::windows_strings::PCWSTR = ::windows_strings::w!("GeographicOrigin");
pub const NAME_MediaObj_Height: ::windows_strings::PCWSTR = ::windows_strings::w!("Height");
pub const NAME_MediaObj_MediaType: ::windows_strings::PCWSTR = ::windows_strings::w!("MediaType");
pub const NAME_MediaObj_MediaUID: ::windows_strings::PCWSTR = ::windows_strings::w!("MediaUID");
pub const NAME_MediaObj_Mood: ::windows_strings::PCWSTR = ::windows_strings::w!("Mood");
pub const NAME_MediaObj_Owner: ::windows_strings::PCWSTR = ::windows_strings::w!("Owner");
pub const NAME_MediaObj_ParentalRating: ::windows_strings::PCWSTR = ::windows_strings::w!("ParentalRating");
pub const NAME_MediaObj_Producer: ::windows_strings::PCWSTR = ::windows_strings::w!("Producer");
pub const NAME_MediaObj_SampleRate: ::windows_strings::PCWSTR = ::windows_strings::w!("SampleRate");
pub const NAME_MediaObj_SkipCount: ::windows_strings::PCWSTR = ::windows_strings::w!("SkipCount");
pub const NAME_MediaObj_SubscriptionContentID: ::windows_strings::PCWSTR = ::windows_strings::w!("SubscriptionContentID");
pub const NAME_MediaObj_Subtitle: ::windows_strings::PCWSTR = ::windows_strings::w!("Subtitle");
pub const NAME_MediaObj_TotalBitRate: ::windows_strings::PCWSTR = ::windows_strings::w!("TotalBitRate");
pub const NAME_MediaObj_Track: ::windows_strings::PCWSTR = ::windows_strings::w!("Track");
pub const NAME_MediaObj_URLLink: ::windows_strings::PCWSTR = ::windows_strings::w!("URLLink");
pub const NAME_MediaObj_URLSource: ::windows_strings::PCWSTR = ::windows_strings::w!("URLSource");
pub const NAME_MediaObj_UseCount: ::windows_strings::PCWSTR = ::windows_strings::w!("UseCount");
pub const NAME_MediaObj_UserRating: ::windows_strings::PCWSTR = ::windows_strings::w!("UserRating");
pub const NAME_MediaObj_WebMaster: ::windows_strings::PCWSTR = ::windows_strings::w!("WebMaster");
pub const NAME_MediaObj_Width: ::windows_strings::PCWSTR = ::windows_strings::w!("Width");
pub const NAME_MessageObj_BCC: ::windows_strings::PCWSTR = ::windows_strings::w!("BCC");
pub const NAME_MessageObj_Body: ::windows_strings::PCWSTR = ::windows_strings::w!("Body");
pub const NAME_MessageObj_CC: ::windows_strings::PCWSTR = ::windows_strings::w!("CC");
pub const NAME_MessageObj_Category: ::windows_strings::PCWSTR = ::windows_strings::w!("Category");
pub const NAME_MessageObj_PatternDayOfMonth: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternDayOfMonth");
pub const NAME_MessageObj_PatternDayOfWeek: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternDayOfWeek");
pub const NAME_MessageObj_PatternDeleteDates: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternDeleteDates");
pub const NAME_MessageObj_PatternInstance: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternInstance");
pub const NAME_MessageObj_PatternMonthOfYear: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternMonthOfYear");
pub const NAME_MessageObj_PatternOriginalDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternOriginalDateTime");
pub const NAME_MessageObj_PatternPeriod: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternPeriod");
pub const NAME_MessageObj_PatternType: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternType");
pub const NAME_MessageObj_PatternValidEndDate: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternValidEndDate");
pub const NAME_MessageObj_PatternValidStartDate: ::windows_strings::PCWSTR = ::windows_strings::w!("PatternValidStartDate");
pub const NAME_MessageObj_Priority: ::windows_strings::PCWSTR = ::windows_strings::w!("Priority");
pub const NAME_MessageObj_Read: ::windows_strings::PCWSTR = ::windows_strings::w!("Read");
pub const NAME_MessageObj_ReceivedTime: ::windows_strings::PCWSTR = ::windows_strings::w!("ReceivedTime");
pub const NAME_MessageObj_Sender: ::windows_strings::PCWSTR = ::windows_strings::w!("Sender");
pub const NAME_MessageObj_Subject: ::windows_strings::PCWSTR = ::windows_strings::w!("Subject");
pub const NAME_MessageObj_To: ::windows_strings::PCWSTR = ::windows_strings::w!("To");
pub const NAME_MessageSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Message");
pub const NAME_NotesSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Notes");
pub const NAME_OGGFile: ::windows_strings::PCWSTR = ::windows_strings::w!("OGGFile");
pub const NAME_PCDImage: ::windows_strings::PCWSTR = ::windows_strings::w!("PCDImage");
pub const NAME_PICTImage: ::windows_strings::PCWSTR = ::windows_strings::w!("PICTImage");
pub const NAME_PNGImage: ::windows_strings::PCWSTR = ::windows_strings::w!("PNGImage");
pub const NAME_PSLPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("PSLPlaylist");
pub const NAME_PowerPointDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("PowerPointDocument");
pub const NAME_QCELPFile: ::windows_strings::PCWSTR = ::windows_strings::w!("QCELPFile");
pub const NAME_RingtonesSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Ringtones");
pub const NAME_RingtonesSvc_DefaultRingtone: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultRingtone");
pub const NAME_Services_ServiceDisplayName: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceDisplayName");
pub const NAME_Services_ServiceIcon: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceIcon");
pub const NAME_Services_ServiceLocale: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceLocale");
pub const NAME_StatusSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Status");
pub const NAME_StatusSvc_BatteryLife: ::windows_strings::PCWSTR = ::windows_strings::w!("BatteryLife");
pub const NAME_StatusSvc_ChargingState: ::windows_strings::PCWSTR = ::windows_strings::w!("ChargingState");
pub const NAME_StatusSvc_MissedCalls: ::windows_strings::PCWSTR = ::windows_strings::w!("MissedCalls");
pub const NAME_StatusSvc_NetworkName: ::windows_strings::PCWSTR = ::windows_strings::w!("NetworkName");
pub const NAME_StatusSvc_NetworkType: ::windows_strings::PCWSTR = ::windows_strings::w!("NetworkType");
pub const NAME_StatusSvc_NewPictures: ::windows_strings::PCWSTR = ::windows_strings::w!("NewPictures");
pub const NAME_StatusSvc_Roaming: ::windows_strings::PCWSTR = ::windows_strings::w!("Roaming");
pub const NAME_StatusSvc_SignalStrength: ::windows_strings::PCWSTR = ::windows_strings::w!("SignalStrength");
pub const NAME_StatusSvc_StorageCapacity: ::windows_strings::PCWSTR = ::windows_strings::w!("StorageCapacity");
pub const NAME_StatusSvc_StorageFreeSpace: ::windows_strings::PCWSTR = ::windows_strings::w!("StorageFreeSpace");
pub const NAME_StatusSvc_TextMessages: ::windows_strings::PCWSTR = ::windows_strings::w!("TextMessages");
pub const NAME_StatusSvc_VoiceMail: ::windows_strings::PCWSTR = ::windows_strings::w!("VoiceMail");
pub const NAME_SyncObj_LastAuthorProxyID: ::windows_strings::PCWSTR = ::windows_strings::w!("LastAuthorProxyID");
pub const NAME_SyncSvc_BeginSync: ::windows_strings::PCWSTR = ::windows_strings::w!("BeginSync");
pub const NAME_SyncSvc_EndSync: ::windows_strings::PCWSTR = ::windows_strings::w!("EndSync");
pub const NAME_SyncSvc_FilterType: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterType");
pub const NAME_SyncSvc_LocalOnlyDelete: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalOnlyDelete");
pub const NAME_SyncSvc_SyncFormat: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncFormat");
pub const NAME_SyncSvc_SyncObjectReferences: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncObjectReferences");
pub const NAME_TIFFEPImage: ::windows_strings::PCWSTR = ::windows_strings::w!("TIFFEPImage");
pub const NAME_TIFFITImage: ::windows_strings::PCWSTR = ::windows_strings::w!("TIFFITImage");
pub const NAME_TIFFImage: ::windows_strings::PCWSTR = ::windows_strings::w!("TIFFImage");
pub const NAME_TaskObj_BeginDate: ::windows_strings::PCWSTR = ::windows_strings::w!("BeginDate");
pub const NAME_TaskObj_Complete: ::windows_strings::PCWSTR = ::windows_strings::w!("Complete");
pub const NAME_TaskObj_EndDate: ::windows_strings::PCWSTR = ::windows_strings::w!("EndDate");
pub const NAME_TaskObj_ReminderDateTime: ::windows_strings::PCWSTR = ::windows_strings::w!("ReminderDateTime");
pub const NAME_TasksSvc: ::windows_strings::PCWSTR = ::windows_strings::w!("Tasks");
pub const NAME_TasksSvc_SyncActiveOnly: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterType");
pub const NAME_TextDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("TextDocument");
pub const NAME_Undefined: ::windows_strings::PCWSTR = ::windows_strings::w!("Undefined");
pub const NAME_UndefinedAudio: ::windows_strings::PCWSTR = ::windows_strings::w!("UndefinedAudio");
pub const NAME_UndefinedCollection: ::windows_strings::PCWSTR = ::windows_strings::w!("UndefinedCollection");
pub const NAME_UndefinedDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("UndefinedDocument");
pub const NAME_UndefinedVideo: ::windows_strings::PCWSTR = ::windows_strings::w!("UndefinedVideo");
pub const NAME_UnknownImage: ::windows_strings::PCWSTR = ::windows_strings::w!("UnknownImage");
pub const NAME_VCalendar1Activity: ::windows_strings::PCWSTR = ::windows_strings::w!("VCalendar1");
pub const NAME_VCard2Contact: ::windows_strings::PCWSTR = ::windows_strings::w!("VCard2Contact");
pub const NAME_VCard3Contact: ::windows_strings::PCWSTR = ::windows_strings::w!("VCard3Contact");
pub const NAME_VideoObj_KeyFrameDistance: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyFrameDistance");
pub const NAME_VideoObj_ScanType: ::windows_strings::PCWSTR = ::windows_strings::w!("ScanType");
pub const NAME_VideoObj_Source: ::windows_strings::PCWSTR = ::windows_strings::w!("Source");
pub const NAME_VideoObj_VideoBitRate: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoBitRate");
pub const NAME_VideoObj_VideoFormatCode: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoFormatCode");
pub const NAME_VideoObj_VideoFrameRate: ::windows_strings::PCWSTR = ::windows_strings::w!("VideoFrameRate");
pub const NAME_WAVFile: ::windows_strings::PCWSTR = ::windows_strings::w!("WAVFile");
pub const NAME_WBMPImage: ::windows_strings::PCWSTR = ::windows_strings::w!("WBMPImage");
pub const NAME_WMAFile: ::windows_strings::PCWSTR = ::windows_strings::w!("WMAFile");
pub const NAME_WMVFile: ::windows_strings::PCWSTR = ::windows_strings::w!("WMVFile");
pub const NAME_WPLPlaylist: ::windows_strings::PCWSTR = ::windows_strings::w!("WPLPlaylist");
pub const NAME_WordDocument: ::windows_strings::PCWSTR = ::windows_strings::w!("WordDocument");
...
pub const PORTABLE_DEVICE_IS_MASS_STORAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("PortableDeviceIsMassStorage");
pub const PORTABLE_DEVICE_NAMESPACE_EXCLUDE_FROM_SHELL: ::windows_strings::PCWSTR = ::windows_strings::w!("PortableDeviceNameSpaceExcludeFromShell");
...
pub const STR_WPDNSE_FAST_ENUM: ::windows_strings::PCWSTR = ::windows_strings::w!("WPDNSE Fast Enum");
pub const STR_WPDNSE_SIMPLE_ITEM: ::windows_strings::PCWSTR = ::windows_strings::w!("WPDNSE SimpleItem");
...
pub const WPD_DEVICE_OBJECT_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("DEVICE");
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
