...
pub const DEVICEDISPLAY_DISCOVERYMETHOD_AD_PRINTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Published Printer");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_ASP_INFRA: ::windows_strings::PCWSTR = ::windows_strings::w!("AspInfra");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_BLUETOOTH: ::windows_strings::PCWSTR = ::windows_strings::w!("Bluetooth");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_BLUETOOTH_LE: ::windows_strings::PCWSTR = ::windows_strings::w!("Bluetooth Low Energy");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_NETBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("NetBIOS");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_PNP: ::windows_strings::PCWSTR = ::windows_strings::w!("PnP");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_UPNP: ::windows_strings::PCWSTR = ::windows_strings::w!("UPnP");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_WFD: ::windows_strings::PCWSTR = ::windows_strings::w!("WiFiDirect");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_WSD: ::windows_strings::PCWSTR = ::windows_strings::w!("WSD");
pub const DEVICEDISPLAY_DISCOVERYMETHOD_WUSB: ::windows_strings::PCWSTR = ::windows_strings::w!("WUSB");
...
pub const FCTN_CATEGORY_BT: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Devices.Bluetooth");
pub const FCTN_CATEGORY_DEVICEDISPLAYOBJECTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Base.DeviceDisplayObjects");
pub const FCTN_CATEGORY_DEVICEFUNCTIONENUMERATORS: ::windows_strings::PCWSTR = ::windows_strings::w!("Layered\\Microsoft.Devices.FunctionEnumerators");
pub const FCTN_CATEGORY_DEVICEPAIRING: ::windows_strings::PCWSTR = ::windows_strings::w!("Layered\\Microsoft.Base.DevicePairing");
pub const FCTN_CATEGORY_DEVICES: ::windows_strings::PCWSTR = ::windows_strings::w!("Layered\\Microsoft.Base.Devices");
pub const FCTN_CATEGORY_DEVQUERYOBJECTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Base.DevQueryObjects");
pub const FCTN_CATEGORY_NETBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Networking.Netbios");
pub const FCTN_CATEGORY_NETWORKDEVICES: ::windows_strings::PCWSTR = ::windows_strings::w!("Layered\\Microsoft.Networking.Devices");
pub const FCTN_CATEGORY_PNP: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Base.PnP");
pub const FCTN_CATEGORY_PNPXASSOCIATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.PnPX.Association");
pub const FCTN_CATEGORY_PUBLICATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Base.Publication");
pub const FCTN_CATEGORY_REGISTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Base.Registry");
pub const FCTN_CATEGORY_SSDP: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Networking.SSDP");
pub const FCTN_CATEGORY_WCN: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Networking.WCN");
pub const FCTN_CATEGORY_WSDISCOVERY: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Networking.WSD");
pub const FCTN_CATEGORY_WUSB: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider\\Microsoft.Devices.WirelessUSB");
pub const FCTN_SUBCAT_DEVICES_WSDPRINTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("WSDPrinters");
pub const FCTN_SUBCAT_NETWORKDEVICES_SSDP: ::windows_strings::PCWSTR = ::windows_strings::w!("SSDP");
pub const FCTN_SUBCAT_NETWORKDEVICES_WSD: ::windows_strings::PCWSTR = ::windows_strings::w!("WSD");
pub const FCTN_SUBCAT_REG_DIRECTED: ::windows_strings::PCWSTR = ::windows_strings::w!("Directed");
pub const FCTN_SUBCAT_REG_PUBLICATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Publication");
pub const FD_CONSTRAINTVALUE_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const FD_CONSTRAINTVALUE_COMCLSCONTEXT_INPROC_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("1");
pub const FD_CONSTRAINTVALUE_COMCLSCONTEXT_LOCAL_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("4");
pub const FD_CONSTRAINTVALUE_FALSE: ::windows_strings::PCWSTR = ::windows_strings::w!("FALSE");
pub const FD_CONSTRAINTVALUE_PAIRED: ::windows_strings::PCWSTR = ::windows_strings::w!("Paired");
pub const FD_CONSTRAINTVALUE_RECURSESUBCATEGORY_TRUE: ::windows_strings::PCWSTR = ::windows_strings::w!("TRUE");
pub const FD_CONSTRAINTVALUE_ROUTINGSCOPE_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const FD_CONSTRAINTVALUE_ROUTINGSCOPE_DIRECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Direct");
pub const FD_CONSTRAINTVALUE_TRUE: ::windows_strings::PCWSTR = ::windows_strings::w!("TRUE");
pub const FD_CONSTRAINTVALUE_UNPAIRED: ::windows_strings::PCWSTR = ::windows_strings::w!("UnPaired");
pub const FD_CONSTRAINTVALUE_VISIBILITY_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("1");
pub const FD_CONSTRAINTVALUE_VISIBILITY_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("0");
...
pub const FD_QUERYCONSTRAINT_COMCLSCONTEXT: ::windows_strings::PCWSTR = ::windows_strings::w!("COMClsContext");
pub const FD_QUERYCONSTRAINT_INQUIRY_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("InquiryModeTimeout");
pub const FD_QUERYCONSTRAINT_PAIRING_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("PairingState");
pub const FD_QUERYCONSTRAINT_PROVIDERINSTANCEID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderInstanceID");
pub const FD_QUERYCONSTRAINT_RECURSESUBCATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("RecurseSubcategory");
pub const FD_QUERYCONSTRAINT_ROUTINGSCOPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RoutingScope");
pub const FD_QUERYCONSTRAINT_SUBCATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("Subcategory");
pub const FD_QUERYCONSTRAINT_VISIBILITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Visibility");
pub const FD_SUBKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("SOFTWARE\\Microsoft\\Function Discovery\\");
...
pub const ONLINE_PROVIDER_DEVICES_QUERYCONSTRAINT_OWNERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("OwnerName");
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
pub const PNPX_DEVICECATEGORY_FAX: ::windows_strings::PCWSTR = ::windows_strings::w!("FAX");
pub const PNPX_DEVICECATEGORY_GAMING_DEVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("Gaming");
pub const PNPX_DEVICECATEGORY_HOME_AUTOMATION_SYSTEM: ::windows_strings::PCWSTR = ::windows_strings::w!("HomeAutomation");
pub const PNPX_DEVICECATEGORY_HOME_SECURITY_SYSTEM: ::windows_strings::PCWSTR = ::windows_strings::w!("HomeSecurity");
pub const PNPX_DEVICECATEGORY_INPUTDEVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("Input");
pub const PNPX_DEVICECATEGORY_MFP: ::windows_strings::PCWSTR = ::windows_strings::w!("MFP");
pub const PNPX_DEVICECATEGORY_MULTIMEDIA_DEVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("MediaDevices");
pub const PNPX_DEVICECATEGORY_NETWORK_INFRASTRUCTURE: ::windows_strings::PCWSTR = ::windows_strings::w!("NetworkInfrastructure");
pub const PNPX_DEVICECATEGORY_OTHER: ::windows_strings::PCWSTR = ::windows_strings::w!("Other");
pub const PNPX_DEVICECATEGORY_PRINTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Printers");
...
pub const PROVIDERDDO_QUERYCONSTRAINT_DEVICEINTERFACES: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceInterfaces");
pub const PROVIDERDDO_QUERYCONSTRAINT_ONLYCONNECTEDDEVICES: ::windows_strings::PCWSTR = ::windows_strings::w!("OnlyConnectedDevices");
pub const PROVIDERPNP_QUERYCONSTRAINT_INTERFACECLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("InterfaceClass");
pub const PROVIDERPNP_QUERYCONSTRAINT_NOTIFICATIONSONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("NotifyOnly");
pub const PROVIDERPNP_QUERYCONSTRAINT_NOTPRESENT: ::windows_strings::PCWSTR = ::windows_strings::w!("NotPresent");
pub const PROVIDERSSDP_QUERYCONSTRAINT_CUSTOMXMLPROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("CustomXmlProperty");
pub const PROVIDERSSDP_QUERYCONSTRAINT_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("Type");
pub const PROVIDERWNET_QUERYCONSTRAINT_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Properties");
pub const PROVIDERWNET_QUERYCONSTRAINT_RESOURCETYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceType");
pub const PROVIDERWNET_QUERYCONSTRAINT_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("Type");
pub const PROVIDERWSD_QUERYCONSTRAINT_DIRECTEDADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("RemoteAddress");
pub const PROVIDERWSD_QUERYCONSTRAINT_SCOPE: ::windows_strings::PCWSTR = ::windows_strings::w!("Scope");
pub const PROVIDERWSD_QUERYCONSTRAINT_SECURITY_REQUIREMENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("SecurityRequirements");
...
pub const SSDP_CONSTRAINTVALUE_TYPE_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("ssdp:all");
pub const SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("urn:schemas-upnp-org:device:");
pub const SSDP_CONSTRAINTVALUE_TYPE_ROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("upnp:rootdevice");
pub const SSDP_CONSTRAINTVALUE_TYPE_SVC_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("urn:schemas-upnp-org:service:");
...
pub const WNET_CONSTRAINTVALUE_PROPERTIES_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const WNET_CONSTRAINTVALUE_PROPERTIES_LIMITED: ::windows_strings::PCWSTR = ::windows_strings::w!("Limited");
pub const WNET_CONSTRAINTVALUE_RESOURCETYPE_DISK: ::windows_strings::PCWSTR = ::windows_strings::w!("Disk");
pub const WNET_CONSTRAINTVALUE_RESOURCETYPE_DISKORPRINTER: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskOrPrinter");
pub const WNET_CONSTRAINTVALUE_RESOURCETYPE_PRINTER: ::windows_strings::PCWSTR = ::windows_strings::w!("Printer");
pub const WNET_CONSTRAINTVALUE_TYPE_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const WNET_CONSTRAINTVALUE_TYPE_DOMAIN: ::windows_strings::PCWSTR = ::windows_strings::w!("Domain");
pub const WNET_CONSTRAINTVALUE_TYPE_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Server");
pub const WSD_CONSTRAINTVALUE_NO_TRUST_VERIFICATION: ::windows_strings::PCWSTR = ::windows_strings::w!("3");
pub const WSD_CONSTRAINTVALUE_REQUIRE_SECURECHANNEL: ::windows_strings::PCWSTR = ::windows_strings::w!("1");
pub const WSD_CONSTRAINTVALUE_REQUIRE_SECURECHANNEL_AND_COMPACTSIGNATURE: ::windows_strings::PCWSTR = ::windows_strings::w!("2");
#[repr(transparent)]
