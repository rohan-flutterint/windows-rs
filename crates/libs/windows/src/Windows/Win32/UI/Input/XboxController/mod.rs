...
pub const XINPUT_DLL: ::windows_strings::PCWSTR = ::windows_strings::w!("xinput1_4.dll");
pub const XINPUT_DLL_A: ::windows_strings::PCSTR = ::windows_strings::s!("xinput1_4.dll");
pub const XINPUT_DLL_W: ::windows_strings::PCWSTR = ::windows_strings::w!("xinput1_4.dll");
