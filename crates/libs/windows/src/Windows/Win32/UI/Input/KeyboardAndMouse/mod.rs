...
pub const wszACUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{301}");
pub const wszBREVE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{306}");
pub const wszCEDILLA: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{327}");
pub const wszCIRCUMFLEX: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{302}");
pub const wszDIARESIS_TONOS: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{385}");
pub const wszDOT_ABOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{307}");
pub const wszDOUBLE_ACUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{30b}");
pub const wszGRAVE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{300}");
pub const wszHACEK: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{30c}");
pub const wszHOOK_ABOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{309}");
pub const wszMACRON: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{304}");
pub const wszOGONEK: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{328}");
pub const wszOVERSCORE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{305}");
pub const wszRING: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{30a}");
pub const wszTILDE: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{303}");
pub const wszTONOS: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{384}");
pub const wszUMLAUT: ::windows_strings::PCWSTR = ::windows_strings::w!("\u{308}");
#[repr(transparent)]
