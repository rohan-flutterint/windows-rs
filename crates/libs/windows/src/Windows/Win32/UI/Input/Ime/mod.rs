...
pub const RWM_CHGKEYMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEChangeKeyMap");
pub const RWM_DOCUMENTFEED: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEDocumentFeed");
pub const RWM_KEYMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEKeyMap");
pub const RWM_MODEBIAS: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEModeBias");
pub const RWM_MOUSE: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEMouseOperation");
pub const RWM_NTFYKEYMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMENotifyKeyMap");
pub const RWM_QUERYPOSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEQueryPosition");
pub const RWM_RECONVERT: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEReconvert");
pub const RWM_RECONVERTOPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEReconvertOptions");
pub const RWM_RECONVERTREQUEST: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEReconvertRequest");
pub const RWM_SERVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEService");
pub const RWM_SHOWIMEPAD: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEShowImePad");
pub const RWM_UIREADY: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIMEUIReady");
...
pub const szImeChina: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIME.China");
pub const szImeJapan: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIME.Japan");
pub const szImeKorea: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIME.Korea");
pub const szImeTaiwan: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIME.Taiwan");
