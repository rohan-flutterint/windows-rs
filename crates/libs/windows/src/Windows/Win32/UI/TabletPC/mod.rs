...
pub const FACTOID_BOPOMOFO: ::windows_strings::PCWSTR = ::windows_strings::w!("BOPOMOFO");
pub const FACTOID_CHINESESIMPLECOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("CHS_COMMON");
pub const FACTOID_CHINESETRADITIONALCOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("CHT_COMMON");
pub const FACTOID_CURRENCY: ::windows_strings::PCWSTR = ::windows_strings::w!("CURRENCY");
pub const FACTOID_DATE: ::windows_strings::PCWSTR = ::windows_strings::w!("DATE");
pub const FACTOID_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("DEFAULT");
pub const FACTOID_DIGIT: ::windows_strings::PCWSTR = ::windows_strings::w!("DIGIT");
pub const FACTOID_EMAIL: ::windows_strings::PCWSTR = ::windows_strings::w!("EMAIL");
pub const FACTOID_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FILENAME");
pub const FACTOID_HANGULCOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("HANGUL_COMMON");
pub const FACTOID_HANGULRARE: ::windows_strings::PCWSTR = ::windows_strings::w!("HANGUL_RARE");
pub const FACTOID_HIRAGANA: ::windows_strings::PCWSTR = ::windows_strings::w!("HIRAGANA");
pub const FACTOID_JAMO: ::windows_strings::PCWSTR = ::windows_strings::w!("JAMO");
pub const FACTOID_JAPANESECOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("JPN_COMMON");
pub const FACTOID_KANJICOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("KANJI_COMMON");
pub const FACTOID_KANJIRARE: ::windows_strings::PCWSTR = ::windows_strings::w!("KANJI_RARE");
pub const FACTOID_KATAKANA: ::windows_strings::PCWSTR = ::windows_strings::w!("KATAKANA");
pub const FACTOID_KOREANCOMMON: ::windows_strings::PCWSTR = ::windows_strings::w!("KOR_COMMON");
pub const FACTOID_LOWERCHAR: ::windows_strings::PCWSTR = ::windows_strings::w!("LOWERCHAR");
pub const FACTOID_NONE: ::windows_strings::PCWSTR = ::windows_strings::w!("NONE");
pub const FACTOID_NUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("NUMBER");
pub const FACTOID_NUMBERSIMPLE: ::windows_strings::PCWSTR = ::windows_strings::w!("NUMSIMPLE");
pub const FACTOID_ONECHAR: ::windows_strings::PCWSTR = ::windows_strings::w!("ONECHAR");
pub const FACTOID_PERCENT: ::windows_strings::PCWSTR = ::windows_strings::w!("PERCENT");
pub const FACTOID_POSTALCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("POSTALCODE");
pub const FACTOID_PUNCCHAR: ::windows_strings::PCWSTR = ::windows_strings::w!("PUNCCHAR");
pub const FACTOID_SYSTEMDICTIONARY: ::windows_strings::PCWSTR = ::windows_strings::w!("SYSDICT");
pub const FACTOID_TELEPHONE: ::windows_strings::PCWSTR = ::windows_strings::w!("TELEPHONE");
pub const FACTOID_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("TIME");
pub const FACTOID_UPPERCHAR: ::windows_strings::PCWSTR = ::windows_strings::w!("UPPERCHAR");
pub const FACTOID_WEB: ::windows_strings::PCWSTR = ::windows_strings::w!("WEB");
pub const FACTOID_WORDLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("WORDLIST");
...
pub const INKEDIT_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("INKEDIT");
pub const INKEDIT_CLASSW: ::windows_strings::PCWSTR = ::windows_strings::w!("INKEDIT");
pub const INKRECOGNITIONPROPERTY_BOXNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("{2C243E3A-F733-4EB6-B1F8-B5DC5C2C4CDA}");
pub const INKRECOGNITIONPROPERTY_CONFIDENCELEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("{7DFE11A7-FB5D-4958-8765-154ADF0D833F}");
pub const INKRECOGNITIONPROPERTY_HOTPOINT: ::windows_strings::PCWSTR = ::windows_strings::w!("{CA6F40DC-5292-452a-91FB-2181C0BEC0DE}");
pub const INKRECOGNITIONPROPERTY_LINEMETRICS: ::windows_strings::PCWSTR = ::windows_strings::w!("{8CC24B27-30A9-4b96-9056-2D3A90DA0727}");
pub const INKRECOGNITIONPROPERTY_LINENUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("{DBF29F2C-5289-4BE8-B3D8-6EF63246253E}");
pub const INKRECOGNITIONPROPERTY_MAXIMUMSTROKECOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("{BF0EEC4E-4B7D-47a9-8CFA-234DD24BD22A}");
pub const INKRECOGNITIONPROPERTY_POINTSPERINCH: ::windows_strings::PCWSTR = ::windows_strings::w!("{7ED16B76-889C-468e-8276-0021B770187E}");
pub const INKRECOGNITIONPROPERTY_SEGMENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{B3C0FE6C-FB51-4164-BA2F-844AF8F983DA}");
pub const INK_SERIALIZED_FORMAT: ::windows_strings::PCWSTR = ::windows_strings::w!("Ink Serialized Format");
...
pub const MICROSOFT_PENINPUT_PANEL_PROPERTY_T: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft PenInputPanel 1.5");
pub const MICROSOFT_TIP_COMBOBOXLIST_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft TIP ComboBox List Window Identifier");
pub const MICROSOFT_TIP_NO_INSERT_BUTTON_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft TIP No Insert Option");
pub const MICROSOFT_TIP_OPENING_MSG: ::windows_strings::PCWSTR = ::windows_strings::w!("TabletInputPanelOpening");
pub const MICROSOFT_URL_EXPERIENCE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft TIP URL Experience");
...
pub const STR_GUID_ALTITUDEORIENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{82DEC5C7-F6BA-4906-894F-66D68DFC456C}");
pub const STR_GUID_AZIMUTHORIENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{029123B4-8828-410B-B250-A0536595E5DC}");
pub const STR_GUID_BUTTONPRESSURE: ::windows_strings::PCWSTR = ::windows_strings::w!("{8B7FEFC4-96AA-4BFE-AC26-8A5F0BE07BF5}");
pub const STR_GUID_DEVICE_CONTACT_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("{02585B91-049B-4750-9615-DF8948AB3C9C}");
pub const STR_GUID_FINGERCONTACTCONFIDENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("{E706C804-57F0-4F00-8A0C-853D57789BE9}");
pub const STR_GUID_HEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("{E61858D2-E447-4218-9D3F-18865C203DF4}");
pub const STR_GUID_NORMALPRESSURE: ::windows_strings::PCWSTR = ::windows_strings::w!("{7307502D-F9F4-4E18-B3F2-2CE1B1A3610C}");
pub const STR_GUID_PAKETSTATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("{6E0E07BF-AFE7-4CF7-87D1-AF6446208418}");
pub const STR_GUID_PITCHROTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{7F7E57B7-BE37-4BE1-A356-7A84160E1893}");
pub const STR_GUID_ROLLROTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{5D5D5E56-6BA9-4C5B-9FB0-851C91714E56}");
pub const STR_GUID_SERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("{78A81B56-0935-4493-BAAE-00541A8A16C4}");
pub const STR_GUID_TANGENTPRESSURE: ::windows_strings::PCWSTR = ::windows_strings::w!("{6DA4488B-5244-41EC-905B-32D89AB80809}");
pub const STR_GUID_TIMERTICK: ::windows_strings::PCWSTR = ::windows_strings::w!("{436510C5-FED3-45D1-8B76-71D3EA7A829D}");
pub const STR_GUID_TWISTORIENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{0D324960-13B2-41E4-ACE6-7AE9D43D2D3B}");
pub const STR_GUID_WIDTH: ::windows_strings::PCWSTR = ::windows_strings::w!("{BAABE94D-2712-48F5-BE9D-8F8B5EA0711A}");
pub const STR_GUID_X: ::windows_strings::PCWSTR = ::windows_strings::w!("{598A6A8F-52C0-4BA0-93AF-AF357411A561}");
pub const STR_GUID_XTILTORIENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{A8D07B3A-8BF0-40B0-95A9-B80A6BB787BF}");
pub const STR_GUID_Y: ::windows_strings::PCWSTR = ::windows_strings::w!("{B53F9F75-04E0-4498-A7EE-C30DBB5A9011}");
pub const STR_GUID_YAWROTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{6A849980-7C3A-45B7-AA82-90A262950E89}");
pub const STR_GUID_YTILTORIENTATION: ::windows_strings::PCWSTR = ::windows_strings::w!("{0E932389-1D77-43AF-AC00-5B950D6D4B2D}");
pub const STR_GUID_Z: ::windows_strings::PCWSTR = ::windows_strings::w!("{735ADB30-0EBB-4788-A0E4-0F316490055D}");
