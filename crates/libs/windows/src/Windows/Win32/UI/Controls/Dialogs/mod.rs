...
pub const COLOROKSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_ColorOK");
pub const COLOROKSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_ColorOK");
pub const COLOROKSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_ColorOK");
...
pub const FILEOKSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_FileNameOK");
pub const FILEOKSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_FileNameOK");
pub const FILEOKSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_FileNameOK");
pub const FINDMSGSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_FindReplace");
pub const FINDMSGSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_FindReplace");
pub const FINDMSGSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_FindReplace");
...
pub const HELPMSGSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_help");
pub const HELPMSGSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_help");
pub const HELPMSGSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_help");
pub const ITALIC_FONTTYPE: CHOOSEFONT_FONT_TYPE = CHOOSEFONT_FONT_TYPE(512u16);
pub const LBSELCHSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_LBSelChangedNotify");
pub const LBSELCHSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_LBSelChangedNotify");
pub const LBSELCHSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_LBSelChangedNotify");
...
pub const SETRGBSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_SetRGBColor");
pub const SETRGBSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_SetRGBColor");
pub const SETRGBSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_SetRGBColor");
pub const SHAREVISTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_ShareViolation");
pub const SHAREVISTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("commdlg_ShareViolation");
pub const SHAREVISTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("commdlg_ShareViolation");
