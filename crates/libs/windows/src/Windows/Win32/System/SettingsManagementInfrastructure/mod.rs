...
pub const WCM_SETTINGS_ID_ARCHITECTURE: ::windows_strings::PCWSTR = ::windows_strings::w!("architecture");
pub const WCM_SETTINGS_ID_FLAG_DEFINITION: u32 = 1u32;
pub const WCM_SETTINGS_ID_FLAG_REFERENCE: u32 = 0u32;
pub const WCM_SETTINGS_ID_LANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("language");
pub const WCM_SETTINGS_ID_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("name");
pub const WCM_SETTINGS_ID_TOKEN: ::windows_strings::PCWSTR = ::windows_strings::w!("token");
pub const WCM_SETTINGS_ID_URI: ::windows_strings::PCWSTR = ::windows_strings::w!("uri");
pub const WCM_SETTINGS_ID_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("version");
pub const WCM_SETTINGS_ID_VERSION_SCOPE: ::windows_strings::PCWSTR = ::windows_strings::w!("versionScope");
