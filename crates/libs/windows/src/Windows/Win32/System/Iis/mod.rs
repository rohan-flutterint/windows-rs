...
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEYA: ::windows_strings::PCSTR = ::windows_strings::s!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEYW: ::windows_strings::PCWSTR = ::windows_strings::w!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_REG_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
pub const IISADMIN_EXTENSIONS_REG_KEYA: ::windows_strings::PCSTR = ::windows_strings::s!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
pub const IISADMIN_EXTENSIONS_REG_KEYW: ::windows_strings::PCWSTR = ::windows_strings::w!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
pub const IIS_CLASS_CERTMAPPER: ::windows_strings::PCSTR = ::windows_strings::s!("IIsCertMapper");
pub const IIS_CLASS_CERTMAPPER_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsCertMapper");
pub const IIS_CLASS_COMPRESS_SCHEME: ::windows_strings::PCSTR = ::windows_strings::s!("IIsCompressionScheme");
pub const IIS_CLASS_COMPRESS_SCHEMES: ::windows_strings::PCSTR = ::windows_strings::s!("IIsCompressionSchemes");
pub const IIS_CLASS_COMPRESS_SCHEMES_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsCompressionSchemes");
pub const IIS_CLASS_COMPRESS_SCHEME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsCompressionScheme");
pub const IIS_CLASS_COMPUTER: ::windows_strings::PCSTR = ::windows_strings::s!("IIsComputer");
pub const IIS_CLASS_COMPUTER_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsComputer");
pub const IIS_CLASS_FILTER: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFilter");
pub const IIS_CLASS_FILTERS: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFilters");
pub const IIS_CLASS_FILTERS_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFilters");
pub const IIS_CLASS_FILTER_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFilter");
pub const IIS_CLASS_FTP_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFtpInfo");
pub const IIS_CLASS_FTP_INFO_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFtpInfo");
pub const IIS_CLASS_FTP_SERVER: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFtpServer");
pub const IIS_CLASS_FTP_SERVER_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFtpServer");
pub const IIS_CLASS_FTP_SERVICE: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFtpService");
pub const IIS_CLASS_FTP_SERVICE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFtpService");
pub const IIS_CLASS_FTP_VDIR: ::windows_strings::PCSTR = ::windows_strings::s!("IIsFtpVirtualDir");
pub const IIS_CLASS_FTP_VDIR_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsFtpVirtualDir");
pub const IIS_CLASS_LOG_MODULE: ::windows_strings::PCSTR = ::windows_strings::s!("IIsLogModule");
pub const IIS_CLASS_LOG_MODULES: ::windows_strings::PCSTR = ::windows_strings::s!("IIsLogModules");
pub const IIS_CLASS_LOG_MODULES_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsLogModules");
pub const IIS_CLASS_LOG_MODULE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsLogModule");
pub const IIS_CLASS_MIMEMAP: ::windows_strings::PCSTR = ::windows_strings::s!("IIsMimeMap");
pub const IIS_CLASS_MIMEMAP_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsMimeMap");
pub const IIS_CLASS_WEB_DIR: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebDirectory");
pub const IIS_CLASS_WEB_DIR_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebDirectory");
pub const IIS_CLASS_WEB_FILE: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebFile");
pub const IIS_CLASS_WEB_FILE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebFile");
pub const IIS_CLASS_WEB_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebInfo");
pub const IIS_CLASS_WEB_INFO_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebInfo");
pub const IIS_CLASS_WEB_SERVER: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebServer");
pub const IIS_CLASS_WEB_SERVER_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebServer");
pub const IIS_CLASS_WEB_SERVICE: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebService");
pub const IIS_CLASS_WEB_SERVICE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebService");
pub const IIS_CLASS_WEB_VDIR: ::windows_strings::PCSTR = ::windows_strings::s!("IIsWebVirtualDir");
pub const IIS_CLASS_WEB_VDIR_W: ::windows_strings::PCWSTR = ::windows_strings::w!("IIsWebVirtualDir");
pub const IIS_MD_ADSI_METAID_BEGIN: u32 = 130000u32;
pub const IIS_MD_ADSI_SCHEMA_PATH_A: ::windows_strings::PCSTR = ::windows_strings::s!("/Schema");
pub const IIS_MD_ADSI_SCHEMA_PATH_W: ::windows_strings::PCWSTR = ::windows_strings::w!("/Schema");
...
pub const IIS_MD_INSTANCE_ROOT: ::windows_strings::PCSTR = ::windows_strings::s!("Root");
pub const IIS_MD_ISAPI_FILTERS: ::windows_strings::PCSTR = ::windows_strings::s!("/Filters");
pub const IIS_MD_LOCAL_MACHINE_PATH: ::windows_strings::PCSTR = ::windows_strings::s!("LM");
...
pub const IIS_MD_SVC_INFO_PATH: ::windows_strings::PCSTR = ::windows_strings::s!("Info");
...
pub const IIS_WEBSOCKET: ::windows_strings::PCWSTR = ::windows_strings::w!("websockets");
pub const IIS_WEBSOCKET_SERVER_VARIABLE: ::windows_strings::PCSTR = ::windows_strings::s!("IIS_WEBSOCK");
...
pub const MD_DEFAULT_BACKUP_LOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("MDBackUp");
...
pub const MD_INSERT_PATH_STRING: ::windows_strings::PCWSTR = ::windows_strings::w!("<%INSERT_PATH%>");
pub const MD_INSERT_PATH_STRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("<%INSERT_PATH%>");
...
pub const WEB_CORE_ACTIVATE_DLL_ENTRY: ::windows_strings::PCSTR = ::windows_strings::s!("WebCoreActivate");
pub const WEB_CORE_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("hwebcore.dll");
pub const WEB_CORE_SET_METADATA_DLL_ENTRY: ::windows_strings::PCSTR = ::windows_strings::s!("WebCoreSetMetadata");
pub const WEB_CORE_SHUTDOWN_DLL_ENTRY: ::windows_strings::PCSTR = ::windows_strings::s!("WebCoreShutdown");
#[repr(transparent)]
