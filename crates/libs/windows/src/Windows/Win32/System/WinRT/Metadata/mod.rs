...
pub const ASSEMBLY_METADATA_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Reflection.AssemblyMetadataAttribute");
pub const ASSEMBLY_METADATA_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Reflection.AssemblyMetadataAttribute");
...
pub const CMOD_CALLCONV_NAMESPACE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices");
pub const CMOD_CALLCONV_NAMESPACE_OLD: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices");
pub const CMOD_CALLCONV_NAME_CDECL: ::windows_strings::PCSTR = ::windows_strings::s!("CallConvCdecl");
pub const CMOD_CALLCONV_NAME_FASTCALL: ::windows_strings::PCSTR = ::windows_strings::s!("CallConvFastcall");
pub const CMOD_CALLCONV_NAME_STDCALL: ::windows_strings::PCSTR = ::windows_strings::s!("CallConvStdcall");
pub const CMOD_CALLCONV_NAME_THISCALL: ::windows_strings::PCSTR = ::windows_strings::s!("CallConvThiscall");
...
pub const COMPILATIONRELAXATIONS_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.CompilationRelaxationsAttribute");
pub const COMPILATIONRELAXATIONS_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.CompilationRelaxationsAttribute");
pub const COR_BASE_SECURITY_ATTRIBUTE_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Security.Permissions.SecurityAttribute");
pub const COR_BASE_SECURITY_ATTRIBUTE_CLASS_ANSI: ::windows_strings::PCSTR = ::windows_strings::s!("System.Security.Permissions.SecurityAttribute");
pub const COR_CCTOR_METHOD_NAME: ::windows_strings::PCSTR = ::windows_strings::s!(".cctor");
pub const COR_CCTOR_METHOD_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!(".cctor");
pub const COR_COMPILERSERVICE_DISCARDABLEATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DiscardableAttribute");
pub const COR_COMPILERSERVICE_DISCARDABLEATTRIBUTE_ASNI: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DiscardableAttribute");
pub const COR_CTOR_METHOD_NAME: ::windows_strings::PCSTR = ::windows_strings::s!(".ctor");
pub const COR_CTOR_METHOD_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!(".ctor");
pub const COR_DELETED_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("_Deleted");
pub const COR_DELETED_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("_Deleted");
pub const COR_ENUM_FIELD_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("value__");
pub const COR_ENUM_FIELD_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("value__");
...
pub const COR_NATIVE_LINK_CUSTOM_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("COMPLUS_NativeLink");
pub const COR_NATIVE_LINK_CUSTOM_VALUE_ANSI: ::windows_strings::PCSTR = ::windows_strings::s!("COMPLUS_NativeLink");
pub const COR_NATIVE_LINK_CUSTOM_VALUE_CC: u32 = 18u32;
pub const COR_REQUIRES_SECOBJ_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Security.DynamicSecurityMethodAttribute");
pub const COR_REQUIRES_SECOBJ_ATTRIBUTE_ANSI: ::windows_strings::PCSTR = ::windows_strings::s!("System.Security.DynamicSecurityMethodAttribute");
pub const COR_SUPPRESS_UNMANAGED_CODE_CHECK_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Security.SuppressUnmanagedCodeSecurityAttribute");
pub const COR_SUPPRESS_UNMANAGED_CODE_CHECK_ATTRIBUTE_ANSI: ::windows_strings::PCSTR = ::windows_strings::s!("System.Security.SuppressUnmanagedCodeSecurityAttribute");
pub const COR_UNVER_CODE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Security.UnverifiableCodeAttribute");
pub const COR_UNVER_CODE_ATTRIBUTE_ANSI: ::windows_strings::PCSTR = ::windows_strings::s!("System.Security.UnverifiableCodeAttribute");
pub const COR_VTABLEGAP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("_VtblGap");
pub const COR_VTABLEGAP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("_VtblGap");
...
pub const DEFAULTDEPENDENCY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DefaultDependencyAttribute");
pub const DEFAULTDEPENDENCY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DefaultDependencyAttribute");
pub const DEFAULTDOMAIN_LOADEROPTIMIZATION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.LoaderOptimizationAttribute");
pub const DEFAULTDOMAIN_LOADEROPTIMIZATION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.LoaderOptimizationAttribute");
pub const DEFAULTDOMAIN_MTA_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.MTAThreadAttribute");
pub const DEFAULTDOMAIN_MTA_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.MTAThreadAttribute");
pub const DEFAULTDOMAIN_STA_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.STAThreadAttribute");
pub const DEFAULTDOMAIN_STA_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.STAThreadAttribute");
pub const DEPENDENCY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DependencyAttribute");
pub const DEPENDENCY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DependencyAttribute");
pub const DESCR_GROUP_METHODDEF: i32 = 0i32;
pub const DESCR_GROUP_METHODIMPL: i32 = 1i32;
pub const DISABLED_PRIVATE_REFLECTION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DisablePrivateReflectionAttribute");
pub const DISABLED_PRIVATE_REFLECTION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DisablePrivateReflectionAttribute");
...
pub const FORWARD_INTEROP_STUB_METHOD_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ManagedToNativeComInteropStubAttribute");
pub const FORWARD_INTEROP_STUB_METHOD_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ManagedToNativeComInteropStubAttribute");
pub const FRAMEWORK_REGISTRY_KEY: ::windows_strings::PCSTR = ::windows_strings::s!("Software\\Microsoft\\.NETFramework");
pub const FRAMEWORK_REGISTRY_KEY_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\.NETFramework");
pub const FRIEND_ACCESS_ALLOWED_ATTRIBUTE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.FriendAccessAllowedAttribute");
pub const FRIEND_ACCESS_ALLOWED_ATTRIBUTE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.FriendAccessAllowedAttribute");
pub const FRIEND_ASSEMBLY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.InternalsVisibleToAttribute");
pub const FRIEND_ASSEMBLY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.InternalsVisibleToAttribute");
...
pub const INTEROP_AUTOPROXY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.AutomationProxyAttribute");
pub const INTEROP_AUTOPROXY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.AutomationProxyAttribute");
pub const INTEROP_BESTFITMAPPING_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.BestFitMappingAttribute");
pub const INTEROP_BESTFITMAPPING_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.BestFitMappingAttribute");
pub const INTEROP_CLASSINTERFACE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ClassInterfaceAttribute");
pub const INTEROP_CLASSINTERFACE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ClassInterfaceAttribute");
pub const INTEROP_COCLASS_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.CoClassAttribute");
pub const INTEROP_COCLASS_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.CoClassAttribute");
pub const INTEROP_COMALIASNAME_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComAliasNameAttribute");
pub const INTEROP_COMALIASNAME_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComAliasNameAttribute");
pub const INTEROP_COMCOMPATIBLEVERSION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComCompatibleVersionAttribute");
pub const INTEROP_COMCOMPATIBLEVERSION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComCompatibleVersionAttribute");
pub const INTEROP_COMCONVERSIONLOSS_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComConversionLossAttribute");
pub const INTEROP_COMCONVERSIONLOSS_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComConversionLossAttribute");
pub const INTEROP_COMDEFAULTINTERFACE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComDefaultInterfaceAttribute");
pub const INTEROP_COMDEFAULTINTERFACE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComDefaultInterfaceAttribute");
pub const INTEROP_COMEMULATE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComEmulateAttribute");
pub const INTEROP_COMEMULATE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComEmulateAttribute");
pub const INTEROP_COMEVENTINTERFACE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComEventInterfaceAttribute");
pub const INTEROP_COMEVENTINTERFACE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComEventInterfaceAttribute");
pub const INTEROP_COMIMPORT_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComImportAttribute");
pub const INTEROP_COMIMPORT_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComImportAttribute");
pub const INTEROP_COMREGISTERFUNCTION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComRegisterFunctionAttribute");
pub const INTEROP_COMREGISTERFUNCTION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComRegisterFunctionAttribute");
pub const INTEROP_COMSOURCEINTERFACES_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComSourceInterfacesAttribute");
pub const INTEROP_COMSOURCEINTERFACES_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComSourceInterfacesAttribute");
pub const INTEROP_COMSUBSTITUTABLEINTERFACE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComSubstitutableInterfaceAttribute");
pub const INTEROP_COMSUBSTITUTABLEINTERFACE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComSubstitutableInterfaceAttribute");
pub const INTEROP_COMUNREGISTERFUNCTION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComUnregisterFunctionAttribute");
pub const INTEROP_COMUNREGISTERFUNCTION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComUnregisterFunctionAttribute");
pub const INTEROP_COMVISIBLE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ComVisibleAttribute");
pub const INTEROP_COMVISIBLE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ComVisibleAttribute");
pub const INTEROP_DATETIMEVALUE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DateTimeConstantAttribute");
pub const INTEROP_DATETIMEVALUE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DateTimeConstantAttribute");
pub const INTEROP_DECIMALVALUE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.DecimalConstantAttribute");
pub const INTEROP_DECIMALVALUE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.DecimalConstantAttribute");
pub const INTEROP_DEFAULTMEMBER_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Reflection.DefaultMemberAttribute");
pub const INTEROP_DEFAULTMEMBER_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Reflection.DefaultMemberAttribute");
pub const INTEROP_DISPID_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.DispIdAttribute");
pub const INTEROP_DISPID_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.DispIdAttribute");
pub const INTEROP_GUID_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.GuidAttribute");
pub const INTEROP_GUID_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.GuidAttribute");
pub const INTEROP_IDISPATCHIMPL_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.IDispatchImplAttribute");
pub const INTEROP_IDISPATCHIMPL_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.IDispatchImplAttribute");
pub const INTEROP_IDISPATCHVALUE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.IDispatchConstantAttribute");
pub const INTEROP_IDISPATCHVALUE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.IDispatchConstantAttribute");
pub const INTEROP_IMPORTEDFROMTYPELIB_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.ImportedFromTypeLibAttribute");
pub const INTEROP_IMPORTEDFROMTYPELIB_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.ImportedFromTypeLibAttribute");
pub const INTEROP_INTERFACETYPE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.InterfaceTypeAttribute");
pub const INTEROP_INTERFACETYPE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.InterfaceTypeAttribute");
pub const INTEROP_IN_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.InAttribute");
pub const INTEROP_IN_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.InAttribute");
pub const INTEROP_IUNKNOWNVALUE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.IUnknownConstantAttribute");
pub const INTEROP_IUNKNOWNVALUE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.IUnknownConstantAttribute");
pub const INTEROP_LCIDCONVERSION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.LCIDConversionAttribute");
pub const INTEROP_LCIDCONVERSION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.LCIDConversionAttribute");
pub const INTEROP_MARSHALAS_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.MarshalAsAttribute");
pub const INTEROP_MARSHALAS_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.MarshalAsAttribute");
pub const INTEROP_OUT_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.OutAttribute");
pub const INTEROP_OUT_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.OutAttribute");
pub const INTEROP_PARAMARRAY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.ParamArrayAttribute");
pub const INTEROP_PARAMARRAY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.ParamArrayAttribute");
pub const INTEROP_PRESERVESIG_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.PreserveSigAttribure");
pub const INTEROP_PRESERVESIG_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.PreserveSigAttribure");
pub const INTEROP_PRIMARYINTEROPASSEMBLY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.PrimaryInteropAssemblyAttribute");
pub const INTEROP_PRIMARYINTEROPASSEMBLY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.PrimaryInteropAssemblyAttribute");
pub const INTEROP_SERIALIZABLE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.SerializableAttribute");
pub const INTEROP_SERIALIZABLE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.SerializableAttribute");
pub const INTEROP_SETWIN32CONTEXTINIDISPATCHATTRIBUTE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.SetWin32ContextInIDispatchAttribute");
pub const INTEROP_SETWIN32CONTEXTINIDISPATCHATTRIBUTE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.SetWin32ContextInIDispatchAttribute");
pub const INTEROP_TYPELIBFUNC_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.TypeLibFuncAttribute");
pub const INTEROP_TYPELIBFUNC_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.TypeLibFuncAttribute");
pub const INTEROP_TYPELIBIMPORTCLASS_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.TypeLibImportClassAttribute");
pub const INTEROP_TYPELIBIMPORTCLASS_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.TypeLibImportClassAttribute");
pub const INTEROP_TYPELIBTYPE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.TypeLibTypeAttribute");
pub const INTEROP_TYPELIBTYPE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.TypeLibTypeAttribute");
pub const INTEROP_TYPELIBVAR_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.TypeLibVarAttribute");
pub const INTEROP_TYPELIBVAR_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.TypeLibVarAttribute");
pub const INTEROP_TYPELIBVERSION_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.InteropServices.TypeLibVersionAttribute");
pub const INTEROP_TYPELIBVERSION_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.InteropServices.TypeLibVersionAttribute");
...
pub const MAIN_CLR_MODULE_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("coreclr");
pub const MAIN_CLR_MODULE_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("coreclr");
...
pub const MSCOREE_SHIM_A: ::windows_strings::PCSTR = ::windows_strings::s!("mscoree.dll");
pub const MSCOREE_SHIM_W: ::windows_strings::PCWSTR = ::windows_strings::w!("mscoree.dll");
...
pub const NONVERSIONABLE_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.Versioning.NonVersionableAttribute");
pub const NONVERSIONABLE_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.Versioning.NonVersionableAttribute");
pub const NoDupCheck: MergeFlags = MergeFlags(4i32);
pub const RUNTIMECOMPATIBILITY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.RuntimeCompatibilityAttribute");
pub const RUNTIMECOMPATIBILITY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.RuntimeCompatibilityAttribute");
...
pub const SUBJECT_ASSEMBLY_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.CompilerServices.IgnoresAccessChecksToAttribute");
pub const SUBJECT_ASSEMBLY_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.CompilerServices.IgnoresAccessChecksToAttribute");
pub const TARGET_FRAMEWORK_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("System.Runtime.Versioning.TargetFrameworkAttribute");
pub const TARGET_FRAMEWORK_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("System.Runtime.Versioning.TargetFrameworkAttribute");
pub const USER_FRAMEWORK_REGISTRY_KEY: ::windows_strings::PCSTR = ::windows_strings::s!("Software\\Microsoft\\.NETFramework64");
pub const USER_FRAMEWORK_REGISTRY_KEY_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\.NETFramework64");
