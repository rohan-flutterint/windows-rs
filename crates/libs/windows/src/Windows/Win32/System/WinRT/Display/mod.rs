...
impl IDisplayDeviceInterop {
        ...
        P0: ::windows_core::IntoParam<::windows_core::IInspectable>,
    {
        ...
        ::windows_core::vcall!(self.CreateSharedHandle(pobject.into_param().abi(), psecurityattributes, access, ::core::mem::transmute_copy(name), &mut result__)).from_abi(result__)
    }
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.OpenSharedHandle(nthandle.into_param().abi(), ::core::mem::transmute(riid), &mut result__)).from_abi(result__)
    }
}
...
impl IDisplayPathInterop {
    ...
    pub unsafe fn CreateSourcePresentationHandle(&self) -> ::windows_core::Result<super::super::super::Foundation::HANDLE> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateSourcePresentationHandle(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetSourceId(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetSourceId(&mut result__)).from_abi(result__)
    }
}
