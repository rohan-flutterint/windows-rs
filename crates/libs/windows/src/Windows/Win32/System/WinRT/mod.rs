...
pub const CastingSourceInfo_Property_CastingTypes: ::windows_strings::PCWSTR = ::windows_strings::w!("CastingTypes");
pub const CastingSourceInfo_Property_PreferredSourceUriScheme: ::windows_strings::PCWSTR = ::windows_strings::w!("PreferredSourceUriScheme");
pub const CastingSourceInfo_Property_ProtectedMedia: ::windows_strings::PCWSTR = ::windows_strings::w!("ProtectedMedia");
