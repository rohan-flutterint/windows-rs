...
pub const WTS_CURRENT_SERVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("");
...
pub const WTS_PROPERTY_DEFAULT_CONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultConfig");
