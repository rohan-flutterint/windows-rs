...
pub const GP_DLLNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DllName");
pub const GP_ENABLEASYNCHRONOUSPROCESSING: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableAsynchronousProcessing");
pub const GP_MAXNOGPOLISTCHANGESINTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxNoGPOListChangesInterval");
pub const GP_NOBACKGROUNDPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("NoBackgroundPolicy");
pub const GP_NOGPOLISTCHANGES: ::windows_strings::PCWSTR = ::windows_strings::w!("NoGPOListChanges");
pub const GP_NOMACHINEPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("NoMachinePolicy");
pub const GP_NOSLOWLINK: ::windows_strings::PCWSTR = ::windows_strings::w!("NoSlowLink");
pub const GP_NOTIFYLINKTRANSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("NotifyLinkTransition");
pub const GP_NOUSERPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("NoUserPolicy");
pub const GP_PERUSERLOCALSETTINGS: ::windows_strings::PCWSTR = ::windows_strings::w!("PerUserLocalSettings");
pub const GP_PROCESSGROUPPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("ProcessGroupPolicy");
pub const GP_REQUIRESSUCCESSFULREGISTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("RequiresSuccessfulRegistry");
