...
pub const MI_SUBSCRIBE_BOOKMARK_NEWEST: ::windows_strings::PCWSTR = ::windows_strings::w!("MI_SUBSCRIBE_BOOKMARK_NEWEST");
pub const MI_SUBSCRIBE_BOOKMARK_OLDEST: ::windows_strings::PCWSTR = ::windows_strings::w!("MI_SUBSCRIBE_BOOKMARK_OLDEST");
