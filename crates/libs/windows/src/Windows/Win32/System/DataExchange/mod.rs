...
pub const SZDDESYS_ITEM_FORMATS: ::windows_strings::PCWSTR = ::windows_strings::w!("Formats");
pub const SZDDESYS_ITEM_HELP: ::windows_strings::PCWSTR = ::windows_strings::w!("Help");
pub const SZDDESYS_ITEM_RTNMSG: ::windows_strings::PCWSTR = ::windows_strings::w!("ReturnMessage");
pub const SZDDESYS_ITEM_STATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("Status");
pub const SZDDESYS_ITEM_SYSITEMS: ::windows_strings::PCWSTR = ::windows_strings::w!("SysItems");
pub const SZDDESYS_ITEM_TOPICS: ::windows_strings::PCWSTR = ::windows_strings::w!("Topics");
pub const SZDDESYS_TOPIC: ::windows_strings::PCWSTR = ::windows_strings::w!("System");
pub const SZDDE_ITEM_ITEMLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("TopicItemList");
