...
impl IWSMan {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateSession(connection.into_param().abi(), flags, connectionoptions.into_param().abi(), &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_System_Com\"`"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateConnectionOptions(&self) -> ::windows_core::Result<super::Com::IDispatch> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateConnectionOptions(&mut result__)).from_abi(result__)
    }
    pub unsafe fn CommandLine(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CommandLine(&mut result__)).from_abi(result__)
    }
...
impl IWSManConnectionOptions {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetUserName(name.into_param().abi())).ok()
    }
    pub unsafe fn SetPassword<P0>(&self, password: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetPassword(password.into_param().abi())).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManConnectionOptionsEx {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.base__.SetUserName(name.into_param().abi())).ok()
    }
    pub unsafe fn SetPassword<P0>(&self, password: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.base__.SetPassword(password.into_param().abi())).ok()
    }
    pub unsafe fn CertificateThumbprint(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CertificateThumbprint(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetCertificateThumbprint<P0>(&self, thumbprint: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetCertificateThumbprint(thumbprint.into_param().abi())).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManConnectionOptionsEx2 {
    pub unsafe fn UserName(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.UserName(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetUserName<P0>(&self, name: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.base__.base__.SetUserName(name.into_param().abi())).ok()
    }
    pub unsafe fn SetPassword<P0>(&self, password: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.base__.base__.SetPassword(password.into_param().abi())).ok()
    }
    pub unsafe fn CertificateThumbprint(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.CertificateThumbprint(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetCertificateThumbprint<P0>(&self, thumbprint: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.base__.SetCertificateThumbprint(thumbprint.into_param().abi())).ok()
    }
    ...
    {
        ::windows_core::vcall!(self.SetProxy(accesstype, authenticationmechanism, username.into_param().abi(), password.into_param().abi())).ok()
    }
    pub unsafe fn ProxyIEConfig(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyIEConfig(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyWinHttpConfig(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyWinHttpConfig(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyAutoDetect(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyAutoDetect(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyNoProxyServer(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyNoProxyServer(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyAuthenticationUseNegotiate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyAuthenticationUseNegotiate(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyAuthenticationUseBasic(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyAuthenticationUseBasic(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ProxyAuthenticationUseDigest(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ProxyAuthenticationUseDigest(&mut result__)).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManEnumerator {
    pub unsafe fn ReadItem(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ReadItem(&mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn AtEndOfStream(&self) -> ::windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.AtEndOfStream(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Error(&mut result__)).from_abi(result__)
...
impl IWSManEx {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.CreateSession(connection.into_param().abi(), flags, connectionoptions.into_param().abi(), &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_System_Com\"`"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateConnectionOptions(&self) -> ::windows_core::Result<super::Com::IDispatch> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.CreateConnectionOptions(&mut result__)).from_abi(result__)
    }
    pub unsafe fn CommandLine(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.CommandLine(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.CreateResourceLocator(strresourcelocator.into_param().abi(), &mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUTF8(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUTF8(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagCredUsernamePassword(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagCredUsernamePassword(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCACheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagSkipCACheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCNCheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagSkipCNCheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseDigest(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseDigest(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNegotiate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseNegotiate(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseBasic(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseBasic(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseKerberos(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseKerberos(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagNoEncryption(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagNoEncryption(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagEnableSPNServerPort(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagEnableSPNServerPort(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNoAuthentication(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseNoAuthentication(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagNonXmlText(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagNonXmlText(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagReturnEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObjectAndEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagReturnObjectAndEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetErrorMessage(&self, errornumber: u32) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.GetErrorMessage(errornumber, &mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeep(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagHierarchyDeep(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyShallow(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagHierarchyShallow(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeepBasePropsOnly(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagHierarchyDeepBasePropsOnly(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObject(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagReturnObject(&mut result__)).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManEx2 {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.CreateSession(connection.into_param().abi(), flags, connectionoptions.into_param().abi(), &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_System_Com\"`"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateConnectionOptions(&self) -> ::windows_core::Result<super::Com::IDispatch> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.CreateConnectionOptions(&mut result__)).from_abi(result__)
    }
    pub unsafe fn CommandLine(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.CommandLine(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.CreateResourceLocator(strresourcelocator.into_param().abi(), &mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUTF8(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUTF8(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagCredUsernamePassword(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagCredUsernamePassword(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCACheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagSkipCACheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCNCheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagSkipCNCheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseDigest(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseDigest(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNegotiate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseNegotiate(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseBasic(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseBasic(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseKerberos(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseKerberos(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagNoEncryption(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagNoEncryption(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagEnableSPNServerPort(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagEnableSPNServerPort(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNoAuthentication(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseNoAuthentication(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagNonXmlText(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagNonXmlText(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagReturnEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObjectAndEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagReturnObjectAndEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetErrorMessage(&self, errornumber: u32) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.GetErrorMessage(errornumber, &mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeep(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagHierarchyDeep(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyShallow(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagHierarchyShallow(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeepBasePropsOnly(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagHierarchyDeepBasePropsOnly(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObject(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.EnumerationFlagReturnObject(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseClientCertificate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseClientCertificate(&mut result__)).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManEx3 {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.base__.CreateSession(connection.into_param().abi(), flags, connectionoptions.into_param().abi(), &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_System_Com\"`"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateConnectionOptions(&self) -> ::windows_core::Result<super::Com::IDispatch> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.base__.CreateConnectionOptions(&mut result__)).from_abi(result__)
    }
    pub unsafe fn CommandLine(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.base__.CommandLine(&mut result__)).from_abi(result__)
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.CreateResourceLocator(strresourcelocator.into_param().abi(), &mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUTF8(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUTF8(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagCredUsernamePassword(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagCredUsernamePassword(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCACheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagSkipCACheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipCNCheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagSkipCNCheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseDigest(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUseDigest(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNegotiate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUseNegotiate(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseBasic(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUseBasic(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseKerberos(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUseKerberos(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagNoEncryption(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagNoEncryption(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagEnableSPNServerPort(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagEnableSPNServerPort(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseNoAuthentication(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.SessionFlagUseNoAuthentication(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagNonXmlText(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagNonXmlText(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagReturnEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObjectAndEPR(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagReturnObjectAndEPR(&mut result__)).from_abi(result__)
    }
    pub unsafe fn GetErrorMessage(&self, errornumber: u32) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.GetErrorMessage(errornumber, &mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeep(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagHierarchyDeep(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyShallow(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagHierarchyShallow(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagHierarchyDeepBasePropsOnly(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagHierarchyDeepBasePropsOnly(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagReturnObject(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.base__.EnumerationFlagReturnObject(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseClientCertificate(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.base__.SessionFlagUseClientCertificate(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUTF16(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUTF16(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseCredSsp(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseCredSsp(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagAssociationInstance(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagAssociationInstance(&mut result__)).from_abi(result__)
    }
    pub unsafe fn EnumerationFlagAssociatedInstance(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.EnumerationFlagAssociatedInstance(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagSkipRevocationCheck(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagSkipRevocationCheck(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagAllowNegotiateImplicitCredentials(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagAllowNegotiateImplicitCredentials(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SessionFlagUseSsl(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.SessionFlagUseSsl(&mut result__)).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManInternal {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ConfigSDDL(session.into_param().abi(), ::core::mem::transmute(resourceuri), flags, &mut result__)).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWSManResourceLocator {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetResourceURI(uri.into_param().abi())).ok()
    }
    pub unsafe fn ResourceURI(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.ResourceURI(&mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.AddSelector(resourceselname.into_param().abi(), ::core::mem::transmute(selvalue))).ok()
    }
    pub unsafe fn ClearSelectors(&self) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.ClearSelectors()).ok()
    }
    pub unsafe fn FragmentPath(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.FragmentPath(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetFragmentPath<P0>(&self, text: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetFragmentPath(text.into_param().abi())).ok()
    }
    pub unsafe fn FragmentDialect(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.FragmentDialect(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetFragmentDialect<P0>(&self, text: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        ::windows_core::vcall!(self.SetFragmentDialect(text.into_param().abi())).ok()
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    where
        ...
        P1: ::windows_core::IntoParam<super::super::Foundation::BOOL>,
    {
        ::windows_core::vcall!(self.AddOption(optionname.into_param().abi(), ::core::mem::transmute(optionvalue), mustcomply.into_param().abi())).ok()
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    {
        ::windows_core::vcall!(self.SetMustUnderstandOptions(mustunderstand.into_param().abi())).ok()
    }
    #[doc = "Required features: `\"Win32_Foundation\"`"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn MustUnderstandOptions(&self) -> ::windows_core::Result<super::super::Foundation::BOOL> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.MustUnderstandOptions(&mut result__)).from_abi(result__)
    }
    pub unsafe fn ClearOptions(&self) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.ClearOptions()).ok()
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Error(&mut result__)).from_abi(result__)
...
impl IWSManSession {
    ...
    pub unsafe fn Get(&self, resourceuri: super::Variant::VARIANT, flags: i32) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Get(::core::mem::transmute(resourceuri), flags, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Put(::core::mem::transmute(resourceuri), resource.into_param().abi(), flags, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Create(::core::mem::transmute(resourceuri), resource.into_param().abi(), flags, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn Delete(&self, resourceuri: super::Variant::VARIANT, flags: i32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.Delete(::core::mem::transmute(resourceuri), flags)).ok()
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Invoke2(actionuri.into_param().abi(), ::core::mem::transmute(resourceuri), parameters.into_param().abi(), flags, &mut result__)).from_abi(result__)
    }
    #[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`, `\"Win32_System_Variant\"`"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Enumerate(::core::mem::transmute(resourceuri), filter.into_param().abi(), dialect.into_param().abi(), flags, &mut result__)).from_abi(result__)
    }
    pub unsafe fn Identify(&self, flags: i32) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Identify(flags, &mut result__)).from_abi(result__)
    }
    pub unsafe fn Error(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.Error(&mut result__)).from_abi(result__)
    ...
    pub unsafe fn BatchItems(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::std::mem::zeroed();
        ::windows_core::vcall!(self.BatchItems(&mut result__)).from_abi(result__)
    }
    pub unsafe fn SetBatchItems(&self, value: i32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.SetBatchItems(value)).ok()
    }
    ...
    pub unsafe fn SetTimeout(&self, value: i32) -> ::windows_core::Result<()> {
        ::windows_core::vcall!(self.SetTimeout(value)).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
