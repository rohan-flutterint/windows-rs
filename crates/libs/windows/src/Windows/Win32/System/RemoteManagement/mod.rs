...
pub const WSMAN_CMDSHELL_OPTION_CODEPAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("WINRS_CODEPAGE");
pub const WSMAN_CMDSHELL_OPTION_CONSOLEMODE_STDIN: ::windows_strings::PCWSTR = ::windows_strings::w!("WINRS_CONSOLEMODE_STDIN");
pub const WSMAN_CMDSHELL_OPTION_SKIP_CMD_SHELL: ::windows_strings::PCWSTR = ::windows_strings::w!("WINRS_SKIP_CMD_SHELL");
