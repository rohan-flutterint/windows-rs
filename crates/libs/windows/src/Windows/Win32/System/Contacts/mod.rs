...
pub const CONTACTLABEL_PUB_AGENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Agent");
pub const CONTACTLABEL_PUB_BBS: ::windows_strings::PCWSTR = ::windows_strings::w!("BBS");
pub const CONTACTLABEL_PUB_BUSINESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Business");
pub const CONTACTLABEL_PUB_CAR: ::windows_strings::PCWSTR = ::windows_strings::w!("Car");
pub const CONTACTLABEL_PUB_CELLULAR: ::windows_strings::PCWSTR = ::windows_strings::w!("Cellular");
pub const CONTACTLABEL_PUB_DOMESTIC: ::windows_strings::PCWSTR = ::windows_strings::w!("Domestic");
pub const CONTACTLABEL_PUB_FAX: ::windows_strings::PCWSTR = ::windows_strings::w!("Fax");
pub const CONTACTLABEL_PUB_INTERNATIONAL: ::windows_strings::PCWSTR = ::windows_strings::w!("International");
pub const CONTACTLABEL_PUB_ISDN: ::windows_strings::PCWSTR = ::windows_strings::w!("ISDN");
pub const CONTACTLABEL_PUB_LOGO: ::windows_strings::PCWSTR = ::windows_strings::w!("Logo");
pub const CONTACTLABEL_PUB_MOBILE: ::windows_strings::PCWSTR = ::windows_strings::w!("Mobile");
pub const CONTACTLABEL_PUB_MODEM: ::windows_strings::PCWSTR = ::windows_strings::w!("Modem");
pub const CONTACTLABEL_PUB_OTHER: ::windows_strings::PCWSTR = ::windows_strings::w!("Other");
pub const CONTACTLABEL_PUB_PAGER: ::windows_strings::PCWSTR = ::windows_strings::w!("Pager");
pub const CONTACTLABEL_PUB_PARCEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Parcel");
pub const CONTACTLABEL_PUB_PCS: ::windows_strings::PCWSTR = ::windows_strings::w!("PCS");
pub const CONTACTLABEL_PUB_PERSONAL: ::windows_strings::PCWSTR = ::windows_strings::w!("Personal");
pub const CONTACTLABEL_PUB_POSTAL: ::windows_strings::PCWSTR = ::windows_strings::w!("Postal");
pub const CONTACTLABEL_PUB_PREFERRED: ::windows_strings::PCWSTR = ::windows_strings::w!("Preferred");
pub const CONTACTLABEL_PUB_TTY: ::windows_strings::PCWSTR = ::windows_strings::w!("TTY");
pub const CONTACTLABEL_PUB_USERTILE: ::windows_strings::PCWSTR = ::windows_strings::w!("UserTile");
pub const CONTACTLABEL_PUB_VIDEO: ::windows_strings::PCWSTR = ::windows_strings::w!("Video");
pub const CONTACTLABEL_PUB_VOICE: ::windows_strings::PCWSTR = ::windows_strings::w!("Voice");
pub const CONTACTLABEL_WAB_ANNIVERSARY: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Anniversary");
pub const CONTACTLABEL_WAB_ASSISTANT: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Assistant");
pub const CONTACTLABEL_WAB_BIRTHDAY: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Birthday");
pub const CONTACTLABEL_WAB_CHILD: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Child");
pub const CONTACTLABEL_WAB_MANAGER: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Manager");
pub const CONTACTLABEL_WAB_SCHOOL: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:School");
pub const CONTACTLABEL_WAB_SOCIALNETWORK: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:SocialNetwork");
pub const CONTACTLABEL_WAB_SPOUSE: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:Spouse");
pub const CONTACTLABEL_WAB_WISHLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("wab:WishList");
pub const CONTACTPROP_PUB_CREATIONDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CreationDate");
pub const CONTACTPROP_PUB_GENDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Gender");
pub const CONTACTPROP_PUB_GENDER_FEMALE: ::windows_strings::PCWSTR = ::windows_strings::w!("Female");
pub const CONTACTPROP_PUB_GENDER_MALE: ::windows_strings::PCWSTR = ::windows_strings::w!("Male");
pub const CONTACTPROP_PUB_GENDER_UNSPECIFIED: ::windows_strings::PCWSTR = ::windows_strings::w!("Unspecified");
pub const CONTACTPROP_PUB_L1_CERTIFICATECOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateCollection");
pub const CONTACTPROP_PUB_L1_CONTACTIDCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("ContactIDCollection");
pub const CONTACTPROP_PUB_L1_DATECOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DateCollection");
pub const CONTACTPROP_PUB_L1_EMAILADDRESSCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("EmailAddressCollection");
pub const CONTACTPROP_PUB_L1_IMADDRESSCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("IMAddressCollection");
pub const CONTACTPROP_PUB_L1_NAMECOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("NameCollection");
pub const CONTACTPROP_PUB_L1_PERSONCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonCollection");
pub const CONTACTPROP_PUB_L1_PHONENUMBERCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("PhoneNumberCollection");
pub const CONTACTPROP_PUB_L1_PHOTOCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("PhotoCollection");
pub const CONTACTPROP_PUB_L1_PHYSICALADDRESSCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("PhysicalAddressCollection");
pub const CONTACTPROP_PUB_L1_POSITIONCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("PositionCollection");
pub const CONTACTPROP_PUB_L1_URLCOLLECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("UrlCollection");
pub const CONTACTPROP_PUB_L2_CERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Certificate");
pub const CONTACTPROP_PUB_L2_CONTACTID: ::windows_strings::PCWSTR = ::windows_strings::w!("/ContactID");
pub const CONTACTPROP_PUB_L2_DATE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Date");
pub const CONTACTPROP_PUB_L2_EMAILADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("/EmailAddress");
pub const CONTACTPROP_PUB_L2_IMADDRESSENTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("/IMAddress");
pub const CONTACTPROP_PUB_L2_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/Name");
pub const CONTACTPROP_PUB_L2_PERSON: ::windows_strings::PCWSTR = ::windows_strings::w!("/Person");
pub const CONTACTPROP_PUB_L2_PHONENUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("/PhoneNumber");
pub const CONTACTPROP_PUB_L2_PHOTO: ::windows_strings::PCWSTR = ::windows_strings::w!("/Photo");
pub const CONTACTPROP_PUB_L2_PHYSICALADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("/PhysicalAddress");
pub const CONTACTPROP_PUB_L2_POSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("/Position");
pub const CONTACTPROP_PUB_L2_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("/Url");
pub const CONTACTPROP_PUB_L3_ADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("/Address");
pub const CONTACTPROP_PUB_L3_ADDRESSLABEL: ::windows_strings::PCWSTR = ::windows_strings::w!("/AddressLabel");
pub const CONTACTPROP_PUB_L3_ALTERNATE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Alternate");
pub const CONTACTPROP_PUB_L3_COMPANY: ::windows_strings::PCWSTR = ::windows_strings::w!("/Company");
pub const CONTACTPROP_PUB_L3_COUNTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("/Country");
pub const CONTACTPROP_PUB_L3_DEPARTMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("/Department");
pub const CONTACTPROP_PUB_L3_EXTENDEDADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("/ExtendedAddress");
pub const CONTACTPROP_PUB_L3_FAMILYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/FamilyName");
pub const CONTACTPROP_PUB_L3_FORMATTEDNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/FormattedName");
pub const CONTACTPROP_PUB_L3_GENERATION: ::windows_strings::PCWSTR = ::windows_strings::w!("/Generation");
pub const CONTACTPROP_PUB_L3_GIVENNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/GivenName");
pub const CONTACTPROP_PUB_L3_JOB_TITLE: ::windows_strings::PCWSTR = ::windows_strings::w!("/JobTitle");
pub const CONTACTPROP_PUB_L3_LOCALITY: ::windows_strings::PCWSTR = ::windows_strings::w!("/Locality");
pub const CONTACTPROP_PUB_L3_MIDDLENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/MiddleName");
pub const CONTACTPROP_PUB_L3_NICKNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("/NickName");
pub const CONTACTPROP_PUB_L3_NUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("/Number");
pub const CONTACTPROP_PUB_L3_OFFICE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Office");
pub const CONTACTPROP_PUB_L3_ORGANIZATION: ::windows_strings::PCWSTR = ::windows_strings::w!("/Organization");
pub const CONTACTPROP_PUB_L3_PERSONID: ::windows_strings::PCWSTR = ::windows_strings::w!("/PersonID");
pub const CONTACTPROP_PUB_L3_PHONETIC: ::windows_strings::PCWSTR = ::windows_strings::w!("/Phonetic");
pub const CONTACTPROP_PUB_L3_POBOX: ::windows_strings::PCWSTR = ::windows_strings::w!("/POBox");
pub const CONTACTPROP_PUB_L3_POSTALCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("/PostalCode");
pub const CONTACTPROP_PUB_L3_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("/Prefix");
pub const CONTACTPROP_PUB_L3_PROFESSION: ::windows_strings::PCWSTR = ::windows_strings::w!("/Profession");
pub const CONTACTPROP_PUB_L3_PROTOCOL: ::windows_strings::PCWSTR = ::windows_strings::w!("/Protocol");
pub const CONTACTPROP_PUB_L3_REGION: ::windows_strings::PCWSTR = ::windows_strings::w!("/Region");
pub const CONTACTPROP_PUB_L3_ROLE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Role");
pub const CONTACTPROP_PUB_L3_STREET: ::windows_strings::PCWSTR = ::windows_strings::w!("/Street");
pub const CONTACTPROP_PUB_L3_SUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("/Suffix");
pub const CONTACTPROP_PUB_L3_THUMBPRINT: ::windows_strings::PCWSTR = ::windows_strings::w!("/ThumbPrint");
pub const CONTACTPROP_PUB_L3_TITLE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Title");
pub const CONTACTPROP_PUB_L3_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Type");
pub const CONTACTPROP_PUB_L3_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("/Url");
pub const CONTACTPROP_PUB_L3_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("/Value");
pub const CONTACTPROP_PUB_MAILER: ::windows_strings::PCWSTR = ::windows_strings::w!("Mailer");
pub const CONTACTPROP_PUB_NOTES: ::windows_strings::PCWSTR = ::windows_strings::w!("Notes");
pub const CONTACTPROP_PUB_PROGID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgID");
