...
pub const OLESTDDELIM: ::windows_strings::PCWSTR = ::windows_strings::w!("\\");
...
pub const PROP_HWND_CHGICONDLG: ::windows_strings::PCWSTR = ::windows_strings::w!("HWND_CIDLG");
...
pub const STDOLE_TLB: ::windows_strings::PCSTR = ::windows_strings::s!("stdole2.tlb");
pub const STDTYPE_TLB: ::windows_strings::PCSTR = ::windows_strings::s!("stdole2.tlb");
pub const SZOLEUI_MSG_ADDCONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_ADDCONTROL");
pub const SZOLEUI_MSG_BROWSE: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_BROWSE");
pub const SZOLEUI_MSG_BROWSE_OFN: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_BROWSE_OFN");
pub const SZOLEUI_MSG_CHANGEICON: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_CHANGEICON");
pub const SZOLEUI_MSG_CHANGESOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_CHANGESOURCE");
pub const SZOLEUI_MSG_CLOSEBUSYDIALOG: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_CLOSEBUSYDIALOG");
pub const SZOLEUI_MSG_CONVERT: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_CONVERT");
pub const SZOLEUI_MSG_ENDDIALOG: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_ENDDIALOG");
pub const SZOLEUI_MSG_HELP: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEUI_MSG_HELP");
