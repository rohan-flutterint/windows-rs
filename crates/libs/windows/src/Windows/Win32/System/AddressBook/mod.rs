...
pub const OPENSTREAMONFILE: ::windows_strings::PCSTR = ::windows_strings::s!("OpenStreamOnFile");
...
pub const WAB_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WAB32.DLL");
pub const WAB_DLL_PATH_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\WAB\\DLLPath");
...
pub const szHrDispatchNotifications: ::windows_strings::PCSTR = ::windows_strings::s!("HrDispatchNotifications");
pub const szMAPINotificationMsg: ::windows_strings::PCSTR = ::windows_strings::s!("MAPI Notify window message");
pub const szScCreateConversationIndex: ::windows_strings::PCSTR = ::windows_strings::s!("ScCreateConversationIndex");
#[repr(transparent)]
