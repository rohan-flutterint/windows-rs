...
pub const STORAGE_CRASH_TELEMETRY_REGKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Registry\\Machine\\System\\CurrentControlSet\\Control\\CrashControl\\StorageTelemetry");
...
pub const STORAGE_DEVICE_TELEMETRY_REGKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Registry\\Machine\\System\\CurrentControlSet\\Control\\Storage\\StorageTelemetry");
...
pub const TC_PUBLIC_DATA_TYPE_ATAGP: ::windows_strings::PCSTR = ::windows_strings::s!("ATAGPLogPages");
pub const TC_PUBLIC_DATA_TYPE_ATASMART: ::windows_strings::PCSTR = ::windows_strings::s!("ATASMARTPages");
