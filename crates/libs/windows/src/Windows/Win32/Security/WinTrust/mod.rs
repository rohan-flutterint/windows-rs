...
pub const CAT_MEMBERINFO2_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.12.2.3");
pub const CAT_MEMBERINFO2_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2223i32 as _);
pub const CAT_MEMBERINFO_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.12.2.2");
pub const CAT_MEMBERINFO_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2222i32 as _);
pub const CAT_NAMEVALUE_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.12.2.1");
...
pub const DRIVER_CLEANUPPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverCleanupPolicy");
pub const DRIVER_FINALPOLPROV_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverFinalPolicy");
pub const DRIVER_INITPROV_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverInitializePolicy");
...
pub const GENERIC_CHAIN_CERTTRUST_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("GenericChainCertificateTrust");
pub const GENERIC_CHAIN_FINALPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("GenericChainFinalProv");
pub const HTTPSPROV_ACTION: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x573e31f8_aaba_11d0_8ccb_00c04fc295ee);
pub const HTTPS_CERTTRUST_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("HTTPSCertificateTrust");
pub const HTTPS_CHKCERT_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("HTTPSCheckCertProv");
pub const HTTPS_FINALPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("HTTPSFinalProv");
...
pub const OFFICE_CLEANUPPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("OfficeCleanupPolicy");
pub const OFFICE_INITPROV_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("OfficeInitializePolicy");
pub const OFFICE_POLICY_PROVIDER_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WINTRUST.DLL");
...
pub const SPC_CAB_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.25");
pub const SPC_CAB_DATA_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2008i32 as _);
pub const SPC_CERT_EXTENSIONS_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.14");
pub const SPC_COMMERCIAL_SP_KEY_PURPOSE_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.22");
pub const SPC_COMMON_NAME_OBJID: ::windows_strings::PCWSTR = ::windows_strings::w!("2.5.4.3");
pub const SPC_ENCRYPTED_DIGEST_RETRY_COUNT_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.6.2");
pub const SPC_FILE_LINK_CHOICE: u32 = 3u32;
pub const SPC_FINANCIAL_CRITERIA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.27");
pub const SPC_FINANCIAL_CRITERIA_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2002i32 as _);
pub const SPC_GLUE_RDN_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.25");
pub const SPC_INDIRECT_DATA_CONTENT_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2003i32 as _);
pub const SPC_INDIRECT_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.4");
pub const SPC_INDIVIDUAL_SP_KEY_PURPOSE_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.21");
pub const SPC_JAVA_CLASS_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.20");
pub const SPC_JAVA_CLASS_DATA_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2009i32 as _);
pub const SPC_LINK_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.28");
pub const SPC_LINK_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2005i32 as _);
pub const SPC_MINIMAL_CRITERIA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.26");
...
pub const SPC_NATURAL_AUTH_PLUGIN_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.96.1.1");
pub const SPC_PE_IMAGE_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.15");
pub const SPC_PE_IMAGE_DATA_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2004i32 as _);
pub const SPC_PE_IMAGE_PAGE_HASHES_V1_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.3.1");
pub const SPC_PE_IMAGE_PAGE_HASHES_V2_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.3.2");
pub const SPC_RAW_FILE_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.18");
pub const SPC_RELAXED_PE_MARKER_CHECK_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.6.1");
pub const SPC_SIGINFO_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.30");
pub const SPC_SIGINFO_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2130i32 as _);
pub const SPC_SP_AGENCY_INFO_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.10");
pub const SPC_SP_AGENCY_INFO_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2000i32 as _);
pub const SPC_SP_OPUS_INFO_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.12");
pub const SPC_SP_OPUS_INFO_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2007i32 as _);
pub const SPC_STATEMENT_TYPE_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.11");
pub const SPC_STATEMENT_TYPE_STRUCT: ::windows_core::PCSTR = ::windows_core::PCSTR(2006i32 as _);
pub const SPC_STRUCTURED_STORAGE_DATA_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.19");
pub const SPC_TIME_STAMP_REQUEST_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.3.2.1");
pub const SPC_URL_LINK_CHOICE: u32 = 1u32;
pub const SPC_UUID_LENGTH: u32 = 16u32;
pub const SPC_WINDOWS_HELLO_COMPATIBILITY_OBJID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.41.1");
pub const SP_CHKCERT_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubCheckCert");
pub const SP_CLEANUPPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubCleanup");
pub const SP_FINALPOLICY_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubAuthenticode");
pub const SP_GENERIC_CERT_INIT_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubDefCertInit");
pub const SP_INIT_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubInitialize");
pub const SP_OBJTRUST_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubLoadMessage");
pub const SP_POLICY_PROVIDER_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WINTRUST.DLL");
pub const SP_SIGTRUST_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubLoadSignature");
pub const SP_TESTDUMPPOLICY_FUNCTION_TEST: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftpubDumpStructure");
...
pub const WINTRUST_CONFIG_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Cryptography\\Wintrust\\Config");
pub const WINTRUST_MAX_HASH_BYTES_TO_MAP_DEFAULT: u32 = 1048576u32;
pub const WINTRUST_MAX_HASH_BYTES_TO_MAP_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxHashBytesToMap");
pub const WINTRUST_MAX_HEADER_BYTES_TO_MAP_DEFAULT: u32 = 10485760u32;
pub const WINTRUST_MAX_HEADER_BYTES_TO_MAP_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxHeaderBytesToMap");
...
pub const WT_PROVIDER_CERTTRUST_FUNCTION: ::windows_strings::PCWSTR = ::windows_strings::w!("WintrustCertificateTrust");
pub const WT_PROVIDER_DLL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WINTRUST.DLL");
...
pub const szOID_ENHANCED_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.5.1");
pub const szOID_INTENT_TO_SEAL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.4.2");
pub const szOID_NESTED_SIGNATURE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.4.1");
pub const szOID_PKCS_9_SEQUENCE_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.25.4");
pub const szOID_SEALING_SIGNATURE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.4.3");
pub const szOID_SEALING_TIMESTAMP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.4.4");
pub const szOID_TRUSTED_CLIENT_AUTH_CA_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.2.2");
pub const szOID_TRUSTED_CODESIGNING_CA_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.2.1");
pub const szOID_TRUSTED_SERVER_AUTH_CA_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.2.3");
#[repr(transparent)]
