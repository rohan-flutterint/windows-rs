...
pub const SRP_POLICY_APPX: ::windows_strings::PCWSTR = ::windows_strings::w!("APPX");
pub const SRP_POLICY_DLL: ::windows_strings::PCWSTR = ::windows_strings::w!("DLL");
pub const SRP_POLICY_EXE: ::windows_strings::PCWSTR = ::windows_strings::w!("EXE");
pub const SRP_POLICY_MANAGEDINSTALLER: ::windows_strings::PCWSTR = ::windows_strings::w!("MANAGEDINSTALLER");
pub const SRP_POLICY_MSI: ::windows_strings::PCWSTR = ::windows_strings::w!("MSI");
pub const SRP_POLICY_NOV2: ::windows_strings::PCWSTR = ::windows_strings::w!("IGNORESRPV2");
pub const SRP_POLICY_SCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("SCRIPT");
pub const SRP_POLICY_SHELL: ::windows_strings::PCWSTR = ::windows_strings::w!("SHELL");
pub const SRP_POLICY_WLDPCONFIGCI: ::windows_strings::PCWSTR = ::windows_strings::w!("WLDPCONFIGCI");
pub const SRP_POLICY_WLDPMSI: ::windows_strings::PCWSTR = ::windows_strings::w!("WLDPMSI");
pub const SRP_POLICY_WLDPSCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("WLDPSCRIPT");
