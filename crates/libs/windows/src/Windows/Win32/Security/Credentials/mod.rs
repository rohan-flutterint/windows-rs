...
pub const CREDSSP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CREDSSP");
...
pub const CRED_SESSION_WILDCARD_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("*Session");
pub const CRED_SESSION_WILDCARD_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("*Session");
pub const CRED_SESSION_WILDCARD_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("*Session");
pub const CRED_TARGETNAME_ATTRIBUTE_BATCH: ::windows_strings::PCWSTR = ::windows_strings::w!("batch");
pub const CRED_TARGETNAME_ATTRIBUTE_BATCH_A: ::windows_strings::PCSTR = ::windows_strings::s!("batch");
pub const CRED_TARGETNAME_ATTRIBUTE_BATCH_W: ::windows_strings::PCWSTR = ::windows_strings::w!("batch");
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE_A: ::windows_strings::PCSTR = ::windows_strings::s!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("interactive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE_A: ::windows_strings::PCSTR = ::windows_strings::s!("interactive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("interactive");
pub const CRED_TARGETNAME_ATTRIBUTE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("name");
pub const CRED_TARGETNAME_ATTRIBUTE_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("name");
pub const CRED_TARGETNAME_ATTRIBUTE_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("name");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORK: ::windows_strings::PCWSTR = ::windows_strings::w!("network");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT: ::windows_strings::PCWSTR = ::windows_strings::w!("networkcleartext");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT_A: ::windows_strings::PCSTR = ::windows_strings::s!("networkcleartext");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT_W: ::windows_strings::PCWSTR = ::windows_strings::w!("networkcleartext");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORK_A: ::windows_strings::PCSTR = ::windows_strings::s!("network");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORK_W: ::windows_strings::PCWSTR = ::windows_strings::w!("network");
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("remoteinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE_A: ::windows_strings::PCSTR = ::windows_strings::s!("remoteinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("remoteinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_SERVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("service");
pub const CRED_TARGETNAME_ATTRIBUTE_SERVICE_A: ::windows_strings::PCSTR = ::windows_strings::s!("service");
pub const CRED_TARGETNAME_ATTRIBUTE_SERVICE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("service");
pub const CRED_TARGETNAME_ATTRIBUTE_TARGET: ::windows_strings::PCWSTR = ::windows_strings::w!("target");
pub const CRED_TARGETNAME_ATTRIBUTE_TARGET_A: ::windows_strings::PCSTR = ::windows_strings::s!("target");
pub const CRED_TARGETNAME_ATTRIBUTE_TARGET_W: ::windows_strings::PCWSTR = ::windows_strings::w!("target");
pub const CRED_TARGETNAME_DOMAIN_NAMESPACE: ::windows_strings::PCWSTR = ::windows_strings::w!("Domain");
pub const CRED_TARGETNAME_DOMAIN_NAMESPACE_A: ::windows_strings::PCSTR = ::windows_strings::s!("Domain");
pub const CRED_TARGETNAME_DOMAIN_NAMESPACE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Domain");
pub const CRED_TARGETNAME_LEGACYGENERIC_NAMESPACE_A: ::windows_strings::PCSTR = ::windows_strings::s!("LegacyGeneric");
pub const CRED_TARGETNAME_LEGACYGENERIC_NAMESPACE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("LegacyGeneric");
...
pub const SCARD_ALL_READERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SCard$AllReaders\u{0}00");
...
pub const SCARD_DEFAULT_READERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SCard$DefaultReaders\u{0}00");
pub const SCARD_EJECT_CARD: u32 = 3u32;
pub const SCARD_LEAVE_CARD: u32 = 0u32;
pub const SCARD_LOCAL_READERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SCard$LocalReaders\u{0}00");
...
pub const SCARD_SYSTEM_READERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SCard$SystemReaders\u{0}00");
...
pub const TS_SSP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("TSSSP");
pub const TS_SSP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("TSSSP");
...
pub const szOID_TS_KP_TS_SERVER_AUTH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.54.1.2");
#[repr(transparent)]
