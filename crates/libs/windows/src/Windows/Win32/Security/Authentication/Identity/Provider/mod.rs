...
pub const IDENTITY_KEYWORD_ASSOCIATED: ::windows_strings::PCWSTR = ::windows_strings::w!("associated");
pub const IDENTITY_KEYWORD_CONNECTED: ::windows_strings::PCWSTR = ::windows_strings::w!("connected");
pub const IDENTITY_KEYWORD_HOMEGROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("homegroup");
pub const IDENTITY_KEYWORD_LOCAL: ::windows_strings::PCWSTR = ::windows_strings::w!("local");
...
pub const STR_COMPLETE_ACCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CompleteAccount");
pub const STR_MODERN_SETTINGS_ADD_USER: ::windows_strings::PCWSTR = ::windows_strings::w!("ModernSettingsAddUser");
pub const STR_NTH_USER_FIRST_AUTH: ::windows_strings::PCWSTR = ::windows_strings::w!("NthUserFirstAuth");
pub const STR_OUT_OF_BOX_EXPERIENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("OutOfBoxExperience");
pub const STR_OUT_OF_BOX_UPGRADE_EXPERIENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("OutOfBoxUpgradeExperience");
pub const STR_PROPERTY_STORE: ::windows_strings::PCWSTR = ::windows_strings::w!("PropertyStore");
pub const STR_USER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Username");
#[repr(transparent)]
