...
pub fn type_is_borrowed(ty: &Type) -> bool {
    match ty {
        ...
        Type::Name(TypeName::BSTR) | Type::Name(TypeName::VARIANT) | Type::Name(TypeName::PROPVARIANT) | Type::PCSTR | Type::PCWSTR | Type::IInspectable | Type::Name(TypeName::IUnknown) | Type::GenericParam(_) => true,
        _ => false,
    }
}
