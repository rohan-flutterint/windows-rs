...
pub const D3DKMT_SUBKEY_DX9: ::windows_strings::PCWSTR = ::windows_strings::w!("DX9");
pub const D3DKMT_SUBKEY_OPENGL: ::windows_strings::PCWSTR = ::windows_strings::w!("OpenGL");
