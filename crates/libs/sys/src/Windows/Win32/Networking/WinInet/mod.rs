...
pub const DIALPROP_DOMAIN: ::windows_strings::PCWSTR = ::windows_strings::w!("Domain");
pub const DIALPROP_LASTERROR: ::windows_strings::PCWSTR = ::windows_strings::w!("LastError");
pub const DIALPROP_PASSWORD: ::windows_strings::PCWSTR = ::windows_strings::w!("Password");
pub const DIALPROP_PHONENUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("PhoneNumber");
pub const DIALPROP_REDIALCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("RedialCount");
pub const DIALPROP_REDIALINTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("RedialInterval");
pub const DIALPROP_RESOLVEDPHONE: ::windows_strings::PCWSTR = ::windows_strings::w!("ResolvedPhone");
pub const DIALPROP_SAVEPASSWORD: ::windows_strings::PCWSTR = ::windows_strings::w!("SavePassword");
pub const DIALPROP_USERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("UserName");
...
pub const GOPHER_ABSTRACT_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Abstract");
pub const GOPHER_ABSTRACT_CATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("+ABSTRACT");
pub const GOPHER_ADMIN_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Admin");
pub const GOPHER_ADMIN_CATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("+ADMIN");
...
pub const GOPHER_GEOG_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Geog");
pub const GOPHER_INFO_CATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("+INFO");
pub const GOPHER_LOCATION_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Loc");
pub const GOPHER_MOD_DATE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Mod-Date");
pub const GOPHER_ORG_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Org");
pub const GOPHER_PROVIDER_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider");
pub const GOPHER_RANGE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Score-range");
pub const GOPHER_SCORE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Score");
pub const GOPHER_SITE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Site");
pub const GOPHER_TIMEZONE_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("TZ");
pub const GOPHER_TREEWALK_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("treewalk");
pub const GOPHER_TTL_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("TTL");
...
pub const GOPHER_VERONICA_CATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("+VERONICA");
pub const GOPHER_VERSION_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const GOPHER_VIEWS_CATEGORY: ::windows_strings::PCWSTR = ::windows_strings::w!("+VIEWS");
pub const GOPHER_VIEW_ATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("View");
...
pub const HTTP_VERSIONA: ::windows_strings::PCSTR = ::windows_strings::s!("HTTP/1.0");
pub const HTTP_VERSIONW: ::windows_strings::PCWSTR = ::windows_strings::w!("HTTP/1.0");
...
pub const LOCAL_NAMESPACE_PREFIX: ::windows_strings::PCSTR = ::windows_strings::s!("Local\\");
pub const LOCAL_NAMESPACE_PREFIX_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Local\\");
...
pub const REGSTR_DIAL_AUTOCONNECT: ::windows_strings::PCSTR = ::windows_strings::s!("AutoConnect");
pub const REGSTR_LEASH_LEGACY_COOKIES: ::windows_strings::PCSTR = ::windows_strings::s!("LeashLegacyCookies");
