...
pub const SERVICE_TYPE_VALUE_CONN: ::windows_strings::PCWSTR = ::windows_strings::w!("ConnectionOriented");
pub const SERVICE_TYPE_VALUE_CONNA: ::windows_strings::PCSTR = ::windows_strings::s!("ConnectionOriented");
pub const SERVICE_TYPE_VALUE_CONNW: ::windows_strings::PCWSTR = ::windows_strings::w!("ConnectionOriented");
pub const SERVICE_TYPE_VALUE_IPXPORTA: ::windows_strings::PCSTR = ::windows_strings::s!("IpxSocket");
pub const SERVICE_TYPE_VALUE_IPXPORTW: ::windows_strings::PCWSTR = ::windows_strings::w!("IpxSocket");
pub const SERVICE_TYPE_VALUE_OBJECTID: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectId");
pub const SERVICE_TYPE_VALUE_OBJECTIDA: ::windows_strings::PCSTR = ::windows_strings::s!("ObjectId");
pub const SERVICE_TYPE_VALUE_OBJECTIDW: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectId");
pub const SERVICE_TYPE_VALUE_SAPID: ::windows_strings::PCWSTR = ::windows_strings::w!("SapId");
pub const SERVICE_TYPE_VALUE_SAPIDA: ::windows_strings::PCSTR = ::windows_strings::s!("SapId");
pub const SERVICE_TYPE_VALUE_SAPIDW: ::windows_strings::PCWSTR = ::windows_strings::w!("SapId");
pub const SERVICE_TYPE_VALUE_TCPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("TcpPort");
pub const SERVICE_TYPE_VALUE_TCPPORTA: ::windows_strings::PCSTR = ::windows_strings::s!("TcpPort");
pub const SERVICE_TYPE_VALUE_TCPPORTW: ::windows_strings::PCWSTR = ::windows_strings::w!("TcpPort");
pub const SERVICE_TYPE_VALUE_UDPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("UdpPort");
pub const SERVICE_TYPE_VALUE_UDPPORTA: ::windows_strings::PCSTR = ::windows_strings::s!("UdpPort");
pub const SERVICE_TYPE_VALUE_UDPPORTW: ::windows_strings::PCWSTR = ::windows_strings::w!("UdpPort");
