...
pub const ACMHELPMSGCONTEXTHELP: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_contexthelp");
pub const ACMHELPMSGCONTEXTHELPA: ::windows_strings::PCSTR = ::windows_strings::s!("acmchoose_contexthelp");
pub const ACMHELPMSGCONTEXTHELPW: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_contexthelp");
pub const ACMHELPMSGCONTEXTMENU: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_contextmenu");
pub const ACMHELPMSGCONTEXTMENUA: ::windows_strings::PCSTR = ::windows_strings::s!("acmchoose_contextmenu");
pub const ACMHELPMSGCONTEXTMENUW: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_contextmenu");
pub const ACMHELPMSGSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_help");
pub const ACMHELPMSGSTRINGA: ::windows_strings::PCSTR = ::windows_strings::s!("acmchoose_help");
pub const ACMHELPMSGSTRINGW: ::windows_strings::PCWSTR = ::windows_strings::w!("acmchoose_help");
...
pub const VIRTUAL_AUDIO_DEVICE_PROCESS_LOOPBACK: ::windows_strings::PCWSTR = ::windows_strings::w!("VAD\\Process_Loopback");
