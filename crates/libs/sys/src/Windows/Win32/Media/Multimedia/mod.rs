...
pub const DRIVERS_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DRIVERS32");
...
pub const JOY_CONFIGCHANGED_MSGSTRING: ::windows_strings::PCSTR = ::windows_strings::s!("MSJSTICK_VJOYD_MSGSTR");
...
pub const MCIWND_WINDOW_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("MCIWndClass");
...
pub const MCI_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("MCI32");
...
pub const TARGET_DEVICE_FRIENDLY_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("TargetDeviceFriendlyName");
pub const TARGET_DEVICE_OPEN_EXCLUSIVELY: ::windows_strings::PCSTR = ::windows_strings::s!("TargetDeviceOpenExclusively");
