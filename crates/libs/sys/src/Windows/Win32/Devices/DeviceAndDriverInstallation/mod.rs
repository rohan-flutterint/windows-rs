...
pub const INFSTR_BUS_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("BUS_ALL");
pub const INFSTR_BUS_EISA: ::windows_strings::PCWSTR = ::windows_strings::w!("BUS_EISA");
pub const INFSTR_BUS_ISA: ::windows_strings::PCWSTR = ::windows_strings::w!("BUS_ISA");
pub const INFSTR_BUS_MCA: ::windows_strings::PCWSTR = ::windows_strings::w!("BUS_MCA");
pub const INFSTR_CFGPRI_DESIRED: ::windows_strings::PCWSTR = ::windows_strings::w!("DESIRED");
pub const INFSTR_CFGPRI_DISABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("DISABLED");
pub const INFSTR_CFGPRI_FORCECONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("FORCECONFIG");
pub const INFSTR_CFGPRI_HARDRECONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("HARDRECONFIG");
pub const INFSTR_CFGPRI_HARDWIRED: ::windows_strings::PCWSTR = ::windows_strings::w!("HARDWIRED");
pub const INFSTR_CFGPRI_NORMAL: ::windows_strings::PCWSTR = ::windows_strings::w!("NORMAL");
pub const INFSTR_CFGPRI_POWEROFF: ::windows_strings::PCWSTR = ::windows_strings::w!("POWEROFF");
pub const INFSTR_CFGPRI_REBOOT: ::windows_strings::PCWSTR = ::windows_strings::w!("REBOOT");
pub const INFSTR_CFGPRI_RESTART: ::windows_strings::PCWSTR = ::windows_strings::w!("RESTART");
pub const INFSTR_CFGPRI_SUBOPTIMAL: ::windows_strings::PCWSTR = ::windows_strings::w!("SUBOPTIMAL");
pub const INFSTR_CFGTYPE_BASIC: ::windows_strings::PCWSTR = ::windows_strings::w!("BASIC");
pub const INFSTR_CFGTYPE_FORCED: ::windows_strings::PCWSTR = ::windows_strings::w!("FORCED");
pub const INFSTR_CFGTYPE_OVERRIDE: ::windows_strings::PCWSTR = ::windows_strings::w!("OVERRIDE");
pub const INFSTR_CLASS_SAFEEXCL: ::windows_strings::PCWSTR = ::windows_strings::w!("SAFE_EXCL");
pub const INFSTR_CONTROLFLAGS_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("ControlFlags");
pub const INFSTR_DRIVERSELECT_FUNCTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverSelectFunctions");
pub const INFSTR_DRIVERSELECT_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverSelect");
pub const INFSTR_DRIVERVERSION_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverVer");
pub const INFSTR_KEY_ACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Action");
pub const INFSTR_KEY_ALWAYSEXCLUDEFROMSELECT: ::windows_strings::PCWSTR = ::windows_strings::w!("AlwaysExcludeFromSelect");
pub const INFSTR_KEY_BUFFER_SIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("BufferSize");
pub const INFSTR_KEY_CATALOGFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("CatalogFile");
pub const INFSTR_KEY_CHANNEL_ACCESS: ::windows_strings::PCWSTR = ::windows_strings::w!("Access");
pub const INFSTR_KEY_CHANNEL_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled");
pub const INFSTR_KEY_CHANNEL_ISOLATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Isolation");
pub const INFSTR_KEY_CHANNEL_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("Value");
pub const INFSTR_KEY_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("Class");
pub const INFSTR_KEY_CLASSGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("ClassGUID");
pub const INFSTR_KEY_CLOCK_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ClockType");
pub const INFSTR_KEY_CONFIGPRIORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigPriority");
pub const INFSTR_KEY_COPYFILESONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("CopyFilesOnly");
pub const INFSTR_KEY_DATA_ITEM: ::windows_strings::PCWSTR = ::windows_strings::w!("DataItem");
pub const INFSTR_KEY_DELAYEDAUTOSTART: ::windows_strings::PCWSTR = ::windows_strings::w!("DelayedAutoStart");
pub const INFSTR_KEY_DEPENDENCIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Dependencies");
pub const INFSTR_KEY_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const INFSTR_KEY_DETECTLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("DetectList");
pub const INFSTR_KEY_DETPARAMS: ::windows_strings::PCWSTR = ::windows_strings::w!("Params");
pub const INFSTR_KEY_DISABLE_REALTIME_PERSISTENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableRealtimePersistence");
pub const INFSTR_KEY_DISPLAYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisplayName");
pub const INFSTR_KEY_DMA: ::windows_strings::PCWSTR = ::windows_strings::w!("DMA");
pub const INFSTR_KEY_DMACONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("DMAConfig");
pub const INFSTR_KEY_DRIVERSET: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverSet");
pub const INFSTR_KEY_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled");
pub const INFSTR_KEY_ENABLE_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableFlags");
pub const INFSTR_KEY_ENABLE_LEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableLevel");
pub const INFSTR_KEY_ENABLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableProperty");
pub const INFSTR_KEY_ERRORCONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("ErrorControl");
pub const INFSTR_KEY_EXCLUDEFROMSELECT: ::windows_strings::PCWSTR = ::windows_strings::w!("ExcludeFromSelect");
pub const INFSTR_KEY_EXCLUDERES: ::windows_strings::PCWSTR = ::windows_strings::w!("ExcludeRes");
pub const INFSTR_KEY_EXTENSIONID: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionId");
pub const INFSTR_KEY_FAILURE_ACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Action");
pub const INFSTR_KEY_FILE_MAX: ::windows_strings::PCWSTR = ::windows_strings::w!("FileMax");
pub const INFSTR_KEY_FILE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FileName");
pub const INFSTR_KEY_FLUSH_TIMER: ::windows_strings::PCWSTR = ::windows_strings::w!("FlushTimer");
pub const INFSTR_KEY_FROMINET: ::windows_strings::PCWSTR = ::windows_strings::w!("FromINet");
pub const INFSTR_KEY_HARDWARE_CLASS: ::windows_strings::PCWSTR = ::windows_strings::w!("Class");
pub const INFSTR_KEY_HARDWARE_CLASSGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("ClassGUID");
pub const INFSTR_KEY_INTERACTIVEINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("InteractiveInstall");
pub const INFSTR_KEY_IO: ::windows_strings::PCWSTR = ::windows_strings::w!("IO");
pub const INFSTR_KEY_IOCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("IOConfig");
pub const INFSTR_KEY_IRQ: ::windows_strings::PCWSTR = ::windows_strings::w!("IRQ");
pub const INFSTR_KEY_IRQCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("IRQConfig");
pub const INFSTR_KEY_LOADORDERGROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("LoadOrderGroup");
pub const INFSTR_KEY_LOGGING_AUTOBACKUP: ::windows_strings::PCWSTR = ::windows_strings::w!("LoggingAutoBackup");
pub const INFSTR_KEY_LOGGING_MAXSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("LoggingMaxSize");
pub const INFSTR_KEY_LOGGING_RETENTION: ::windows_strings::PCWSTR = ::windows_strings::w!("LoggingRetention");
pub const INFSTR_KEY_LOG_FILE_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("LogFileMode");
pub const INFSTR_KEY_MATCH_ALL_KEYWORD: ::windows_strings::PCWSTR = ::windows_strings::w!("MatchAllKeyword");
pub const INFSTR_KEY_MATCH_ANY_KEYWORD: ::windows_strings::PCWSTR = ::windows_strings::w!("MatchAnyKeyword");
pub const INFSTR_KEY_MAXIMUM_BUFFERS: ::windows_strings::PCWSTR = ::windows_strings::w!("MaximumBuffers");
pub const INFSTR_KEY_MAX_FILE_SIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxFileSize");
pub const INFSTR_KEY_MEM: ::windows_strings::PCWSTR = ::windows_strings::w!("Mem");
pub const INFSTR_KEY_MEMCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("MemConfig");
pub const INFSTR_KEY_MEMLARGECONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("MemLargeConfig");
pub const INFSTR_KEY_MESSAGE_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("MessageFile");
pub const INFSTR_KEY_MFCARDCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("MfCardConfig");
pub const INFSTR_KEY_MINIMUM_BUFFERS: ::windows_strings::PCWSTR = ::windows_strings::w!("MinimumBuffers");
pub const INFSTR_KEY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const INFSTR_KEY_NON_CRASH_FAILURES: ::windows_strings::PCWSTR = ::windows_strings::w!("NonCrashFailures");
pub const INFSTR_KEY_NOSETUPINF: ::windows_strings::PCWSTR = ::windows_strings::w!("NoSetupInf");
pub const INFSTR_KEY_PARAMETER_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("ParameterFile");
pub const INFSTR_KEY_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Path");
pub const INFSTR_KEY_PCCARDCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("PcCardConfig");
pub const INFSTR_KEY_PNPLOCKDOWN: ::windows_strings::PCWSTR = ::windows_strings::w!("PnpLockDown");
pub const INFSTR_KEY_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider");
pub const INFSTR_KEY_PROVIDER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderName");
pub const INFSTR_KEY_REQUESTADDITIONALSOFTWARE: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestAdditionalSoftware");
pub const INFSTR_KEY_REQUIREDPRIVILEGES: ::windows_strings::PCWSTR = ::windows_strings::w!("RequiredPrivileges");
pub const INFSTR_KEY_RESET_PERIOD: ::windows_strings::PCWSTR = ::windows_strings::w!("ResetPeriod");
pub const INFSTR_KEY_RESOURCE_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("ResourceFile");
pub const INFSTR_KEY_SECURITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Security");
pub const INFSTR_KEY_SERVICEBINARY: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceBinary");
pub const INFSTR_KEY_SERVICESIDTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceSidType");
pub const INFSTR_KEY_SERVICETYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ServiceType");
pub const INFSTR_KEY_SIGNATURE: ::windows_strings::PCWSTR = ::windows_strings::w!("Signature");
pub const INFSTR_KEY_SKIPLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("SkipList");
pub const INFSTR_KEY_START: ::windows_strings::PCWSTR = ::windows_strings::w!("Start");
pub const INFSTR_KEY_STARTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("StartName");
pub const INFSTR_KEY_STARTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("StartType");
pub const INFSTR_KEY_SUB_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("SubType");
pub const INFSTR_KEY_TRIGGER_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("TriggerType");
pub const INFSTR_PLATFORM_NT: ::windows_strings::PCWSTR = ::windows_strings::w!("NT");
pub const INFSTR_PLATFORM_NTALPHA: ::windows_strings::PCWSTR = ::windows_strings::w!("NTAlpha");
pub const INFSTR_PLATFORM_NTAMD64: ::windows_strings::PCWSTR = ::windows_strings::w!("NTAMD64");
pub const INFSTR_PLATFORM_NTARM: ::windows_strings::PCWSTR = ::windows_strings::w!("NTARM");
pub const INFSTR_PLATFORM_NTARM64: ::windows_strings::PCWSTR = ::windows_strings::w!("NTARM64");
pub const INFSTR_PLATFORM_NTAXP64: ::windows_strings::PCWSTR = ::windows_strings::w!("NTAXP64");
pub const INFSTR_PLATFORM_NTIA64: ::windows_strings::PCWSTR = ::windows_strings::w!("NTIA64");
pub const INFSTR_PLATFORM_NTMIPS: ::windows_strings::PCWSTR = ::windows_strings::w!("NTMIPS");
pub const INFSTR_PLATFORM_NTPPC: ::windows_strings::PCWSTR = ::windows_strings::w!("NTPPC");
pub const INFSTR_PLATFORM_NTX86: ::windows_strings::PCWSTR = ::windows_strings::w!("NTx86");
pub const INFSTR_PLATFORM_WIN: ::windows_strings::PCWSTR = ::windows_strings::w!("Win");
pub const INFSTR_REBOOT: ::windows_strings::PCWSTR = ::windows_strings::w!("Reboot");
pub const INFSTR_RESTART: ::windows_strings::PCWSTR = ::windows_strings::w!("Restart");
pub const INFSTR_RISK_BIOSROMRD: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_BIOSROMRD");
pub const INFSTR_RISK_DELICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_DELICATE");
pub const INFSTR_RISK_IORD: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_IORD");
pub const INFSTR_RISK_IOWR: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_IOWR");
pub const INFSTR_RISK_LOW: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_LOW");
pub const INFSTR_RISK_MEMRD: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_MEMRD");
pub const INFSTR_RISK_MEMWR: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_MEMWR");
pub const INFSTR_RISK_NONE: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_NONE");
pub const INFSTR_RISK_QUERYDRV: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_QUERYDRV");
pub const INFSTR_RISK_SWINT: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_SWINT");
pub const INFSTR_RISK_UNRELIABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_UNRELIABLE");
pub const INFSTR_RISK_VERYHIGH: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_VERYHIGH");
pub const INFSTR_RISK_VERYLOW: ::windows_strings::PCWSTR = ::windows_strings::w!("RISK_VERYLOW");
pub const INFSTR_SECT_AUTOEXECBAT: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoexecBatDrivers");
pub const INFSTR_SECT_AVOIDCFGSYSDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.AvoidCfgSysDev");
pub const INFSTR_SECT_AVOIDENVDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.AvoidEnvDev");
pub const INFSTR_SECT_AVOIDINIDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.AvoidIniDev");
pub const INFSTR_SECT_BADACPIBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadACPIBios");
pub const INFSTR_SECT_BADDISKBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadDiskBios");
pub const INFSTR_SECT_BADDSBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadDSBios");
pub const INFSTR_SECT_BADPMCALLBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadProtectedModeCallBios");
pub const INFSTR_SECT_BADPNPBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadPnpBios");
pub const INFSTR_SECT_BADRMCALLBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadRealModeCallBios");
pub const INFSTR_SECT_BADROUTINGTABLEBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("BadPCIIRQRoutingTableBios");
pub const INFSTR_SECT_CFGSYS: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigSysDrivers");
pub const INFSTR_SECT_CLASS_INSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("ClassInstall");
pub const INFSTR_SECT_CLASS_INSTALL_32: ::windows_strings::PCWSTR = ::windows_strings::w!("ClassInstall32");
pub const INFSTR_SECT_DEFAULT_INSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultInstall");
pub const INFSTR_SECT_DEFAULT_UNINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultUninstall");
pub const INFSTR_SECT_DETCLASSINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.ClassInfo");
pub const INFSTR_SECT_DETMODULES: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.Modules");
pub const INFSTR_SECT_DETOPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.Options");
pub const INFSTR_SECT_DEVINFS: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.DevINFs");
pub const INFSTR_SECT_DISPLAY_CLEANUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DisplayCleanup");
pub const INFSTR_SECT_EXTENSIONCONTRACTS: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionContracts");
pub const INFSTR_SECT_FORCEHWVERIFY: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.ForceHWVerify");
pub const INFSTR_SECT_GOODACPIBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("GoodACPIBios");
pub const INFSTR_SECT_HPOMNIBOOK: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.HPOmnibook");
pub const INFSTR_SECT_INTERFACE_INSTALL_32: ::windows_strings::PCWSTR = ::windows_strings::w!("InterfaceInstall32");
pub const INFSTR_SECT_MACHINEIDBIOS: ::windows_strings::PCWSTR = ::windows_strings::w!("MachineIDBios");
pub const INFSTR_SECT_MANUALDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.ManualDev");
pub const INFSTR_SECT_MFG: ::windows_strings::PCWSTR = ::windows_strings::w!("Manufacturer");
pub const INFSTR_SECT_REGCFGSYSDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.RegCfgSysDev");
pub const INFSTR_SECT_REGENVDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.RegEnvDev");
pub const INFSTR_SECT_REGINIDEV: ::windows_strings::PCWSTR = ::windows_strings::w!("Det.RegIniDev");
pub const INFSTR_SECT_SYSINI: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemIniDrivers");
pub const INFSTR_SECT_SYSINIDRV: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemIniDriversLine");
pub const INFSTR_SECT_TARGETCOMPUTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("TargetComputers");
pub const INFSTR_SECT_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const INFSTR_SECT_WININIRUN: ::windows_strings::PCWSTR = ::windows_strings::w!("WinIniRunLine");
pub const INFSTR_SOFTWAREVERSION_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("SoftwareVersion");
pub const INFSTR_STRKEY_DRVDESC: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverDesc");
pub const INFSTR_SUBKEY_COINSTALLERS: ::windows_strings::PCWSTR = ::windows_strings::w!("CoInstallers");
pub const INFSTR_SUBKEY_CTL: ::windows_strings::PCWSTR = ::windows_strings::w!("CTL");
pub const INFSTR_SUBKEY_DET: ::windows_strings::PCWSTR = ::windows_strings::w!("Det");
pub const INFSTR_SUBKEY_EVENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Events");
pub const INFSTR_SUBKEY_FACTDEF: ::windows_strings::PCWSTR = ::windows_strings::w!("FactDef");
pub const INFSTR_SUBKEY_FILTERS: ::windows_strings::PCWSTR = ::windows_strings::w!("Filters");
pub const INFSTR_SUBKEY_HW: ::windows_strings::PCWSTR = ::windows_strings::w!("Hw");
pub const INFSTR_SUBKEY_INTERFACES: ::windows_strings::PCWSTR = ::windows_strings::w!("Interfaces");
pub const INFSTR_SUBKEY_LOGCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("LogConfig");
pub const INFSTR_SUBKEY_LOGCONFIGOVERRIDE: ::windows_strings::PCWSTR = ::windows_strings::w!("LogConfigOverride");
pub const INFSTR_SUBKEY_NORESOURCEDUPS: ::windows_strings::PCWSTR = ::windows_strings::w!("NoResDup");
pub const INFSTR_SUBKEY_POSSIBLEDUPS: ::windows_strings::PCWSTR = ::windows_strings::w!("PosDup");
pub const INFSTR_SUBKEY_SERVICES: ::windows_strings::PCWSTR = ::windows_strings::w!("Services");
pub const INFSTR_SUBKEY_SOFTWARE: ::windows_strings::PCWSTR = ::windows_strings::w!("Software");
pub const INFSTR_SUBKEY_WMI: ::windows_strings::PCWSTR = ::windows_strings::w!("WMI");
...
pub const SZ_KEY_ADDAUTOLOGGER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddAutoLogger");
pub const SZ_KEY_ADDAUTOLOGGERPROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddAutoLoggerProvider");
pub const SZ_KEY_ADDCHANNEL: ::windows_strings::PCWSTR = ::windows_strings::w!("AddChannel");
pub const SZ_KEY_ADDEVENTPROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddEventProvider");
pub const SZ_KEY_ADDFILTER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddFilter");
pub const SZ_KEY_ADDIME: ::windows_strings::PCWSTR = ::windows_strings::w!("AddIme");
pub const SZ_KEY_ADDINTERFACE: ::windows_strings::PCWSTR = ::windows_strings::w!("AddInterface");
pub const SZ_KEY_ADDPOWERSETTING: ::windows_strings::PCWSTR = ::windows_strings::w!("AddPowerSetting");
pub const SZ_KEY_ADDPROP: ::windows_strings::PCWSTR = ::windows_strings::w!("AddProperty");
pub const SZ_KEY_ADDREG: ::windows_strings::PCWSTR = ::windows_strings::w!("AddReg");
pub const SZ_KEY_ADDREGNOCLOBBER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddRegNoClobber");
pub const SZ_KEY_ADDSERVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("AddService");
pub const SZ_KEY_ADDTRIGGER: ::windows_strings::PCWSTR = ::windows_strings::w!("AddTrigger");
pub const SZ_KEY_BITREG: ::windows_strings::PCWSTR = ::windows_strings::w!("BitReg");
pub const SZ_KEY_CLEANONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("CleanOnly");
pub const SZ_KEY_COPYFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("CopyFiles");
pub const SZ_KEY_COPYINF: ::windows_strings::PCWSTR = ::windows_strings::w!("CopyINF");
pub const SZ_KEY_DEFAULTOPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultOption");
pub const SZ_KEY_DEFDESTDIR: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultDestDir");
pub const SZ_KEY_DELFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("DelFiles");
pub const SZ_KEY_DELIME: ::windows_strings::PCWSTR = ::windows_strings::w!("DelIme");
pub const SZ_KEY_DELPROP: ::windows_strings::PCWSTR = ::windows_strings::w!("DelProperty");
pub const SZ_KEY_DELREG: ::windows_strings::PCWSTR = ::windows_strings::w!("DelReg");
pub const SZ_KEY_DELSERVICE: ::windows_strings::PCWSTR = ::windows_strings::w!("DelService");
pub const SZ_KEY_DESTDIRS: ::windows_strings::PCWSTR = ::windows_strings::w!("DestinationDirs");
pub const SZ_KEY_EXCLUDEID: ::windows_strings::PCWSTR = ::windows_strings::w!("ExcludeId");
pub const SZ_KEY_FAILUREACTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("FailureActions");
pub const SZ_KEY_FEATURESCORE: ::windows_strings::PCWSTR = ::windows_strings::w!("FeatureScore");
pub const SZ_KEY_FILTERLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterLevel");
pub const SZ_KEY_FILTERPOSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterPosition");
pub const SZ_KEY_HARDWARE: ::windows_strings::PCWSTR = ::windows_strings::w!("Hardware");
pub const SZ_KEY_IMPORTCHANNEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ImportChannel");
pub const SZ_KEY_INI2REG: ::windows_strings::PCWSTR = ::windows_strings::w!("Ini2Reg");
pub const SZ_KEY_LAYOUT_FILE: ::windows_strings::PCWSTR = ::windows_strings::w!("LayoutFile");
pub const SZ_KEY_LDIDOEM: ::windows_strings::PCWSTR = ::windows_strings::w!("LdidOEM");
pub const SZ_KEY_LFN_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("VarLDID.LFN");
pub const SZ_KEY_LISTOPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("ListOptions");
pub const SZ_KEY_LOGCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("LogConfig");
pub const SZ_KEY_MODULES: ::windows_strings::PCWSTR = ::windows_strings::w!("Modules");
pub const SZ_KEY_OPTIONDESC: ::windows_strings::PCWSTR = ::windows_strings::w!("OptionDesc");
pub const SZ_KEY_PHASE1: ::windows_strings::PCWSTR = ::windows_strings::w!("Phase1");
pub const SZ_KEY_PROFILEITEMS: ::windows_strings::PCWSTR = ::windows_strings::w!("ProfileItems");
pub const SZ_KEY_REGSVR: ::windows_strings::PCWSTR = ::windows_strings::w!("RegisterDlls");
pub const SZ_KEY_RENFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("RenFiles");
pub const SZ_KEY_SFN_SECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("VarLDID.SFN");
pub const SZ_KEY_SRCDISKFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceDisksFiles");
pub const SZ_KEY_SRCDISKNAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceDisksNames");
pub const SZ_KEY_STRINGS: ::windows_strings::PCWSTR = ::windows_strings::w!("Strings");
pub const SZ_KEY_UNREGSVR: ::windows_strings::PCWSTR = ::windows_strings::w!("UnregisterDlls");
pub const SZ_KEY_UPDATEAUTOLOGGER: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateAutoLogger");
pub const SZ_KEY_UPDATEINIFIELDS: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateIniFields");
pub const SZ_KEY_UPDATEINIS: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateInis");
pub const SZ_KEY_UPGRADEONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("UpgradeOnly");
