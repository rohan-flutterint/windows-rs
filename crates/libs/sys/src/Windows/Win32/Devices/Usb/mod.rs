...
pub const KREGMANUSBFNENUMPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMode\\Current\\USBFN\\");
pub const KREGUSBFNENUMPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\");
...
pub const MS_OS_STRING_SIGNATURE: ::windows_strings::PCWSTR = ::windows_strings::w!("MSFT100");
...
pub const UREGMANUSBFNENUMPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMode\\Current\\USBFN\\");
pub const UREGUSBFNENUMPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\");
