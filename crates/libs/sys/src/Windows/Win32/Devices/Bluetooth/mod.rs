...
pub const STR_ADDR_FMT: ::windows_strings::PCWSTR = ::windows_strings::w!("(%02x:%02x:%02x:%02x:%02x:%02x)");
pub const STR_ADDR_FMTA: ::windows_strings::PCSTR = ::windows_strings::s!("(%02x:%02x:%02x:%02x:%02x:%02x)");
pub const STR_ADDR_FMTW: ::windows_strings::PCWSTR = ::windows_strings::w!("(%02x:%02x:%02x:%02x:%02x:%02x)");
pub const STR_ADDR_SHORT_FMT: ::windows_strings::PCWSTR = ::windows_strings::w!("%04x%08x");
pub const STR_ADDR_SHORT_FMTA: ::windows_strings::PCSTR = ::windows_strings::s!("%04x%08x");
pub const STR_ADDR_SHORT_FMTW: ::windows_strings::PCWSTR = ::windows_strings::w!("%04x%08x");
pub const STR_USBHCI_CLASS_HARDWAREID: ::windows_strings::PCWSTR = ::windows_strings::w!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDA: ::windows_strings::PCSTR = ::windows_strings::s!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDW: ::windows_strings::PCWSTR = ::windows_strings::w!("USB\\Class_E0&SubClass_01&Prot_01");
