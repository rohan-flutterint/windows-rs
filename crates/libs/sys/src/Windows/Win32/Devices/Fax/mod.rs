...
pub const CF_MSFAXSRV_DEVICE_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("FAXSRV_DeviceID");
pub const CF_MSFAXSRV_FSP_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("FAXSRV_FSPGuid");
pub const CF_MSFAXSRV_ROUTEEXT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FAXSRV_RoutingExtName");
pub const CF_MSFAXSRV_ROUTING_METHOD_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("FAXSRV_RoutingMethodGuid");
pub const CF_MSFAXSRV_SERVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FAXSRV_ServerName");
...
pub const IS_DIGITAL_CAMERA_STR: ::windows_strings::PCWSTR = ::windows_strings::w!("IsDigitalCamera");
...
pub const MS_FAXROUTE_EMAIL_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("{6bbf7bfe-9af2-11d0-abf7-00c04fd91a4e}");
pub const MS_FAXROUTE_FOLDER_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("{92041a90-9af2-11d0-abf7-00c04fd91a4e}");
pub const MS_FAXROUTE_PRINTING_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("{aec1b37c-9af2-11d0-abf7-00c04fd91a4e}");
...
pub const REGSTR_VAL_BAUDRATE: ::windows_strings::PCWSTR = ::windows_strings::w!("BaudRate");
pub const REGSTR_VAL_BAUDRATE_A: ::windows_strings::PCSTR = ::windows_strings::s!("BaudRate");
pub const REGSTR_VAL_DATA_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceData");
pub const REGSTR_VAL_DEVICESUBTYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceSubType");
pub const REGSTR_VAL_DEVICETYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceType");
pub const REGSTR_VAL_DEVICE_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverDesc");
pub const REGSTR_VAL_DEV_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceName");
pub const REGSTR_VAL_DRIVER_DESC_W: ::windows_strings::PCWSTR = ::windows_strings::w!("DriverDesc");
pub const REGSTR_VAL_FRIENDLY_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("FriendlyName");
pub const REGSTR_VAL_GENERIC_CAPS_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Capabilities");
pub const REGSTR_VAL_GUID: ::windows_strings::PCWSTR = ::windows_strings::w!("GUID");
pub const REGSTR_VAL_GUID_W: ::windows_strings::PCWSTR = ::windows_strings::w!("GUID");
pub const REGSTR_VAL_HARDWARE: ::windows_strings::PCWSTR = ::windows_strings::w!("HardwareConfig");
pub const REGSTR_VAL_HARDWARE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("HardwareConfig");
pub const REGSTR_VAL_LAUNCHABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Launchable");
pub const REGSTR_VAL_LAUNCHABLE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Launchable");
pub const REGSTR_VAL_LAUNCH_APPS: ::windows_strings::PCWSTR = ::windows_strings::w!("LaunchApplications");
pub const REGSTR_VAL_LAUNCH_APPS_W: ::windows_strings::PCWSTR = ::windows_strings::w!("LaunchApplications");
pub const REGSTR_VAL_SHUTDOWNDELAY: ::windows_strings::PCWSTR = ::windows_strings::w!("ShutdownIfUnusedDelay");
pub const REGSTR_VAL_SHUTDOWNDELAY_W: ::windows_strings::PCWSTR = ::windows_strings::w!("ShutdownIfUnusedDelay");
pub const REGSTR_VAL_TYPE_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Type");
pub const REGSTR_VAL_VENDOR_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Vendor");
...
pub const STI_ADD_DEVICE_BROADCAST_ACTION: ::windows_strings::PCSTR = ::windows_strings::s!("Arrival");
pub const STI_ADD_DEVICE_BROADCAST_STRING: ::windows_strings::PCSTR = ::windows_strings::s!("STI\\");
...
pub const STI_DEVICE_VALUE_DEFAULT_LAUNCHAPP: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultLaunchApp");
pub const STI_DEVICE_VALUE_DEFAULT_LAUNCHAPP_A: ::windows_strings::PCSTR = ::windows_strings::s!("DefaultLaunchApp");
pub const STI_DEVICE_VALUE_DISABLE_NOTIFICATIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableNotifications");
pub const STI_DEVICE_VALUE_DISABLE_NOTIFICATIONS_A: ::windows_strings::PCSTR = ::windows_strings::s!("DisableNotifications");
pub const STI_DEVICE_VALUE_ICM_PROFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("ICMProfile");
pub const STI_DEVICE_VALUE_ICM_PROFILE_A: ::windows_strings::PCSTR = ::windows_strings::s!("ICMProfile");
pub const STI_DEVICE_VALUE_ISIS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ISISDriverName");
pub const STI_DEVICE_VALUE_ISIS_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("ISISDriverName");
pub const STI_DEVICE_VALUE_TIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("PollTimeout");
pub const STI_DEVICE_VALUE_TIMEOUT_A: ::windows_strings::PCSTR = ::windows_strings::s!("PollTimeout");
pub const STI_DEVICE_VALUE_TWAIN_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("TwainDS");
pub const STI_DEVICE_VALUE_TWAIN_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("TwainDS");
...
pub const STI_REMOVE_DEVICE_BROADCAST_ACTION: ::windows_strings::PCSTR = ::windows_strings::s!("Removal");
pub const STI_REMOVE_DEVICE_BROADCAST_STRING: ::windows_strings::PCSTR = ::windows_strings::s!("STI\\");
...
pub const SUPPORTS_MSCPLUS_STR: ::windows_strings::PCWSTR = ::windows_strings::w!("SupportsMSCPlus");
