...
pub const DRM_DEFAULTGROUPIDTYPE_PASSPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("PassportAuthProvider");
pub const DRM_DEFAULTGROUPIDTYPE_WINDOWSAUTH: ::windows_strings::PCWSTR = ::windows_strings::w!("WindowsAuthProvider");
