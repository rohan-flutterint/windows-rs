...
pub const ICW_REGKEYCOMPLETED: ::windows_strings::PCSTR = ::windows_strings::s!("Completed");
pub const ICW_REGPATHSETTINGS: ::windows_strings::PCSTR = ::windows_strings::s!("Software\\Microsoft\\Internet Connection Wizard");
