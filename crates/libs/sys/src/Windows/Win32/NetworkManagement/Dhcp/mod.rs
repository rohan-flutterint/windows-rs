...
pub const DHCP_CALLOUT_ENTRY_POINT: ::windows_strings::PCSTR = ::windows_strings::s!("DhcpServerCalloutEntry");
pub const DHCP_CALLOUT_LIST_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("System\\CurrentControlSet\\Services\\DHCPServer\\Parameters");
pub const DHCP_CALLOUT_LIST_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("CalloutDlls");
