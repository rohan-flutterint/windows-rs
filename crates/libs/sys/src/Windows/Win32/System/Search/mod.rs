...
pub const MS_PERSIST_PROGID: ::windows_strings::PCSTR = ::windows_strings::s!("MSPersist");
...
pub const PROGID_MSPersist_Version_W: ::windows_strings::PCWSTR = ::windows_strings::w!("MSPersist.1");
pub const PROGID_MSPersist_W: ::windows_strings::PCWSTR = ::windows_strings::w!("MSPersist");
...
pub const SQL_ALL_CATALOGS: ::windows_strings::PCSTR = ::windows_strings::s!("%");
pub const SQL_ALL_EXCEPT_LIKE: u32 = 2u32;
pub const SQL_ALL_SCHEMAS: ::windows_strings::PCSTR = ::windows_strings::s!("%");
pub const SQL_ALL_TABLE_TYPES: ::windows_strings::PCSTR = ::windows_strings::s!("%");
...
pub const SQL_OPT_TRACE_FILE_DEFAULT: ::windows_strings::PCSTR = ::windows_strings::s!("\\SQL.LOG");
...
pub const SQL_SPEC_STRING: ::windows_strings::PCSTR = ::windows_strings::s!("03.80");
...
pub const SQL_SS_DL_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("STATS.LOG");
pub const SQL_SS_QI_DEFAULT: u32 = 30000u32;
pub const SQL_SS_QL_DEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("QUERY.LOG");
