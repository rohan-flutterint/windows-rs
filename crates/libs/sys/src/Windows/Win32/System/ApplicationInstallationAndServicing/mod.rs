...
pub const IACTIONNAME_ADMIN: ::windows_strings::PCWSTR = ::windows_strings::w!("ADMIN");
pub const IACTIONNAME_ADVERTISE: ::windows_strings::PCWSTR = ::windows_strings::w!("ADVERTISE");
pub const IACTIONNAME_COLLECTUSERINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("CollectUserInfo");
pub const IACTIONNAME_FIRSTRUN: ::windows_strings::PCWSTR = ::windows_strings::w!("FirstRun");
pub const IACTIONNAME_INSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("INSTALL");
pub const IACTIONNAME_SEQUENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("SEQUENCE");
...
pub const INSTALLPROPERTY_ASSIGNMENTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("AssignmentType");
pub const INSTALLPROPERTY_AUTHORIZED_LUA_APP: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthorizedLUAApp");
pub const INSTALLPROPERTY_DISKPROMPT: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskPrompt");
pub const INSTALLPROPERTY_DISPLAYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisplayName");
pub const INSTALLPROPERTY_HELPLINK: ::windows_strings::PCWSTR = ::windows_strings::w!("HelpLink");
pub const INSTALLPROPERTY_HELPTELEPHONE: ::windows_strings::PCWSTR = ::windows_strings::w!("HelpTelephone");
pub const INSTALLPROPERTY_INSTALLDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("InstallDate");
pub const INSTALLPROPERTY_INSTALLEDLANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("InstalledLanguage");
pub const INSTALLPROPERTY_INSTALLEDPRODUCTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("InstalledProductName");
pub const INSTALLPROPERTY_INSTALLLOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("InstallLocation");
pub const INSTALLPROPERTY_INSTALLSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("InstallSource");
pub const INSTALLPROPERTY_INSTANCETYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("InstanceType");
pub const INSTALLPROPERTY_LANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Language");
pub const INSTALLPROPERTY_LASTUSEDSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("LastUsedSource");
pub const INSTALLPROPERTY_LASTUSEDTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("LastUsedType");
pub const INSTALLPROPERTY_LOCALPACKAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalPackage");
pub const INSTALLPROPERTY_LUAENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("LUAEnabled");
pub const INSTALLPROPERTY_MEDIAPACKAGEPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("MediaPackagePath");
pub const INSTALLPROPERTY_MOREINFOURL: ::windows_strings::PCWSTR = ::windows_strings::w!("MoreInfoURL");
pub const INSTALLPROPERTY_PACKAGECODE: ::windows_strings::PCWSTR = ::windows_strings::w!("PackageCode");
pub const INSTALLPROPERTY_PACKAGENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PackageName");
pub const INSTALLPROPERTY_PATCHSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("State");
pub const INSTALLPROPERTY_PATCHTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("PatchType");
pub const INSTALLPROPERTY_PRODUCTICON: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductIcon");
pub const INSTALLPROPERTY_PRODUCTID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductID");
pub const INSTALLPROPERTY_PRODUCTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductName");
pub const INSTALLPROPERTY_PRODUCTSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("State");
pub const INSTALLPROPERTY_PUBLISHER: ::windows_strings::PCWSTR = ::windows_strings::w!("Publisher");
pub const INSTALLPROPERTY_REGCOMPANY: ::windows_strings::PCWSTR = ::windows_strings::w!("RegCompany");
pub const INSTALLPROPERTY_REGOWNER: ::windows_strings::PCWSTR = ::windows_strings::w!("RegOwner");
pub const INSTALLPROPERTY_TRANSFORMS: ::windows_strings::PCWSTR = ::windows_strings::w!("Transforms");
pub const INSTALLPROPERTY_UNINSTALLABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Uninstallable");
pub const INSTALLPROPERTY_URLINFOABOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("URLInfoAbout");
pub const INSTALLPROPERTY_URLUPDATEINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("URLUpdateInfo");
pub const INSTALLPROPERTY_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const INSTALLPROPERTY_VERSIONMAJOR: ::windows_strings::PCWSTR = ::windows_strings::w!("VersionMajor");
pub const INSTALLPROPERTY_VERSIONMINOR: ::windows_strings::PCWSTR = ::windows_strings::w!("VersionMinor");
pub const INSTALLPROPERTY_VERSIONSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("VersionString");
...
pub const IPROPNAME_ACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("ACTION");
pub const IPROPNAME_ADMINTOOLS_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("AdminToolsFolder");
pub const IPROPNAME_ADMINUSER: ::windows_strings::PCWSTR = ::windows_strings::w!("AdminUser");
pub const IPROPNAME_ADMIN_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("AdminProperties");
pub const IPROPNAME_AFTERREBOOT: ::windows_strings::PCWSTR = ::windows_strings::w!("AFTERREBOOT");
pub const IPROPNAME_ALLOWEDPROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("SecureCustomProperties");
pub const IPROPNAME_ALLUSERS: ::windows_strings::PCWSTR = ::windows_strings::w!("ALLUSERS");
pub const IPROPNAME_APPDATA_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("AppDataFolder");
pub const IPROPNAME_ARM: ::windows_strings::PCWSTR = ::windows_strings::w!("Arm");
pub const IPROPNAME_ARM64: ::windows_strings::PCWSTR = ::windows_strings::w!("Arm64");
pub const IPROPNAME_ARPAUTHORIZEDCDFPREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPAUTHORIZEDCDFPREFIX");
pub const IPROPNAME_ARPCOMMENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPCOMMENTS");
pub const IPROPNAME_ARPCONTACT: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPCONTACT");
pub const IPROPNAME_ARPHELPLINK: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPHELPLINK");
pub const IPROPNAME_ARPHELPTELEPHONE: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPHELPTELEPHONE");
pub const IPROPNAME_ARPINSTALLLOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPINSTALLLOCATION");
pub const IPROPNAME_ARPNOMODIFY: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPNOMODIFY");
pub const IPROPNAME_ARPNOREMOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPNOREMOVE");
pub const IPROPNAME_ARPNOREPAIR: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPNOREPAIR");
pub const IPROPNAME_ARPPRODUCTICON: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPPRODUCTICON");
pub const IPROPNAME_ARPREADME: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPREADME");
pub const IPROPNAME_ARPSETTINGSIDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIARPSETTINGSIDENTIFIER");
pub const IPROPNAME_ARPSHIMFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SHIMFLAGS");
pub const IPROPNAME_ARPSHIMSERVICEPACKLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("SHIMSERVICEPACKLEVEL");
pub const IPROPNAME_ARPSHIMVERSIONNT: ::windows_strings::PCWSTR = ::windows_strings::w!("SHIMVERSIONNT");
pub const IPROPNAME_ARPSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPSIZE");
pub const IPROPNAME_ARPSYSTEMCOMPONENT: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPSYSTEMCOMPONENT");
pub const IPROPNAME_ARPURLINFOABOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPURLINFOABOUT");
pub const IPROPNAME_ARPURLUPDATEINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("ARPURLUPDATEINFO");
pub const IPROPNAME_AVAILABLEFREEREG: ::windows_strings::PCWSTR = ::windows_strings::w!("AVAILABLEFREEREG");
pub const IPROPNAME_BORDERSIDE: ::windows_strings::PCWSTR = ::windows_strings::w!("BorderSide");
pub const IPROPNAME_BORDERTOP: ::windows_strings::PCWSTR = ::windows_strings::w!("BorderTop");
pub const IPROPNAME_CAPTIONHEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("CaptionHeight");
pub const IPROPNAME_CARRYINGNDP: ::windows_strings::PCWSTR = ::windows_strings::w!("CARRYINGNDP");
pub const IPROPNAME_CHECKCRCS: ::windows_strings::PCWSTR = ::windows_strings::w!("MSICHECKCRCS");
pub const IPROPNAME_COLORBITS: ::windows_strings::PCWSTR = ::windows_strings::w!("ColorBits");
pub const IPROPNAME_COMMONAPPDATA_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonAppDataFolder");
pub const IPROPNAME_COMMONFILES64_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonFiles64Folder");
pub const IPROPNAME_COMMONFILES_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonFilesFolder");
pub const IPROPNAME_COMPANYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("COMPANYNAME");
pub const IPROPNAME_COMPONENTADDDEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("COMPADDDEFAULT");
pub const IPROPNAME_COMPONENTADDLOCAL: ::windows_strings::PCWSTR = ::windows_strings::w!("COMPADDLOCAL");
pub const IPROPNAME_COMPONENTADDSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("COMPADDSOURCE");
pub const IPROPNAME_COMPUTERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ComputerName");
pub const IPROPNAME_COSTINGCOMPLETE: ::windows_strings::PCWSTR = ::windows_strings::w!("CostingComplete");
pub const IPROPNAME_CUSTOMACTIONDATA: ::windows_strings::PCWSTR = ::windows_strings::w!("CustomActionData");
pub const IPROPNAME_DATE: ::windows_strings::PCWSTR = ::windows_strings::w!("Date");
pub const IPROPNAME_DATETIME: ::windows_strings::PCWSTR = ::windows_strings::w!("DateTime");
pub const IPROPNAME_DEFAULTUIFONT: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultUIFont");
pub const IPROPNAME_DESKTOP_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("DesktopFolder");
pub const IPROPNAME_DISABLEADVTSHORTCUTS: ::windows_strings::PCWSTR = ::windows_strings::w!("DISABLEADVTSHORTCUTS");
pub const IPROPNAME_DISABLEROLLBACK: ::windows_strings::PCWSTR = ::windows_strings::w!("DISABLEROLLBACK");
pub const IPROPNAME_DISKPROMPT: ::windows_strings::PCWSTR = ::windows_strings::w!("DiskPrompt");
pub const IPROPNAME_ENABLEUSERCONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableUserControl");
pub const IPROPNAME_ENFORCE_UPGRADE_COMPONENT_RULES: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIENFORCEUPGRADECOMPONENTRULES");
pub const IPROPNAME_EXECUTEACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("EXECUTEACTION");
pub const IPROPNAME_EXECUTEMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("EXECUTEMODE");
pub const IPROPNAME_FAVORITES_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("FavoritesFolder");
pub const IPROPNAME_FEATUREADDDEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("ADDDEFAULT");
pub const IPROPNAME_FEATUREADDLOCAL: ::windows_strings::PCWSTR = ::windows_strings::w!("ADDLOCAL");
pub const IPROPNAME_FEATUREADDSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("ADDSOURCE");
pub const IPROPNAME_FEATUREADVERTISE: ::windows_strings::PCWSTR = ::windows_strings::w!("ADVERTISE");
pub const IPROPNAME_FEATUREREMOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("REMOVE");
pub const IPROPNAME_FILEADDDEFAULT: ::windows_strings::PCWSTR = ::windows_strings::w!("FILEADDDEFAULT");
pub const IPROPNAME_FILEADDLOCAL: ::windows_strings::PCWSTR = ::windows_strings::w!("FILEADDLOCAL");
pub const IPROPNAME_FILEADDSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("FILEADDSOURCE");
pub const IPROPNAME_FONTS_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("FontsFolder");
pub const IPROPNAME_HIDDEN_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiHiddenProperties");
pub const IPROPNAME_HIDECANCEL: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiUIHideCancel");
pub const IPROPNAME_IA64: ::windows_strings::PCWSTR = ::windows_strings::w!("IA64");
pub const IPROPNAME_INSTALLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Installed");
pub const IPROPNAME_INSTALLLANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductLanguage");
pub const IPROPNAME_INSTALLLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("INSTALLLEVEL");
pub const IPROPNAME_INSTALLPERUSER: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIINSTALLPERUSER");
pub const IPROPNAME_INTEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Intel");
pub const IPROPNAME_INTEL64: ::windows_strings::PCWSTR = ::windows_strings::w!("Intel64");
pub const IPROPNAME_INTERNALINSTALLEDPERUSER: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIINTERNALINSTALLEDPERUSER");
pub const IPROPNAME_ISADMINPACKAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("IsAdminPackage");
pub const IPROPNAME_LEFTUNIT: ::windows_strings::PCWSTR = ::windows_strings::w!("LeftUnit");
pub const IPROPNAME_LIMITUI: ::windows_strings::PCWSTR = ::windows_strings::w!("LIMITUI");
pub const IPROPNAME_LOCALAPPDATA_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalAppDataFolder");
pub const IPROPNAME_LOGACTION: ::windows_strings::PCWSTR = ::windows_strings::w!("LOGACTION");
pub const IPROPNAME_LOGONUSER: ::windows_strings::PCWSTR = ::windows_strings::w!("LogonUser");
pub const IPROPNAME_MANUFACTURER: ::windows_strings::PCWSTR = ::windows_strings::w!("Manufacturer");
pub const IPROPNAME_MSIAMD64: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiAMD64");
pub const IPROPNAME_MSIDISABLEEEUI: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIDISABLEEEUI");
pub const IPROPNAME_MSIDISABLELUAPATCHING: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIDISABLELUAPATCHING");
pub const IPROPNAME_MSIINSTANCEGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIINSTANCEGUID");
pub const IPROPNAME_MSILOGFILELOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiLogFileLocation");
pub const IPROPNAME_MSILOGGINGMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiLogging");
pub const IPROPNAME_MSINEWINSTANCE: ::windows_strings::PCWSTR = ::windows_strings::w!("MSINEWINSTANCE");
pub const IPROPNAME_MSINODISABLEMEDIA: ::windows_strings::PCWSTR = ::windows_strings::w!("MSINODISABLEMEDIA");
pub const IPROPNAME_MSIPACKAGEDOWNLOADLOCALCOPY: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIPACKAGEDOWNLOADLOCALCOPY");
pub const IPROPNAME_MSIPATCHDOWNLOADLOCALCOPY: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIPATCHDOWNLOADLOCALCOPY");
pub const IPROPNAME_MSIPATCHREMOVE: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIPATCHREMOVE");
pub const IPROPNAME_MSITABLETPC: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiTabletPC");
pub const IPROPNAME_MSIX64: ::windows_strings::PCWSTR = ::windows_strings::w!("Msix64");
pub const IPROPNAME_MSI_FASTINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIFASTINSTALL");
pub const IPROPNAME_MSI_REBOOT_PENDING: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiSystemRebootPending");
pub const IPROPNAME_MSI_RM_CONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIRESTARTMANAGERCONTROL");
pub const IPROPNAME_MSI_RM_DISABLE_RESTART: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIDISABLERMRESTART");
pub const IPROPNAME_MSI_RM_SESSION_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiRestartManagerSessionKey");
pub const IPROPNAME_MSI_RM_SHUTDOWN: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIRMSHUTDOWN");
pub const IPROPNAME_MSI_UAC_DEPLOYMENT_COMPLIANT: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIDEPLOYMENTCOMPLIANT");
pub const IPROPNAME_MSI_UNINSTALL_SUPERSEDED_COMPONENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIUNINSTALLSUPERSEDEDCOMPONENTS");
pub const IPROPNAME_MSI_USE_REAL_ADMIN_DETECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("MSIUSEREALADMINDETECTION");
pub const IPROPNAME_MYPICTURES_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("MyPicturesFolder");
pub const IPROPNAME_NETASSEMBLYSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNetAssemblySupport");
pub const IPROPNAME_NETHOOD_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("NetHoodFolder");
pub const IPROPNAME_NOCOMPANYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("NOCOMPANYNAME");
pub const IPROPNAME_NOUSERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("NOUSERNAME");
pub const IPROPNAME_NTPRODUCTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTProductType");
pub const IPROPNAME_NTSUITEBACKOFFICE: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteBackOffice");
pub const IPROPNAME_NTSUITEDATACENTER: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteDataCenter");
pub const IPROPNAME_NTSUITEENTERPRISE: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteEnterprise");
pub const IPROPNAME_NTSUITEPERSONAL: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuitePersonal");
pub const IPROPNAME_NTSUITESMALLBUSINESS: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteSmallBusiness");
pub const IPROPNAME_NTSUITESMALLBUSINESSRESTRICTED: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteSmallBusinessRestricted");
pub const IPROPNAME_NTSUITEWEBSERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiNTSuiteWebServer");
pub const IPROPNAME_OLEADVTSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("OLEAdvtSupport");
pub const IPROPNAME_OUTOFDISKSPACE: ::windows_strings::PCWSTR = ::windows_strings::w!("OutOfDiskSpace");
pub const IPROPNAME_OUTOFNORBDISKSPACE: ::windows_strings::PCWSTR = ::windows_strings::w!("OutOfNoRbDiskSpace");
pub const IPROPNAME_PATCH: ::windows_strings::PCWSTR = ::windows_strings::w!("PATCH");
pub const IPROPNAME_PATCHNEWPACKAGECODE: ::windows_strings::PCWSTR = ::windows_strings::w!("PATCHNEWPACKAGECODE");
pub const IPROPNAME_PATCHNEWSUMMARYCOMMENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("PATCHNEWSUMMARYCOMMENTS");
pub const IPROPNAME_PATCHNEWSUMMARYSUBJECT: ::windows_strings::PCWSTR = ::windows_strings::w!("PATCHNEWSUMMARYSUBJECT");
pub const IPROPNAME_PERSONAL_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("PersonalFolder");
pub const IPROPNAME_PHYSICALMEMORY: ::windows_strings::PCWSTR = ::windows_strings::w!("PhysicalMemory");
pub const IPROPNAME_PIDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("PIDKEY");
pub const IPROPNAME_PIDTEMPLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("PIDTemplate");
pub const IPROPNAME_PRESELECTED: ::windows_strings::PCWSTR = ::windows_strings::w!("Preselected");
pub const IPROPNAME_PRIMARYFOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("PRIMARYFOLDER");
pub const IPROPNAME_PRIMARYFOLDER_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryVolumePath");
pub const IPROPNAME_PRIMARYFOLDER_SPACEAVAILABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryVolumeSpaceAvailable");
pub const IPROPNAME_PRIMARYFOLDER_SPACEREMAINING: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryVolumeSpaceRemaining");
pub const IPROPNAME_PRIMARYFOLDER_SPACEREQUIRED: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimaryVolumeSpaceRequired");
pub const IPROPNAME_PRINTHOOD_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("PrintHoodFolder");
pub const IPROPNAME_PRIVILEGED: ::windows_strings::PCWSTR = ::windows_strings::w!("Privileged");
pub const IPROPNAME_PRODUCTCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductCode");
pub const IPROPNAME_PRODUCTID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductID");
pub const IPROPNAME_PRODUCTLANGUAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("PRODUCTLANGUAGE");
pub const IPROPNAME_PRODUCTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductName");
pub const IPROPNAME_PRODUCTSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductState");
pub const IPROPNAME_PRODUCTVERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductVersion");
pub const IPROPNAME_PROGRAMFILES64_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgramFiles64Folder");
pub const IPROPNAME_PROGRAMFILES_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgramFilesFolder");
pub const IPROPNAME_PROGRAMMENU_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("ProgramMenuFolder");
pub const IPROPNAME_PROGRESSONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiUIProgressOnly");
pub const IPROPNAME_PROMPTROLLBACKCOST: ::windows_strings::PCWSTR = ::windows_strings::w!("PROMPTROLLBACKCOST");
pub const IPROPNAME_REBOOT: ::windows_strings::PCWSTR = ::windows_strings::w!("REBOOT");
pub const IPROPNAME_REBOOTPROMPT: ::windows_strings::PCWSTR = ::windows_strings::w!("REBOOTPROMPT");
pub const IPROPNAME_RECENT_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("RecentFolder");
pub const IPROPNAME_REDIRECTEDDLLSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("RedirectedDllSupport");
pub const IPROPNAME_REINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("REINSTALL");
pub const IPROPNAME_REINSTALLMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("REINSTALLMODE");
pub const IPROPNAME_REMOTEADMINTS: ::windows_strings::PCWSTR = ::windows_strings::w!("RemoteAdminTS");
pub const IPROPNAME_REPLACEDINUSEFILES: ::windows_strings::PCWSTR = ::windows_strings::w!("ReplacedInUseFiles");
pub const IPROPNAME_RESTRICTEDUSERCONTROL: ::windows_strings::PCWSTR = ::windows_strings::w!("RestrictedUserControl");
pub const IPROPNAME_RESUME: ::windows_strings::PCWSTR = ::windows_strings::w!("RESUME");
pub const IPROPNAME_ROLLBACKDISABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("RollbackDisabled");
pub const IPROPNAME_ROOTDRIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("ROOTDRIVE");
pub const IPROPNAME_RUNNINGELEVATED: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiRunningElevated");
pub const IPROPNAME_SCREENX: ::windows_strings::PCWSTR = ::windows_strings::w!("ScreenX");
pub const IPROPNAME_SCREENY: ::windows_strings::PCWSTR = ::windows_strings::w!("ScreenY");
pub const IPROPNAME_SENDTO_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("SendToFolder");
pub const IPROPNAME_SEQUENCE: ::windows_strings::PCWSTR = ::windows_strings::w!("SEQUENCE");
pub const IPROPNAME_SERVICEPACKLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicePackLevel");
pub const IPROPNAME_SERVICEPACKLEVELMINOR: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicePackLevelMinor");
pub const IPROPNAME_SHAREDWINDOWS: ::windows_strings::PCWSTR = ::windows_strings::w!("SharedWindows");
pub const IPROPNAME_SHELLADVTSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("ShellAdvtSupport");
pub const IPROPNAME_SHORTFILENAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("SHORTFILENAMES");
pub const IPROPNAME_SOURCEDIR: ::windows_strings::PCWSTR = ::windows_strings::w!("SourceDir");
pub const IPROPNAME_SOURCELIST: ::windows_strings::PCWSTR = ::windows_strings::w!("SOURCELIST");
pub const IPROPNAME_SOURCERESONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiUISourceResOnly");
pub const IPROPNAME_STARTMENU_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("StartMenuFolder");
pub const IPROPNAME_STARTUP_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("StartupFolder");
pub const IPROPNAME_SYSTEM16_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("System16Folder");
pub const IPROPNAME_SYSTEM64_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("System64Folder");
pub const IPROPNAME_SYSTEMLANGUAGEID: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemLanguageID");
pub const IPROPNAME_SYSTEM_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemFolder");
pub const IPROPNAME_TARGETDIR: ::windows_strings::PCWSTR = ::windows_strings::w!("TARGETDIR");
pub const IPROPNAME_TEMPLATE_AMD64: ::windows_strings::PCWSTR = ::windows_strings::w!("AMD64");
pub const IPROPNAME_TEMPLATE_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("TemplateFolder");
pub const IPROPNAME_TEMPLATE_X64: ::windows_strings::PCWSTR = ::windows_strings::w!("x64");
pub const IPROPNAME_TEMP_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("TempFolder");
pub const IPROPNAME_TERMSERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("TerminalServer");
pub const IPROPNAME_TEXTHEIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("TextHeight");
pub const IPROPNAME_TEXTHEIGHT_CORRECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("TextHeightCorrection");
pub const IPROPNAME_TEXTINTERNALLEADING: ::windows_strings::PCWSTR = ::windows_strings::w!("TextInternalLeading");
pub const IPROPNAME_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("Time");
pub const IPROPNAME_TRANSFORMS: ::windows_strings::PCWSTR = ::windows_strings::w!("TRANSFORMS");
pub const IPROPNAME_TRANSFORMSATSOURCE: ::windows_strings::PCWSTR = ::windows_strings::w!("TRANSFORMSATSOURCE");
pub const IPROPNAME_TRANSFORMSSECURE: ::windows_strings::PCWSTR = ::windows_strings::w!("TRANSFORMSSECURE");
pub const IPROPNAME_TRUEADMINUSER: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiTrueAdminUser");
pub const IPROPNAME_TTCSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("TTCSupport");
pub const IPROPNAME_UACONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiUIUACOnly");
pub const IPROPNAME_UPDATESTARTED: ::windows_strings::PCWSTR = ::windows_strings::w!("UpdateStarted");
pub const IPROPNAME_UPGRADECODE: ::windows_strings::PCWSTR = ::windows_strings::w!("UpgradeCode");
pub const IPROPNAME_USERLANGUAGEID: ::windows_strings::PCWSTR = ::windows_strings::w!("UserLanguageID");
pub const IPROPNAME_USERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("USERNAME");
pub const IPROPNAME_USERSID: ::windows_strings::PCWSTR = ::windows_strings::w!("UserSID");
pub const IPROPNAME_VERSION9X: ::windows_strings::PCWSTR = ::windows_strings::w!("Version9X");
pub const IPROPNAME_VERSIONNT: ::windows_strings::PCWSTR = ::windows_strings::w!("VersionNT");
pub const IPROPNAME_VERSIONNT64: ::windows_strings::PCWSTR = ::windows_strings::w!("VersionNT64");
pub const IPROPNAME_VIRTUALMEMORY: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualMemory");
pub const IPROPNAME_WIN32ASSEMBLYSUPPORT: ::windows_strings::PCWSTR = ::windows_strings::w!("MsiWin32AssemblySupport");
pub const IPROPNAME_WINDOWSBUILD: ::windows_strings::PCWSTR = ::windows_strings::w!("WindowsBuild");
pub const IPROPNAME_WINDOWS_FOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("WindowsFolder");
pub const IPROPNAME_WINDOWS_VOLUME: ::windows_strings::PCWSTR = ::windows_strings::w!("WindowsVolume");
pub const IPROPVALUE_EXECUTEMODE_NONE: ::windows_strings::PCWSTR = ::windows_strings::w!("NONE");
pub const IPROPVALUE_EXECUTEMODE_SCRIPT: ::windows_strings::PCWSTR = ::windows_strings::w!("SCRIPT");
pub const IPROPVALUE_FEATURE_ALL: ::windows_strings::PCWSTR = ::windows_strings::w!("ALL");
pub const IPROPVALUE_MSI_RM_CONTROL_DISABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Disable");
pub const IPROPVALUE_MSI_RM_CONTROL_DISABLESHUTDOWN: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableShutdown");
pub const IPROPVALUE_RBCOST_FAIL: ::windows_strings::PCWSTR = ::windows_strings::w!("F");
pub const IPROPVALUE_RBCOST_PROMPT: ::windows_strings::PCWSTR = ::windows_strings::w!("P");
pub const IPROPVALUE_RBCOST_SILENT: ::windows_strings::PCWSTR = ::windows_strings::w!("D");
pub const IPROPVALUE__CARRYINGNDP_URTREINSTALL: ::windows_strings::PCWSTR = ::windows_strings::w!("URTREINSTALL");
pub const IPROPVALUE__CARRYINGNDP_URTUPGRADE: ::windows_strings::PCWSTR = ::windows_strings::w!("URTUPGRADE");
...
pub const SFC_IDLE_TRIGGER: ::windows_strings::PCWSTR = ::windows_strings::w!("WFP_IDLE_TRIGGER");
