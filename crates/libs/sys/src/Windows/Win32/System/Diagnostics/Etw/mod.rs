...
pub const EVENT_LOGGER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLog");
pub const EVENT_LOGGER_NAMEA: ::windows_strings::PCSTR = ::windows_strings::s!("EventLog");
pub const EVENT_LOGGER_NAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLog");
...
pub const GLOBAL_LOGGER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("GlobalLogger");
pub const GLOBAL_LOGGER_NAMEA: ::windows_strings::PCSTR = ::windows_strings::s!("GlobalLogger");
pub const GLOBAL_LOGGER_NAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("GlobalLogger");
pub const ImageLoadGuid: ::windows_sys::core::GUID = ::windows_sys::core::GUID::from_u128(0x2cb15d1d_5fc1_11d2_abe1_00a0c911f518);
pub const KERNEL_LOGGER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("NT Kernel Logger");
pub const KERNEL_LOGGER_NAMEA: ::windows_strings::PCSTR = ::windows_strings::s!("NT Kernel Logger");
pub const KERNEL_LOGGER_NAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("NT Kernel Logger");
