...
pub const RESTORE_LAST_ERROR_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreLastError");
pub const RESTORE_LAST_ERROR_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("RestoreLastError");
pub const RESTORE_LAST_ERROR_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreLastError");
