...
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_A_A: ::windows_strings::PCSTR = ::windows_strings::s!("GetSystemWow64DirectoryA");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_A_T: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryA");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_A_W: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryA");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_A: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryW");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_T: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryW");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_T_W: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryW");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_A: ::windows_strings::PCSTR = ::windows_strings::s!("GetSystemWow64DirectoryW");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_T: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryW");
pub const GET_SYSTEM_WOW64_DIRECTORY_NAME_W_W: ::windows_strings::PCWSTR = ::windows_strings::w!("GetSystemWow64DirectoryW");
...
pub const REG_RESTORE_LOG_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("RegRestoreLogFile");
pub const REG_SAVE_LOG_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("RegSaveLogFile");
...
pub const WLDP_CANEXECUTEBUFFER_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpCanExecuteBuffer");
pub const WLDP_CANEXECUTEFILE_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpCanExecuteFile");
pub const WLDP_DLL: ::windows_strings::PCWSTR = ::windows_strings::w!("WLDP.DLL");
...
pub const WLDP_GETLOCKDOWNPOLICY_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpGetLockdownPolicy");
...
pub const WLDP_ISAPPAPPROVEDBYPOLICY_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpIsAppApprovedByPolicy");
pub const WLDP_ISCLASSINAPPROVEDLIST_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpIsClassInApprovedList");
pub const WLDP_ISDYNAMICCODEPOLICYENABLED_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpIsDynamicCodePolicyEnabled");
pub const WLDP_ISPRODUCTIONCONFIGURATION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpIsProductionConfiguration");
pub const WLDP_ISWCOSPRODUCTIONCONFIGURATION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpIsWcosProductionConfiguration");
...
pub const WLDP_QUERYDANAMICCODETRUST_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryDynamicCodeTrust");
pub const WLDP_QUERYDEVICESECURITYINFORMATION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryDeviceSecurityInformation");
pub const WLDP_QUERYDYNAMICCODETRUST_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryDynamicCodeTrust");
pub const WLDP_QUERYPOLICYSETTINGENABLED2_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryPolicySettingEnabled2");
pub const WLDP_QUERYPOLICYSETTINGENABLED_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryPolicySettingEnabled");
pub const WLDP_QUERYWINDOWSLOCKDOWNMODE_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryWindowsLockdownMode");
pub const WLDP_QUERYWINDOWSLOCKDOWNRESTRICTION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpQueryWindowsLockdownRestriction");
pub const WLDP_RESETPRODUCTIONCONFIGURATION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpResetProductionConfiguration");
pub const WLDP_RESETWCOSPRODUCTIONCONFIGURATION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpResetWcosProductionConfiguration");
pub const WLDP_SETDYNAMICCODETRUST_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpSetDynamicCodeTrust");
pub const WLDP_SETWINDOWSLOCKDOWNRESTRICTION_FN: ::windows_strings::PCSTR = ::windows_strings::s!("WldpSetWindowsLockdownRestriction");
