...
pub const SC_AGGREGATE_STORAGE_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("System\\CurrentControlSet\\Control\\ServiceAggregatedEvents");
...
pub const SERVICES_ACTIVE_DATABASE: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicesActive");
pub const SERVICES_ACTIVE_DATABASEA: ::windows_strings::PCSTR = ::windows_strings::s!("ServicesActive");
pub const SERVICES_ACTIVE_DATABASEW: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicesActive");
pub const SERVICES_FAILED_DATABASE: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicesFailed");
pub const SERVICES_FAILED_DATABASEA: ::windows_strings::PCSTR = ::windows_strings::s!("ServicesFailed");
pub const SERVICES_FAILED_DATABASEW: ::windows_strings::PCWSTR = ::windows_strings::w!("ServicesFailed");
...
pub const SERVICE_TRIGGER_STARTED_ARGUMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("TriggerStarted");
