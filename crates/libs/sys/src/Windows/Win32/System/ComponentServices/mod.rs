...
pub const TRACKER_INIT_EVENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Global\\COM+ Tracker Init Event");
pub const TRACKER_STARTSTOP_EVENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Global\\COM+ Tracker Push Event");
