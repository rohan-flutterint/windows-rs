...
pub const PERF_AGGREGATE_INSTANCE: ::windows_strings::PCWSTR = ::windows_strings::w!("_Total");
...
pub const PERF_WILDCARD_INSTANCE: ::windows_strings::PCWSTR = ::windows_strings::w!("*");
