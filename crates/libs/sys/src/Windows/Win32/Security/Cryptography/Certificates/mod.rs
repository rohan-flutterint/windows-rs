...
pub const szBACKUPANNOTATION: ::windows_strings::PCSTR = ::windows_strings::s!("Cert Server Backup Interface");
pub const szDBBASENAMEPARM: ::windows_strings::PCSTR = ::windows_strings::s!("edb");
pub const szNAMESEPARATORDEFAULT: ::windows_strings::PCSTR = ::windows_strings::s!("\n");
pub const szPROPASNTAG: ::windows_strings::PCSTR = ::windows_strings::s!("{asn}");
pub const szRESTOREANNOTATION: ::windows_strings::PCSTR = ::windows_strings::s!("Cert Server Restore Interface");
pub const wszAT_EKCERTINF: ::windows_strings::PCWSTR = ::windows_strings::w!("@EKCert");
pub const wszAT_TESTROOT: ::windows_strings::PCWSTR = ::windows_strings::w!("@TestRoot");
pub const wszCAPOLICYFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPolicy.inf");
pub const wszCERTEXITMODULE_POSTFIX: ::windows_strings::PCWSTR = ::windows_strings::w!(".Exit");
pub const wszCERTIFICATETRANSPARENCYFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateTransparencyFlags");
pub const wszCERTMANAGE_SUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("Manage");
pub const wszCERTPOLICYMODULE_POSTFIX: ::windows_strings::PCWSTR = ::windows_strings::w!(".Policy");
pub const wszCERT_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestType");
pub const wszCERT_TYPE_CLIENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Client");
pub const wszCERT_TYPE_CODESIGN: ::windows_strings::PCWSTR = ::windows_strings::w!("CodeSign");
pub const wszCERT_TYPE_CUSTOMER: ::windows_strings::PCWSTR = ::windows_strings::w!("SetCustomer");
pub const wszCERT_TYPE_MERCHANT: ::windows_strings::PCWSTR = ::windows_strings::w!("SetMerchant");
pub const wszCERT_TYPE_PAYMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("SetPayment");
pub const wszCERT_TYPE_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Server");
pub const wszCERT_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const wszCERT_VERSION_1: ::windows_strings::PCWSTR = ::windows_strings::w!("1");
pub const wszCERT_VERSION_2: ::windows_strings::PCWSTR = ::windows_strings::w!("2");
pub const wszCERT_VERSION_3: ::windows_strings::PCWSTR = ::windows_strings::w!("3");
pub const wszCLASS_CERTADMIN: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.Admin");
pub const wszCLASS_CERTCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.Config");
pub const wszCLASS_CERTDBMEM: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.DBMem");
pub const wszCLASS_CERTENCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.Encode");
pub const wszCLASS_CERTGETCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.GetConfig");
pub const wszCLASS_CERTREQUEST: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.Request");
pub const wszCLASS_CERTSERVEREXIT: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.ServerExit");
pub const wszCLASS_CERTSERVERPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.ServerPolicy");
pub const wszCLASS_CERTVIEW: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority.View");
pub const wszCMM_PROP_COPYRIGHT: ::windows_strings::PCWSTR = ::windows_strings::w!("Copyright");
pub const wszCMM_PROP_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const wszCMM_PROP_DISPLAY_HWND: ::windows_strings::PCWSTR = ::windows_strings::w!("HWND");
pub const wszCMM_PROP_FILEVER: ::windows_strings::PCWSTR = ::windows_strings::w!("File Version");
pub const wszCMM_PROP_ISMULTITHREADED: ::windows_strings::PCWSTR = ::windows_strings::w!("IsMultiThreaded");
pub const wszCMM_PROP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const wszCMM_PROP_PRODUCTVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Product Version");
pub const wszCNGENCRYPTIONALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CNGEncryptionAlgorithm");
pub const wszCNGHASHALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CNGHashAlgorithm");
pub const wszCNGPUBLICKEYALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CNGPublicKeyAlgorithm");
pub const wszCONFIG_AUTHORITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Authority");
pub const wszCONFIG_COMMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Comment");
pub const wszCONFIG_COMMONNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonName");
pub const wszCONFIG_CONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("Config");
pub const wszCONFIG_COUNTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("Country");
pub const wszCONFIG_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const wszCONFIG_EXCHANGECERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("ExchangeCertificate");
pub const wszCONFIG_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
pub const wszCONFIG_LOCALITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Locality");
pub const wszCONFIG_ORGANIZATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Organization");
pub const wszCONFIG_ORGUNIT: ::windows_strings::PCWSTR = ::windows_strings::w!("OrgUnit");
pub const wszCONFIG_SANITIZEDNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SanitizedName");
pub const wszCONFIG_SANITIZEDSHORTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SanitizedShortName");
pub const wszCONFIG_SERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("Server");
pub const wszCONFIG_SHORTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ShortName");
pub const wszCONFIG_SIGNATURECERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SignatureCertificate");
pub const wszCONFIG_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("State");
pub const wszCONFIG_WEBENROLLMENTSERVERS: ::windows_strings::PCWSTR = ::windows_strings::w!("WebEnrollmentServers");
pub const wszCRLPUBLISHRETRYCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublishRetryCount");
pub const wszCRTFILENAMEEXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".crt");
pub const wszDATFILENAMEEXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".dat");
pub const wszDBBACKUPCERTBACKDAT: ::windows_strings::PCWSTR = ::windows_strings::w!("certbkxp.dat");
pub const wszDBBACKUPSUBDIR: ::windows_strings::PCWSTR = ::windows_strings::w!("DataBase");
pub const wszDBFILENAMEEXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".edb");
pub const wszENCRYPTIONALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("EncryptionAlgorithm");
pub const wszENROLLMENTAGENTRIGHTS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnrollmentAgentRights");
pub const wszHASHALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("HashAlgorithm");
pub const wszINFKEY_ALTERNATESIGNATUREALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AlternateSignatureAlgorithm");
pub const wszINFKEY_ATTESTPRIVATEKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("AttestPrivateKey");
pub const wszINFKEY_CACAPABILITIES: ::windows_strings::PCWSTR = ::windows_strings::w!("CACapabilities");
pub const wszINFKEY_CACERTS: ::windows_strings::PCWSTR = ::windows_strings::w!("CACerts");
pub const wszINFKEY_CATHUMBPRINT: ::windows_strings::PCWSTR = ::windows_strings::w!("CAThumbprint");
pub const wszINFKEY_CCDPSYNCDELTATIME: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncDeltaTime");
pub const wszINFKEY_CHALLENGEPASSWORD: ::windows_strings::PCWSTR = ::windows_strings::w!("ChallengePassword");
pub const wszINFKEY_CONTINUE: ::windows_strings::PCWSTR = ::windows_strings::w!("_continue_");
pub const wszINFKEY_CRITICAL: ::windows_strings::PCWSTR = ::windows_strings::w!("Critical");
pub const wszINFKEY_CRLDELTAPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaPeriodUnits");
pub const wszINFKEY_CRLDELTAPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaPeriod");
pub const wszINFKEY_CRLPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPeriodUnits");
pub const wszINFKEY_CRLPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPeriod");
pub const wszINFKEY_DIRECTORYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DirectoryName");
pub const wszINFKEY_DNS: ::windows_strings::PCWSTR = ::windows_strings::w!("DNS");
pub const wszINFKEY_ECCKEYPARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters");
pub const wszINFKEY_ECCKEYPARAMETERSTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParametersType");
pub const wszINFKEY_ECCKEYPARAMETERS_A: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_A");
pub const wszINFKEY_ECCKEYPARAMETERS_B: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_B");
pub const wszINFKEY_ECCKEYPARAMETERS_BASE: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_Base");
pub const wszINFKEY_ECCKEYPARAMETERS_COFACTOR: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_Cofactor");
pub const wszINFKEY_ECCKEYPARAMETERS_ORDER: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_Order");
pub const wszINFKEY_ECCKEYPARAMETERS_P: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_P");
pub const wszINFKEY_ECCKEYPARAMETERS_SEED: ::windows_strings::PCWSTR = ::windows_strings::w!("EccKeyParameters_Seed");
pub const wszINFKEY_EMAIL: ::windows_strings::PCWSTR = ::windows_strings::w!("EMail");
pub const wszINFKEY_EMPTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Empty");
pub const wszINFKEY_ENABLEKEYCOUNTING: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableKeyCounting");
pub const wszINFKEY_ENCRYPTIONALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("EncryptionAlgorithm");
pub const wszINFKEY_ENCRYPTIONLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("EncryptionLength");
pub const wszINFKEY_EXCLUDE: ::windows_strings::PCWSTR = ::windows_strings::w!("Exclude");
pub const wszINFKEY_EXPORTABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Exportable");
pub const wszINFKEY_EXPORTABLEENCRYPTED: ::windows_strings::PCWSTR = ::windows_strings::w!("ExportableEncrypted");
pub const wszINFKEY_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
pub const wszINFKEY_FORCEUTF8: ::windows_strings::PCWSTR = ::windows_strings::w!("ForceUTF8");
pub const wszINFKEY_FRIENDLYNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FriendlyName");
pub const wszINFKEY_HASHALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("HashAlgorithm");
pub const wszINFKEY_INCLUDE: ::windows_strings::PCWSTR = ::windows_strings::w!("Include");
pub const wszINFKEY_INHIBITPOLICYMAPPING: ::windows_strings::PCWSTR = ::windows_strings::w!("InhibitPolicyMapping");
pub const wszINFKEY_IPADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("IPAddress");
pub const wszINFKEY_KEYALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyAlgorithm");
pub const wszINFKEY_KEYALGORITHMPARMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyAlgorithmParameters");
pub const wszINFKEY_KEYCONTAINER: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyContainer");
pub const wszINFKEY_KEYLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyLength");
pub const wszINFKEY_KEYPROTECTION: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyProtection");
pub const wszINFKEY_KEYUSAGEEXTENSION: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyUsage");
pub const wszINFKEY_KEYUSAGEPROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyUsageProperty");
pub const wszINFKEY_LEGACYKEYSPEC: ::windows_strings::PCWSTR = ::windows_strings::w!("KeySpec");
pub const wszINFKEY_LOADDEFAULTTEMPLATES: ::windows_strings::PCWSTR = ::windows_strings::w!("LoadDefaultTemplates");
pub const wszINFKEY_MACHINEKEYSET: ::windows_strings::PCWSTR = ::windows_strings::w!("MachineKeySet");
pub const wszINFKEY_NOTAFTER: ::windows_strings::PCWSTR = ::windows_strings::w!("NotAfter");
pub const wszINFKEY_NOTBEFORE: ::windows_strings::PCWSTR = ::windows_strings::w!("NotBefore");
pub const wszINFKEY_NOTICE: ::windows_strings::PCWSTR = ::windows_strings::w!("Notice");
pub const wszINFKEY_OID: ::windows_strings::PCWSTR = ::windows_strings::w!("OID");
pub const wszINFKEY_OTHERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("OtherName");
pub const wszINFKEY_PATHLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("PathLength");
pub const wszINFKEY_POLICIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Policies");
pub const wszINFKEY_PRIVATEKEYARCHIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrivateKeyArchive");
pub const wszINFKEY_PROVIDERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderName");
pub const wszINFKEY_PROVIDERTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderType");
pub const wszINFKEY_PUBLICKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKey");
pub const wszINFKEY_PUBLICKEYPARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKeyParameters");
pub const wszINFKEY_READERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ReaderName");
pub const wszINFKEY_REGISTEREDID: ::windows_strings::PCWSTR = ::windows_strings::w!("RegisteredId");
pub const wszINFKEY_RENEWALCERT: ::windows_strings::PCWSTR = ::windows_strings::w!("RenewalCert");
pub const wszINFKEY_RENEWALKEYLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("RenewalKeyLength");
pub const wszINFKEY_RENEWALVALIDITYPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("RenewalValidityPeriodUnits");
pub const wszINFKEY_RENEWALVALIDITYPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("RenewalValidityPeriod");
pub const wszINFKEY_REQUESTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestType");
pub const wszINFKEY_REQUIREEXPLICITPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("RequireExplicitPolicy");
pub const wszINFKEY_SECURITYDESCRIPTOR: ::windows_strings::PCWSTR = ::windows_strings::w!("SecurityDescriptor");
pub const wszINFKEY_SERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("SerialNumber");
pub const wszINFKEY_SHOWALLCSPS: ::windows_strings::PCWSTR = ::windows_strings::w!("ShowAllCSPs");
pub const wszINFKEY_SILENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Silent");
pub const wszINFKEY_SMIME: ::windows_strings::PCWSTR = ::windows_strings::w!("SMIME");
pub const wszINFKEY_SUBJECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Subject");
pub const wszINFKEY_SUBJECTNAMEFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectNameFlags");
pub const wszINFKEY_SUBTREE: ::windows_strings::PCWSTR = ::windows_strings::w!("SubTree");
pub const wszINFKEY_SUPPRESSDEFAULTS: ::windows_strings::PCWSTR = ::windows_strings::w!("SuppressDefaults");
pub const wszINFKEY_UICONTEXTMESSAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("UIContextMessage");
pub const wszINFKEY_UPN: ::windows_strings::PCWSTR = ::windows_strings::w!("UPN");
pub const wszINFKEY_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("URL");
pub const wszINFKEY_USEEXISTINGKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("UseExistingKeySet");
pub const wszINFKEY_USERPROTECTED: ::windows_strings::PCWSTR = ::windows_strings::w!("UserProtected");
pub const wszINFKEY_UTF8: ::windows_strings::PCWSTR = ::windows_strings::w!("UTF8");
pub const wszINFKEY_X500NAMEFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("X500NameFlags");
pub const wszINFSECTION_AIA: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthorityInformationAccess");
pub const wszINFSECTION_APPLICATIONPOLICYCONSTRAINTS: ::windows_strings::PCWSTR = ::windows_strings::w!("ApplicationPolicyConstraintsExtension");
pub const wszINFSECTION_APPLICATIONPOLICYMAPPINGS: ::windows_strings::PCWSTR = ::windows_strings::w!("ApplicationPolicyMappingsExtension");
pub const wszINFSECTION_APPLICATIONPOLICYSTATEMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("ApplicationPolicyStatementExtension");
pub const wszINFSECTION_BASICCONSTRAINTS: ::windows_strings::PCWSTR = ::windows_strings::w!("BasicConstraintsExtension");
pub const wszINFSECTION_CAPOLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPolicy");
pub const wszINFSECTION_CCDP: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossCertificateDistributionPointsExtension");
pub const wszINFSECTION_CDP: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDistributionPoint");
pub const wszINFSECTION_CERTSERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("certsrv_server");
pub const wszINFSECTION_EKU: ::windows_strings::PCWSTR = ::windows_strings::w!("EnhancedKeyUsageExtension");
pub const wszINFSECTION_EXTENSIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("Extensions");
pub const wszINFSECTION_NAMECONSTRAINTS: ::windows_strings::PCWSTR = ::windows_strings::w!("NameConstraintsExtension");
pub const wszINFSECTION_NEWREQUEST: ::windows_strings::PCWSTR = ::windows_strings::w!("NewRequest");
pub const wszINFSECTION_POLICYCONSTRAINTS: ::windows_strings::PCWSTR = ::windows_strings::w!("PolicyConstraintsExtension");
pub const wszINFSECTION_POLICYMAPPINGS: ::windows_strings::PCWSTR = ::windows_strings::w!("PolicyMappingsExtension");
pub const wszINFSECTION_POLICYSTATEMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("PolicyStatementExtension");
pub const wszINFSECTION_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Properties");
pub const wszINFSECTION_REQUESTATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestAttributes");
pub const wszINFVALUE_ENDORSEMENTKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("EndorsementKey");
pub const wszINFVALUE_REQUESTTYPE_CERT: ::windows_strings::PCWSTR = ::windows_strings::w!("Cert");
pub const wszINFVALUE_REQUESTTYPE_CMC: ::windows_strings::PCWSTR = ::windows_strings::w!("CMC");
pub const wszINFVALUE_REQUESTTYPE_PKCS10: ::windows_strings::PCWSTR = ::windows_strings::w!("PKCS10");
pub const wszINFVALUE_REQUESTTYPE_PKCS7: ::windows_strings::PCWSTR = ::windows_strings::w!("PKCS7");
pub const wszINFVALUE_REQUESTTYPE_SCEP: ::windows_strings::PCWSTR = ::windows_strings::w!("SCEP");
pub const wszLDAPSESSIONOPTIONVALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPSessionOptionValue");
pub const wszLOCALIZEDTIMEPERIODUNITS: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalizedTimePeriodUnits");
pub const wszLOGFILENAMEEXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".log");
pub const wszLOGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("CertLog");
pub const wszMACHINEKEYSET: ::windows_strings::PCWSTR = ::windows_strings::w!("MachineKeyset");
pub const wszMICROSOFTCERTMODULE_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateAuthority_MicrosoftDefault");
pub const wszNETSCAPEREVOCATIONTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("Netscape");
pub const wszOCSPCAPROP_CACERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CACertificate");
pub const wszOCSPCAPROP_CACONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("CAConfig");
pub const wszOCSPCAPROP_CSPNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CSPName");
pub const wszOCSPCAPROP_ERRORCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("ErrorCode");
pub const wszOCSPCAPROP_HASHALGORITHMID: ::windows_strings::PCWSTR = ::windows_strings::w!("HashAlgorithmId");
pub const wszOCSPCAPROP_KEYSPEC: ::windows_strings::PCWSTR = ::windows_strings::w!("KeySpec");
pub const wszOCSPCAPROP_LOCALREVOCATIONINFORMATION: ::windows_strings::PCWSTR = ::windows_strings::w!("LocalRevocationInformation");
pub const wszOCSPCAPROP_PROVIDERCLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderCLSID");
pub const wszOCSPCAPROP_PROVIDERPROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider");
pub const wszOCSPCAPROP_REMINDERDURATION: ::windows_strings::PCWSTR = ::windows_strings::w!("ReminderDuration");
pub const wszOCSPCAPROP_SIGNINGCERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SigningCertificate");
pub const wszOCSPCAPROP_SIGNINGCERTIFICATETEMPLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SigningCertificateTemplate");
pub const wszOCSPCAPROP_SIGNINGFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SigningFlags");
pub const wszOCSPCOMMONPROP_MAXINCOMINGMESSAGESIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxIncomingMessageSize");
pub const wszOCSPCOMMONPROP_MAXNUMOFREQUESTENTRIES: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxNumOfRequestEntries");
pub const wszOCSPCOMMONPROP_REQFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestFlags");
pub const wszOCSPISAPIPROP_DEBUG: ::windows_strings::PCWSTR = ::windows_strings::w!("ISAPIDebug");
pub const wszOCSPISAPIPROP_MAXAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAge");
pub const wszOCSPISAPIPROP_MAXNUMOFCACHEENTRIES: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxNumOfCacheEntries");
pub const wszOCSPISAPIPROP_NUMOFBACKENDCONNECTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("NumOfBackendConnections");
pub const wszOCSPISAPIPROP_NUMOFTHREADS: ::windows_strings::PCWSTR = ::windows_strings::w!("NumOfThreads");
pub const wszOCSPISAPIPROP_REFRESHRATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RefreshRate");
pub const wszOCSPISAPIPROP_VIRTUALROOTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("VirtualRootName");
pub const wszOCSPPROP_ARRAYCONTROLLER: ::windows_strings::PCWSTR = ::windows_strings::w!("ArrayController");
pub const wszOCSPPROP_ARRAYMEMBERS: ::windows_strings::PCWSTR = ::windows_strings::w!("ArrayMembers");
pub const wszOCSPPROP_AUDITFILTER: ::windows_strings::PCWSTR = ::windows_strings::w!("AuditFilter");
pub const wszOCSPPROP_DEBUG: ::windows_strings::PCWSTR = ::windows_strings::w!("Debug");
pub const wszOCSPPROP_ENROLLPOLLINTERVAL: ::windows_strings::PCWSTR = ::windows_strings::w!("EnrollPollInterval");
pub const wszOCSPPROP_LOGLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("LogLevel");
pub const wszOCSPREVPROP_BASECRL: ::windows_strings::PCWSTR = ::windows_strings::w!("BaseCrl");
pub const wszOCSPREVPROP_BASECRLURLS: ::windows_strings::PCWSTR = ::windows_strings::w!("BaseCrlUrls");
pub const wszOCSPREVPROP_CRLURLTIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("CrlUrlTimeOut");
pub const wszOCSPREVPROP_DELTACRL: ::windows_strings::PCWSTR = ::windows_strings::w!("DeltaCrl");
pub const wszOCSPREVPROP_DELTACRLURLS: ::windows_strings::PCWSTR = ::windows_strings::w!("DeltaCrlUrls");
pub const wszOCSPREVPROP_ERRORCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("RevocationErrorCode");
pub const wszOCSPREVPROP_REFRESHTIMEOUT: ::windows_strings::PCWSTR = ::windows_strings::w!("RefreshTimeOut");
pub const wszOCSPREVPROP_SERIALNUMBERSDIRS: ::windows_strings::PCWSTR = ::windows_strings::w!("IssuedSerialNumbersDirectories");
pub const wszPERIODDAYS: ::windows_strings::PCWSTR = ::windows_strings::w!("Days");
pub const wszPERIODHOURS: ::windows_strings::PCWSTR = ::windows_strings::w!("Hours");
pub const wszPERIODMINUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("Minutes");
pub const wszPERIODMONTHS: ::windows_strings::PCWSTR = ::windows_strings::w!("Months");
pub const wszPERIODSECONDS: ::windows_strings::PCWSTR = ::windows_strings::w!("Seconds");
pub const wszPERIODWEEKS: ::windows_strings::PCWSTR = ::windows_strings::w!("Weeks");
pub const wszPERIODYEARS: ::windows_strings::PCWSTR = ::windows_strings::w!("Years");
pub const wszPFXFILENAMEEXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".p12");
pub const wszPROPATTESTATIONCHALLENGE: ::windows_strings::PCWSTR = ::windows_strings::w!("AttestationChallenge");
pub const wszPROPATTRIBNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AttributeName");
pub const wszPROPATTRIBREQUESTID: ::windows_strings::PCWSTR = ::windows_strings::w!("AttributeRequestId");
pub const wszPROPATTRIBVALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("AttributeValue");
pub const wszPROPCALLERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CallerName");
pub const wszPROPCATYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("CAType");
pub const wszPROPCERTCLIENTMACHINE: ::windows_strings::PCWSTR = ::windows_strings::w!("ccm");
pub const wszPROPCERTCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CertCount");
pub const wszPROPCERTIFICATEENROLLMENTFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnrollmentFlags");
pub const wszPROPCERTIFICATEGENERALFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("GeneralFlags");
pub const wszPROPCERTIFICATEHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateHash");
pub const wszPROPCERTIFICATENOTAFTERDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("NotAfter");
pub const wszPROPCERTIFICATENOTBEFOREDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("NotBefore");
pub const wszPROPCERTIFICATEPRIVATEKEYFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("PrivatekeyFlags");
pub const wszPROPCERTIFICATEPUBLICKEYALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKeyAlgorithm");
pub const wszPROPCERTIFICATEPUBLICKEYLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKeyLength");
pub const wszPROPCERTIFICATERAWPUBLICKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("RawPublicKey");
pub const wszPROPCERTIFICATERAWPUBLICKEYALGORITHMPARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("RawPublicKeyAlgorithmParameters");
pub const wszPROPCERTIFICATERAWSMIMECAPABILITIES: ::windows_strings::PCWSTR = ::windows_strings::w!("RawSMIMECapabilities");
pub const wszPROPCERTIFICATEREQUESTID: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestID");
pub const wszPROPCERTIFICATESERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("SerialNumber");
pub const wszPROPCERTIFICATESUBJECTKEYIDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectKeyIdentifier");
pub const wszPROPCERTIFICATETEMPLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateTemplate");
pub const wszPROPCERTIFICATETYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateType");
pub const wszPROPCERTIFICATEUPN: ::windows_strings::PCWSTR = ::windows_strings::w!("UPN");
pub const wszPROPCERTSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertState");
pub const wszPROPCERTSUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("CertSuffix");
pub const wszPROPCERTTEMPLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateTemplate");
pub const wszPROPCERTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertType");
pub const wszPROPCERTUSAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertificateUsage");
pub const wszPROPCHALLENGE: ::windows_strings::PCWSTR = ::windows_strings::w!("Challenge");
pub const wszPROPCLIENTBROWSERMACHINE: ::windows_strings::PCWSTR = ::windows_strings::w!("cbm");
pub const wszPROPCLIENTDCDNS: ::windows_strings::PCWSTR = ::windows_strings::w!("cdc");
pub const wszPROPCOMMONNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonName");
pub const wszPROPCONFIGDN: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigDN");
pub const wszPROPCOUNTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("Country");
pub const wszPROPCRITICALTAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{critical}");
pub const wszPROPCRLCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLCount");
pub const wszPROPCRLEFFECTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLEffective");
pub const wszPROPCRLINDEX: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLIndex");
pub const wszPROPCRLLASTPUBLISHED: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLLastPublished");
pub const wszPROPCRLMINBASE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLMinBase");
pub const wszPROPCRLNAMEID: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLNameId");
pub const wszPROPCRLNEXTPUBLISH: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLNextPublish");
pub const wszPROPCRLNEXTUPDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLNextUpdate");
pub const wszPROPCRLNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLNumber");
pub const wszPROPCRLPROPAGATIONCOMPLETE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPropagationComplete");
pub const wszPROPCRLPUBLISHATTEMPTS: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublishAttempts");
pub const wszPROPCRLPUBLISHERROR: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublishError");
pub const wszPROPCRLPUBLISHFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublishFlags");
pub const wszPROPCRLPUBLISHSTATUSCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublishStatusCode");
pub const wszPROPCRLRAWCRL: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLRawCRL");
pub const wszPROPCRLROWID: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLRowId");
pub const wszPROPCRLSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLState");
pub const wszPROPCRLSUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLSuffix");
pub const wszPROPCRLTHISPUBLISH: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLThisPublish");
pub const wszPROPCRLTHISUPDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLThisUpdate");
pub const wszPROPCROSSFOREST: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossForest");
pub const wszPROPDCNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DCName");
pub const wszPROPDECIMALTAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{decimal}");
pub const wszPROPDELTACRLSDISABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("fDeltaCRLsDisabled");
pub const wszPROPDEVICESERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("DeviceSerialNumber");
pub const wszPROPDISPOSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("Disposition");
pub const wszPROPDISPOSITIONDENY: ::windows_strings::PCWSTR = ::windows_strings::w!("Deny");
pub const wszPROPDISPOSITIONPENDING: ::windows_strings::PCWSTR = ::windows_strings::w!("Pending");
pub const wszPROPDISTINGUISHEDNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DistinguishedName");
pub const wszPROPDN: ::windows_strings::PCWSTR = ::windows_strings::w!("dn");
pub const wszPROPDNS: ::windows_strings::PCWSTR = ::windows_strings::w!("dns");
pub const wszPROPDOMAINCOMPONENT: ::windows_strings::PCWSTR = ::windows_strings::w!("DomainComponent");
pub const wszPROPDOMAINDN: ::windows_strings::PCWSTR = ::windows_strings::w!("DomainDN");
pub const wszPROPEMAIL: ::windows_strings::PCWSTR = ::windows_strings::w!("EMail");
pub const wszPROPENDORSEMENTCERTIFICATEHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("EndorsementCertificateHash");
pub const wszPROPENDORSEMENTKEYHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("EndorsementKeyHash");
pub const wszPROPEVENTLOGERROR: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLogError");
pub const wszPROPEVENTLOGEXHAUSTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLogExhaustive");
pub const wszPROPEVENTLOGTERSE: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLogTerse");
pub const wszPROPEVENTLOGVERBOSE: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLogVerbose");
pub const wszPROPEVENTLOGWARNING: ::windows_strings::PCWSTR = ::windows_strings::w!("EventLogWarning");
pub const wszPROPEXITCERTFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertFile");
pub const wszPROPEXPECTEDCHALLENGE: ::windows_strings::PCWSTR = ::windows_strings::w!("ExpectedChallenge");
pub const wszPROPEXPIRATIONDATE: ::windows_strings::PCWSTR = ::windows_strings::w!("ExpirationDate");
pub const wszPROPEXTFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionFlags");
pub const wszPROPEXTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionName");
pub const wszPROPEXTRAWVALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionRawValue");
pub const wszPROPEXTREQUESTID: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionRequestId");
pub const wszPROPFILETAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{file}");
pub const wszPROPGIVENNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("GivenName");
pub const wszPROPGUID: ::windows_strings::PCWSTR = ::windows_strings::w!("guid");
pub const wszPROPHEXTAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{hex}");
pub const wszPROPINITIALS: ::windows_strings::PCWSTR = ::windows_strings::w!("Initials");
pub const wszPROPIPADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("ipaddress");
pub const wszPROPKEYARCHIVED: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyArchived");
pub const wszPROPLOCALITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Locality");
pub const wszPROPLOGLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("LogLevel");
pub const wszPROPMACHINEDNSNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MachineDNSName");
pub const wszPROPMODULEREGLOC: ::windows_strings::PCWSTR = ::windows_strings::w!("ModuleRegistryLocation");
pub const wszPROPNAMETYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("NameType");
pub const wszPROPOCTETTAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{octet}");
pub const wszPROPOFFICER: ::windows_strings::PCWSTR = ::windows_strings::w!("Officer");
pub const wszPROPOID: ::windows_strings::PCWSTR = ::windows_strings::w!("oid");
pub const wszPROPORGANIZATION: ::windows_strings::PCWSTR = ::windows_strings::w!("Organization");
pub const wszPROPORGUNIT: ::windows_strings::PCWSTR = ::windows_strings::w!("OrgUnit");
pub const wszPROPPUBLISHEXPIREDCERTINCRL: ::windows_strings::PCWSTR = ::windows_strings::w!("PublishExpiredCertInCRL");
pub const wszPROPRAWCACERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RawCACertificate");
pub const wszPROPRAWCERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RawCertificate");
pub const wszPROPRAWCRL: ::windows_strings::PCWSTR = ::windows_strings::w!("RawCRL");
pub const wszPROPRAWDELTACRL: ::windows_strings::PCWSTR = ::windows_strings::w!("RawDeltaCRL");
pub const wszPROPRAWNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RawName");
pub const wszPROPRAWPRECERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RawPrecertificate");
pub const wszPROPREQUESTARCHIVEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("ArchivedKey");
pub const wszPROPREQUESTATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestAttributes");
pub const wszPROPREQUESTCSPPROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestCSPProvider");
pub const wszPROPREQUESTDISPOSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("Disposition");
pub const wszPROPREQUESTDISPOSITIONMESSAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("DispositionMessage");
pub const wszPROPREQUESTDOT: ::windows_strings::PCWSTR = ::windows_strings::w!("Request.");
pub const wszPROPREQUESTERCAACCESS: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterCAAccess");
pub const wszPROPREQUESTERDN: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterDN");
pub const wszPROPREQUESTERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterName");
pub const wszPROPREQUESTERNAMEFROMOLDCERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterNameFromOldCertificate");
pub const wszPROPREQUESTERSAMNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterSAMName");
pub const wszPROPREQUESTERUPN: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterUPN");
pub const wszPROPREQUESTFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestFlags");
pub const wszPROPREQUESTKEYRECOVERYHASHES: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyRecoveryHashes");
pub const wszPROPREQUESTMACHINEDNS: ::windows_strings::PCWSTR = ::windows_strings::w!("rmd");
pub const wszPROPREQUESTOSVERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestOSVersion");
pub const wszPROPREQUESTRAWARCHIVEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("RawArchivedKey");
pub const wszPROPREQUESTRAWOLDCERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("RawOldCertificate");
pub const wszPROPREQUESTRAWREQUEST: ::windows_strings::PCWSTR = ::windows_strings::w!("RawRequest");
pub const wszPROPREQUESTREQUESTID: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestID");
pub const wszPROPREQUESTRESOLVEDWHEN: ::windows_strings::PCWSTR = ::windows_strings::w!("ResolvedWhen");
pub const wszPROPREQUESTREVOKEDEFFECTIVEWHEN: ::windows_strings::PCWSTR = ::windows_strings::w!("RevokedEffectiveWhen");
pub const wszPROPREQUESTREVOKEDREASON: ::windows_strings::PCWSTR = ::windows_strings::w!("RevokedReason");
pub const wszPROPREQUESTREVOKEDWHEN: ::windows_strings::PCWSTR = ::windows_strings::w!("RevokedWhen");
pub const wszPROPREQUESTSTATUSCODE: ::windows_strings::PCWSTR = ::windows_strings::w!("StatusCode");
pub const wszPROPREQUESTSUBMITTEDWHEN: ::windows_strings::PCWSTR = ::windows_strings::w!("SubmittedWhen");
pub const wszPROPREQUESTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestType");
pub const wszPROPSANITIZEDCANAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SanitizedCAName");
pub const wszPROPSANITIZEDSHORTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SanitizedShortName");
pub const wszPROPSEAUDITFILTER: ::windows_strings::PCWSTR = ::windows_strings::w!("SEAuditFilter");
pub const wszPROPSEAUDITID: ::windows_strings::PCWSTR = ::windows_strings::w!("SEAuditId");
pub const wszPROPSERVERUPGRADED: ::windows_strings::PCWSTR = ::windows_strings::w!("fServerUpgraded");
pub const wszPROPSESSIONCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("SessionCount");
pub const wszPROPSIGNERAPPLICATIONPOLICIES: ::windows_strings::PCWSTR = ::windows_strings::w!("SignerApplicationPolicies");
pub const wszPROPSIGNERPOLICIES: ::windows_strings::PCWSTR = ::windows_strings::w!("SignerPolicies");
pub const wszPROPSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("State");
pub const wszPROPSTREETADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("StreetAddress");
pub const wszPROPSUBJECTALTNAME2: ::windows_strings::PCWSTR = ::windows_strings::w!("san");
pub const wszPROPSUBJECTDOT: ::windows_strings::PCWSTR = ::windows_strings::w!("Subject.");
pub const wszPROPSURNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SurName");
pub const wszPROPTEMPLATECHANGESEQUENCENUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("TemplateChangeSequenceNumber");
pub const wszPROPTEXTTAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{text}");
pub const wszPROPTITLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Title");
pub const wszPROPUNSTRUCTUREDADDRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("UnstructuredAddress");
pub const wszPROPUNSTRUCTUREDNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("UnstructuredName");
pub const wszPROPUPN: ::windows_strings::PCWSTR = ::windows_strings::w!("upn");
pub const wszPROPURL: ::windows_strings::PCWSTR = ::windows_strings::w!("url");
pub const wszPROPUSEDS: ::windows_strings::PCWSTR = ::windows_strings::w!("fUseDS");
pub const wszPROPUSERDN: ::windows_strings::PCWSTR = ::windows_strings::w!("UserDN");
pub const wszPROPUTF8TAG: ::windows_strings::PCWSTR = ::windows_strings::w!("{utf8}");
pub const wszPROPVALIDITYPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("ValidityPeriodUnits");
pub const wszPROPVALIDITYPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("ValidityPeriod");
pub const wszPROPVOLATILEMODE: ::windows_strings::PCWSTR = ::windows_strings::w!("VolatileMode");
pub const wszREGACTIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("Active");
pub const wszREGAELOGLEVEL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("AEEventLogLevel");
pub const wszREGAIKCLOUDCAURL: ::windows_strings::PCWSTR = ::windows_strings::w!("AIKCloudCAURL");
pub const wszREGAIKKEYALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AIKKeyAlgorithm");
pub const wszREGAIKKEYLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("AIKKeyLength");
pub const wszREGALLPROVIDERS: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const wszREGALTERNATEPUBLISHDOMAINS: ::windows_strings::PCWSTR = ::windows_strings::w!("AlternatePublishDomains");
pub const wszREGALTERNATESIGNATUREALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AlternateSignatureAlgorithm");
pub const wszREGAUDITFILTER: ::windows_strings::PCWSTR = ::windows_strings::w!("AuditFilter");
pub const wszREGB2ICERTMANAGEMODULE: ::windows_strings::PCWSTR = ::windows_strings::w!("ICertManageModule");
pub const wszREGBACKUPLOGDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("BackupLogDirectory");
pub const wszREGCACERTFILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CACertFileName");
pub const wszREGCACERTHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("CACertHash");
pub const wszREGCACERTPUBLICATIONURLS: ::windows_strings::PCWSTR = ::windows_strings::w!("CACertPublicationURLs");
pub const wszREGCADESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("CADescription");
pub const wszREGCAPATHLENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPathLength");
pub const wszREGCASECURITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Security");
pub const wszREGCASERIALNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("CACertSerialNumber");
pub const wszREGCASERVERNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CAServerName");
pub const wszREGCATYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("CAType");
pub const wszREGCAUSEDS: ::windows_strings::PCWSTR = ::windows_strings::w!("UseDS");
pub const wszREGCAXCHGCERTHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("CAXchgCertHash");
pub const wszREGCAXCHGOVERLAPPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CAXchgOverlapPeriodUnits");
pub const wszREGCAXCHGOVERLAPPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CAXchgOverlapPeriod");
pub const wszREGCAXCHGVALIDITYPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CAXchgValidityPeriodUnits");
pub const wszREGCAXCHGVALIDITYPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CAXchgValidityPeriod");
pub const wszREGCERTENROLLCOMPATIBLE: ::windows_strings::PCWSTR = ::windows_strings::w!("CertEnrollCompatible");
pub const wszREGCERTIFICATETRANSPARENCYINFOOID: ::windows_strings::PCWSTR = ::windows_strings::w!("CTInformationExtensionOid");
pub const wszREGCERTPUBLISHFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("PublishCertFlags");
pub const wszREGCERTSRVDEBUG: ::windows_strings::PCWSTR = ::windows_strings::w!("Debug");
pub const wszREGCHECKPOINTFILE: ::windows_strings::PCWSTR = ::windows_strings::w!("CheckPointFile");
pub const wszREGCLOCKSKEWMINUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("ClockSkewMinutes");
pub const wszREGCOMMONNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CommonName");
pub const wszREGCRLATTEMPTREPUBLISH: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLAttemptRepublish");
pub const wszREGCRLDELTANEXTPUBLISH: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaNextPublish");
pub const wszREGCRLDELTAOVERLAPPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaOverlapUnits");
pub const wszREGCRLDELTAOVERLAPPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaOverlapPeriod");
pub const wszREGCRLDELTAPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaPeriodUnits");
pub const wszREGCRLDELTAPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLDeltaPeriod");
pub const wszREGCRLEDITFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLEditFlags");
pub const wszREGCRLFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLFlags");
pub const wszREGCRLNEXTPUBLISH: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLNextPublish");
pub const wszREGCRLOVERLAPPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLOverlapUnits");
pub const wszREGCRLOVERLAPPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLOverlapPeriod");
pub const wszREGCRLPATH_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPath");
pub const wszREGCRLPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPeriodUnits");
pub const wszREGCRLPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPeriod");
pub const wszREGCRLPUBLICATIONURLS: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLPublicationURLs");
pub const wszREGDATABASERECOVERED: ::windows_strings::PCWSTR = ::windows_strings::w!("DatabaseRecovered");
pub const wszREGDBDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("DBDirectory");
pub const wszREGDBFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("DBFlags");
pub const wszREGDBLASTFULLBACKUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DBLastFullBackup");
pub const wszREGDBLASTINCREMENTALBACKUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DBLastIncrementalBackup");
pub const wszREGDBLASTRECOVERY: ::windows_strings::PCWSTR = ::windows_strings::w!("DBLastRecovery");
pub const wszREGDBLOGDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("DBLogDirectory");
pub const wszREGDBMAXREADSESSIONCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("DBMaxReadSessionCount");
pub const wszREGDBSESSIONCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("DBSessionCount");
pub const wszREGDBSYSDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("DBSystemDirectory");
pub const wszREGDBTEMPDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("DBTempDirectory");
pub const wszREGDEFAULTSMIME: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultSMIME");
pub const wszREGDIRECTORY: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigurationDirectory");
pub const wszREGDISABLEEXTENSIONLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableExtensionList");
pub const wszREGDSCONFIGDN: ::windows_strings::PCWSTR = ::windows_strings::w!("DSConfigDN");
pub const wszREGDSDOMAINDN: ::windows_strings::PCWSTR = ::windows_strings::w!("DSDomainDN");
pub const wszREGEDITFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EditFlags");
pub const wszREGEKPUBLISTDIRECTORIES: ::windows_strings::PCWSTR = ::windows_strings::w!("EndorsementKeyListDirectories");
pub const wszREGEKUOIDSFORPUBLISHEXPIREDCERTINCRL: ::windows_strings::PCWSTR = ::windows_strings::w!("EKUOIDsForPublishExpiredCertInCRL");
pub const wszREGEKUOIDSFORVOLATILEREQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("EKUOIDsforVolatileRequests");
pub const wszREGENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled");
pub const wszREGENABLEDEKUFORDEFINEDCACERT: ::windows_strings::PCWSTR = ::windows_strings::w!("EnabledEKUForDefinedCACert");
pub const wszREGENABLEENROLLEEREQUESTEXTENSIONLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableEnrolleeRequestExtensionList");
pub const wszREGENABLEREQUESTEXTENSIONLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableRequestExtensionList");
pub const wszREGENFORCEX500NAMELENGTHS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnforceX500NameLengths");
pub const wszREGENROLLFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("EnrollFlags");
pub const wszREGEXITBODYARG: ::windows_strings::PCWSTR = ::windows_strings::w!("BodyArg");
pub const wszREGEXITBODYFORMAT: ::windows_strings::PCWSTR = ::windows_strings::w!("BodyFormat");
pub const wszREGEXITCRLISSUEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLIssued");
pub const wszREGEXITDENIEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Denied");
pub const wszREGEXITIMPORTEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Imported");
pub const wszREGEXITISSUEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Issued");
pub const wszREGEXITPENDINGKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Pending");
pub const wszREGEXITPROPNOTFOUND: ::windows_strings::PCWSTR = ::windows_strings::w!("???");
pub const wszREGEXITREVOKEDKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Revoked");
pub const wszREGEXITSHUTDOWNKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Shutdown");
pub const wszREGEXITSMTPAUTHENTICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SMTPAuthenticate");
pub const wszREGEXITSMTPCC: ::windows_strings::PCWSTR = ::windows_strings::w!("Cc");
pub const wszREGEXITSMTPEVENTFILTER: ::windows_strings::PCWSTR = ::windows_strings::w!("EventFilter");
pub const wszREGEXITSMTPFROM: ::windows_strings::PCWSTR = ::windows_strings::w!("From");
pub const wszREGEXITSMTPKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("SMTP");
pub const wszREGEXITSMTPSERVER: ::windows_strings::PCWSTR = ::windows_strings::w!("SMTPServer");
pub const wszREGEXITSMTPTEMPLATES: ::windows_strings::PCWSTR = ::windows_strings::w!("Templates");
pub const wszREGEXITSMTPTO: ::windows_strings::PCWSTR = ::windows_strings::w!("To");
pub const wszREGEXITSTARTUPKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("Startup");
pub const wszREGEXITTITLEARG: ::windows_strings::PCWSTR = ::windows_strings::w!("TitleArg");
pub const wszREGEXITTITLEFORMAT: ::windows_strings::PCWSTR = ::windows_strings::w!("TitleFormat");
pub const wszREGFILEISSUERCERTURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("FileIssuerCertURL");
pub const wszREGFILEREVOCATIONCRLURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("FileRevocationCRLURL");
pub const wszREGFORCETELETEX: ::windows_strings::PCWSTR = ::windows_strings::w!("ForceTeletex");
pub const wszREGFTPISSUERCERTURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("FTPIssuerCertURL");
pub const wszREGFTPREVOCATIONCRLURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("FTPRevocationCRLURL");
pub const wszREGHIGHLOGNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("HighLogNumber");
pub const wszREGHIGHSERIAL: ::windows_strings::PCWSTR = ::windows_strings::w!("HighSerial");
pub const wszREGINTERFACEFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("InterfaceFlags");
pub const wszREGISSUERCERTURLFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("IssuerCertURLFlags");
pub const wszREGISSUERCERTURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("IssuerCertURL");
pub const wszREGKEYBASE: ::windows_strings::PCWSTR = ::windows_strings::w!("SYSTEM\\CurrentControlSet\\Services\\CertSvc");
pub const wszREGKEYCERTSVCPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("SYSTEM\\CurrentControlSet\\Services\\CertSvc");
pub const wszREGKEYCONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("Configuration");
pub const wszREGKEYCSP: ::windows_strings::PCWSTR = ::windows_strings::w!("CSP");
pub const wszREGKEYDBPARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("DBParameters");
pub const wszREGKEYENCRYPTIONCSP: ::windows_strings::PCWSTR = ::windows_strings::w!("EncryptionCSP");
pub const wszREGKEYENROLLMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Cryptography\\AutoEnrollment");
pub const wszREGKEYEXITMODULES: ::windows_strings::PCWSTR = ::windows_strings::w!("ExitModules");
pub const wszREGKEYGROUPPOLICYENROLLMENT: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Policies\\Microsoft\\Cryptography\\AutoEnrollment");
pub const wszREGKEYNOSYSTEMCERTSVCPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("CurrentControlSet\\Services\\CertSvc");
pub const wszREGKEYPOLICYMODULES: ::windows_strings::PCWSTR = ::windows_strings::w!("PolicyModules");
pub const wszREGKEYREPAIR: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyRepair");
pub const wszREGKEYRESTOREINPROGRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreInProgress");
pub const wszREGKEYSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("KeySize");
pub const wszREGKRACERTCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("KRACertCount");
pub const wszREGKRACERTHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("KRACertHash");
pub const wszREGKRAFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("KRAFlags");
pub const wszREGLDAPFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPFlags");
pub const wszREGLDAPISSUERCERTURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPIssuerCertURL");
pub const wszREGLDAPREVOCATIONCRLURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPRevocationCRLURL");
pub const wszREGLDAPREVOCATIONDNTEMPLATE_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPRevocationDNTemplate");
pub const wszREGLDAPREVOCATIONDN_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPRevocationDN");
pub const wszREGLDAPSESSIONOPTIONS: ::windows_strings::PCWSTR = ::windows_strings::w!("LDAPSessionOptions");
pub const wszREGLOGLEVEL: ::windows_strings::PCWSTR = ::windows_strings::w!("LogLevel");
pub const wszREGLOGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("LogPath");
pub const wszREGLOWLOGNUMBER: ::windows_strings::PCWSTR = ::windows_strings::w!("LowLogNumber");
pub const wszREGMAXINCOMINGALLOCSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxIncomingAllocSize");
pub const wszREGMAXINCOMINGMESSAGESIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxIncomingMessageSize");
pub const wszREGMAXPENDINGREQUESTDAYS: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxPendingRequestDays");
pub const wszREGMAXSCTLISTSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxSCTListSize");
pub const wszREGNAMESEPARATOR: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectNameSeparator");
pub const wszREGNETSCAPECERTTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("NetscapeCertType");
pub const wszREGOFFICERRIGHTS: ::windows_strings::PCWSTR = ::windows_strings::w!("OfficerRights");
pub const wszREGPARENTCAMACHINE: ::windows_strings::PCWSTR = ::windows_strings::w!("ParentCAMachine");
pub const wszREGPARENTCANAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ParentCAName");
pub const wszREGPOLICYFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("PolicyFlags");
pub const wszREGPRESERVESCEPDUMMYCERTS: ::windows_strings::PCWSTR = ::windows_strings::w!("PreserveSCEPDummyCerts");
pub const wszREGPROCESSINGFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("ProcessingFlags");
pub const wszREGPROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider");
pub const wszREGPROVIDERTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderType");
pub const wszREGREQUESTDISPOSITION: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestDisposition");
pub const wszREGREQUESTFILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestFileName");
pub const wszREGREQUESTID: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestId");
pub const wszREGREQUESTKEYCONTAINER: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestKeyContainer");
pub const wszREGREQUESTKEYINDEX: ::windows_strings::PCWSTR = ::windows_strings::w!("RequestKeyIndex");
pub const wszREGRESTOREMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreMap");
pub const wszREGRESTOREMAPCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreMapCount");
pub const wszREGRESTORESTATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("RestoreStatus");
pub const wszREGREVOCATIONCRLURL_OLD: ::windows_strings::PCWSTR = ::windows_strings::w!("RevocationCRLURL");
pub const wszREGREVOCATIONTYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("RevocationType");
pub const wszREGREVOCATIONURL: ::windows_strings::PCWSTR = ::windows_strings::w!("RevocationURL");
pub const wszREGROLESEPARATIONENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("RoleSeparationEnabled");
pub const wszREGSETUPSTATUS: ::windows_strings::PCWSTR = ::windows_strings::w!("SetupStatus");
pub const wszREGSP4DEFAULTCONFIGURATION: ::windows_strings::PCWSTR = ::windows_strings::w!("DefaultConfiguration");
pub const wszREGSP4KEYSETNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("KeySetName");
pub const wszREGSP4NAMES: ::windows_strings::PCWSTR = ::windows_strings::w!("Names");
pub const wszREGSP4QUERIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Queries");
pub const wszREGSP4SUBJECTNAMESEPARATOR: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectNameSeparator");
pub const wszREGSUBJECTALTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectAltName");
pub const wszREGSUBJECTALTNAME2: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectAltName2");
pub const wszREGSUBJECTTEMPLATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SubjectTemplate");
pub const wszREGSYMMETRICKEYSIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("SymmetricKeySize");
pub const wszREGUNICODE: ::windows_strings::PCWSTR = ::windows_strings::w!("Unicode");
pub const wszREGUPNMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("UPNMap");
pub const wszREGUSEDEFINEDCACERTINREQ: ::windows_strings::PCWSTR = ::windows_strings::w!("UseDefinedCACertInRequest");
pub const wszREGVALIDITYPERIODCOUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("ValidityPeriodUnits");
pub const wszREGVALIDITYPERIODSTRING: ::windows_strings::PCWSTR = ::windows_strings::w!("ValidityPeriod");
pub const wszREGVERIFYFLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("VerifyFlags");
pub const wszREGVERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
pub const wszREGVIEWAGEMINUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewAgeMinutes");
pub const wszREGVIEWIDLEMINUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewIdleMinutes");
pub const wszREGWEBCLIENTCAMACHINE: ::windows_strings::PCWSTR = ::windows_strings::w!("WebClientCAMachine");
pub const wszREGWEBCLIENTCANAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WebClientCAName");
pub const wszREGWEBCLIENTCATYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("WebClientCAType");
pub const wszSECUREDATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("SignedAttributes");
pub const wszSERVICE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CertSvc");
pub const wszzDEFAULTSIGNEDATTRIBUTES: ::windows_strings::PCWSTR = ::windows_strings::w!("RequesterName\u{0}");
