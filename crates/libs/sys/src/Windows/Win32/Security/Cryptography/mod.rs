...
pub const BCRYPT_3DES_112_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("3DES_112");
...
pub const BCRYPT_3DES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("3DES");
...
pub const BCRYPT_AES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AES");
...
pub const BCRYPT_AES_CMAC_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AES-CMAC");
...
pub const BCRYPT_AES_GMAC_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AES-GMAC");
pub const BCRYPT_AES_GMAC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 273u32 as _;
pub const BCRYPT_AES_WRAP_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("Rfc3565KeyWrapBlob");
pub const BCRYPT_ALGORITHM_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AlgorithmName");
...
pub const BCRYPT_AUTH_TAG_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthTagLength");
pub const BCRYPT_BLOCK_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("BlockLength");
pub const BCRYPT_BLOCK_PADDING: BCRYPT_FLAGS = 1u32;
pub const BCRYPT_BLOCK_SIZE_LIST: ::windows_strings::PCWSTR = ::windows_strings::w!("BlockSizeList");
pub const BCRYPT_BUFFERS_LOCKED_FLAG: u32 = 64u32;
pub const BCRYPT_CAPI_AES_FLAG: u32 = 16u32;
pub const BCRYPT_CAPI_KDF_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPI_KDF");
pub const BCRYPT_CAPI_KDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 801u32 as _;
pub const BCRYPT_CHACHA20_POLY1305_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CHACHA20_POLY1305");
pub const BCRYPT_CHACHA20_POLY1305_ALG_HANDLE: BCRYPT_ALG_HANDLE = 929u32 as _;
pub const BCRYPT_CHAINING_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingMode");
pub const BCRYPT_CHAIN_MODE_CBC: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeCBC");
pub const BCRYPT_CHAIN_MODE_CCM: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeCCM");
pub const BCRYPT_CHAIN_MODE_CFB: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeCFB");
pub const BCRYPT_CHAIN_MODE_ECB: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeECB");
pub const BCRYPT_CHAIN_MODE_GCM: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeGCM");
pub const BCRYPT_CHAIN_MODE_NA: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainingModeN/A");
pub const BCRYPT_CIPHER_INTERFACE: BCRYPT_INTERFACE = 1u32;
pub const BCRYPT_CIPHER_OPERATION: BCRYPT_OPERATION = 1u32;
pub const BCRYPT_DESX_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DESX");
...
pub const BCRYPT_DES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DES");
...
pub const BCRYPT_DH_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DH");
pub const BCRYPT_DH_ALG_HANDLE: BCRYPT_ALG_HANDLE = 641u32 as _;
pub const BCRYPT_DH_PARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("DHParameters");
pub const BCRYPT_DH_PARAMETERS_MAGIC: u32 = 1297107012u32;
pub const BCRYPT_DH_PRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("DHPRIVATEBLOB");
pub const BCRYPT_DH_PRIVATE_MAGIC: BCRYPT_DH_KEY_BLOB_MAGIC = 1448101956u32;
pub const BCRYPT_DH_PUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("DHPUBLICBLOB");
pub const BCRYPT_DH_PUBLIC_MAGIC: BCRYPT_DH_KEY_BLOB_MAGIC = 1112557636u32;
pub const BCRYPT_DSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DSA");
pub const BCRYPT_DSA_ALG_HANDLE: BCRYPT_ALG_HANDLE = 721u32 as _;
pub const BCRYPT_DSA_PARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("DSAParameters");
pub const BCRYPT_DSA_PARAMETERS_MAGIC: u32 = 1297109828u32;
pub const BCRYPT_DSA_PARAMETERS_MAGIC_V2: u32 = 843927620u32;
pub const BCRYPT_DSA_PRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("DSAPRIVATEBLOB");
pub const BCRYPT_DSA_PRIVATE_MAGIC: BCRYPT_DSA_MAGIC = 1448104772u32;
pub const BCRYPT_DSA_PRIVATE_MAGIC_V2: u32 = 844517444u32;
pub const BCRYPT_DSA_PUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("DSAPUBLICBLOB");
pub const BCRYPT_DSA_PUBLIC_MAGIC: BCRYPT_DSA_MAGIC = 1112560452u32;
pub const BCRYPT_DSA_PUBLIC_MAGIC_V2: u32 = 843206724u32;
pub const BCRYPT_ECCFULLPRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCFULLPRIVATEBLOB");
pub const BCRYPT_ECCFULLPUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCFULLPUBLICBLOB");
pub const BCRYPT_ECCPRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCPRIVATEBLOB");
pub const BCRYPT_ECCPUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCPUBLICBLOB");
pub const BCRYPT_ECC_CURVE_25519: ::windows_strings::PCWSTR = ::windows_strings::w!("curve25519");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP160R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP160r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP160T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP160t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP192R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP192r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP192T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP192t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP224R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP224r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP224T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP224t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP256R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP256r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP256T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP256t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP320R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP320r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP320T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP320t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP384R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP384r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP384T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP384t1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP512R1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP512r1");
pub const BCRYPT_ECC_CURVE_BRAINPOOLP512T1: ::windows_strings::PCWSTR = ::windows_strings::w!("brainpoolP512t1");
pub const BCRYPT_ECC_CURVE_EC192WAPI: ::windows_strings::PCWSTR = ::windows_strings::w!("ec192wapi");
pub const BCRYPT_ECC_CURVE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCCurveName");
pub const BCRYPT_ECC_CURVE_NAME_LIST: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCCurveNameList");
pub const BCRYPT_ECC_CURVE_NISTP192: ::windows_strings::PCWSTR = ::windows_strings::w!("nistP192");
pub const BCRYPT_ECC_CURVE_NISTP224: ::windows_strings::PCWSTR = ::windows_strings::w!("nistP224");
pub const BCRYPT_ECC_CURVE_NISTP256: ::windows_strings::PCWSTR = ::windows_strings::w!("nistP256");
pub const BCRYPT_ECC_CURVE_NISTP384: ::windows_strings::PCWSTR = ::windows_strings::w!("nistP384");
pub const BCRYPT_ECC_CURVE_NISTP521: ::windows_strings::PCWSTR = ::windows_strings::w!("nistP521");
pub const BCRYPT_ECC_CURVE_NUMSP256T1: ::windows_strings::PCWSTR = ::windows_strings::w!("numsP256t1");
pub const BCRYPT_ECC_CURVE_NUMSP384T1: ::windows_strings::PCWSTR = ::windows_strings::w!("numsP384t1");
pub const BCRYPT_ECC_CURVE_NUMSP512T1: ::windows_strings::PCWSTR = ::windows_strings::w!("numsP512t1");
pub const BCRYPT_ECC_CURVE_SECP160K1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP160k1");
pub const BCRYPT_ECC_CURVE_SECP160R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP160r1");
pub const BCRYPT_ECC_CURVE_SECP160R2: ::windows_strings::PCWSTR = ::windows_strings::w!("secP160r2");
pub const BCRYPT_ECC_CURVE_SECP192K1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP192k1");
pub const BCRYPT_ECC_CURVE_SECP192R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP192r1");
pub const BCRYPT_ECC_CURVE_SECP224K1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP224k1");
pub const BCRYPT_ECC_CURVE_SECP224R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP224r1");
pub const BCRYPT_ECC_CURVE_SECP256K1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP256k1");
pub const BCRYPT_ECC_CURVE_SECP256R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP256r1");
pub const BCRYPT_ECC_CURVE_SECP384R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP384r1");
pub const BCRYPT_ECC_CURVE_SECP521R1: ::windows_strings::PCWSTR = ::windows_strings::w!("secP521r1");
pub const BCRYPT_ECC_CURVE_WTLS12: ::windows_strings::PCWSTR = ::windows_strings::w!("wtls12");
pub const BCRYPT_ECC_CURVE_WTLS7: ::windows_strings::PCWSTR = ::windows_strings::w!("wtls7");
pub const BCRYPT_ECC_CURVE_WTLS9: ::windows_strings::PCWSTR = ::windows_strings::w!("wtls9");
pub const BCRYPT_ECC_CURVE_X962P192V1: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P192v1");
pub const BCRYPT_ECC_CURVE_X962P192V2: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P192v2");
pub const BCRYPT_ECC_CURVE_X962P192V3: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P192v3");
pub const BCRYPT_ECC_CURVE_X962P239V1: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P239v1");
pub const BCRYPT_ECC_CURVE_X962P239V2: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P239v2");
pub const BCRYPT_ECC_CURVE_X962P239V3: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P239v3");
pub const BCRYPT_ECC_CURVE_X962P256V1: ::windows_strings::PCWSTR = ::windows_strings::w!("x962P256v1");
pub const BCRYPT_ECC_FULLKEY_BLOB_V1: u32 = 1u32;
pub const BCRYPT_ECC_PARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCParameters");
...
pub const BCRYPT_ECDH_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH");
pub const BCRYPT_ECDH_ALG_HANDLE: BCRYPT_ALG_HANDLE = 657u32 as _;
pub const BCRYPT_ECDH_P256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P256");
pub const BCRYPT_ECDH_P256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 673u32 as _;
pub const BCRYPT_ECDH_P384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P384");
pub const BCRYPT_ECDH_P384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 689u32 as _;
pub const BCRYPT_ECDH_P521_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P521");
...
pub const BCRYPT_ECDSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA");
pub const BCRYPT_ECDSA_ALG_HANDLE: BCRYPT_ALG_HANDLE = 241u32 as _;
pub const BCRYPT_ECDSA_P256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P256");
pub const BCRYPT_ECDSA_P256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 737u32 as _;
pub const BCRYPT_ECDSA_P384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P384");
pub const BCRYPT_ECDSA_P384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 753u32 as _;
pub const BCRYPT_ECDSA_P521_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P521");
...
pub const BCRYPT_EFFECTIVE_KEY_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("EffectiveKeyLength");
...
pub const BCRYPT_GLOBAL_PARAMETERS: ::windows_strings::PCWSTR = ::windows_strings::w!("SecretAgreementParam");
pub const BCRYPT_HASH_BLOCK_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("HashBlockLength");
pub const BCRYPT_HASH_INTERFACE: BCRYPT_INTERFACE = 2u32;
pub const BCRYPT_HASH_INTERFACE_MAJORVERSION_2: u32 = 2u32;
pub const BCRYPT_HASH_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("HashDigestLength");
pub const BCRYPT_HASH_OID_LIST: ::windows_strings::PCWSTR = ::windows_strings::w!("HashOIDList");
...
pub const BCRYPT_HKDF_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("HKDF");
pub const BCRYPT_HKDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 913u32 as _;
pub const BCRYPT_HKDF_HASH_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("HkdfHashAlgorithm");
pub const BCRYPT_HKDF_PRK_AND_FINALIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("HkdfPrkAndFinalize");
pub const BCRYPT_HKDF_SALT_AND_FINALIZE: ::windows_strings::PCWSTR = ::windows_strings::w!("HkdfSaltAndFinalize");
...
pub const BCRYPT_INITIALIZATION_VECTOR: ::windows_strings::PCWSTR = ::windows_strings::w!("IV");
pub const BCRYPT_IS_IFX_TPM_WEAK_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("IsIfxTpmWeakKey");
pub const BCRYPT_IS_KEYED_HASH: ::windows_strings::PCWSTR = ::windows_strings::w!("IsKeyedHash");
pub const BCRYPT_IS_REUSABLE_HASH: ::windows_strings::PCWSTR = ::windows_strings::w!("IsReusableHash");
pub const BCRYPT_KDF_HASH: ::windows_strings::PCWSTR = ::windows_strings::w!("HASH");
pub const BCRYPT_KDF_HKDF: ::windows_strings::PCWSTR = ::windows_strings::w!("HKDF");
pub const BCRYPT_KDF_HMAC: ::windows_strings::PCWSTR = ::windows_strings::w!("HMAC");
pub const BCRYPT_KDF_RAW_SECRET: ::windows_strings::PCWSTR = ::windows_strings::w!("TRUNCATE");
pub const BCRYPT_KDF_SP80056A_CONCAT: ::windows_strings::PCWSTR = ::windows_strings::w!("SP800_56A_CONCAT");
pub const BCRYPT_KDF_TLS_PRF: ::windows_strings::PCWSTR = ::windows_strings::w!("TLS_PRF");
pub const BCRYPT_KEY_DATA_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyDataBlob");
...
pub const BCRYPT_KEY_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyLength");
pub const BCRYPT_KEY_LENGTHS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyLengths");
pub const BCRYPT_KEY_OBJECT_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyObjectLength");
pub const BCRYPT_KEY_STRENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyStrength");
...
pub const BCRYPT_MD2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD2");
pub const BCRYPT_MD2_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1u32 as _;
pub const BCRYPT_MD4_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD4");
pub const BCRYPT_MD4_ALG_HANDLE: BCRYPT_ALG_HANDLE = 17u32 as _;
pub const BCRYPT_MD5_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD5");
pub const BCRYPT_MD5_ALG_HANDLE: BCRYPT_ALG_HANDLE = 33u32 as _;
pub const BCRYPT_MESSAGE_BLOCK_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("MessageBlockLength");
pub const BCRYPT_MULTI_FLAG: u32 = 64u32;
pub const BCRYPT_MULTI_OBJECT_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("MultiObjectLength");
...
pub const BCRYPT_OBJECT_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("ObjectLength");
pub const BCRYPT_OPAQUE_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("OpaqueKeyBlob");
pub const BCRYPT_OPERATION_TYPE_HASH: BCRYPT_MULTI_OPERATION_TYPE = 1i32;
pub const BCRYPT_PADDING_SCHEMES: ::windows_strings::PCWSTR = ::windows_strings::w!("PaddingSchemes");
...
pub const BCRYPT_PBKDF2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("PBKDF2");
pub const BCRYPT_PBKDF2_ALG_HANDLE: BCRYPT_ALG_HANDLE = 817u32 as _;
pub const BCRYPT_PCP_PLATFORM_TYPE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_TYPE");
pub const BCRYPT_PCP_PROVIDER_VERSION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PROVIDER_VERSION");
pub const BCRYPT_PRIMITIVE_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("PrimitiveType");
pub const BCRYPT_PRIVATE_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("PrivKeyVal");
pub const BCRYPT_PRIVATE_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("PRIVATEBLOB");
pub const BCRYPT_PRIVATE_KEY_FLAG: u32 = 2u32;
pub const BCRYPT_PROVIDER_HANDLE: ::windows_strings::PCWSTR = ::windows_strings::w!("ProviderHandle");
pub const BCRYPT_PROV_DISPATCH: BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS = 1u32;
pub const BCRYPT_PUBLIC_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("PUBLICBLOB");
pub const BCRYPT_PUBLIC_KEY_FLAG: u32 = 1u32;
pub const BCRYPT_PUBLIC_KEY_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKeyLength");
pub const BCRYPT_RC2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RC2");
...
pub const BCRYPT_RC4_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RC4");
...
pub const BCRYPT_RNG_DUAL_EC_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DUALECRNG");
pub const BCRYPT_RNG_FIPS186_DSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("FIPS186DSARNG");
...
pub const BCRYPT_RSAFULLPRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("RSAFULLPRIVATEBLOB");
pub const BCRYPT_RSAFULLPRIVATE_MAGIC: BCRYPT_RSAKEY_BLOB_MAGIC = 859919186u32;
pub const BCRYPT_RSAPRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("RSAPRIVATEBLOB");
pub const BCRYPT_RSAPRIVATE_MAGIC: BCRYPT_RSAKEY_BLOB_MAGIC = 843141970u32;
pub const BCRYPT_RSAPUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("RSAPUBLICBLOB");
pub const BCRYPT_RSAPUBLIC_MAGIC: BCRYPT_RSAKEY_BLOB_MAGIC = 826364754u32;
pub const BCRYPT_RSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RSA");
pub const BCRYPT_RSA_ALG_HANDLE: BCRYPT_ALG_HANDLE = 225u32 as _;
pub const BCRYPT_RSA_SIGN_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RSA_SIGN");
...
pub const BCRYPT_SHA1_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA1");
pub const BCRYPT_SHA1_ALG_HANDLE: BCRYPT_ALG_HANDLE = 49u32 as _;
pub const BCRYPT_SHA256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA256");
pub const BCRYPT_SHA256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 65u32 as _;
pub const BCRYPT_SHA384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA384");
pub const BCRYPT_SHA384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 81u32 as _;
pub const BCRYPT_SHA512_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA512");
...
pub const BCRYPT_SIGNATURE_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("SignatureLength");
pub const BCRYPT_SIGNATURE_OPERATION: BCRYPT_OPERATION = 16u32;
pub const BCRYPT_SP800108_CTR_HMAC_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SP800_108_CTR_HMAC");
pub const BCRYPT_SP800108_CTR_HMAC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 833u32 as _;
pub const BCRYPT_SP80056A_CONCAT_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SP800_56A_CONCAT");
...
pub const BCRYPT_TLS1_1_KDF_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("TLS1_1_KDF");
pub const BCRYPT_TLS1_1_KDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 865u32 as _;
pub const BCRYPT_TLS1_2_KDF_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("TLS1_2_KDF");
...
pub const BCRYPT_XTS_AES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("XTS-AES");
...
pub const CERT_AUTH_ROOT_AUTO_UPDATE_ENCODED_CTL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EncodedCtl");
pub const CERT_AUTH_ROOT_AUTO_UPDATE_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
pub const CERT_AUTH_ROOT_AUTO_UPDATE_LAST_SYNC_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("LastSyncTime");
pub const CERT_AUTH_ROOT_AUTO_UPDATE_ROOT_DIR_URL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RootDirUrl");
pub const CERT_AUTH_ROOT_AUTO_UPDATE_SYNC_DELTA_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncDeltaTime");
pub const CERT_AUTH_ROOT_CAB_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("authrootstl.cab");
pub const CERT_AUTH_ROOT_CERT_EXT: ::windows_strings::PCWSTR = ::windows_strings::w!(".crt");
pub const CERT_AUTH_ROOT_CTL_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("authroot.stl");
pub const CERT_AUTH_ROOT_CTL_FILENAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("authroot.stl");
pub const CERT_AUTH_ROOT_SEQ_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("authrootseq.txt");
...
pub const CERT_AUTO_UPDATE_ROOT_DIR_URL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RootDirUrl");
pub const CERT_AUTO_UPDATE_SYNC_FROM_DIR_URL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SyncFromDirUrl");
...
pub const CERT_CHAIN_AUTO_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoFlags");
pub const CERT_CHAIN_AUTO_FLUSH_DISABLE_FLAG: u32 = 1u32;
pub const CERT_CHAIN_AUTO_FLUSH_FIRST_DELTA_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoFlushFirstDeltaSeconds");
pub const CERT_CHAIN_AUTO_FLUSH_NEXT_DELTA_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoFlushNextDeltaSeconds");
...
pub const CERT_CHAIN_AUTO_LOG_FILE_NAME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AutoLogFileName");
...
pub const CERT_CHAIN_CACHE_RESYNC_FILETIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainCacheResyncFiletime");
pub const CERT_CHAIN_CONFIG_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Cryptography\\OID\\EncodingType 0\\CertDllCreateCertificateChainEngine\\Config");
pub const CERT_CHAIN_CRL_VALIDITY_EXT_PERIOD_HOURS_DEFAULT: u32 = 12u32;
pub const CERT_CHAIN_CRL_VALIDITY_EXT_PERIOD_HOURS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CRLValidityExtensionPeriod");
pub const CERT_CHAIN_CROSS_CERT_DOWNLOAD_INTERVAL_HOURS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CrossCertDownloadIntervalHours");
pub const CERT_CHAIN_DEFAULT_CONFIG_SUBDIR: ::windows_strings::PCWSTR = ::windows_strings::w!("Default");
pub const CERT_CHAIN_DISABLE_AIA: u32 = 8192u32;
pub const CERT_CHAIN_DISABLE_AIA_URL_RETRIEVAL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableAIAUrlRetrieval");
pub const CERT_CHAIN_DISABLE_ALL_EKU_WEAK_FLAG: u32 = 65536u32;
pub const CERT_CHAIN_DISABLE_AUTH_ROOT_AUTO_UPDATE: u32 = 256u32;
pub const CERT_CHAIN_DISABLE_AUTO_FLUSH_PROCESS_NAME_LIST_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableAutoFlushProcessNameList");
pub const CERT_CHAIN_DISABLE_CA_NAME_CONSTRAINTS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableCANameConstraints");
...
pub const CERT_CHAIN_DISABLE_MANDATORY_BASIC_CONSTRAINTS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableMandatoryBasicConstraints");
...
pub const CERT_CHAIN_DISABLE_SERIAL_CHAIN_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableSerialChain");
pub const CERT_CHAIN_DISABLE_SERVER_AUTH_WEAK_FLAG: u32 = 1048576u32;
pub const CERT_CHAIN_DISABLE_SYNC_WITH_SSL_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableSyncWithSslTime");
...
pub const CERT_CHAIN_DISABLE_UNSUPPORTED_CRITICAL_EXTENSIONS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableUnsupportedCriticalExtensions");
...
pub const CERT_CHAIN_ENABLE_WEAK_SIGNATURE_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableWeakSignatureFlags");
...
pub const CERT_CHAIN_MAX_AIA_URL_COUNT_IN_CERT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAIAUrlCountInCert");
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_BYTE_COUNT_DEFAULT: u32 = 100000u32;
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_BYTE_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAIAUrlRetrievalByteCount");
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_CERT_COUNT_DEFAULT: u32 = 10u32;
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_CERT_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAIAUrlRetrievalCertCount");
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_COUNT_PER_CHAIN_DEFAULT: u32 = 3u32;
pub const CERT_CHAIN_MAX_AIA_URL_RETRIEVAL_COUNT_PER_CHAIN_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAIAUrlRetrievalCountPerChain");
...
pub const CERT_CHAIN_MAX_SSL_TIME_UPDATED_EVENT_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxSslTimeUpdatedEventCount");
pub const CERT_CHAIN_MAX_URL_RETRIEVAL_BYTE_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxUrlRetrievalByteCount");
...
pub const CERT_CHAIN_MIN_RSA_PUB_KEY_BIT_LENGTH_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MinRsaPubKeyBitLength");
pub const CERT_CHAIN_MOTW_IGNORE_AFTER_TIME_WEAK_FLAG: u32 = 1073741824u32;
pub const CERT_CHAIN_OCSP_VALIDITY_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("OcspValiditySeconds");
pub const CERT_CHAIN_ONLY_ADDITIONAL_AND_AUTH_ROOT: u32 = 32768u32;
pub const CERT_CHAIN_OPTIONS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Options");
...
pub const CERT_CHAIN_REV_ACCUMULATIVE_URL_RETRIEVAL_TIMEOUT_MILLISECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainRevAccumulativeUrlRetrievalTimeoutMilliseconds");
pub const CERT_CHAIN_SERIAL_CHAIN_LOG_FILE_NAME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SerialChainLogFileName");
pub const CERT_CHAIN_SSL_HANDSHAKE_LOG_FILE_NAME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SslHandshakeLogFileName");
...
pub const CERT_CHAIN_URL_RETRIEVAL_TIMEOUT_MILLISECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ChainUrlRetrievalTimeoutMilliseconds");
pub const CERT_CHAIN_USE_LOCAL_MACHINE_STORE: u32 = 8u32;
pub const CERT_CHAIN_WEAK_AFTER_TIME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AfterTime");
pub const CERT_CHAIN_WEAK_ALL_CONFIG_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("All");
pub const CERT_CHAIN_WEAK_FILE_HASH_AFTER_TIME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FileHashAfterTime");
pub const CERT_CHAIN_WEAK_FLAGS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
pub const CERT_CHAIN_WEAK_HYGIENE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Hygiene");
pub const CERT_CHAIN_WEAK_MIN_BIT_LENGTH_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MinBitLength");
pub const CERT_CHAIN_WEAK_PREFIX_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Weak");
pub const CERT_CHAIN_WEAK_RSA_PUB_KEY_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WeakRsaPubKeyTime");
pub const CERT_CHAIN_WEAK_SHA256_ALLOW_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Sha256Allow");
pub const CERT_CHAIN_WEAK_SIGNATURE_LOG_DIR_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WeakSignatureLogDir");
pub const CERT_CHAIN_WEAK_THIRD_PARTY_CONFIG_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ThirdParty");
pub const CERT_CHAIN_WEAK_TIMESTAMP_HASH_AFTER_TIME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("TimestampHashAfterTime");
...
pub const CERT_DEFAULT_OID_PUBLIC_KEY_SIGN: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.113549.1.1.1");
pub const CERT_DEFAULT_OID_PUBLIC_KEY_XCHG: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.113549.1.1.1");
pub const CERT_DESCRIPTION_PROP_ID: u32 = 13u32;
pub const CERT_DIGITAL_SIGNATURE_KEY_USAGE: u32 = 128u32;
pub const CERT_DISABLE_PIN_RULES_AUTO_UPDATE_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisablePinRulesAutoUpdate");
pub const CERT_DISABLE_ROOT_AUTO_UPDATE_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableRootAutoUpdate");
pub const CERT_DISALLOWED_CA_FILETIME_PROP_ID: u32 = 128u32;
pub const CERT_DISALLOWED_CERT_AUTO_UPDATE_ENCODED_CTL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisallowedCertEncodedCtl");
pub const CERT_DISALLOWED_CERT_AUTO_UPDATE_LAST_SYNC_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisallowedCertLastSyncTime");
pub const CERT_DISALLOWED_CERT_AUTO_UPDATE_LIST_IDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("DisallowedCert_AutoUpdate_1");
pub const CERT_DISALLOWED_CERT_AUTO_UPDATE_SYNC_DELTA_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisallowedCertSyncDeltaTime");
pub const CERT_DISALLOWED_CERT_CAB_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("disallowedcertstl.cab");
pub const CERT_DISALLOWED_CERT_CTL_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("disallowedcert.stl");
pub const CERT_DISALLOWED_CERT_CTL_FILENAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("disallowedcert.stl");
...
pub const CERT_EFSBLOB_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EFSBlob");
pub const CERT_EFS_PROP_ID: u32 = 17u32;
pub const CERT_ENABLE_DISALLOWED_CERT_AUTO_UPDATE_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableDisallowedCertAutoUpdate");
...
pub const CERT_GROUP_POLICY_SYSTEM_STORE_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Policies\\Microsoft\\SystemCertificates");
...
pub const CERT_IE_DIRTY_FLAGS_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Cryptography\\IEDirtyFlags");
...
pub const CERT_LOCAL_MACHINE_SYSTEM_STORE_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\SystemCertificates");
...
pub const CERT_OCM_SUBCOMPONENTS_LOCAL_MACHINE_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Setup\\OC Manager\\Subcomponents");
pub const CERT_OCM_SUBCOMPONENTS_ROOT_AUTO_UPDATE_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("RootAutoUpdate");
...
pub const CERT_PHYSICAL_STORE_AUTH_ROOT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".AuthRoot");
pub const CERT_PHYSICAL_STORE_DEFAULT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".Default");
pub const CERT_PHYSICAL_STORE_DS_USER_CERTIFICATE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".UserCertificate");
pub const CERT_PHYSICAL_STORE_ENTERPRISE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".Enterprise");
pub const CERT_PHYSICAL_STORE_GROUP_POLICY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".GroupPolicy");
pub const CERT_PHYSICAL_STORE_INSERT_COMPUTER_NAME_ENABLE_FLAG: u32 = 8u32;
pub const CERT_PHYSICAL_STORE_LOCAL_MACHINE_GROUP_POLICY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".LocalMachineGroupPolicy");
pub const CERT_PHYSICAL_STORE_LOCAL_MACHINE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".LocalMachine");
...
pub const CERT_PHYSICAL_STORE_SMART_CARD_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!(".SmartCard");
pub const CERT_PIN_RULES_AUTO_UPDATE_ENCODED_CTL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PinRulesEncodedCtl");
pub const CERT_PIN_RULES_AUTO_UPDATE_LAST_SYNC_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PinRulesLastSyncTime");
pub const CERT_PIN_RULES_AUTO_UPDATE_LIST_IDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("PinRules_AutoUpdate_1");
pub const CERT_PIN_RULES_AUTO_UPDATE_SYNC_DELTA_TIME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PinRulesSyncDeltaTime");
pub const CERT_PIN_RULES_CAB_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("pinrulesstl.cab");
pub const CERT_PIN_RULES_CTL_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("pinrules.stl");
pub const CERT_PIN_RULES_CTL_FILENAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("pinrules.stl");
...
pub const CERT_PROT_ROOT_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Flags");
...
pub const CERT_PROT_ROOT_PEER_USAGES_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerUsages");
pub const CERT_PROT_ROOT_PEER_USAGES_VALUE_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("PeerUsages");
...
pub const CERT_RETR_BEHAVIOR_FILE_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AllowFileUrlScheme");
pub const CERT_RETR_BEHAVIOR_INET_AUTH_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableInetUnknownAuth");
pub const CERT_RETR_BEHAVIOR_INET_STATUS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EnableInetLocal");
pub const CERT_RETR_BEHAVIOR_LDAP_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableLDAPSignAndEncrypt");
...
pub const CERT_RSA_PUBLIC_KEY_OBJID: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.113549.1.1.1");
...
pub const CERT_SRV_OCSP_RESP_MAX_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMaxBeforeNextUpdateSeconds");
pub const CERT_SRV_OCSP_RESP_MAX_SYNC_CERT_FILE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMaxSyncCertFileSeconds");
pub const CERT_SRV_OCSP_RESP_MIN_AFTER_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMinAfterNextUpdateSeconds");
pub const CERT_SRV_OCSP_RESP_MIN_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMinBeforeNextUpdateSeconds");
pub const CERT_SRV_OCSP_RESP_MIN_SYNC_CERT_FILE_SECONDS_DEFAULT: u32 = 5u32;
pub const CERT_SRV_OCSP_RESP_MIN_SYNC_CERT_FILE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMinSyncCertFileSeconds");
pub const CERT_SRV_OCSP_RESP_MIN_VALIDITY_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespMinValiditySeconds");
pub const CERT_SRV_OCSP_RESP_URL_RETRIEVAL_TIMEOUT_MILLISECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SrvOcspRespUrlRetrievalTimeoutMilliseconds");
...
pub const CERT_STRONG_SIGN_ECDSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA");
...
pub const CERT_TRUST_PUB_AUTHENTICODE_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthenticodeFlags");
...
pub const CMSG_OID_CAPI1_EXPORT_KEY_AGREE_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllExportKeyAgree");
pub const CMSG_OID_CAPI1_EXPORT_KEY_TRANS_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllExportKeyTrans");
pub const CMSG_OID_CAPI1_EXPORT_MAIL_LIST_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllExportMailList");
pub const CMSG_OID_CAPI1_GEN_CONTENT_ENCRYPT_KEY_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllGenContentEncryptKey");
pub const CMSG_OID_CAPI1_IMPORT_KEY_AGREE_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllImportKeyAgree");
pub const CMSG_OID_CAPI1_IMPORT_KEY_TRANS_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllImportKeyTrans");
pub const CMSG_OID_CAPI1_IMPORT_MAIL_LIST_FUNC: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptMsgDllImportMailList");
pub const CMSG_OID_CNG_EXPORT_KEY_AGREE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGExportKeyAgree");
pub const CMSG_OID_CNG_EXPORT_KEY_TRANS_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGExportKeyTrans");
pub const CMSG_OID_CNG_GEN_CONTENT_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGGenContentEncryptKey");
pub const CMSG_OID_CNG_IMPORT_CONTENT_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGImportContentEncryptKey");
pub const CMSG_OID_CNG_IMPORT_KEY_AGREE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGImportKeyAgree");
pub const CMSG_OID_CNG_IMPORT_KEY_TRANS_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllCNGImportKeyTrans");
pub const CMSG_OID_EXPORT_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllExportEncryptKey");
pub const CMSG_OID_EXPORT_KEY_AGREE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllExportKeyAgree");
pub const CMSG_OID_EXPORT_KEY_TRANS_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllExportKeyTrans");
pub const CMSG_OID_EXPORT_MAIL_LIST_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllExportMailList");
pub const CMSG_OID_GEN_CONTENT_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllGenContentEncryptKey");
pub const CMSG_OID_GEN_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllGenEncryptKey");
pub const CMSG_OID_IMPORT_ENCRYPT_KEY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllImportEncryptKey");
pub const CMSG_OID_IMPORT_KEY_AGREE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllImportKeyAgree");
pub const CMSG_OID_IMPORT_KEY_TRANS_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllImportKeyTrans");
pub const CMSG_OID_IMPORT_MAIL_LIST_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptMsgDllImportMailList");
...
pub const CONTEXT_OID_CREATE_OBJECT_CONTEXT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("ContextDllCreateObjectContext");
...
pub const CRYPTNET_CACHED_OCSP_SWITCH_TO_CRL_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetCachedOcspSwitchToCrlCount");
pub const CRYPTNET_CRL_BEFORE_OCSP_ENABLE: u32 = 4294967295u32;
pub const CRYPTNET_CRL_PRE_FETCH_DISABLE_INFORMATION_EVENTS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("DisableInformationEvents");
pub const CRYPTNET_CRL_PRE_FETCH_LOG_FILE_NAME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("LogFileName");
pub const CRYPTNET_CRL_PRE_FETCH_MAX_AGE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MaxAgeSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_MIN_AFTER_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MinAfterNextUpdateSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_MIN_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("MinBeforeNextUpdateSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_PROCESS_NAME_LIST_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("ProcessNameList");
pub const CRYPTNET_CRL_PRE_FETCH_PUBLISH_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PublishBeforeNextUpdateSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_PUBLISH_RANDOM_INTERVAL_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PublishRandomIntervalSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_TIMEOUT_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("TimeoutSeconds");
pub const CRYPTNET_CRL_PRE_FETCH_URL_LIST_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PreFetchUrlList");
pub const CRYPTNET_MAX_CACHED_OCSP_PER_CRL_COUNT_DEFAULT: u32 = 500u32;
pub const CRYPTNET_MAX_CACHED_OCSP_PER_CRL_COUNT_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetMaxCachedOcspPerCrlCount");
pub const CRYPTNET_OCSP_AFTER_CRL_DISABLE: u32 = 4294967295u32;
pub const CRYPTNET_PRE_FETCH_AFTER_CURRENT_TIME_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchAfterCurrentTimePreFetchPeriodSeconds");
pub const CRYPTNET_PRE_FETCH_AFTER_PUBLISH_PRE_FETCH_DIVISOR_DEFAULT: u32 = 10u32;
pub const CRYPTNET_PRE_FETCH_AFTER_PUBLISH_PRE_FETCH_DIVISOR_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchAfterPublishPreFetchDivisor");
pub const CRYPTNET_PRE_FETCH_BEFORE_NEXT_UPDATE_PRE_FETCH_DIVISOR_DEFAULT: u32 = 20u32;
pub const CRYPTNET_PRE_FETCH_BEFORE_NEXT_UPDATE_PRE_FETCH_DIVISOR_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchBeforeNextUpdatePreFetchDivisor");
pub const CRYPTNET_PRE_FETCH_MAX_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMaxAfterNextUpdatePreFetchPeriodSeconds");
pub const CRYPTNET_PRE_FETCH_MAX_MAX_AGE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMaxMaxAgeSeconds");
pub const CRYPTNET_PRE_FETCH_MIN_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMinAfterNextUpdatePreFetchPeriodSeconds");
pub const CRYPTNET_PRE_FETCH_MIN_BEFORE_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMinBeforeNextUpdatePreFetchSeconds");
pub const CRYPTNET_PRE_FETCH_MIN_MAX_AGE_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMinMaxAgeSeconds");
pub const CRYPTNET_PRE_FETCH_MIN_OCSP_VALIDITY_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchMinOcspValidityPeriodSeconds");
pub const CRYPTNET_PRE_FETCH_RETRIEVAL_TIMEOUT_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchRetrievalTimeoutSeconds");
pub const CRYPTNET_PRE_FETCH_SCAN_AFTER_TRIGGER_DELAY_SECONDS_DEFAULT: u32 = 60u32;
pub const CRYPTNET_PRE_FETCH_SCAN_AFTER_TRIGGER_DELAY_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchScanAfterTriggerDelaySeconds");
pub const CRYPTNET_PRE_FETCH_TRIGGER_DISABLE: u32 = 4294967295u32;
pub const CRYPTNET_PRE_FETCH_TRIGGER_PERIOD_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchTriggerPeriodSeconds");
pub const CRYPTNET_PRE_FETCH_VALIDITY_PERIOD_AFTER_NEXT_UPDATE_PRE_FETCH_DIVISOR_DEFAULT: u32 = 10u32;
pub const CRYPTNET_PRE_FETCH_VALIDITY_PERIOD_AFTER_NEXT_UPDATE_PRE_FETCH_DIVISOR_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetPreFetchValidityPeriodAfterNextUpdatePreFetchDivisor");
pub const CRYPTNET_URL_CACHE_DEFAULT_FLUSH: u32 = 0u32;
pub const CRYPTNET_URL_CACHE_DEFAULT_FLUSH_EXEMPT_SECONDS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptnetDefaultFlushExemptSeconds");
...
pub const CRYPT_DEFAULT_CONTEXT: ::windows_strings::PCWSTR = ::windows_strings::w!("Default");
...
pub const CRYPT_DEFAULT_OID: ::windows_strings::PCSTR = ::windows_strings::s!("DEFAULT");
...
pub const CRYPT_LOCALIZED_NAME_OID: ::windows_strings::PCSTR = ::windows_strings::s!("LocalizedNames");
...
pub const CRYPT_OID_CREATE_COM_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllCreateCOMObject");
pub const CRYPT_OID_DECODE_OBJECT_EX_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllDecodeObjectEx");
pub const CRYPT_OID_DECODE_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllDecodeObject");
pub const CRYPT_OID_DISABLE_SEARCH_DS_FLAG: u32 = 2147483648u32;
pub const CRYPT_OID_ENCODE_OBJECT_EX_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllEncodeObjectEx");
pub const CRYPT_OID_ENCODE_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllEncodeObject");
pub const CRYPT_OID_ENUM_PHYSICAL_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllEnumPhysicalStore");
pub const CRYPT_OID_ENUM_SYSTEM_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllEnumSystemStore");
pub const CRYPT_OID_EXPORT_PRIVATE_KEY_INFO_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllExportPrivateKeyInfoEx");
pub const CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllExportPublicKeyInfoEx2");
pub const CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_FROM_BCRYPT_HANDLE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllExportPublicKeyInfoFromBCryptKeyHandle");
pub const CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllExportPublicKeyInfoEx");
pub const CRYPT_OID_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllExtractEncodedSignatureParameters");
pub const CRYPT_OID_FIND_LOCALIZED_NAME_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllFindLocalizedName");
pub const CRYPT_OID_FIND_OID_INFO_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllFindOIDInfo");
pub const CRYPT_OID_FORMAT_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllFormatObject");
pub const CRYPT_OID_IMPORT_PRIVATE_KEY_INFO_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllImportPrivateKeyInfoEx");
pub const CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllImportPublicKeyInfoEx2");
pub const CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllImportPublicKeyInfoEx");
...
pub const CRYPT_OID_INFO_ECC_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoECCParameters");
pub const CRYPT_OID_INFO_ECC_WRAP_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoECCWrapParameters");
pub const CRYPT_OID_INFO_HASH_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoHashParameters");
pub const CRYPT_OID_INFO_MGF1_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoMgf1Parameters");
pub const CRYPT_OID_INFO_NAME_KEY: u32 = 2u32;
pub const CRYPT_OID_INFO_NO_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoNoParameters");
pub const CRYPT_OID_INFO_NO_SIGN_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoNoSign");
pub const CRYPT_OID_INFO_OAEP_PARAMETERS_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptOIDInfoOAEPParameters");
...
pub const CRYPT_OID_OPEN_STORE_PROV_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllOpenStoreProv");
pub const CRYPT_OID_OPEN_SYSTEM_STORE_PROV_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllOpenSystemStoreProv");
...
pub const CRYPT_OID_REGISTER_PHYSICAL_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllRegisterPhysicalStore");
pub const CRYPT_OID_REGISTER_SYSTEM_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllRegisterSystemStore");
pub const CRYPT_OID_REGPATH: ::windows_strings::PCSTR = ::windows_strings::s!("Software\\Microsoft\\Cryptography\\OID");
pub const CRYPT_OID_REG_DLL_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Dll");
pub const CRYPT_OID_REG_ENCODING_TYPE_PREFIX: ::windows_strings::PCSTR = ::windows_strings::s!("EncodingType ");
pub const CRYPT_OID_REG_FLAGS_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CryptFlags");
pub const CRYPT_OID_REG_FUNC_NAME_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FuncName");
pub const CRYPT_OID_REG_FUNC_NAME_VALUE_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("FuncName");
pub const CRYPT_OID_SIGN_AND_ENCODE_HASH_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllSignAndEncodeHash");
pub const CRYPT_OID_SYSTEM_STORE_LOCATION_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemStoreLocation");
pub const CRYPT_OID_UNREGISTER_PHYSICAL_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllUnregisterPhysicalStore");
pub const CRYPT_OID_UNREGISTER_SYSTEM_STORE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllUnregisterSystemStore");
...
pub const CRYPT_OID_VERIFY_CERTIFICATE_CHAIN_POLICY_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllVerifyCertificateChainPolicy");
pub const CRYPT_OID_VERIFY_CTL_USAGE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllVerifyCTLUsage");
pub const CRYPT_OID_VERIFY_ENCODED_SIGNATURE_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CryptDllVerifyEncodedSignature");
pub const CRYPT_OID_VERIFY_REVOCATION_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("CertDllVerifyRevocation");
...
pub const EXPO_OFFLOAD_FUNC_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("OffloadModExpo");
pub const EXPO_OFFLOAD_REG_VALUE: ::windows_strings::PCSTR = ::windows_strings::s!("ExpoOffload");
...
pub const LEGACY_DH_PRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIDHPRIVATEBLOB");
pub const LEGACY_DH_PUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIDHPUBLICBLOB");
pub const LEGACY_DSA_PRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIDSAPRIVATEBLOB");
pub const LEGACY_DSA_PUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIDSAPUBLICBLOB");
pub const LEGACY_DSA_V2_PRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("V2CAPIDSAPRIVATEBLOB");
pub const LEGACY_DSA_V2_PUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("V2CAPIDSAPUBLICBLOB");
pub const LEGACY_RSAPRIVATE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIPRIVATEBLOB");
pub const LEGACY_RSAPUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPIPUBLICBLOB");
...
pub const MS_DEF_DH_SCHANNEL_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft DH SChannel Cryptographic Provider");
pub const MS_DEF_DH_SCHANNEL_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft DH SChannel Cryptographic Provider");
pub const MS_DEF_DH_SCHANNEL_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft DH SChannel Cryptographic Provider");
pub const MS_DEF_DSS_DH_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_DEF_DSS_DH_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Base DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_DEF_DSS_DH_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_DEF_DSS_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base DSS Cryptographic Provider");
pub const MS_DEF_DSS_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Base DSS Cryptographic Provider");
pub const MS_DEF_DSS_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base DSS Cryptographic Provider");
pub const MS_DEF_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base Cryptographic Provider v1.0");
pub const MS_DEF_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Base Cryptographic Provider v1.0");
pub const MS_DEF_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base Cryptographic Provider v1.0");
pub const MS_DEF_RSA_SCHANNEL_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft RSA SChannel Cryptographic Provider");
pub const MS_DEF_RSA_SCHANNEL_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft RSA SChannel Cryptographic Provider");
pub const MS_DEF_RSA_SCHANNEL_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft RSA SChannel Cryptographic Provider");
pub const MS_DEF_RSA_SIG_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft RSA Signature Cryptographic Provider");
pub const MS_DEF_RSA_SIG_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft RSA Signature Cryptographic Provider");
pub const MS_DEF_RSA_SIG_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft RSA Signature Cryptographic Provider");
pub const MS_ENHANCED_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced Cryptographic Provider v1.0");
pub const MS_ENHANCED_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Enhanced Cryptographic Provider v1.0");
pub const MS_ENHANCED_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced Cryptographic Provider v1.0");
pub const MS_ENH_DSS_DH_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_ENH_DSS_DH_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Enhanced DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_ENH_DSS_DH_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced DSS and Diffie-Hellman Cryptographic Provider");
pub const MS_ENH_RSA_AES_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced RSA and AES Cryptographic Provider");
pub const MS_ENH_RSA_AES_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Enhanced RSA and AES Cryptographic Provider");
pub const MS_ENH_RSA_AES_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced RSA and AES Cryptographic Provider");
pub const MS_ENH_RSA_AES_PROV_XP: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced RSA and AES Cryptographic Provider (Prototype)");
pub const MS_ENH_RSA_AES_PROV_XP_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Enhanced RSA and AES Cryptographic Provider (Prototype)");
pub const MS_ENH_RSA_AES_PROV_XP_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Enhanced RSA and AES Cryptographic Provider (Prototype)");
pub const MS_KEY_PROTECTION_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Key Protection Provider");
pub const MS_KEY_STORAGE_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Software Key Storage Provider");
pub const MS_NGC_KEY_STORAGE_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Passport Key Storage Provider");
pub const MS_PLATFORM_CRYPTO_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Platform Crypto Provider");
pub const MS_PLATFORM_KEY_STORAGE_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Platform Crypto Provider");
pub const MS_PRIMITIVE_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Primitive Provider");
pub const MS_SCARD_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base Smart Card Crypto Provider");
pub const MS_SCARD_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Base Smart Card Crypto Provider");
pub const MS_SCARD_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Base Smart Card Crypto Provider");
pub const MS_SMART_CARD_KEY_STORAGE_PROVIDER: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Smart Card Key Storage Provider");
pub const MS_STRONG_PROV: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Strong Cryptographic Provider");
pub const MS_STRONG_PROV_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Strong Cryptographic Provider");
pub const MS_STRONG_PROV_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Strong Cryptographic Provider");
...
pub const NCRYPT_3DES_112_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("3DES_112");
pub const NCRYPT_3DES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("3DES");
pub const NCRYPT_AES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("AES");
pub const NCRYPT_AES_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("AES");
pub const NCRYPT_ALGORITHM_GROUP_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Algorithm Group");
pub const NCRYPT_ALGORITHM_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Algorithm Name");
...
pub const NCRYPT_ALTERNATE_KEY_STORAGE_LOCATION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_ALTERNATE_KEY_STORAGE_LOCATION");
pub const NCRYPT_ASSOCIATED_ECDH_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardAssociatedECDHKey");
...
pub const NCRYPT_AUTH_TAG_LENGTH: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthTagLength");
pub const NCRYPT_BLOCK_LENGTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Block Length");
pub const NCRYPT_CAPI_KDF_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("CAPI_KDF");
pub const NCRYPT_CERTIFICATE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardKeyCertificate");
pub const NCRYPT_CHAINING_MODE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Chaining Mode");
pub const NCRYPT_CHANGEPASSWORD_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_CHANGEPASSWORD");
pub const NCRYPT_CIPHER_BLOCK_PADDING_FLAG: u32 = 1u32;
pub const NCRYPT_CIPHER_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CipherKeyBlob");
...
pub const NCRYPT_DESCR_DELIMITER_AND: ::windows_strings::PCWSTR = ::windows_strings::w!("AND");
pub const NCRYPT_DESCR_DELIMITER_OR: ::windows_strings::PCWSTR = ::windows_strings::w!("OR");
pub const NCRYPT_DESCR_EQUAL: ::windows_strings::PCWSTR = ::windows_strings::w!("=");
pub const NCRYPT_DESX_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DESX");
pub const NCRYPT_DES_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DES");
pub const NCRYPT_DES_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DES");
pub const NCRYPT_DH_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DH");
pub const NCRYPT_DH_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DH");
pub const NCRYPT_DH_PARAMETERS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("DHParameters");
pub const NCRYPT_DISMISS_UI_TIMEOUT_SEC_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardDismissUITimeoutSeconds");
pub const NCRYPT_DO_NOT_FINALIZE_FLAG: u32 = 1024u32;
pub const NCRYPT_DSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("DSA");
pub const NCRYPT_DSA_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("DSA");
pub const NCRYPT_ECC_CURVE_NAME_LIST_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCCurveNameList");
pub const NCRYPT_ECC_CURVE_NAME_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCCurveName");
pub const NCRYPT_ECC_PARAMETERS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("ECCParameters");
pub const NCRYPT_ECDH_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH");
pub const NCRYPT_ECDH_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH");
pub const NCRYPT_ECDH_P256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P256");
pub const NCRYPT_ECDH_P384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P384");
pub const NCRYPT_ECDH_P521_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDH_P521");
pub const NCRYPT_ECDSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA");
pub const NCRYPT_ECDSA_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA");
pub const NCRYPT_ECDSA_P256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P256");
pub const NCRYPT_ECDSA_P384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P384");
pub const NCRYPT_ECDSA_P521_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("ECDSA_P521");
...
pub const NCRYPT_EXPORT_POLICY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Export Policy");
pub const NCRYPT_EXTENDED_ERRORS_FLAG: u32 = 268435456u32;
pub const NCRYPT_HASH_OPERATION: NCRYPT_OPERATION = 2u32;
pub const NCRYPT_HMAC_SHA256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("HMAC-SHA256");
...
pub const NCRYPT_IMPL_TYPE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Impl Type");
pub const NCRYPT_IMPL_VIRTUAL_ISOLATION_FLAG: u32 = 32u32;
pub const NCRYPT_INITIALIZATION_VECTOR: ::windows_strings::PCWSTR = ::windows_strings::w!("IV");
...
pub const NCRYPT_ISOLATED_KEY_ENVELOPE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ISOLATED_KEY_ENVELOPE");
pub const NCRYPT_ISOLATED_KEY_FLAG_CREATED_IN_ISOLATION: u32 = 1u32;
pub const NCRYPT_ISOLATED_KEY_FLAG_IMPORT_ONLY: u32 = 2u32;
pub const NCRYPT_KDF_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("KDFKeyBlob");
pub const NCRYPT_KDF_KEY_BLOB_MAGIC: u32 = 826688587u32;
pub const NCRYPT_KDF_SECRET_VALUE: ::windows_strings::PCWSTR = ::windows_strings::w!("KDFKeySecret");
pub const NCRYPT_KEY_ACCESS_POLICY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Key Access Policy");
pub const NCRYPT_KEY_ACCESS_POLICY_VERSION: u32 = 1u32;
pub const NCRYPT_KEY_ATTEST_MAGIC: u32 = 1146110283u32;
pub const NCRYPT_KEY_DERIVATION_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("KEY_DERIVATION");
pub const NCRYPT_KEY_DERIVATION_INTERFACE: u32 = 7u32;
pub const NCRYPT_KEY_DERIVATION_OPERATION: u32 = 64u32;
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_CERTIFICATE: ::windows_strings::PCWSTR = ::windows_strings::w!("CERTIFICATE");
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_LOCAL: ::windows_strings::PCWSTR = ::windows_strings::w!("LOCAL");
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_LOCKEDCREDENTIALS: ::windows_strings::PCWSTR = ::windows_strings::w!("LOCKEDCREDENTIALS");
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_SDDL: ::windows_strings::PCWSTR = ::windows_strings::w!("SDDL");
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_SID: ::windows_strings::PCWSTR = ::windows_strings::w!("SID");
pub const NCRYPT_KEY_PROTECTION_ALGORITHM_WEBCREDENTIALS: ::windows_strings::PCWSTR = ::windows_strings::w!("WEBCREDENTIALS");
pub const NCRYPT_KEY_PROTECTION_CERT_CERTBLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("CertBlob");
pub const NCRYPT_KEY_PROTECTION_CERT_HASHID: ::windows_strings::PCWSTR = ::windows_strings::w!("HashId");
pub const NCRYPT_KEY_PROTECTION_INTERFACE: u32 = 65540u32;
pub const NCRYPT_KEY_PROTECTION_LOCAL_LOGON: ::windows_strings::PCWSTR = ::windows_strings::w!("logon");
pub const NCRYPT_KEY_PROTECTION_LOCAL_MACHINE: ::windows_strings::PCWSTR = ::windows_strings::w!("machine");
pub const NCRYPT_KEY_PROTECTION_LOCAL_USER: ::windows_strings::PCWSTR = ::windows_strings::w!("user");
pub const NCRYPT_KEY_STORAGE_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("KEY_STORAGE");
pub const NCRYPT_KEY_STORAGE_INTERFACE: BCRYPT_INTERFACE = 65537u32;
pub const NCRYPT_KEY_TYPE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Key Type");
pub const NCRYPT_KEY_USAGE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Key Usage");
pub const NCRYPT_LAST_MODIFIED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Modified");
pub const NCRYPT_LENGTHS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Lengths");
pub const NCRYPT_LENGTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Length");
...
pub const NCRYPT_MAX_NAME_LENGTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Max Name Length");
pub const NCRYPT_MAX_PROPERTY_DATA: u32 = 1048576u32;
pub const NCRYPT_MAX_PROPERTY_NAME: u32 = 64u32;
pub const NCRYPT_MD2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD2");
pub const NCRYPT_MD4_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD4");
pub const NCRYPT_MD5_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("MD5");
pub const NCRYPT_NAMED_DESCRIPTOR_FLAG: u32 = 1u32;
pub const NCRYPT_NAME_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
...
pub const NCRYPT_OPAQUETRANSPORT_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("OpaqueTransport");
...
pub const NCRYPT_PBKDF2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("PBKDF2");
pub const NCRYPT_PCP_ALTERNATE_KEY_STORAGE_LOCATION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_ALTERNATE_KEY_STORAGE_LOCATION");
pub const NCRYPT_PCP_CHANGEPASSWORD_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_CHANGEPASSWORD");
pub const NCRYPT_PCP_ECC_EKCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_ECC_EKCERT");
pub const NCRYPT_PCP_ECC_EKNVCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_ECC_EKNVCERT");
pub const NCRYPT_PCP_ECC_EKPUB_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_ECC_EKPUB");
pub const NCRYPT_PCP_EKCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_EKCERT");
pub const NCRYPT_PCP_EKNVCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_EKNVCERT");
pub const NCRYPT_PCP_EKPUB_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_EKPUB");
pub const NCRYPT_PCP_ENCRYPTION_KEY: u32 = 2u32;
pub const NCRYPT_PCP_EXPORT_ALLOWED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_EXPORT_ALLOWED");
pub const NCRYPT_PCP_HMACVERIFICATION_KEY: u32 = 16u32;
pub const NCRYPT_PCP_HMAC_AUTH_NONCE: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_HMAC_AUTH_NONCE");
pub const NCRYPT_PCP_HMAC_AUTH_POLICYINFO: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_HMAC_AUTH_POLICYINFO");
pub const NCRYPT_PCP_HMAC_AUTH_POLICYREF: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_HMAC_AUTH_POLICYREF");
pub const NCRYPT_PCP_HMAC_AUTH_SIGNATURE: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_HMAC_AUTH_SIGNATURE");
pub const NCRYPT_PCP_HMAC_AUTH_TICKET: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_HMAC_AUTH_TICKET");
pub const NCRYPT_PCP_IDENTITY_KEY: u32 = 8u32;
pub const NCRYPT_PCP_INTERMEDIATE_CA_EKCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_INTERMEDIATE_CA_EKCERT");
pub const NCRYPT_PCP_KEYATTESTATION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM12_KEYATTESTATION");
pub const NCRYPT_PCP_KEY_CREATIONHASH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_KEY_CREATIONHASH");
pub const NCRYPT_PCP_KEY_CREATIONTICKET_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_KEY_CREATIONTICKET");
pub const NCRYPT_PCP_KEY_USAGE_POLICY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_KEY_USAGE_POLICY");
pub const NCRYPT_PCP_MIGRATIONPASSWORD_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_MIGRATIONPASSWORD");
pub const NCRYPT_PCP_NO_DA_PROTECTION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_NO_DA_PROTECTION");
pub const NCRYPT_PCP_PASSWORD_REQUIRED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PASSWORD_REQUIRED");
pub const NCRYPT_PCP_PCRTABLE_ALGORITHM_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PCRTABLE_ALGORITHM");
pub const NCRYPT_PCP_PCRTABLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PCRTABLE");
pub const NCRYPT_PCP_PLATFORMHANDLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORMHANDLE");
pub const NCRYPT_PCP_PLATFORM_BINDING_PCRALGID_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_BINDING_PCRALGID");
pub const NCRYPT_PCP_PLATFORM_BINDING_PCRDIGESTLIST_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_BINDING_PCRDIGESTLIST");
pub const NCRYPT_PCP_PLATFORM_BINDING_PCRDIGEST_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_BINDING_PCRDIGEST");
pub const NCRYPT_PCP_PLATFORM_BINDING_PCRMASK_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_BINDING_PCRMASK");
pub const NCRYPT_PCP_PLATFORM_TYPE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PLATFORM_TYPE");
pub const NCRYPT_PCP_PROVIDERHANDLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PROVIDERMHANDLE");
pub const NCRYPT_PCP_PROVIDER_VERSION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_PROVIDER_VERSION");
pub const NCRYPT_PCP_PSS_SALT_SIZE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PSS Salt Size");
pub const NCRYPT_PCP_RAW_POLICYDIGEST_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RAW_POLICYDIGEST");
pub const NCRYPT_PCP_RSA_EKCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RSA_EKCERT");
pub const NCRYPT_PCP_RSA_EKNVCERT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RSA_EKNVCERT");
pub const NCRYPT_PCP_RSA_EKPUB_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RSA_EKPUB");
pub const NCRYPT_PCP_RSA_SCHEME_HASH_ALG_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RSA_SCHEME_HASH_ALG");
pub const NCRYPT_PCP_RSA_SCHEME_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_RSA_SCHEME");
pub const NCRYPT_PCP_SESSIONID_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_SESSIONID");
pub const NCRYPT_PCP_SIGNATURE_KEY: u32 = 1u32;
pub const NCRYPT_PCP_SRKPUB_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_SRKPUB");
pub const NCRYPT_PCP_STORAGEPARENT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_STORAGEPARENT");
pub const NCRYPT_PCP_STORAGE_KEY: u32 = 4u32;
pub const NCRYPT_PCP_SYMMETRIC_KEYBITS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_SYMMETRIC_KEYBITS");
pub const NCRYPT_PCP_TPM12_IDACTIVATION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM12_IDACTIVATION");
pub const NCRYPT_PCP_TPM12_IDBINDING_DYNAMIC_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM12_IDBINDING_DYNAMIC");
pub const NCRYPT_PCP_TPM12_IDBINDING_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM12_IDBINDING");
pub const NCRYPT_PCP_TPM2BNAME_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM2BNAME");
pub const NCRYPT_PCP_TPM_FW_VERSION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM_FW_VERSION");
pub const NCRYPT_PCP_TPM_IFX_RSA_KEYGEN_PROHIBITED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM_IFX_RSA_KEYGEN_PROHIBITED");
pub const NCRYPT_PCP_TPM_IFX_RSA_KEYGEN_VULNERABILITY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM_IFX_RSA_KEYGEN_VULNERABILITY");
pub const NCRYPT_PCP_TPM_MANUFACTURER_ID_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM_MANUFACTURER_ID");
pub const NCRYPT_PCP_TPM_VERSION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_TPM_VERSION");
pub const NCRYPT_PCP_USAGEAUTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PCP_USAGEAUTH");
pub const NCRYPT_PERSIST_FLAG: NCRYPT_FLAGS = 2147483648u32;
pub const NCRYPT_PERSIST_ONLY_FLAG: NCRYPT_FLAGS = 1073741824u32;
pub const NCRYPT_PIN_CACHE_APPLICATION_IMAGE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheApplicationImage");
pub const NCRYPT_PIN_CACHE_APPLICATION_STATUS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheApplicationStatus");
pub const NCRYPT_PIN_CACHE_APPLICATION_TICKET_BYTE_LENGTH: u32 = 90u32;
pub const NCRYPT_PIN_CACHE_APPLICATION_TICKET_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheApplicationTicket");
pub const NCRYPT_PIN_CACHE_CLEAR_FOR_CALLING_PROCESS_OPTION: u32 = 1u32;
pub const NCRYPT_PIN_CACHE_CLEAR_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheClear");
pub const NCRYPT_PIN_CACHE_DISABLE_DPL_FLAG: u32 = 1u32;
pub const NCRYPT_PIN_CACHE_FLAGS_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheFlags");
pub const NCRYPT_PIN_CACHE_FREE_APPLICATION_TICKET_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheFreeApplicationTicket");
pub const NCRYPT_PIN_CACHE_IS_GESTURE_REQUIRED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCacheIsGestureRequired");
pub const NCRYPT_PIN_CACHE_PIN_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PinCachePin");
pub const NCRYPT_PIN_CACHE_REQUIRE_GESTURE_FLAG: u32 = 1u32;
pub const NCRYPT_PIN_PROMPT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardPinPrompt");
pub const NCRYPT_PIN_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardPin");
pub const NCRYPT_PKCS7_ENVELOPE_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("PKCS7_ENVELOPE");
pub const NCRYPT_PKCS8_PRIVATE_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("PKCS8_PRIVATEKEY");
pub const NCRYPT_PLATFORM_ATTEST_MAGIC: u32 = 1146110288u32;
pub const NCRYPT_PREFER_VIRTUAL_ISOLATION_FLAG: u32 = 65536u32;
pub const NCRYPT_PROTECTED_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("ProtectedKeyBlob");
...
pub const NCRYPT_PROVIDER_HANDLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Provider Handle");
pub const NCRYPT_PUBLIC_LENGTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("PublicKeyLength");
pub const NCRYPT_RC2_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RC2");
pub const NCRYPT_RC2_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("RC2");
pub const NCRYPT_READER_ICON_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardReaderIcon");
pub const NCRYPT_READER_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardReader");
pub const NCRYPT_REGISTER_NOTIFY_FLAG: NCRYPT_FLAGS = 1u32;
pub const NCRYPT_REQUIRE_KDS_LRPC_BIND_FLAG: u32 = 536870912u32;
pub const NCRYPT_ROOT_CERTSTORE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartcardRootCertStore");
pub const NCRYPT_RSA_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RSA");
pub const NCRYPT_RSA_ALGORITHM_GROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("RSA");
pub const NCRYPT_RSA_SIGN_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("RSA_SIGN");
pub const NCRYPT_SCARD_NGC_KEY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardNgcKeyName");
pub const NCRYPT_SCARD_PIN_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardPinId");
pub const NCRYPT_SCARD_PIN_INFO: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardPinInfo");
...
pub const NCRYPT_SECURE_PIN_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardSecurePin");
pub const NCRYPT_SECURITY_DESCR_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Security Descr");
pub const NCRYPT_SECURITY_DESCR_SUPPORT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Security Descr Support");
pub const NCRYPT_SHA1_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA1");
pub const NCRYPT_SHA256_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA256");
pub const NCRYPT_SHA384_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA384");
pub const NCRYPT_SHA512_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHA512");
pub const NCRYPT_SIGNATURE_INTERFACE: NCRYPT_ALGORITHM_NAME_CLASS = 5u32;
pub const NCRYPT_SIGNATURE_LENGTH_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SignatureLength");
pub const NCRYPT_SIGNATURE_OPERATION: NCRYPT_OPERATION = 16u32;
pub const NCRYPT_SILENT_FLAG: NCRYPT_FLAGS = 64u32;
pub const NCRYPT_SMARTCARD_GUID_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardGuid");
pub const NCRYPT_SP800108_CTR_HMAC_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SP800_108_CTR_HMAC");
pub const NCRYPT_SP80056A_CONCAT_ALGORITHM: ::windows_strings::PCWSTR = ::windows_strings::w!("SP800_56A_CONCAT");
pub const NCRYPT_TPM12_PROVIDER: u32 = 65536u32;
pub const NCRYPT_TPM_LOADABLE_KEY_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("PcpTpmProtectedKeyBlob");
...
pub const NCRYPT_UI_POLICY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("UI Policy");
pub const NCRYPT_UI_PROTECT_KEY_FLAG: u32 = 1u32;
pub const NCRYPT_UNIQUE_NAME_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Unique Name");
pub const NCRYPT_UNPROTECT_NO_DECRYPT: NCRYPT_FLAGS = 1u32;
pub const NCRYPT_UNREGISTER_NOTIFY_FLAG: NCRYPT_FLAGS = 2u32;
pub const NCRYPT_USER_CERTSTORE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCardUserCertStore");
pub const NCRYPT_USE_CONTEXT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Use Context");
pub const NCRYPT_USE_COUNT_ENABLED_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Enabled Use Count");
pub const NCRYPT_USE_COUNT_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Use Count");
pub const NCRYPT_USE_PER_BOOT_KEY_FLAG: u32 = 262144u32;
pub const NCRYPT_USE_PER_BOOT_KEY_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Per Boot Key");
pub const NCRYPT_USE_VIRTUAL_ISOLATION_FLAG: u32 = 131072u32;
pub const NCRYPT_USE_VIRTUAL_ISOLATION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Virtual Iso");
pub const NCRYPT_VERSION_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
...
pub const NCRYPT_WINDOW_HANDLE_PROPERTY: ::windows_strings::PCWSTR = ::windows_strings::w!("HWND Handle");
...
pub const PKCS12_CONFIG_REGPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Software\\Microsoft\\Windows\\CurrentVersion\\PFX");
pub const PKCS12_DISABLE_ENCRYPT_CERTIFICATES: u32 = 256u32;
pub const PKCS12_ENCRYPT_CERTIFICATES: u32 = 512u32;
pub const PKCS12_ENCRYPT_CERTIFICATES_VALUE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("EncryptCertificates");
...
pub const PKCS12_ONLY_CERTIFICATES_CONTAINER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PfxContainer");
pub const PKCS12_ONLY_CERTIFICATES_PROVIDER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PfxProvider");
pub const PKCS12_ONLY_CERTIFICATES_PROVIDER_TYPE: u32 = 0u32;
pub const PKCS12_ONLY_NOT_ENCRYPTED_CERTIFICATES: u32 = 2048u32;
pub const PKCS12_PBES2_ALG_AES256_SHA256: ::windows_strings::PCWSTR = ::windows_strings::w!("AES256-SHA256");
pub const PKCS12_PBKDF2_ID_HMAC_SHA1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.7");
pub const PKCS12_PBKDF2_ID_HMAC_SHA256: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.9");
pub const PKCS12_PBKDF2_ID_HMAC_SHA384: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.10");
pub const PKCS12_PBKDF2_ID_HMAC_SHA512: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.11");
...
pub const SCHEME_OID_RETRIEVE_ENCODED_OBJECTW_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("SchemeDllRetrieveEncodedObjectW");
pub const SCHEME_OID_RETRIEVE_ENCODED_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("SchemeDllRetrieveEncodedObject");
...
pub const SSL_ECCPUBLIC_BLOB: ::windows_strings::PCWSTR = ::windows_strings::w!("SSLECCPUBLICBLOB");
...
pub const SSL_OBJECT_LOCATOR_CERT_VALIDATION_CONFIG_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("SslObjectLocatorInitializeCertValidationConfig");
pub const SSL_OBJECT_LOCATOR_ISSUER_LIST_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("SslObjectLocatorInitializeIssuerList");
pub const SSL_OBJECT_LOCATOR_PFX_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("SslObjectLocatorInitializePfx");
...
pub const TIME_VALID_OID_FLUSH_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("TimeValidDllFlushObject");
...
pub const TIME_VALID_OID_GET_OBJECT_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("TimeValidDllGetObject");
pub const TPM_RSA_SRK_SEAL_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("MICROSOFT_PCP_KSP_RSA_SEAL_KEY_3BD1C4BF-004E-4E2F-8A4D-0BF633DCB074");
...
pub const URL_OID_GET_OBJECT_URL_FUNC: ::windows_strings::PCSTR = ::windows_strings::s!("UrlDllGetObjectUrl");
...
pub const szFORCE_KEY_PROTECTION: ::windows_strings::PCSTR = ::windows_strings::s!("ForceKeyProtection");
pub const szKEY_CACHE_ENABLED: ::windows_strings::PCSTR = ::windows_strings::s!("CachePrivateKeys");
pub const szKEY_CACHE_SECONDS: ::windows_strings::PCSTR = ::windows_strings::s!("PrivateKeyLifetimeSeconds");
pub const szKEY_CRYPTOAPI_PRIVATE_KEY_OPTIONS: ::windows_strings::PCSTR = ::windows_strings::s!("Software\\Policies\\Microsoft\\Cryptography");
pub const szOIDVerisign_FailInfo: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.4");
pub const szOIDVerisign_MessageType: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.2");
pub const szOIDVerisign_PkiStatus: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.3");
pub const szOIDVerisign_RecipientNonce: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.6");
pub const szOIDVerisign_SenderNonce: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.5");
pub const szOIDVerisign_TransactionID: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.9.7");
pub const szOID_ANSI_X942: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10046");
pub const szOID_ANSI_X942_DH: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10046.2.1");
pub const szOID_ANY_APPLICATION_POLICY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.12.1");
pub const szOID_ANY_CERT_POLICY: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.32.0");
pub const szOID_ANY_ENHANCED_KEY_USAGE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.37.0");
pub const szOID_APPLICATION_CERT_POLICIES: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.10");
pub const szOID_APPLICATION_POLICY_CONSTRAINTS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.12");
pub const szOID_APPLICATION_POLICY_MAPPINGS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.11");
pub const szOID_ARCHIVED_KEY_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.13");
pub const szOID_ARCHIVED_KEY_CERT_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.16");
pub const szOID_ATTEST_WHQL_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.5.1");
pub const szOID_ATTR_PLATFORM_SPECIFICATION: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.17");
pub const szOID_ATTR_SUPPORTED_ALGORITHMS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.52");
pub const szOID_ATTR_TPM_SECURITY_ASSERTIONS: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.18");
pub const szOID_ATTR_TPM_SPECIFICATION: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.16");
pub const szOID_AUTHORITY_INFO_ACCESS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.1");
pub const szOID_AUTHORITY_KEY_IDENTIFIER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.1");
pub const szOID_AUTHORITY_KEY_IDENTIFIER2: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.35");
pub const szOID_AUTHORITY_REVOCATION_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.38");
pub const szOID_AUTO_ENROLL_CTL_USAGE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.1");
pub const szOID_BACKGROUND_OTHER_LOGOTYPE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.20.2");
pub const szOID_BASIC_CONSTRAINTS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.10");
pub const szOID_BASIC_CONSTRAINTS2: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.19");
pub const szOID_BIOMETRIC_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.2");
pub const szOID_BIOMETRIC_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.41");
pub const szOID_BUSINESS_CATEGORY: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.15");
pub const szOID_CA_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.37");
pub const szOID_CERTIFICATE_REVOCATION_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.39");
pub const szOID_CERTIFICATE_TEMPLATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.7");
pub const szOID_CERTSRV_CA_VERSION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.1");
pub const szOID_CERTSRV_CROSSCA_VERSION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.22");
pub const szOID_CERTSRV_PREVIOUS_CERT_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.2");
pub const szOID_CERT_DISALLOWED_CA_FILETIME_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.128");
pub const szOID_CERT_DISALLOWED_FILETIME_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.104");
pub const szOID_CERT_EXTENSIONS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.2.1.14");
pub const szOID_CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.28");
pub const szOID_CERT_KEY_IDENTIFIER_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.20");
pub const szOID_CERT_MANIFOLD: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.3");
pub const szOID_CERT_MD5_HASH_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.4");
pub const szOID_CERT_POLICIES: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.32");
pub const szOID_CERT_POLICIES_95: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.3");
pub const szOID_CERT_POLICIES_95_QUALIFIER1: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.7.1.1");
pub const szOID_CERT_PROP_ID_PREFIX: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.");
pub const szOID_CERT_SIGNATURE_HASH_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.15");
pub const szOID_CERT_STRONG_KEY_OS_1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.72.2.1");
pub const szOID_CERT_STRONG_KEY_OS_CURRENT: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.6.1.4.1.311.72.2.1");
pub const szOID_CERT_STRONG_KEY_OS_PREFIX: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.72.2.");
pub const szOID_CERT_STRONG_SIGN_OS_1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.72.1.1");
pub const szOID_CERT_STRONG_SIGN_OS_CURRENT: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.6.1.4.1.311.72.1.1");
pub const szOID_CERT_STRONG_SIGN_OS_PREFIX: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.72.1.");
pub const szOID_CERT_SUBJECT_NAME_MD5_HASH_PROP_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.11.29");
pub const szOID_CMC: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7");
pub const szOID_CMC_ADD_ATTRIBUTES: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.10.1");
pub const szOID_CMC_ADD_EXTENSIONS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.8");
pub const szOID_CMC_DATA_RETURN: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.4");
pub const szOID_CMC_DECRYPTED_POP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.10");
pub const szOID_CMC_ENCRYPTED_POP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.9");
pub const szOID_CMC_GET_CERT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.15");
pub const szOID_CMC_GET_CRL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.16");
pub const szOID_CMC_IDENTIFICATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.2");
pub const szOID_CMC_IDENTITY_PROOF: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.3");
pub const szOID_CMC_ID_CONFIRM_CERT_ACCEPTANCE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.24");
pub const szOID_CMC_ID_POP_LINK_RANDOM: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.22");
pub const szOID_CMC_ID_POP_LINK_WITNESS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.23");
pub const szOID_CMC_LRA_POP_WITNESS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.11");
pub const szOID_CMC_QUERY_PENDING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.21");
pub const szOID_CMC_RECIPIENT_NONCE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.7");
pub const szOID_CMC_REG_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.18");
pub const szOID_CMC_RESPONSE_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.19");
pub const szOID_CMC_REVOKE_REQUEST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.17");
pub const szOID_CMC_SENDER_NONCE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.6");
pub const szOID_CMC_STATUS_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.1");
pub const szOID_CMC_TRANSACTION_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.7.5");
pub const szOID_CN_ECDSA_SHA256: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.156.11235.1.1.1");
pub const szOID_COMMON_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.3");
pub const szOID_COUNTRY_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.6");
pub const szOID_CRL_DIST_POINTS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.31");
pub const szOID_CRL_NEXT_PUBLISH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.4");
pub const szOID_CRL_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.20");
pub const szOID_CRL_REASON_CODE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.21");
pub const szOID_CRL_SELF_CDP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.14");
pub const szOID_CRL_VIRTUAL_BASE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.3");
pub const szOID_CROSS_CERTIFICATE_PAIR: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.40");
pub const szOID_CROSS_CERT_DIST_POINTS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.9.1");
pub const szOID_CTL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.1");
pub const szOID_CT_CERT_SCTLIST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.11129.2.4.2");
pub const szOID_CT_PKI_DATA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.12.2");
pub const szOID_CT_PKI_RESPONSE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.12.3");
pub const szOID_DELTA_CRL_INDICATOR: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.27");
pub const szOID_DESCRIPTION: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.13");
pub const szOID_DESTINATION_INDICATOR: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.27");
pub const szOID_DEVICE_SERIAL_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.5");
pub const szOID_DH_SINGLE_PASS_STDDH_SHA1_KDF: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.133.16.840.63.0.2");
pub const szOID_DH_SINGLE_PASS_STDDH_SHA256_KDF: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.1.11.1");
pub const szOID_DH_SINGLE_PASS_STDDH_SHA384_KDF: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.1.11.2");
pub const szOID_DISALLOWED_HASH: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.6.1.4.1.311.10.11.15");
pub const szOID_DISALLOWED_LIST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.30");
pub const szOID_DN_QUALIFIER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.46");
pub const szOID_DOMAIN_COMPONENT: ::windows_strings::PCSTR = ::windows_strings::s!("0.9.2342.19200300.100.1.25");
pub const szOID_DRM: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.5.1");
pub const szOID_DRM_INDIVIDUALIZATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.5.2");
pub const szOID_DS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5");
pub const szOID_DSALG: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.8");
pub const szOID_DSALG_CRPT: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.8.1");
pub const szOID_DSALG_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.8.2");
pub const szOID_DSALG_RSA: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.8.1.1");
pub const szOID_DSALG_SIGN: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.8.3");
pub const szOID_DS_EMAIL_REPLICATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.19");
pub const szOID_DYNAMIC_CODE_GEN_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.76.5.1");
pub const szOID_ECC_CURVE_BRAINPOOLP160R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.1");
pub const szOID_ECC_CURVE_BRAINPOOLP160T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.2");
pub const szOID_ECC_CURVE_BRAINPOOLP192R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.3");
pub const szOID_ECC_CURVE_BRAINPOOLP192T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.4");
pub const szOID_ECC_CURVE_BRAINPOOLP224R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.5");
pub const szOID_ECC_CURVE_BRAINPOOLP224T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.6");
pub const szOID_ECC_CURVE_BRAINPOOLP256R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.7");
pub const szOID_ECC_CURVE_BRAINPOOLP256T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.8");
pub const szOID_ECC_CURVE_BRAINPOOLP320R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.9");
pub const szOID_ECC_CURVE_BRAINPOOLP320T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.10");
pub const szOID_ECC_CURVE_BRAINPOOLP384R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.11");
pub const szOID_ECC_CURVE_BRAINPOOLP384T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.12");
pub const szOID_ECC_CURVE_BRAINPOOLP512R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.13");
pub const szOID_ECC_CURVE_BRAINPOOLP512T1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.36.3.3.2.8.1.1.14");
pub const szOID_ECC_CURVE_EC192WAPI: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.156.11235.1.1.2.1");
pub const szOID_ECC_CURVE_NISTP192: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.1");
pub const szOID_ECC_CURVE_NISTP224: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.33");
pub const szOID_ECC_CURVE_NISTP256: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.10045.3.1.7");
pub const szOID_ECC_CURVE_NISTP384: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.34");
pub const szOID_ECC_CURVE_NISTP521: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.35");
pub const szOID_ECC_CURVE_P256: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.7");
pub const szOID_ECC_CURVE_P384: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.34");
pub const szOID_ECC_CURVE_P521: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.35");
pub const szOID_ECC_CURVE_SECP160K1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.9");
pub const szOID_ECC_CURVE_SECP160R1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.8");
pub const szOID_ECC_CURVE_SECP160R2: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.30");
pub const szOID_ECC_CURVE_SECP192K1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.31");
pub const szOID_ECC_CURVE_SECP192R1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.10045.3.1.1");
pub const szOID_ECC_CURVE_SECP224K1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.32");
pub const szOID_ECC_CURVE_SECP224R1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.33");
pub const szOID_ECC_CURVE_SECP256K1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.132.0.10");
pub const szOID_ECC_CURVE_SECP256R1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.10045.3.1.7");
pub const szOID_ECC_CURVE_SECP384R1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.34");
pub const szOID_ECC_CURVE_SECP521R1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.35");
pub const szOID_ECC_CURVE_WTLS12: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.33");
pub const szOID_ECC_CURVE_WTLS7: ::windows_strings::PCWSTR = ::windows_strings::w!("1.3.132.0.30");
pub const szOID_ECC_CURVE_WTLS9: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.43.1.4.9");
pub const szOID_ECC_CURVE_X962P192V1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.1");
pub const szOID_ECC_CURVE_X962P192V2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.2");
pub const szOID_ECC_CURVE_X962P192V3: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.3");
pub const szOID_ECC_CURVE_X962P239V1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.4");
pub const szOID_ECC_CURVE_X962P239V2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.5");
pub const szOID_ECC_CURVE_X962P239V3: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.3.1.6");
pub const szOID_ECC_CURVE_X962P256V1: ::windows_strings::PCWSTR = ::windows_strings::w!("1.2.840.10045.3.1.7");
pub const szOID_ECC_PUBLIC_KEY: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.2.1");
pub const szOID_ECDSA_SHA1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.4.1");
pub const szOID_ECDSA_SHA256: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.4.3.2");
pub const szOID_ECDSA_SHA384: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.4.3.3");
pub const szOID_ECDSA_SHA512: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.4.3.4");
pub const szOID_ECDSA_SPECIFIED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10045.4.3");
pub const szOID_EFS_RECOVERY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.4.1");
pub const szOID_EMBEDDED_NT_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.8");
pub const szOID_ENCLAVE_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.42");
pub const szOID_ENCRYPTED_KEY_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.21");
pub const szOID_ENHANCED_KEY_USAGE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.37");
pub const szOID_ENROLLMENT_AGENT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.2.1");
pub const szOID_ENROLLMENT_CSP_PROVIDER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.13.2.2");
pub const szOID_ENROLLMENT_NAME_VALUE_PAIR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.13.2.1");
pub const szOID_ENROLL_AIK_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.39");
pub const szOID_ENROLL_ATTESTATION_CHALLENGE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.28");
pub const szOID_ENROLL_ATTESTATION_STATEMENT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.24");
pub const szOID_ENROLL_CAXCHGCERT_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.27");
pub const szOID_ENROLL_CERTTYPE_EXTENSION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.2");
pub const szOID_ENROLL_EKPUB_CHALLENGE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.26");
pub const szOID_ENROLL_EKVERIFYCERT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.31");
pub const szOID_ENROLL_EKVERIFYCREDS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.32");
pub const szOID_ENROLL_EKVERIFYKEY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.30");
pub const szOID_ENROLL_EK_CA_KEYID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.43");
pub const szOID_ENROLL_EK_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.23");
pub const szOID_ENROLL_ENCRYPTION_ALGORITHM: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.29");
pub const szOID_ENROLL_KEY_AFFINITY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.41");
pub const szOID_ENROLL_KSP_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.25");
pub const szOID_ENROLL_SCEP_CHALLENGE_ANSWER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.35");
pub const szOID_ENROLL_SCEP_CLIENT_REQUEST: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.37");
pub const szOID_ENROLL_SCEP_ERROR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.33");
pub const szOID_ENROLL_SCEP_SERVER_MESSAGE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.38");
pub const szOID_ENROLL_SCEP_SERVER_SECRET: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.40");
pub const szOID_ENROLL_SCEP_SERVER_STATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.34");
pub const szOID_ENROLL_SCEP_SIGNER_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.42");
pub const szOID_ENTERPRISE_OID_ROOT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.8");
pub const szOID_EV_RDN_COUNTRY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.2.1.3");
pub const szOID_EV_RDN_LOCALE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.2.1.1");
pub const szOID_EV_RDN_STATE_OR_PROVINCE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.2.1.2");
pub const szOID_EV_WHQL_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.39");
pub const szOID_FACSIMILE_TELEPHONE_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.23");
pub const szOID_FRESHEST_CRL: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.46");
pub const szOID_GIVEN_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.42");
pub const szOID_HPKP_DOMAIN_NAME_CTL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.60");
pub const szOID_HPKP_HEADER_VALUE_CTL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.61");
pub const szOID_INFOSEC: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1");
pub const szOID_INFOSEC_SuiteAConfidentiality: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.14");
pub const szOID_INFOSEC_SuiteAIntegrity: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.15");
pub const szOID_INFOSEC_SuiteAKMandSig: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.18");
pub const szOID_INFOSEC_SuiteAKeyManagement: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.17");
pub const szOID_INFOSEC_SuiteASignature: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.13");
pub const szOID_INFOSEC_SuiteATokenProtection: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.16");
pub const szOID_INFOSEC_mosaicConfidentiality: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.4");
pub const szOID_INFOSEC_mosaicIntegrity: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.6");
pub const szOID_INFOSEC_mosaicKMandSig: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.12");
pub const szOID_INFOSEC_mosaicKMandUpdSig: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.20");
pub const szOID_INFOSEC_mosaicKeyManagement: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.10");
pub const szOID_INFOSEC_mosaicSignature: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.2");
pub const szOID_INFOSEC_mosaicTokenProtection: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.8");
pub const szOID_INFOSEC_mosaicUpdatedInteg: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.21");
pub const szOID_INFOSEC_mosaicUpdatedSig: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.19");
pub const szOID_INFOSEC_sdnsConfidentiality: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.3");
pub const szOID_INFOSEC_sdnsIntegrity: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.5");
pub const szOID_INFOSEC_sdnsKMandSig: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.11");
pub const szOID_INFOSEC_sdnsKeyManagement: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.9");
pub const szOID_INFOSEC_sdnsSignature: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.1");
pub const szOID_INFOSEC_sdnsTokenProtection: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.2.1.1.7");
pub const szOID_INHIBIT_ANY_POLICY: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.54");
pub const szOID_INITIALS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.43");
pub const szOID_INTERNATIONALIZED_EMAIL_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.2.4");
pub const szOID_INTERNATIONAL_ISDN_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.25");
pub const szOID_IPSEC_KP_IKE_INTERMEDIATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.8.2.2");
pub const szOID_ISSUED_CERT_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.17");
pub const szOID_ISSUER_ALT_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.8");
pub const szOID_ISSUER_ALT_NAME2: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.18");
pub const szOID_ISSUING_DIST_POINT: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.28");
pub const szOID_IUM_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.37");
pub const szOID_KEYID_RDN: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.7.1");
pub const szOID_KEY_ATTRIBUTES: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.2");
pub const szOID_KEY_USAGE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.15");
pub const szOID_KEY_USAGE_RESTRICTION: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.4");
pub const szOID_KP_CA_EXCHANGE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.5");
pub const szOID_KP_CSP_SIGNATURE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.16");
pub const szOID_KP_CTL_USAGE_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.1");
pub const szOID_KP_DOCUMENT_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.12");
pub const szOID_KP_EFS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.4");
pub const szOID_KP_FLIGHT_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.27");
pub const szOID_KP_KERNEL_MODE_CODE_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.61.1.1");
pub const szOID_KP_KERNEL_MODE_HAL_EXTENSION_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.61.5.1");
pub const szOID_KP_KERNEL_MODE_TRUSTED_BOOT_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.61.4.1");
pub const szOID_KP_KEY_RECOVERY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.11");
pub const szOID_KP_KEY_RECOVERY_AGENT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.6");
pub const szOID_KP_LIFETIME_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.13");
pub const szOID_KP_MOBILE_DEVICE_SOFTWARE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.14");
pub const szOID_KP_PRIVACY_CA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.36");
pub const szOID_KP_QUALIFIED_SUBORDINATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.10");
pub const szOID_KP_SMARTCARD_LOGON: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.2.2");
pub const szOID_KP_SMART_DISPLAY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.15");
pub const szOID_KP_TIME_STAMP_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.2");
pub const szOID_KP_TPM_AIK_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.8.3");
pub const szOID_KP_TPM_EK_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.8.1");
pub const szOID_KP_TPM_PLATFORM_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.8.2");
pub const szOID_LEGACY_POLICY_MAPPINGS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.5");
pub const szOID_LICENSES: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.6.1");
pub const szOID_LICENSE_SERVER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.6.2");
pub const szOID_LOCALITY_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.7");
pub const szOID_LOCAL_MACHINE_KEYSET: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.17.2");
pub const szOID_LOGOTYPE_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.12");
pub const szOID_LOYALTY_OTHER_LOGOTYPE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.20.1");
pub const szOID_MEMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.31");
pub const szOID_MICROSOFT_PUBLISHER_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.76.8.1");
pub const szOID_NAME_CONSTRAINTS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.30");
pub const szOID_NETSCAPE: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730");
pub const szOID_NETSCAPE_BASE_URL: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.2");
pub const szOID_NETSCAPE_CA_POLICY_URL: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.8");
pub const szOID_NETSCAPE_CA_REVOCATION_URL: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.4");
pub const szOID_NETSCAPE_CERT_EXTENSION: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1");
pub const szOID_NETSCAPE_CERT_RENEWAL_URL: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.7");
pub const szOID_NETSCAPE_CERT_SEQUENCE: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.2.5");
pub const szOID_NETSCAPE_CERT_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.1");
pub const szOID_NETSCAPE_COMMENT: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.13");
pub const szOID_NETSCAPE_DATA_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.2");
pub const szOID_NETSCAPE_REVOCATION_URL: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.3");
pub const szOID_NETSCAPE_SSL_SERVER_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.1.12");
pub const szOID_NEXT_UPDATE_LOCATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.2");
pub const szOID_NIST_AES128_CBC: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.2");
pub const szOID_NIST_AES128_WRAP: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.5");
pub const szOID_NIST_AES192_CBC: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.22");
pub const szOID_NIST_AES192_WRAP: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.25");
pub const szOID_NIST_AES256_CBC: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.42");
pub const szOID_NIST_AES256_WRAP: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.1.45");
pub const szOID_NIST_sha256: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.2.1");
pub const szOID_NIST_sha384: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.2.2");
pub const szOID_NIST_sha512: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.101.3.4.2.3");
pub const szOID_NT5_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.6");
pub const szOID_NTDS_CA_SECURITY_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.25.2");
pub const szOID_NTDS_OBJECTSID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.25.2.1");
pub const szOID_NTDS_REPLICATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.25.1");
pub const szOID_NT_PRINCIPAL_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.20.2.3");
pub const szOID_OEM_WHQL_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.7");
pub const szOID_OIW: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14");
pub const szOID_OIWDIR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2");
pub const szOID_OIWDIR_CRPT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2.1");
pub const szOID_OIWDIR_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2.2");
pub const szOID_OIWDIR_SIGN: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2.3");
pub const szOID_OIWDIR_md2: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2.2.1");
pub const szOID_OIWDIR_md2RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.7.2.3.1");
pub const szOID_OIWSEC: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2");
pub const szOID_OIWSEC_desCBC: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.7");
pub const szOID_OIWSEC_desCFB: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.9");
pub const szOID_OIWSEC_desECB: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.6");
pub const szOID_OIWSEC_desEDE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.17");
pub const szOID_OIWSEC_desMAC: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.10");
pub const szOID_OIWSEC_desOFB: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.8");
pub const szOID_OIWSEC_dhCommMod: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.16");
pub const szOID_OIWSEC_dsa: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.12");
pub const szOID_OIWSEC_dsaComm: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.20");
pub const szOID_OIWSEC_dsaCommSHA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.21");
pub const szOID_OIWSEC_dsaCommSHA1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.28");
pub const szOID_OIWSEC_dsaSHA1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.27");
pub const szOID_OIWSEC_keyHashSeal: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.23");
pub const szOID_OIWSEC_md2RSASign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.24");
pub const szOID_OIWSEC_md4RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.2");
pub const szOID_OIWSEC_md4RSA2: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.4");
pub const szOID_OIWSEC_md5RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.3");
pub const szOID_OIWSEC_md5RSASign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.25");
pub const szOID_OIWSEC_mdc2: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.19");
pub const szOID_OIWSEC_mdc2RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.14");
pub const szOID_OIWSEC_rsaSign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.11");
pub const szOID_OIWSEC_rsaXchg: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.22");
pub const szOID_OIWSEC_sha: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.18");
pub const szOID_OIWSEC_sha1: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.26");
pub const szOID_OIWSEC_sha1RSASign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.29");
pub const szOID_OIWSEC_shaDSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.13");
pub const szOID_OIWSEC_shaRSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.14.3.2.15");
pub const szOID_ORGANIZATIONAL_UNIT_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.11");
pub const szOID_ORGANIZATION_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.10");
pub const szOID_OS_VERSION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.13.2.3");
pub const szOID_OWNER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.32");
pub const szOID_PHYSICAL_DELIVERY_OFFICE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.19");
pub const szOID_PIN_RULES_CTL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.32");
pub const szOID_PIN_RULES_DOMAIN_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.34");
pub const szOID_PIN_RULES_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.33");
pub const szOID_PIN_RULES_LOG_END_DATE_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.35");
pub const szOID_PIN_RULES_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.31");
pub const szOID_PKCS: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1");
pub const szOID_PKCS_1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1");
pub const szOID_PKCS_10: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.10");
pub const szOID_PKCS_12: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12");
pub const szOID_PKCS_12_EXTENDED_ATTRIBUTES: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.17.3");
pub const szOID_PKCS_12_FRIENDLY_NAME_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.20");
pub const szOID_PKCS_12_KEY_PROVIDER_NAME_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.17.1");
pub const szOID_PKCS_12_LOCAL_KEY_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.21");
pub const szOID_PKCS_12_PROTECTED_PASSWORD_SECRET_BAG_TYPE_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.17.4");
pub const szOID_PKCS_12_PbeIds: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1");
pub const szOID_PKCS_12_pbeWithSHA1And128BitRC2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.5");
pub const szOID_PKCS_12_pbeWithSHA1And128BitRC4: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.1");
pub const szOID_PKCS_12_pbeWithSHA1And2KeyTripleDES: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.4");
pub const szOID_PKCS_12_pbeWithSHA1And3KeyTripleDES: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.3");
pub const szOID_PKCS_12_pbeWithSHA1And40BitRC2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.6");
pub const szOID_PKCS_12_pbeWithSHA1And40BitRC4: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.12.1.2");
pub const szOID_PKCS_2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.2");
pub const szOID_PKCS_3: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.3");
pub const szOID_PKCS_4: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.4");
pub const szOID_PKCS_5: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.5");
pub const szOID_PKCS_5_PBES2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.5.13");
pub const szOID_PKCS_5_PBKDF2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.5.12");
pub const szOID_PKCS_6: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.6");
pub const szOID_PKCS_7: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7");
pub const szOID_PKCS_7_DATA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.1");
pub const szOID_PKCS_7_DIGESTED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.5");
pub const szOID_PKCS_7_ENCRYPTED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.6");
pub const szOID_PKCS_7_ENVELOPED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.3");
pub const szOID_PKCS_7_SIGNED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.2");
pub const szOID_PKCS_7_SIGNEDANDENVELOPED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.4");
pub const szOID_PKCS_8: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.8");
pub const szOID_PKCS_9: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9");
pub const szOID_PKCS_9_CONTENT_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.3");
pub const szOID_PKCS_9_MESSAGE_DIGEST: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.4");
pub const szOID_PKINIT_KP_KDC: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.2.3.5");
pub const szOID_PKIX: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7");
pub const szOID_PKIX_ACC_DESCR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48");
pub const szOID_PKIX_CA_ISSUERS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.2");
pub const szOID_PKIX_CA_REPOSITORY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.5");
pub const szOID_PKIX_KP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3");
pub const szOID_PKIX_KP_CLIENT_AUTH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.2");
pub const szOID_PKIX_KP_CODE_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.3");
pub const szOID_PKIX_KP_EMAIL_PROTECTION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.4");
pub const szOID_PKIX_KP_IPSEC_END_SYSTEM: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.5");
pub const szOID_PKIX_KP_IPSEC_TUNNEL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.6");
pub const szOID_PKIX_KP_IPSEC_USER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.7");
pub const szOID_PKIX_KP_OCSP_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.9");
pub const szOID_PKIX_KP_SERVER_AUTH: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.1");
pub const szOID_PKIX_KP_TIMESTAMP_SIGNING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.3.8");
pub const szOID_PKIX_NO_SIGNATURE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.6.2");
pub const szOID_PKIX_OCSP: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.1");
pub const szOID_PKIX_OCSP_BASIC_SIGNED_RESPONSE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.1.1");
pub const szOID_PKIX_OCSP_NOCHECK: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.1.5");
pub const szOID_PKIX_OCSP_NONCE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.1.2");
pub const szOID_PKIX_PE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1");
pub const szOID_PKIX_POLICY_QUALIFIER_CPS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.2.1");
pub const szOID_PKIX_POLICY_QUALIFIER_USERNOTICE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.2.2");
pub const szOID_PKIX_TIME_STAMPING: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.48.3");
pub const szOID_PLATFORM_MANIFEST_BINARY_ID: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.28");
pub const szOID_POLICY_CONSTRAINTS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.36");
pub const szOID_POLICY_MAPPINGS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.33");
pub const szOID_POSTAL_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.16");
pub const szOID_POSTAL_CODE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.17");
pub const szOID_POST_OFFICE_BOX: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.18");
pub const szOID_PREFERRED_DELIVERY_METHOD: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.28");
pub const szOID_PRESENTATION_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.29");
pub const szOID_PRIVATEKEY_USAGE_PERIOD: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.16");
pub const szOID_PRODUCT_UPDATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.31.1");
pub const szOID_PROTECTED_PROCESS_LIGHT_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.22");
pub const szOID_PROTECTED_PROCESS_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.24");
pub const szOID_QC_EU_COMPLIANCE: ::windows_strings::PCSTR = ::windows_strings::s!("0.4.0.1862.1.1");
pub const szOID_QC_SSCD: ::windows_strings::PCSTR = ::windows_strings::s!("0.4.0.1862.1.4");
pub const szOID_QC_STATEMENTS_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.3");
pub const szOID_RDN_DUMMY_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.9");
pub const szOID_RDN_TCG_PLATFORM_MANUFACTURER: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.4");
pub const szOID_RDN_TCG_PLATFORM_MODEL: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.5");
pub const szOID_RDN_TCG_PLATFORM_VERSION: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.6");
pub const szOID_RDN_TPM_MANUFACTURER: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.1");
pub const szOID_RDN_TPM_MODEL: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.2");
pub const szOID_RDN_TPM_VERSION: ::windows_strings::PCSTR = ::windows_strings::s!("2.23.133.2.3");
pub const szOID_REASON_CODE_HOLD: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.23");
pub const szOID_REGISTERED_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.26");
pub const szOID_REMOVE_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.8.1");
pub const szOID_RENEWAL_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.13.1");
pub const szOID_REQUEST_CLIENT_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.20");
pub const szOID_REQUIRE_CERT_CHAIN_POLICY: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.21.15");
pub const szOID_REVOKED_LIST_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.19");
pub const szOID_RFC3161_counterSign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.3.3.1");
pub const szOID_RFC3161v21_counterSign: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.3.3.2");
pub const szOID_RFC3161v21_thumbprints: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.3.3.3");
pub const szOID_ROLE_OCCUPANT: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.33");
pub const szOID_ROOT_LIST_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.9");
pub const szOID_ROOT_PROGRAM_AUTO_UPDATE_CA_REVOCATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.3.1");
pub const szOID_ROOT_PROGRAM_AUTO_UPDATE_END_REVOCATION: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.3.2");
pub const szOID_ROOT_PROGRAM_FLAGS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.1.1");
pub const szOID_ROOT_PROGRAM_NO_OCSP_FAILOVER_TO_CRL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.60.3.3");
pub const szOID_RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549");
pub const szOID_RSAES_OAEP: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.7");
pub const szOID_RSA_DES_EDE3_CBC: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.3.7");
pub const szOID_RSA_DH: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.3.1");
pub const szOID_RSA_ENCRYPT: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.3");
pub const szOID_RSA_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2");
pub const szOID_RSA_MD2: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.2");
pub const szOID_RSA_MD2RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.2");
pub const szOID_RSA_MD4: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.4");
pub const szOID_RSA_MD4RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.3");
pub const szOID_RSA_MD5: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.2.5");
pub const szOID_RSA_MD5RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.4");
pub const szOID_RSA_MGF1: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.8");
pub const szOID_RSA_PSPECIFIED: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.9");
pub const szOID_RSA_RC2CBC: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.3.2");
pub const szOID_RSA_RC4: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.3.4");
pub const szOID_RSA_RC5_CBCPad: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.3.9");
pub const szOID_RSA_RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.1");
pub const szOID_RSA_SETOAEP_RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.6");
pub const szOID_RSA_SHA1RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.5");
pub const szOID_RSA_SHA256RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.11");
pub const szOID_RSA_SHA384RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.12");
pub const szOID_RSA_SHA512RSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.13");
pub const szOID_RSA_SMIMECapabilities: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.15");
pub const szOID_RSA_SMIMEalg: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.16.3");
pub const szOID_RSA_SMIMEalgCMS3DESwrap: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.16.3.6");
pub const szOID_RSA_SMIMEalgCMSRC2wrap: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.16.3.7");
pub const szOID_RSA_SMIMEalgESDH: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.16.3.5");
pub const szOID_RSA_SSA_PSS: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.1.10");
pub const szOID_RSA_certExtensions: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.14");
pub const szOID_RSA_challengePwd: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.7");
pub const szOID_RSA_contentType: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.3");
pub const szOID_RSA_counterSign: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.6");
pub const szOID_RSA_data: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.1");
pub const szOID_RSA_digestedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.5");
pub const szOID_RSA_emailAddr: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.1");
pub const szOID_RSA_encryptedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.6");
pub const szOID_RSA_envelopedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.3");
pub const szOID_RSA_extCertAttrs: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.9");
pub const szOID_RSA_hashedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.5");
pub const szOID_RSA_messageDigest: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.4");
pub const szOID_RSA_preferSignedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.15.1");
pub const szOID_RSA_signEnvData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.4");
pub const szOID_RSA_signedData: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.7.2");
pub const szOID_RSA_signingTime: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.5");
pub const szOID_RSA_unstructAddr: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.8");
pub const szOID_RSA_unstructName: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.2");
pub const szOID_SEARCH_GUIDE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.14");
pub const szOID_SEE_ALSO: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.34");
pub const szOID_SERIALIZED: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.3.1");
pub const szOID_SERVER_GATED_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.3");
pub const szOID_SGC_NETSCAPE: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113730.4.1");
pub const szOID_SITE_PIN_RULES_FLAGS_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.4.3");
pub const szOID_SITE_PIN_RULES_INDEX_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.4.2");
pub const szOID_SORTED_CTL: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.1.1");
pub const szOID_STATE_OR_PROVINCE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.8");
pub const szOID_STREET_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.9");
pub const szOID_SUBJECT_ALT_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.7");
pub const szOID_SUBJECT_ALT_NAME2: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.17");
pub const szOID_SUBJECT_DIR_ATTRS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.9");
pub const szOID_SUBJECT_INFO_ACCESS: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.11");
pub const szOID_SUBJECT_KEY_IDENTIFIER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.29.14");
pub const szOID_SUPPORTED_APPLICATION_CONTEXT: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.30");
pub const szOID_SUR_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.4");
pub const szOID_SYNC_ROOT_CTL_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.50");
pub const szOID_TELEPHONE_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.20");
pub const szOID_TELETEXT_TERMINAL_IDENTIFIER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.22");
pub const szOID_TELEX_NUMBER: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.21");
pub const szOID_TIMESTAMP_TOKEN: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.113549.1.9.16.1.4");
pub const szOID_TITLE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.12");
pub const szOID_TLS_FEATURES_EXT: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.5.5.7.1.24");
pub const szOID_USER_CERTIFICATE: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.36");
pub const szOID_USER_PASSWORD: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.35");
pub const szOID_VERISIGN_BITSTRING_6_13: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.6.13");
pub const szOID_VERISIGN_ISS_STRONG_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.8.1");
pub const szOID_VERISIGN_ONSITE_JURISDICTION_HASH: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.6.11");
pub const szOID_VERISIGN_PRIVATE_6_9: ::windows_strings::PCSTR = ::windows_strings::s!("2.16.840.1.113733.1.6.9");
pub const szOID_WHQL_CRYPTO: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.5");
pub const szOID_WINDOWS_KITS_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.20");
pub const szOID_WINDOWS_RT_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.21");
pub const szOID_WINDOWS_SOFTWARE_EXTENSION_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.26");
pub const szOID_WINDOWS_STORE_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.76.3.1");
pub const szOID_WINDOWS_TCB_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.23");
pub const szOID_WINDOWS_THIRD_PARTY_COMPONENT_SIGNER: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.3.25");
pub const szOID_X21_ADDRESS: ::windows_strings::PCSTR = ::windows_strings::s!("2.5.4.24");
pub const szOID_X957: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10040");
pub const szOID_X957_DSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10040.4.1");
pub const szOID_X957_SHA1DSA: ::windows_strings::PCSTR = ::windows_strings::s!("1.2.840.10040.4.3");
pub const szOID_YESNO_TRUST_ATTR: ::windows_strings::PCSTR = ::windows_strings::s!("1.3.6.1.4.1.311.10.4.1");
pub const szPRIV_KEY_CACHE_MAX_ITEMS: ::windows_strings::PCSTR = ::windows_strings::s!("PrivKeyCacheMaxItems");
pub const szPRIV_KEY_CACHE_PURGE_INTERVAL_SECONDS: ::windows_strings::PCSTR = ::windows_strings::s!("PrivKeyCachePurgeIntervalSeconds");
pub const sz_CERT_STORE_PROV_COLLECTION: ::windows_strings::PCSTR = ::windows_strings::s!("Collection");
pub const sz_CERT_STORE_PROV_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("File");
pub const sz_CERT_STORE_PROV_FILENAME_W: ::windows_strings::PCSTR = ::windows_strings::s!("File");
pub const sz_CERT_STORE_PROV_LDAP: ::windows_strings::PCWSTR = ::windows_strings::w!("Ldap");
pub const sz_CERT_STORE_PROV_LDAP_W: ::windows_strings::PCSTR = ::windows_strings::s!("Ldap");
pub const sz_CERT_STORE_PROV_MEMORY: ::windows_strings::PCSTR = ::windows_strings::s!("Memory");
pub const sz_CERT_STORE_PROV_PHYSICAL: ::windows_strings::PCWSTR = ::windows_strings::w!("Physical");
pub const sz_CERT_STORE_PROV_PHYSICAL_W: ::windows_strings::PCSTR = ::windows_strings::s!("Physical");
pub const sz_CERT_STORE_PROV_PKCS12: ::windows_strings::PCSTR = ::windows_strings::s!("PKCS12");
pub const sz_CERT_STORE_PROV_PKCS7: ::windows_strings::PCSTR = ::windows_strings::s!("PKCS7");
pub const sz_CERT_STORE_PROV_SERIALIZED: ::windows_strings::PCSTR = ::windows_strings::s!("Serialized");
pub const sz_CERT_STORE_PROV_SMART_CARD: ::windows_strings::PCWSTR = ::windows_strings::w!("SmartCard");
pub const sz_CERT_STORE_PROV_SMART_CARD_W: ::windows_strings::PCSTR = ::windows_strings::s!("SmartCard");
pub const sz_CERT_STORE_PROV_SYSTEM: ::windows_strings::PCWSTR = ::windows_strings::w!("System");
pub const sz_CERT_STORE_PROV_SYSTEM_REGISTRY: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemRegistry");
pub const sz_CERT_STORE_PROV_SYSTEM_REGISTRY_W: ::windows_strings::PCSTR = ::windows_strings::s!("SystemRegistry");
pub const sz_CERT_STORE_PROV_SYSTEM_W: ::windows_strings::PCSTR = ::windows_strings::s!("System");
pub const wszURI_CANONICALIZATION_C14N: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/TR/2001/REC-xml-c14n-20010315");
pub const wszURI_CANONICALIZATION_C14NC: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments");
pub const wszURI_CANONICALIZATION_EXSLUSIVE_C14N: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/10/xml-exc-c14n#");
pub const wszURI_CANONICALIZATION_EXSLUSIVE_C14NC: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/10/xml-exc-c14n#WithComments");
pub const wszURI_NTDS_OBJECTSID_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("tag:microsoft.com,2022-09-14:sid:");
pub const wszURI_TRANSFORM_XPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/TR/1999/REC-xpath-19991116");
pub const wszURI_XMLNS_DIGSIG_BASE64: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#base64");
pub const wszURI_XMLNS_DIGSIG_DSA_SHA1: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#dsa-sha1");
pub const wszURI_XMLNS_DIGSIG_ECDSA_SHA1: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1");
pub const wszURI_XMLNS_DIGSIG_ECDSA_SHA256: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256");
pub const wszURI_XMLNS_DIGSIG_ECDSA_SHA384: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384");
pub const wszURI_XMLNS_DIGSIG_ECDSA_SHA512: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512");
pub const wszURI_XMLNS_DIGSIG_HMAC_SHA1: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#hmac-sha1");
pub const wszURI_XMLNS_DIGSIG_HMAC_SHA256: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#hmac-sha256");
pub const wszURI_XMLNS_DIGSIG_HMAC_SHA384: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#hmac-sha384");
pub const wszURI_XMLNS_DIGSIG_HMAC_SHA512: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#hmac-sha512");
pub const wszURI_XMLNS_DIGSIG_RSA_SHA1: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#rsa-sha1");
pub const wszURI_XMLNS_DIGSIG_RSA_SHA256: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#rsa-sha256");
pub const wszURI_XMLNS_DIGSIG_RSA_SHA384: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#rsa-sha384");
pub const wszURI_XMLNS_DIGSIG_RSA_SHA512: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#rsa-sha512");
pub const wszURI_XMLNS_DIGSIG_SHA1: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#sha1");
pub const wszURI_XMLNS_DIGSIG_SHA256: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmlenc#sha256");
pub const wszURI_XMLNS_DIGSIG_SHA384: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmldsig-more#sha384");
pub const wszURI_XMLNS_DIGSIG_SHA512: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2001/04/xmlenc#sha512");
pub const wszURI_XMLNS_TRANSFORM_BASE64: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#base64");
pub const wszURI_XMLNS_TRANSFORM_ENVELOPED: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#enveloped-signature");
pub const wszXMLNS_DIGSIG: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#");
pub const wszXMLNS_DIGSIG_Id: ::windows_strings::PCWSTR = ::windows_strings::w!("Id");
pub const wszXMLNS_DIGSIG_SignatureProperties: ::windows_strings::PCWSTR = ::windows_strings::w!("http://www.w3.org/2000/09/xmldsig#SignatureProperties");
pub type ALG_ID = u32;
