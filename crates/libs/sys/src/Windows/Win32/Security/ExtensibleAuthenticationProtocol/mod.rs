...
pub const EAP_AUTHENTICATOR_VALUENAME_CONFIGUI: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthenticatorConfigUIPath");
pub const EAP_AUTHENTICATOR_VALUENAME_DLL_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthenticatorDllPath");
pub const EAP_AUTHENTICATOR_VALUENAME_FRIENDLY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("AuthenticatorFriendlyName");
pub const EAP_AUTHENTICATOR_VALUENAME_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Properties");
...
pub const EAP_PEER_VALUENAME_CONFIGUI: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerConfigUIPath");
pub const EAP_PEER_VALUENAME_DLL_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerDllPath");
pub const EAP_PEER_VALUENAME_FRIENDLY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerFriendlyName");
pub const EAP_PEER_VALUENAME_IDENTITY: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerIdentityPath");
pub const EAP_PEER_VALUENAME_INTERACTIVEUI: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerInteractiveUIPath");
pub const EAP_PEER_VALUENAME_INVOKE_NAMEDLG: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerInvokeUsernameDialog");
pub const EAP_PEER_VALUENAME_INVOKE_PWDDLG: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerInvokePasswordDialog");
pub const EAP_PEER_VALUENAME_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Properties");
pub const EAP_PEER_VALUENAME_REQUIRE_CONFIGUI: ::windows_strings::PCWSTR = ::windows_strings::w!("PeerRequireConfigUI");
pub const EAP_REGISTRY_LOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("System\\CurrentControlSet\\Services\\EapHost\\Methods");
...
pub const EAP_VALUENAME_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("Properties");
...
pub const RAS_EAP_REGISTRY_LOCATION: ::windows_strings::PCWSTR = ::windows_strings::w!("System\\CurrentControlSet\\Services\\Rasman\\PPP\\EAP");
...
pub const RAS_EAP_VALUENAME_CONFIGUI: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigUIPath");
pub const RAS_EAP_VALUENAME_CONFIG_CLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigCLSID");
pub const RAS_EAP_VALUENAME_DEFAULT_DATA: ::windows_strings::PCWSTR = ::windows_strings::w!("ConfigData");
pub const RAS_EAP_VALUENAME_ENCRYPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("MPPEEncryptionSupported");
pub const RAS_EAP_VALUENAME_FILTER_INNERMETHODS: ::windows_strings::PCWSTR = ::windows_strings::w!("FilterInnerMethods");
pub const RAS_EAP_VALUENAME_FRIENDLY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FriendlyName");
pub const RAS_EAP_VALUENAME_IDENTITY: ::windows_strings::PCWSTR = ::windows_strings::w!("IdentityPath");
pub const RAS_EAP_VALUENAME_INTERACTIVEUI: ::windows_strings::PCWSTR = ::windows_strings::w!("InteractiveUIPath");
pub const RAS_EAP_VALUENAME_INVOKE_NAMEDLG: ::windows_strings::PCWSTR = ::windows_strings::w!("InvokeUsernameDialog");
pub const RAS_EAP_VALUENAME_INVOKE_PWDDLG: ::windows_strings::PCWSTR = ::windows_strings::w!("InvokePasswordDialog");
pub const RAS_EAP_VALUENAME_ISTUNNEL_METHOD: ::windows_strings::PCWSTR = ::windows_strings::w!("IsTunnelMethod");
pub const RAS_EAP_VALUENAME_PATH: ::windows_strings::PCWSTR = ::windows_strings::w!("Path");
pub const RAS_EAP_VALUENAME_PER_POLICY_CONFIG: ::windows_strings::PCWSTR = ::windows_strings::w!("PerPolicyConfig");
pub const RAS_EAP_VALUENAME_REQUIRE_CONFIGUI: ::windows_strings::PCWSTR = ::windows_strings::w!("RequireConfigUI");
pub const RAS_EAP_VALUENAME_ROLES_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("RolesSupported");
pub const RAS_EAP_VALUENAME_STANDALONE_SUPPORTED: ::windows_strings::PCWSTR = ::windows_strings::w!("StandaloneSupported");
