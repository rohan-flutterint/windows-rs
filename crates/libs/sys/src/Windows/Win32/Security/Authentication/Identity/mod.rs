...
pub const CLOUDAP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("CloudAP");
pub const CLOUDAP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("CloudAP");
...
pub const ClOUDAP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("CloudAP");
...
pub const DEFAULT_TLS_SSP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Default TLS SSP");
pub const DEFAULT_TLS_SSP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Default TLS SSP");
pub const DEFAULT_TLS_SSP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Default TLS SSP");
...
pub const ID_CAP_SLAPI: ::windows_strings::PCWSTR = ::windows_strings::w!("slapiQueryLicenseValue");
...
pub const KRB_ANONYMOUS_STRING: ::windows_strings::PCWSTR = ::windows_strings::w!("ANONYMOUS");
...
pub const KRB_WELLKNOWN_STRING: ::windows_strings::PCWSTR = ::windows_strings::w!("WELLKNOWN");
...
pub const LSA_ADT_LEGACY_SECURITY_SOURCE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Security");
pub const LSA_ADT_SECURITY_SOURCE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft-Windows-Security-Auditing");
pub const LSA_AP_NAME_CALL_PACKAGE: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApCallPackage\u{0}");
pub const LSA_AP_NAME_CALL_PACKAGE_PASSTHROUGH: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApCallPackagePassthrough\u{0}");
pub const LSA_AP_NAME_CALL_PACKAGE_UNTRUSTED: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApCallPackageUntrusted\u{0}");
pub const LSA_AP_NAME_INITIALIZE_PACKAGE: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApInitializePackage\u{0}");
pub const LSA_AP_NAME_LOGON_TERMINATED: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApLogonTerminated\u{0}");
pub const LSA_AP_NAME_LOGON_USER: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApLogonUser\u{0}");
pub const LSA_AP_NAME_LOGON_USER_EX: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApLogonUserEx\u{0}");
pub const LSA_AP_NAME_LOGON_USER_EX2: ::windows_strings::PCSTR = ::windows_strings::s!("LsaApLogonUserEx2\u{0}");
...
pub const LSA_GLOBAL_SECRET_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("G$");
pub const LSA_GLOBAL_SECRET_PREFIX_LENGTH: u32 = 2u32;
pub const LSA_LOCAL_SECRET_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("L$");
...
pub const LSA_MACHINE_SECRET_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("M$");
...
pub const MICROSOFT_KERBEROS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Kerberos");
pub const MICROSOFT_KERBEROS_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Kerberos");
pub const MICROSOFT_KERBEROS_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Kerberos");
...
pub const MSV1_0_PACKAGE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("MICROSOFT_AUTHENTICATION_PACKAGE_V1_0");
pub const MSV1_0_PACKAGE_NAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("MICROSOFT_AUTHENTICATION_PACKAGE_V1_0");
...
pub const MSV1_0_SUBAUTHENTICATION_KEY: ::windows_strings::PCSTR = ::windows_strings::s!("SYSTEM\\CurrentControlSet\\Control\\Lsa\\MSV1_0");
pub const MSV1_0_SUBAUTHENTICATION_VALUE: ::windows_strings::PCSTR = ::windows_strings::s!("Auth");
...
pub const NEGOSSP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Negotiate");
pub const NEGOSSP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Negotiate");
pub const NEGOSSP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Negotiate");
...
pub const NTLMSP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("NTLM");
pub const NTLMSP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("NTLM");
...
pub const PCT1SP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft PCT 1.0");
pub const PCT1SP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft PCT 1.0");
pub const PCT1SP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft PCT 1.0");
...
pub const PKU2U_PACKAGE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("pku2u");
pub const PKU2U_PACKAGE_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("pku2u");
pub const PKU2U_PACKAGE_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("pku2u");
...
pub const SAM_CREDENTIAL_UPDATE_FREE_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("CredentialUpdateFree");
pub const SAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("CredentialUpdateNotify");
pub const SAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("RegisterMappedEntrypoints");
pub const SAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("CredentialUpdateRegister");
pub const SAM_DAYS_PER_WEEK: u32 = 7u32;
pub const SAM_INIT_NOTIFICATION_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("InitializeChangeNotify");
pub const SAM_PASSWORD_CHANGE_NOTIFY_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("PasswordChangeNotify");
pub const SAM_PASSWORD_FILTER_ROUTINE: ::windows_strings::PCSTR = ::windows_strings::s!("PasswordFilter");
...
pub const SCHANNEL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Schannel");
pub const SCHANNEL_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Schannel");
pub const SCHANNEL_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Schannel");
...
pub const SECPKG_LSAMODEINIT_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("SpLsaModeInitialize");
...
pub const SECPKG_USERMODEINIT_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("SpUserModeInitialize");
...
pub const SECURITY_ENTRYPOINT: ::windows_strings::PCWSTR = ::windows_strings::w!("INITSECURITYINTERFACEA");
pub const SECURITY_ENTRYPOINT16: ::windows_strings::PCSTR = ::windows_strings::s!("INITSECURITYINTERFACEA");
pub const SECURITY_ENTRYPOINT_ANSI: ::windows_strings::PCWSTR = ::windows_strings::w!("InitSecurityInterfaceW");
pub const SECURITY_ENTRYPOINT_ANSIA: ::windows_strings::PCSTR = ::windows_strings::s!("InitSecurityInterfaceA");
pub const SECURITY_ENTRYPOINT_ANSIW: ::windows_strings::PCSTR = ::windows_strings::s!("InitSecurityInterfaceW");
...
pub const SE_BATCH_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeBatchLogonRight");
pub const SE_DENY_BATCH_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDenyBatchLogonRight");
pub const SE_DENY_INTERACTIVE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDenyInteractiveLogonRight");
pub const SE_DENY_NETWORK_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDenyNetworkLogonRight");
pub const SE_DENY_REMOTE_INTERACTIVE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDenyRemoteInteractiveLogonRight");
pub const SE_DENY_SERVICE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDenyServiceLogonRight");
pub const SE_INTERACTIVE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeInteractiveLogonRight");
pub const SE_MAX_AUDIT_PARAMETERS: u32 = 32u32;
pub const SE_MAX_GENERIC_AUDIT_PARAMETERS: u32 = 28u32;
pub const SE_NETWORK_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeNetworkLogonRight");
pub const SE_REMOTE_INTERACTIVE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeRemoteInteractiveLogonRight");
pub const SE_SERVICE_LOGON_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeServiceLogonRight");
...
pub const SL_DEFAULT_MIGRATION_ENCRYPTOR_URI: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:spp/migrationencryptor/tokenact/1.0");
pub const SL_EVENT_LICENSING_STATE_CHANGED: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/event/licensingstatechanged");
pub const SL_EVENT_POLICY_CHANGED: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/event/policychanged");
pub const SL_EVENT_USER_NOTIFICATION: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/event/usernotification");
...
pub const SL_INFO_KEY_ACTIVE_PLUGINS: ::windows_strings::PCWSTR = ::windows_strings::w!("ActivePlugins");
pub const SL_INFO_KEY_AUTHOR: ::windows_strings::PCWSTR = ::windows_strings::w!("Author");
pub const SL_INFO_KEY_BIOS_OA2_MINOR_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("BiosOA2MinorVersion");
pub const SL_INFO_KEY_BIOS_PKEY: ::windows_strings::PCWSTR = ::windows_strings::w!("BiosProductKey");
pub const SL_INFO_KEY_BIOS_PKEY_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("BiosProductKeyDescription");
pub const SL_INFO_KEY_BIOS_PKEY_PKPN: ::windows_strings::PCWSTR = ::windows_strings::w!("BiosProductKeyPkPn");
pub const SL_INFO_KEY_BIOS_SLIC_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("BiosSlicState");
pub const SL_INFO_KEY_CHANNEL: ::windows_strings::PCWSTR = ::windows_strings::w!("Channel");
pub const SL_INFO_KEY_DESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("Description");
pub const SL_INFO_KEY_DIGITAL_PID: ::windows_strings::PCWSTR = ::windows_strings::w!("DigitalPID");
pub const SL_INFO_KEY_DIGITAL_PID2: ::windows_strings::PCWSTR = ::windows_strings::w!("DigitalPID2");
pub const SL_INFO_KEY_IS_KMS: ::windows_strings::PCWSTR = ::windows_strings::w!("IsKeyManagementService");
pub const SL_INFO_KEY_IS_PRS: ::windows_strings::PCWSTR = ::windows_strings::w!("IsPRS");
pub const SL_INFO_KEY_KMS_CURRENT_COUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceCurrentCount");
pub const SL_INFO_KEY_KMS_FAILED_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceFailedRequests");
pub const SL_INFO_KEY_KMS_LICENSED_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceLicensedRequests");
pub const SL_INFO_KEY_KMS_NON_GENUINE_GRACE_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceNonGenuineGraceRequests");
pub const SL_INFO_KEY_KMS_NOTIFICATION_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceNotificationRequests");
pub const SL_INFO_KEY_KMS_OOB_GRACE_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceOOBGraceRequests");
pub const SL_INFO_KEY_KMS_OOT_GRACE_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceOOTGraceRequests");
pub const SL_INFO_KEY_KMS_REQUIRED_CLIENT_COUNT: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceRequiredClientCount");
pub const SL_INFO_KEY_KMS_TOTAL_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceTotalRequests");
pub const SL_INFO_KEY_KMS_UNLICENSED_REQUESTS: ::windows_strings::PCWSTR = ::windows_strings::w!("KeyManagementServiceUnlicensedRequests");
pub const SL_INFO_KEY_LICENSE_TYPE: ::windows_strings::PCWSTR = ::windows_strings::w!("LicenseType");
pub const SL_INFO_KEY_LICENSOR_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("LicensorUrl");
pub const SL_INFO_KEY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Name");
pub const SL_INFO_KEY_PARTIAL_PRODUCT_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("PartialProductKey");
pub const SL_INFO_KEY_PRODUCT_KEY_ACTIVATION_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("PKCURL");
pub const SL_INFO_KEY_PRODUCT_SKU_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("ProductSkuId");
pub const SL_INFO_KEY_RIGHT_ACCOUNT_ACTIVATION_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("RACURL");
pub const SL_INFO_KEY_SECURE_PROCESSOR_ACTIVATION_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("SPCURL");
pub const SL_INFO_KEY_SECURE_STORE_ID: ::windows_strings::PCWSTR = ::windows_strings::w!("SecureStoreId");
pub const SL_INFO_KEY_SYSTEM_STATE: ::windows_strings::PCWSTR = ::windows_strings::w!("SystemState");
pub const SL_INFO_KEY_USE_LICENSE_ACTIVATION_URL: ::windows_strings::PCWSTR = ::windows_strings::w!("EULURL");
pub const SL_INFO_KEY_VERSION: ::windows_strings::PCWSTR = ::windows_strings::w!("Version");
...
pub const SL_PKEY_DETECT: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/algorithm/pkey/detect");
pub const SL_PKEY_MS2005: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/algorithm/pkey/2005");
pub const SL_PKEY_MS2009: ::windows_strings::PCWSTR = ::windows_strings::w!("msft:rm/algorithm/pkey/2009");
pub const SL_POLICY_EVALUATION_MODE_ENABLED: ::windows_strings::PCWSTR = ::windows_strings::w!("Security-SPP-EvaluationModeEnabled");
pub const SL_PROP_ACTIVATION_VALIDATION_IN_PROGRESS: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_ACTIVATION_VALIDATION_IN_PROGRESS");
pub const SL_PROP_BRT_COMMIT: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_BRT_COMMIT");
pub const SL_PROP_BRT_DATA: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_BRT_DATA");
pub const SL_PROP_GENUINE_RESULT: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_GENUINE_RESULT");
pub const SL_PROP_GET_GENUINE_AUTHZ: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_GET_GENUINE_AUTHZ");
pub const SL_PROP_GET_GENUINE_SERVER_AUTHZ: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_GET_GENUINE_SERVER_AUTHZ");
pub const SL_PROP_LAST_ACT_ATTEMPT_HRESULT: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_LAST_ACT_ATTEMPT_HRESULT");
pub const SL_PROP_LAST_ACT_ATTEMPT_SERVER_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_LAST_ACT_ATTEMPT_SERVER_FLAGS");
pub const SL_PROP_LAST_ACT_ATTEMPT_TIME: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_LAST_ACT_ATTEMPT_TIME");
pub const SL_PROP_NONGENUINE_GRACE_FLAG: ::windows_strings::PCWSTR = ::windows_strings::w!("SL_NONGENUINE_GRACE_FLAG");
...
pub const SP_ACCEPT_CREDENTIALS_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("SpAcceptCredentials\u{0}");
...
pub const SSL2SP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft SSL 2.0");
pub const SSL2SP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft SSL 2.0");
pub const SSL2SP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft SSL 2.0");
pub const SSL3SP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft SSL 3.0");
pub const SSL3SP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft SSL 3.0");
pub const SSL3SP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft SSL 3.0");
pub const SSL_CRACK_CERTIFICATE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SslCrackCertificate");
pub const SSL_FREE_CERTIFICATE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SslFreeCertificate");
...
pub const TLS1SP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft TLS 1.0");
pub const TLS1SP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft TLS 1.0");
pub const TLS1SP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft TLS 1.0");
...
pub const UNISP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Unified Security Protocol Provider");
pub const UNISP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("Microsoft Unified Security Protocol Provider");
pub const UNISP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("Microsoft Unified Security Protocol Provider");
...
pub const WDIGEST_SP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("WDigest");
pub const WDIGEST_SP_NAME_A: ::windows_strings::PCSTR = ::windows_strings::s!("WDigest");
pub const WDIGEST_SP_NAME_W: ::windows_strings::PCWSTR = ::windows_strings::w!("WDigest");
