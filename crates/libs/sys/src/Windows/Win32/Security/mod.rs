...
pub const SE_ASSIGNPRIMARYTOKEN_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeAssignPrimaryTokenPrivilege");
pub const SE_AUDIT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeAuditPrivilege");
pub const SE_BACKUP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeBackupPrivilege");
pub const SE_CHANGE_NOTIFY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeChangeNotifyPrivilege");
pub const SE_CREATE_GLOBAL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeCreateGlobalPrivilege");
pub const SE_CREATE_PAGEFILE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeCreatePagefilePrivilege");
pub const SE_CREATE_PERMANENT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeCreatePermanentPrivilege");
pub const SE_CREATE_SYMBOLIC_LINK_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeCreateSymbolicLinkPrivilege");
pub const SE_CREATE_TOKEN_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeCreateTokenPrivilege");
...
pub const SE_DEBUG_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDebugPrivilege");
pub const SE_DELEGATE_SESSION_USER_IMPERSONATE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeDelegateSessionUserImpersonatePrivilege");
pub const SE_ENABLE_DELEGATION_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeEnableDelegationPrivilege");
pub const SE_GROUP_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 2u16;
pub const SE_IMPERSONATE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeImpersonatePrivilege");
pub const SE_INCREASE_QUOTA_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeIncreaseQuotaPrivilege");
pub const SE_INC_BASE_PRIORITY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeIncreaseBasePriorityPrivilege");
pub const SE_INC_WORKING_SET_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeIncreaseWorkingSetPrivilege");
pub const SE_LOAD_DRIVER_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeLoadDriverPrivilege");
pub const SE_LOCK_MEMORY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeLockMemoryPrivilege");
pub const SE_MACHINE_ACCOUNT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeMachineAccountPrivilege");
pub const SE_MANAGE_VOLUME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeManageVolumePrivilege");
...
pub const SE_PROF_SINGLE_PROCESS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeProfileSingleProcessPrivilege");
pub const SE_RELABEL_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeRelabelPrivilege");
pub const SE_REMOTE_SHUTDOWN_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeRemoteShutdownPrivilege");
pub const SE_RESTORE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeRestorePrivilege");
...
pub const SE_SECURITY_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeSecurityPrivilege");
pub const SE_SELF_RELATIVE: SECURITY_DESCRIPTOR_CONTROL = 32768u16;
pub const SE_SHUTDOWN_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeShutdownPrivilege");
pub const SE_SYNC_AGENT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeSyncAgentPrivilege");
pub const SE_SYSTEMTIME_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeSystemtimePrivilege");
pub const SE_SYSTEM_ENVIRONMENT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeSystemEnvironmentPrivilege");
pub const SE_SYSTEM_PROFILE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeSystemProfilePrivilege");
pub const SE_TAKE_OWNERSHIP_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeTakeOwnershipPrivilege");
pub const SE_TCB_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeTcbPrivilege");
pub const SE_TIME_ZONE_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeTimeZonePrivilege");
pub const SE_TRUSTED_CREDMAN_ACCESS_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeTrustedCredManAccessPrivilege");
pub const SE_UNDOCK_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeUndockPrivilege");
pub const SE_UNSOLICITED_INPUT_NAME: ::windows_strings::PCWSTR = ::windows_strings::w!("SeUnsolicitedInputPrivilege");
...
pub const szLBRACE: ::windows_strings::PCSTR = ::windows_strings::s!("{");
pub const szLPAREN: ::windows_strings::PCSTR = ::windows_strings::s!("(");
pub const szRBRACE: ::windows_strings::PCSTR = ::windows_strings::s!("}");
pub const szRPAREN: ::windows_strings::PCSTR = ::windows_strings::s!(")");
pub const wszCERTENROLLSHAREPATH: ::windows_strings::PCWSTR = ::windows_strings::w!("CertSrv\\CertEnroll");
pub const wszFCSAPARM_CERTFILENAMESUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("%4");
pub const wszFCSAPARM_CONFIGDN: ::windows_strings::PCWSTR = ::windows_strings::w!("%6");
pub const wszFCSAPARM_CRLDELTAFILENAMESUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("%9");
pub const wszFCSAPARM_CRLFILENAMESUFFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("%8");
pub const wszFCSAPARM_DOMAINDN: ::windows_strings::PCWSTR = ::windows_strings::w!("%5");
pub const wszFCSAPARM_DSCACERTATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("%11");
pub const wszFCSAPARM_DSCRLATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("%10");
pub const wszFCSAPARM_DSCROSSCERTPAIRATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("%14");
pub const wszFCSAPARM_DSKRACERTATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("%13");
pub const wszFCSAPARM_DSUSERCERTATTRIBUTE: ::windows_strings::PCWSTR = ::windows_strings::w!("%12");
pub const wszFCSAPARM_SANITIZEDCANAME: ::windows_strings::PCWSTR = ::windows_strings::w!("%3");
pub const wszFCSAPARM_SANITIZEDCANAMEHASH: ::windows_strings::PCWSTR = ::windows_strings::w!("%7");
pub const wszFCSAPARM_SERVERDNSNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("%1");
pub const wszFCSAPARM_SERVERSHORTNAME: ::windows_strings::PCWSTR = ::windows_strings::w!("%2");
pub const wszLBRACE: ::windows_strings::PCWSTR = ::windows_strings::w!("{");
pub const wszLPAREN: ::windows_strings::PCWSTR = ::windows_strings::w!("(");
pub const wszRBRACE: ::windows_strings::PCWSTR = ::windows_strings::w!("}");
pub const wszRPAREN: ::windows_strings::PCWSTR = ::windows_strings::w!(")");
