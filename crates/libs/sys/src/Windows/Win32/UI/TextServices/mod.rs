...
pub const TF_ENABLE_PROCESS_ATOM: ::windows_strings::PCWSTR = ::windows_strings::w!("_CTF_ENABLE_PROCESS_ATOM_");
...
pub const TF_FLOATINGLANGBAR_WNDTITLE: ::windows_strings::PCWSTR = ::windows_strings::w!("TF_FloatingLangBar_WndTitle");
pub const TF_FLOATINGLANGBAR_WNDTITLEA: ::windows_strings::PCSTR = ::windows_strings::s!("TF_FloatingLangBar_WndTitle");
pub const TF_FLOATINGLANGBAR_WNDTITLEW: ::windows_strings::PCWSTR = ::windows_strings::w!("TF_FloatingLangBar_WndTitle");
...
pub const TF_PROCESS_ATOM: ::windows_strings::PCWSTR = ::windows_strings::w!("_CTF_PROCESS_ATOM_");
