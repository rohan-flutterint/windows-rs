...
pub const CFSTR_AUTOPLAY_SHELLIDLISTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Autoplay Enumerated IDList Array");
pub const CFSTR_DROPDESCRIPTION: ::windows_strings::PCWSTR = ::windows_strings::w!("DropDescription");
pub const CFSTR_FILECONTENTS: ::windows_strings::PCWSTR = ::windows_strings::w!("FileContents");
pub const CFSTR_FILEDESCRIPTOR: ::windows_strings::PCWSTR = ::windows_strings::w!("FileGroupDescriptorW");
pub const CFSTR_FILEDESCRIPTORA: ::windows_strings::PCWSTR = ::windows_strings::w!("FileGroupDescriptor");
pub const CFSTR_FILEDESCRIPTORW: ::windows_strings::PCWSTR = ::windows_strings::w!("FileGroupDescriptorW");
pub const CFSTR_FILENAME: ::windows_strings::PCWSTR = ::windows_strings::w!("FileNameW");
pub const CFSTR_FILENAMEA: ::windows_strings::PCWSTR = ::windows_strings::w!("FileName");
pub const CFSTR_FILENAMEMAP: ::windows_strings::PCWSTR = ::windows_strings::w!("FileNameMapW");
pub const CFSTR_FILENAMEMAPA: ::windows_strings::PCWSTR = ::windows_strings::w!("FileNameMap");
pub const CFSTR_FILENAMEMAPW: ::windows_strings::PCWSTR = ::windows_strings::w!("FileNameMapW");
pub const CFSTR_FILENAMEW: ::windows_strings::PCWSTR = ::windows_strings::w!("FileNameW");
pub const CFSTR_FILE_ATTRIBUTES_ARRAY: ::windows_strings::PCWSTR = ::windows_strings::w!("File Attributes Array");
pub const CFSTR_INDRAGLOOP: ::windows_strings::PCWSTR = ::windows_strings::w!("InShellDragLoop");
pub const CFSTR_INETURL: ::windows_strings::PCWSTR = ::windows_strings::w!("UniformResourceLocatorW");
pub const CFSTR_INETURLA: ::windows_strings::PCWSTR = ::windows_strings::w!("UniformResourceLocator");
pub const CFSTR_INETURLW: ::windows_strings::PCWSTR = ::windows_strings::w!("UniformResourceLocatorW");
pub const CFSTR_INVOKECOMMAND_DROPPARAM: ::windows_strings::PCWSTR = ::windows_strings::w!("InvokeCommand DropParam");
pub const CFSTR_LOGICALPERFORMEDDROPEFFECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Logical Performed DropEffect");
pub const CFSTR_MOUNTEDVOLUME: ::windows_strings::PCWSTR = ::windows_strings::w!("MountedVolume");
pub const CFSTR_NETRESOURCES: ::windows_strings::PCWSTR = ::windows_strings::w!("Net Resource");
pub const CFSTR_PASTESUCCEEDED: ::windows_strings::PCWSTR = ::windows_strings::w!("Paste Succeeded");
pub const CFSTR_PERFORMEDDROPEFFECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Performed DropEffect");
pub const CFSTR_PERSISTEDDATAOBJECT: ::windows_strings::PCWSTR = ::windows_strings::w!("PersistedDataObject");
pub const CFSTR_PREFERREDDROPEFFECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Preferred DropEffect");
pub const CFSTR_PRINTERGROUP: ::windows_strings::PCWSTR = ::windows_strings::w!("PrinterFriendlyName");
pub const CFSTR_SHELLDROPHANDLER: ::windows_strings::PCWSTR = ::windows_strings::w!("DropHandlerCLSID");
pub const CFSTR_SHELLIDLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("Shell IDList Array");
pub const CFSTR_SHELLIDLISTOFFSET: ::windows_strings::PCWSTR = ::windows_strings::w!("Shell Object Offsets");
pub const CFSTR_SHELLURL: ::windows_strings::PCWSTR = ::windows_strings::w!("UniformResourceLocator");
pub const CFSTR_TARGETCLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("TargetCLSID");
pub const CFSTR_UNTRUSTEDDRAGDROP: ::windows_strings::PCWSTR = ::windows_strings::w!("UntrustedDragDrop");
pub const CFSTR_ZONEIDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("ZoneIdentifier");
...
pub const CMDSTR_NEWFOLDER: ::windows_strings::PCWSTR = ::windows_strings::w!("NewFolder");
pub const CMDSTR_NEWFOLDERA: ::windows_strings::PCSTR = ::windows_strings::s!("NewFolder");
pub const CMDSTR_NEWFOLDERW: ::windows_strings::PCWSTR = ::windows_strings::w!("NewFolder");
pub const CMDSTR_VIEWDETAILS: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewDetails");
pub const CMDSTR_VIEWDETAILSA: ::windows_strings::PCSTR = ::windows_strings::s!("ViewDetails");
pub const CMDSTR_VIEWDETAILSW: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewDetails");
pub const CMDSTR_VIEWLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewList");
pub const CMDSTR_VIEWLISTA: ::windows_strings::PCSTR = ::windows_strings::s!("ViewList");
pub const CMDSTR_VIEWLISTW: ::windows_strings::PCWSTR = ::windows_strings::w!("ViewList");
...
pub const CONFLICT_RESOLUTION_CLSID_KEY: ::windows_strings::PCWSTR = ::windows_strings::w!("ConflictResolutionCLSID");
...
pub const DI_GETDRAGIMAGE: ::windows_strings::PCWSTR = ::windows_strings::w!("ShellGetDragImage");
...
pub const PROPSTR_EXTENSIONCOMPLETIONSTATE: ::windows_strings::PCWSTR = ::windows_strings::w!("ExtensionCompletionState");
pub const PROP_CONTRACT_DELEGATE: ::windows_strings::PCWSTR = ::windows_strings::w!("ContractDelegate");
...
pub const SHIMGKEY_QUALITY: ::windows_strings::PCWSTR = ::windows_strings::w!("Compression");
pub const SHIMGKEY_RAWFORMAT: ::windows_strings::PCWSTR = ::windows_strings::w!("RawDataFormat");
...
pub const STR_AVOID_DRIVE_RESTRICTION_POLICY: ::windows_strings::PCWSTR = ::windows_strings::w!("Avoid Drive Restriction Policy");
pub const STR_BIND_DELEGATE_CREATE_OBJECT: ::windows_strings::PCWSTR = ::windows_strings::w!("Delegate Object Creation");
pub const STR_BIND_FOLDERS_READ_ONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("Folders As Read Only");
pub const STR_BIND_FOLDER_ENUM_MODE: ::windows_strings::PCWSTR = ::windows_strings::w!("Folder Enum Mode");
pub const STR_BIND_FORCE_FOLDER_SHORTCUT_RESOLVE: ::windows_strings::PCWSTR = ::windows_strings::w!("Force Folder Shortcut Resolve");
pub const STR_DONT_PARSE_RELATIVE: ::windows_strings::PCWSTR = ::windows_strings::w!("Don\'t Parse Relative");
pub const STR_DONT_RESOLVE_LINK: ::windows_strings::PCWSTR = ::windows_strings::w!("Don\'t Resolve Link");
pub const STR_ENUM_ITEMS_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SHCONTF");
pub const STR_FILE_SYS_BIND_DATA: ::windows_strings::PCWSTR = ::windows_strings::w!("File System Bind Data");
pub const STR_FILE_SYS_BIND_DATA_WIN7_FORMAT: ::windows_strings::PCWSTR = ::windows_strings::w!("Win7FileSystemIdList");
pub const STR_GET_ASYNC_HANDLER: ::windows_strings::PCWSTR = ::windows_strings::w!("GetAsyncHandler");
pub const STR_GPS_BESTEFFORT: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_BESTEFFORT");
pub const STR_GPS_DELAYCREATION: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_DELAYCREATION");
pub const STR_GPS_FASTPROPERTIESONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_FASTPROPERTIESONLY");
pub const STR_GPS_HANDLERPROPERTIESONLY: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_HANDLERPROPERTIESONLY");
pub const STR_GPS_NO_OPLOCK: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_NO_OPLOCK");
pub const STR_GPS_OPENSLOWITEM: ::windows_strings::PCWSTR = ::windows_strings::w!("GPS_OPENSLOWITEM");
pub const STR_INTERNAL_NAVIGATE: ::windows_strings::PCWSTR = ::windows_strings::w!("Internal Navigation");
pub const STR_INTERNETFOLDER_PARSE_ONLY_URLMON_BINDABLE: ::windows_strings::PCWSTR = ::windows_strings::w!("Validate URL");
pub const STR_ITEM_CACHE_CONTEXT: ::windows_strings::PCWSTR = ::windows_strings::w!("ItemCacheContext");
pub const STR_MYDOCS_CLSID: ::windows_strings::PCSTR = ::windows_strings::s!("{450D8FBA-AD25-11D0-98A8-0800361B1103}");
pub const STR_NO_VALIDATE_FILENAME_CHARS: ::windows_strings::PCWSTR = ::windows_strings::w!("NoValidateFilenameChars");
pub const STR_PARSE_ALLOW_INTERNET_SHELL_FOLDERS: ::windows_strings::PCWSTR = ::windows_strings::w!("Allow binding to Internet shell folder handlers and negate STR_PARSE_PREFER_WEB_BROWSING");
pub const STR_PARSE_AND_CREATE_ITEM: ::windows_strings::PCWSTR = ::windows_strings::w!("ParseAndCreateItem");
pub const STR_PARSE_DONT_REQUIRE_VALIDATED_URLS: ::windows_strings::PCWSTR = ::windows_strings::w!("Do not require validated URLs");
pub const STR_PARSE_EXPLICIT_ASSOCIATION_SUCCESSFUL: ::windows_strings::PCWSTR = ::windows_strings::w!("ExplicitAssociationSuccessful");
pub const STR_PARSE_PARTIAL_IDLIST: ::windows_strings::PCWSTR = ::windows_strings::w!("ParseOriginalItem");
pub const STR_PARSE_PREFER_FOLDER_BROWSING: ::windows_strings::PCWSTR = ::windows_strings::w!("Parse Prefer Folder Browsing");
pub const STR_PARSE_PREFER_WEB_BROWSING: ::windows_strings::PCWSTR = ::windows_strings::w!("Do not bind to Internet shell folder handlers");
pub const STR_PARSE_PROPERTYSTORE: ::windows_strings::PCWSTR = ::windows_strings::w!("DelegateNamedProperties");
pub const STR_PARSE_SHELL_PROTOCOL_TO_FILE_OBJECTS: ::windows_strings::PCWSTR = ::windows_strings::w!("Parse Shell Protocol To File Objects");
pub const STR_PARSE_SHOW_NET_DIAGNOSTICS_UI: ::windows_strings::PCWSTR = ::windows_strings::w!("Show network diagnostics UI");
pub const STR_PARSE_SKIP_NET_CACHE: ::windows_strings::PCWSTR = ::windows_strings::w!("Skip Net Resource Cache");
pub const STR_PARSE_TRANSLATE_ALIASES: ::windows_strings::PCWSTR = ::windows_strings::w!("Parse Translate Aliases");
pub const STR_PARSE_WITH_EXPLICIT_ASSOCAPP: ::windows_strings::PCWSTR = ::windows_strings::w!("ExplicitAssociationApp");
pub const STR_PARSE_WITH_EXPLICIT_PROGID: ::windows_strings::PCWSTR = ::windows_strings::w!("ExplicitProgid");
pub const STR_PARSE_WITH_PROPERTIES: ::windows_strings::PCWSTR = ::windows_strings::w!("ParseWithProperties");
pub const STR_PROPERTYBAG_PARAM: ::windows_strings::PCWSTR = ::windows_strings::w!("SHBindCtxPropertyBag");
pub const STR_REFERRER_IDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("Referrer Identifier");
pub const STR_SKIP_BINDING_CLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("Skip Binding CLSID");
pub const STR_STORAGEITEM_CREATION_FLAGS: ::windows_strings::PCWSTR = ::windows_strings::w!("SHGETSTORAGEITEM");
pub const STR_TAB_REUSE_IDENTIFIER: ::windows_strings::PCWSTR = ::windows_strings::w!("Tab Reuse Identifier");
pub const STR_TRACK_CLSID: ::windows_strings::PCWSTR = ::windows_strings::w!("Track the CLSID");
...
pub const SZ_CONTENTTYPE_CDF: ::windows_strings::PCWSTR = ::windows_strings::w!("application/x-cdf");
pub const SZ_CONTENTTYPE_CDFA: ::windows_strings::PCSTR = ::windows_strings::s!("application/x-cdf");
pub const SZ_CONTENTTYPE_CDFW: ::windows_strings::PCWSTR = ::windows_strings::w!("application/x-cdf");
pub const SZ_CONTENTTYPE_HTML: ::windows_strings::PCWSTR = ::windows_strings::w!("text/html");
pub const SZ_CONTENTTYPE_HTMLA: ::windows_strings::PCSTR = ::windows_strings::s!("text/html");
pub const SZ_CONTENTTYPE_HTMLW: ::windows_strings::PCWSTR = ::windows_strings::w!("text/html");
...
pub const VOLUME_PREFIX: ::windows_strings::PCWSTR = ::windows_strings::w!("\\\\?\\Volume");
