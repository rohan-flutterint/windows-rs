...
pub const JET_wszConfigStoreReadControl: ::windows_strings::PCWSTR = ::windows_strings::w!("CsReadControl");
pub const JET_wszConfigStoreRelPathSysParamDefault: ::windows_strings::PCWSTR = ::windows_strings::w!("SysParamDefault");
pub const JET_wszConfigStoreRelPathSysParamOverride: ::windows_strings::PCWSTR = ::windows_strings::w!("SysParamOverride");
