...
pub const DD_SCSI_DEVICE_NAME: ::windows_strings::PCSTR = ::windows_strings::s!("\\Device\\ScsiPort");
...
pub const ID_FQDN: ::windows_strings::PCSTR = ::windows_strings::s!("2");
pub const ID_IPV4_ADDR: ::windows_strings::PCSTR = ::windows_strings::s!("1");
pub const ID_IPV6_ADDR: ::windows_strings::PCSTR = ::windows_strings::s!("5");
pub const ID_USER_FQDN: ::windows_strings::PCSTR = ::windows_strings::s!("3");
...
pub const IOCTL_MINIPORT_SIGNATURE_DSM_GENERAL: ::windows_strings::PCSTR = ::windows_strings::s!("MPDSMGEN");
pub const IOCTL_MINIPORT_SIGNATURE_DSM_NOTIFICATION: ::windows_strings::PCSTR = ::windows_strings::s!("MPDSM   ");
pub const IOCTL_MINIPORT_SIGNATURE_ENDURANCE_INFO: ::windows_strings::PCSTR = ::windows_strings::s!("ENDURINF");
pub const IOCTL_MINIPORT_SIGNATURE_FIRMWARE: ::windows_strings::PCSTR = ::windows_strings::s!("FIRMWARE");
pub const IOCTL_MINIPORT_SIGNATURE_HYBRDISK: ::windows_strings::PCSTR = ::windows_strings::s!("HYBRDISK");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PHYSICAL_TOPOLOGY: ::windows_strings::PCSTR = ::windows_strings::s!("TOPOLOGY");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PROTOCOL: ::windows_strings::PCSTR = ::windows_strings::s!("PROTOCOL");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_TEMPERATURE: ::windows_strings::PCSTR = ::windows_strings::s!("TEMPERAT");
pub const IOCTL_MINIPORT_SIGNATURE_SCSIDISK: ::windows_strings::PCSTR = ::windows_strings::s!("SCSIDISK");
pub const IOCTL_MINIPORT_SIGNATURE_SET_PROTOCOL: ::windows_strings::PCSTR = ::windows_strings::s!("SETPROTO");
pub const IOCTL_MINIPORT_SIGNATURE_SET_TEMPERATURE_THRESHOLD: ::windows_strings::PCSTR = ::windows_strings::s!("SETTEMPT");
...
pub const ISCSI_LOGIN_OPTIONS_AUTH_TYPE: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000080");
pub const ISCSI_LOGIN_OPTIONS_DATA_DIGEST: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000002");
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_RETAIN: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000010");
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_WAIT: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000008");
pub const ISCSI_LOGIN_OPTIONS_HEADER_DIGEST: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000001");
pub const ISCSI_LOGIN_OPTIONS_MAXIMUM_CONNECTIONS: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000004");
pub const ISCSI_LOGIN_OPTIONS_PASSWORD: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000040");
pub const ISCSI_LOGIN_OPTIONS_USERNAME: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000020");
...
pub const ISCSI_SECURITY_FLAG_AGGRESSIVE_MODE_ENABLED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000008");
pub const ISCSI_SECURITY_FLAG_IKE_IPSEC_ENABLED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000002");
pub const ISCSI_SECURITY_FLAG_MAIN_MODE_ENABLED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000004");
pub const ISCSI_SECURITY_FLAG_PFS_ENABLED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000010");
pub const ISCSI_SECURITY_FLAG_TRANSPORT_MODE_PREFERRED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000020");
pub const ISCSI_SECURITY_FLAG_TUNNEL_MODE_PREFERRED: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000040");
pub const ISCSI_SECURITY_FLAG_VALID: ::windows_strings::PCSTR = ::windows_strings::s!("0x00000001");
